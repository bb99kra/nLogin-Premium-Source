...
public class ρνΨσρτφψερΩρΓρΨ extends ζαξρυωβζπ implements ξετφΔοΩψνε {
   ...
   private static String[] d = new String[ρνΨσρτφψερΩρΓρΨ.ak];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = πηγμΣΔκκ.E("Կ՟ձՒՍ՚ՄԴծԴ՛Մ", (byte)64, 69);
               d[1] = θεωψξβΛσσ.C("ӣӘӛӛӈӇӎӔӄӪӑӃӺөӷҸәӯһӓҸӱӈӉ", (byte)64, 67);
               d[2] = οοθδΨιοΦΠβδζ.E("ՇԶյՙլԵ\u0558զՅՑ՟Մ", (byte)64, 69);
               break;
            case 1:
               d[0] = μζξτΩσσφυδεπλΨ.E("գզԭՌՏԺՕձ\u0558յԶՄ", (byte)64, 69);
               d[1] = πηγμΣΔκκ.A("ŭŢťťŒőŘŞŎŴŝŰŃĿřńƁƁłŘƊƋŒœ", (byte)64, 65);
               d[2] = πχσδΦΦνθΔπ.E("էԳՈՊՋԳՌՇԹ՜ՋՄ", (byte)64, 69);
               break;
            case 2:
               d[0] = ζοηκορΦνΣθγΩ.B("ŃŃŷŃżűķŌŎŐœĻŔşřŸŝƃŖŋťŻŒœ", (byte)64, 66);
            case 3:
            default:
               break;
            case 4:
               d[0] = πψυκΠΨμΛΩβΣφμφσ.A("ŔūūıĹŎİĿŨĿżĿŭťžžũśŲųţŉŇŁƏŋŜţŌſŬŲ", (byte)64, 65);
         }
      }
   }
   ...
   public String w(String var1) {
      String var2 = ΣλνΨουΩΔοθεβ.ae.a(new Object[ad]);
      int var3 = ΣλνΨουΩΔοθεβ.ad.r();
      return c<"㺀">(ae & af, ag) + var2 + c<"㺃">(ah, ai) + c(var2, var3, var1);
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΦδφπθΩΩλζξ.E("\u058c֙֘՛֛֛֦֗֒֕բ֤֦֠֝֠ըࣻࣸࣤऀࣿःआउࣷऄ࣭आࣙईࣰ", (byte)109, 69));
         }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ρνΨσρτφψερΩρΓρΨ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ΠΛΨοδΩσμνΛγΦφβς.B("ƓƵƷƗƻǚǒǨǔƣǡǗǥǟƨǍǯǮǦǬǦƻ", (byte)118, 66), ρνΨσρτφψερΩρΓρΨ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            μζξτΩσσφυδεπλΨ.A("ǎǛǚƝǝǙǔǝǨǗƤǢǦǟǢǨƪԽԺԦՂՁՅՈՋԹՆԯՈԛՊԲǅ", (byte)118, 65) + var1 + βθκςνθΩθυμςτκχ.D("Ց", (byte)118, 68) + var2.toString(), var4
         );
      }
   }
