...
public class NLoginCore_265 {
   private static String[] b = new String[NLoginCore_265.d];
   private static int a = Integer.reverse(0);
   private static String[] a = new String[NLoginCore_265.c];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = NLoginCore_530.F("ոբՙ\u058bղզձ֠չ֛֓֗ճ֟յ՚֙չժ֧ընճմ", (byte)100, 70);
               break;
            case 1:
               b[0] = NLoginCore_324.D("ԹԣԚՌԳԧԲաԺՔ՝ԯ\u0557ԾթԼդեՙՙԫիՊԮԫըԫՇՌՔԴՋ", (byte)100, 68);
               break;
            case 2:
               b[0] = NLoginCore_110.E("ղշմ֓՚մռցմր֒֕րգ֏֢֘֗ի֖֝նճմ", (byte)100, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = NLoginCore_201.A("ƽƌƯƼƑžƴƯƟƝƅƏ", (byte)100, 65);
         }
      }
   }
