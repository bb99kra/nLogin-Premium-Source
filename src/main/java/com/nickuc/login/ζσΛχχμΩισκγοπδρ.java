...
public class ζσΛχχμΩισκγοπδρ extends τηΩνβΠαεξλκτ {
   ...
   private static String[] b = new String[ζσΛχχμΩισκγοπδρ.ap];
   ...
   private static String[] a = new String[ζσΛχχμΩισκγοπδρ.ao];
   ...
   protected Connection c() {
      try {
         ...
         if (this.a.compareTo(χκιΛφΓκκρλθλψο.c) >= 0) {
            ...
            var10001[ah] = this.aB;
            var10001[ai] = this.e;
            var10001[aj] = Boolean.valueOf((boolean)ak);
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΨφιωσρΓδΔθ.D("ҜҩҨѫҫҧҢҫҶҥѲҰҴҭҰҶѸࠀࠎߧࠔࠕࠋ߹ࠊࠕࠍࠇࠔࠖࠋ࠙", (byte)44, 68));
         }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ζσΛχχμΩισκγοπδρ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ΠΛΨοδΩσμνΛγΦφβς.D("ӐӲӴӔӸԗԏԥԑӠԞԔԢԜӥԊԬԫԣԩԣӸ", (byte)81, 68), ζσΛχχμΩισκγοπδρ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζβησεθωυγτ.C("ԋԘԗӚԚԖԑԚԥԔӡԟԣԜԟԥӧ\u086fࡽࡖࢃࢄࡺࡨࡹࢄࡼࡶࢃࢅࡺ࢈Ԃ", (byte)81, 67) + var1 + χΠξΦιζΨΣωΦσΨζ.B("ś", (byte)81, 66) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = πψυκΠΨμΛΩβΣφμφσ.A("ģŌĒĴņŖķŇŐĹşŖŞŒĢĻŢĴŁœŋŚśĩĬŀīŏŦőŁĲŒŷĳŌļŭŒœūĳŸŇ", (byte)48, 65);
               b[1] = ιΠοθΩΦξκ.D("҆ҵҺҏҖҋҎӄӄҽ҂҈ҞҾ҆ҥӂӅӆҪҝӉҧҿҔҏӎңӇӍӄӊҘҲҬӑӖҫӠӕәӞҴҭ", (byte)48, 68);
               b[2] = λΣΩσμφγχ.F("ՄՖԞՠԽՂՔ՝՜՞ՏԴ", (byte)48, 70);
               b[3] = ιΠοθΩΦξκ.C("үҠҝӂүѾҬҭ҄ӃҲҍ", (byte)48, 67);
               b[4] = ςπυηννναΣ.F("ՖՇՄթՖԥՓՔԫժՙԴ", (byte)48, 70);
               b[5] = ΣφδσΔζιΠρα.D("ѷҵҌҊҎҒѼӆҗӆҨ҈҅ҦҔ҆ҜӎҧӆӃҫҘҙ", (byte)48, 68);
               break;
            case 1:
               b[0] = φΨαξωυθανΣφυκη.C("҉ҲѸҚҬҼҝҭҶҟӅҼӄҸ҈ҡӈҚҧҹұӀӁҏҒҦґҵӌҷҧҘһӒҚҮӗӟҼӐҹӥӦҭ", (byte)48, 67);
               b[1] = ιΠοθΩΦξκ.A("ĠŏŔĩİĥĨŞŞŗĜĢĸŘĠĿŜşŠńķţŁřĮĩŨĽšŧŞŤłňůţŪĽļſűŗŸŇ", (byte)48, 65);
               b[2] = φΨαξωυθανΣφυκη.F("ՕԶԼՕգՀի՝բժՃԴ", (byte)48, 70);
               b[3] = οοθδΨιοΦΠβδζ.A("ĕġņķļĭĝŝŝēŃŔģŅŦŞłĤşŉōŅĲĳ", (byte)48, 65);
               b[4] = μζξτΩσσφυδεπλΨ.F("ԥ՞\u0530Ց՛՚ՓբաԷ\u0557զԯ՟իՅբԾեճԸՒԿՀ", (byte)48, 70);
               b[5] = βθκςνθΩθυμςτκχ.B("đŏĦĤĨĬĖŠıŠłĲĜĞĘİŚŪŀŊŗśĲĳ", (byte)48, 66);
               break;
            case 2:
               b[0] = οΩνΩρωλΨηΛδωδ.F("ՅԸՙԼՕԩբԸիԬ՝Դ", (byte)48, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = ντθΔζβΔζ.D("ҰҠҨҼҼҠҸӀқҖғҖӁӊҋҿҍӈҝӋӋӁҘҙ", (byte)48, 68);
         }
      }
   }

   private ζσΛχχμΩισκγοπδρ(εηχβγρΦβΦΛκγΦοδ<?> var1, χκιΛφΓκκρλθλψο var2, File var3, Properties var4, @Nullable String var5, @Nullable Object var6) {
      ΔυΠωθαψδΣΣαδψω var10000 = var1.a();
      ρΣνμχγΨοΔΦ[] var10001 = new ρΣνμχγΨοΔΦ[a];
      var10001[b] = χκιΛφΓκκρλθλψο.a(var2);
      ΔΦξΩΣαγλθεΓβχ var7 = var10000.a(var10001);

      try {
         Class var8 = var7.loadClass(c<"㺀">(c, d ^ e));
         Constructor var12;
         if (var2 == χκιΛφΓκκρλθλψο.b) {
      ...
      if (!var11.exists() && !var11.mkdirs()) {
         throw new RuntimeException(c<"㺃">(o, p ^ q) + var11 + c<"㺆">(r, s ^ t));
      } else {
         String var9 = var3.getAbsolutePath();
         if (var9.endsWith(c<"㺉">(u, v ^ w))) {
            var9 = var9.substring(x, var9.length() - c<"㺌">(y & z, aa).length());
         }

         this.a = var2;
         this.aA = c<"㺏">(ab & ac, ad) + var9;
         this.c = var4;
         this.aB = var5;
         this.e = var6;
      }
   ...
   public static ζσΛχχμΩισκγοπδρ a(εηχβγρΦβΦΛκγΦοδ<?> var0, χκιΛφΓκκρλθλψο var1, File var2, Properties var3, @Nullable String var4, @Nullable Object var5) {
      return new ζσΛχχμΩισκγοπδρ(var0, var1, var2, var3, var4, var5);
   }

   public static ζσΛχχμΩισκγοπδρ a(εηχβγρΦβΦΛκγΦοδ<?> var0, χκιΛφΓκκρλθλψο var1, File var2, Properties var3) {
