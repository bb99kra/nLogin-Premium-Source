...
enum NLoginCore_506 {
   ...
   private static String[] a = new String[NLoginCore_506.f];
   private static String[] b = new String[NLoginCore_506.g];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = NLoginCore_453.E("ԀӿԏӾԣՉԹԬԡԈՀԓ", (byte)15, 69);
               b[1] = NLoginCore_530.D("ХюзѐєНаЛіПхЪ", (byte)15, 68);
               b[2] = NLoginCore_427.E("ԞԐԒԡԺՊԆԊԋՎԚԓ", (byte)15, 69);
               b[3] = NLoginCore_091.F("ԸԷԲԙԣՃՂԡԖԫԾԦԭԍԫԢԣԒՁ\u0558Ԙ\u0557Ԟԟ", (byte)15, 70);
               break;
            case 1:
               b[0] = NLoginCore_397.C("фкЪиБвљљѡОнЪ", (byte)15, 67);
               b[1] = NLoginCore_110.C("алШвџЛНЛЯјѦяђојѦгїќњЫшеж", (byte)15, 67);
               b[2] = NLoginCore_232.D("юшьэђљпРіьѠчесгкТўеЬюиеж", (byte)15, 68);
               b[3] = NLoginCore_183.D("яющакњљиЭтєПФлШолрншѨўеж", (byte)15, 68);
               break;
            case 2:
               b[0] = NLoginCore_076.A("ĔÔîđúóėìĉĝĔĂÝïĤĄĤúþĈęęðñ", (byte)15, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = NLoginCore_427.E("ԂԅԸԸՀԩԕԅԪԶԜԌԧԽԝԾԳԵՄԬԴ\u0557Ԟԟ", (byte)15, 69);
         }
      }
   }
