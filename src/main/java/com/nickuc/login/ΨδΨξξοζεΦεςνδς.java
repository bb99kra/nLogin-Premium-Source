...
public interface ΨδΨξξοζεΦεςνδς {
   @CheckReturnValue
   default ΔτιηητηζΔ a(String var1, Object... var2) {
      ...
      try {
         ...
         return new ΔτιηητηζΔ(this, var3, var4, var5, null);
   ...
   default θβυσωφιλτπχΓμ<Integer> b(String var1, Object... var2) {
      Connection var3 = this.a();
      ...
      try {
         ...
         try {
            this.a(var4, var2);
            var5 = new θβυσωφιλτπχΓμ(var4.executeUpdate(), null);
   ...
   @CheckReturnValue
   default νξΓωΔΔγλκμ a() {
      return new νξΓωΔΔγλκμ(this, this.a(), null);
   }
   ...
   @CheckReturnValue
   default πεζΣφιησπξφζ a(String var1, Object... var2) {
      Connection var3 = this.a();
      PreparedStatement var4 = null;
      ...
      try {
         var4 = var3.prepareStatement(var1);
         this.a(var4, var2);
         return new πεζΣφιησπξφζ(this, var3, var4, null);
      } catch (SQLException var6) {
         if (var4 != null) {
            var4.close();
         }
   ...
   default θβυσωφιλτπχΓμ<Boolean> a(String var1, Object... var2) {
      Connection var3 = this.a();
      ...
      try {
         ...
         try {
            this.a(var4, var2);
            var5 = new θβυσωφιλτπχΓμ(var4.execute(), null);
         } catch (Throwable var12) {
            if (var4 != null) {
               try {
                  var4.close();
