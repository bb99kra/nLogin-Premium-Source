...
public enum γΠζΣΣΩμΛ {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = οοθδΨιοΦΠβδζ.D("ՄԫճյՁՕՀԲԺՋժՁ", (byte)108, 68);
               b[1] = βεξΠθρρςΔΦμ.B("ƝƞƨǎǄǎǀǒƪǕƓƙǅƥƶǍƨǟƙǄǠƽƪƫ", (byte)108, 66);
               b[2] = ΠΛΨοδΩσμνΛγΦφβς.E("֎ւճ֓յ֢֕ֆ֢ղջհ", (byte)108, 69);
               break;
            case 1:
               b[0] = δΛψπξκσβγςα.A("ƤǁƨǂƿǃǗƏƤǃƲǊǒǛƲǕƟƜƝǤƳƭƪƫ", (byte)108, 65);
               b[1] = βθκςνθΩθυμςτκχ.A("ƝƞƨǎǄǎǀǒƪǕƒǅǐƬǗƹưƓǎǕƮǣƪƫ", (byte)108, 65);
               b[2] = πηγμΣΔκκ.D("Ձզ՜ՖկԮգկ\u0558զՄՁ", (byte)108, 68);
               break;
            case 2:
               b[0] = πηγμΣΔκκ.E("չ֚֚ռ֔֔֕ղ֦֣ս֦է֡օկ\u0590֤֚օփ֭ք֭ձֳֹ֬ֆ֍֫շ", (byte)108, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = πχσδΦΦνθΔπ.E("պժք֓ծշ֔ևֆ֢մչք֏ֲ֤֗֫\u058cֈ֢֣֯֗֨պֳֳ֥֑֭֙", (byte)108, 69);
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(χΠξΦιζΨΣωΦσΨζ.C("ϵЗЙϹНмдъжЅуйчсЊЯёѐшюшН", (byte)8, 67), γΠζΣΣΩμΛ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(χφπρψπφΦθμπ.C("анмϿплжпъйІфшсфъЌޑݿޖބޅތޠހР", (byte)8, 67) + var1 + μεςΩΔΣγν.C("Ї", (byte)8, 67) + var2.toString(), var4);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(βθκςνθΩθυμςτκχ.D("ӪӷӶҹӹӵӰӹԄӳӀӾԂӻӾԄӆࡋ࠹ࡐ࠾\u083fࡆ࡚࠺", (byte)70, 68));
         }
