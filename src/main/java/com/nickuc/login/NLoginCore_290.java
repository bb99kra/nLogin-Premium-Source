...
public class NLoginCore_290 implements NLoginInterface_027 {
   ...
   private static final String m = a(g, NLoginCore_290.h ^ NLoginCore_290.i);
   ...
   static {
      b();
      r = ((NLoginCore_546.a(AsyncPlayerPreLoginEvent.class, a(j, k ^ l) != 0)) != null ? n : o);
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (ZKM_STR_A[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_127.A("ƖƣƢťƥơƜƥưƟŬƪƮƧƪưŲԌәԁӹӨӻԐԏԊԃԗԄԅԕ", (byte)90, 65));
         }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_290.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_453.E("ՉիխՍձ\u0590ֈ֞֊ՙ֗֍֛֕՞փ֥֤֢֜֜ձ", (byte)101, 69), NLoginCore_290.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_173.F("ք֑\u0590Փ֓֏֊֓֞֍՚֘֜֕֘֞ՠࣺࣇࣱ࣯ࣩࣧࣖࣾࣽࣸअࣲࣳःպ", (byte)101, 70) + var1 + NLoginCore_559.F("՛", (byte)101, 70) + var2.toString(), var4
         );
      }
   }

   @Generated
   public NLoginCore_290(nLoginBukkit var1) {
      this.j = var1;
   }
      ...
      if (var1.getLoginResult() == Result.ALLOWED) {
         ...
         if (var4 != null) {
            ...
            if (var5 != null || var6 != null) {
               ...
               if (var6 != null) {
                  var7.setProperty(new ProfileProperty(a(a, b ^ d), var6.ce, var6.cf));
               }
            }
         }
      }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_110.F("ԯ՞ՒձծզմմիՇճբճՖճԶՖռՙ՟ււՉՊ", (byte)58, 70);
               ZKM_STR_B[1] = NLoginCore_530.C("ҜӋҿӞӛӓӡӡӘҴӠӏӠӃӠңӃөӆӌӯӯҶҷ", (byte)58, 67);
               ZKM_STR_B[2] = NLoginCore_223.B("ŖŝňōŨıĽšŝĵŬŗŏœńţļŰķūŖŷŔſłŐŅſŠŁŖŅ", (byte)58, 66);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_324.E("ԯ՞ՒձծզմմիՇճՋռյԯՐՙԼ՞ՒՍ՜ՉՊ", (byte)58, 69);
               ZKM_STR_B[1] = NLoginCore_471.F("ԯ՞ՒձծզմմիՇմպչղԯՇԽՎԸպձՌՉՊ", (byte)58, 70);
               ZKM_STR_B[2] = NLoginCore_127.A("ŖŝňōŨıĽšŝĵŬŗŏœńţļŰķūŖźōĵœŏĸŐőŇŨŸ", (byte)58, 65);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_427.A("ĞŜĩşĦŤŮŎńĬŅŪŴıŭōŉŸśŐŜſņŇ", (byte)58, 65);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_138.B("ŚŚĩśūħņŞŊŋŴűįōņŋŔśŴŰűřņŇ", (byte)58, 66);
         }
      }
   }
}
