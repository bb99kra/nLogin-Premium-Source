...
public class ΓχοθψΦυψωζσσ {
   ...
   private static String[] a = new String[dh];
   ...
   private static String[] b = new String[ΓχοθψΦυψωζσσ.di];
   ...
   private static String aT = c<"㺀">(ΓχοθψΦυψωζσσ.dk, ΓχοθψΦυψωζσσ.dl);
   ...
   private static final int H = ΓχοθψΦυψωζσσ.dj;
   ...
   public βΠτπξπΛχηΦΦΛα a(String var1, File var2, int var3) {
      try {
         return this.b(var1, var2, var3);
      } catch (IOException var5) {
         return new βΠτπξπΛχηΦΦΛα((boolean)bj, bk, 0L, var5);
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(δΛψπξκσβγςα.E("Ե\u0557ՙԹ՝ռմ֊նՅփչևցՊկ֑\u0590ֈ֎ֈ՝", (byte)81, 69), ΓχοθψΦυψωζσσ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            θεωψξβΛσσ.C("ԋԘԗӚԚԖԑԚԥԔӡԟԣԜԟԥӧࡌࢁࡺࡴࢅࡤࢄ࢈ࢊࡸࢆࢇӿ", (byte)81, 67) + var1 + οοθδΨιοΦΠβδζ.A("ś", (byte)81, 65) + var2.toString(), var4
         );
      }
   }

   private void a(HttpURLConnection var1, String var2) {
      var1.setInstanceFollowRedirects((boolean)f);
      if (var2 != null && !var2.isEmpty()) {
         try {
            var1.setRequestMethod(var2);
         } catch (ProtocolException var4) {
            throw new IllegalArgumentException(c<"㺀">(g & h, i) + var2 + c<"㺃">(j & k, l), var4);
         }
      }

      this.h.putIfAbsent(c<"㺆">(m, n ^ o), aT);
   ...
   public βΠτπξπΛχηΦΦΛα b(String var1, File var2, int var3) {
      HttpURLConnection var4 = null;

      try {
         var4 = (HttpURLConnection)new URL(var1).openConnection();
         this.a(var4, c<"㺀">(bl, bm ^ bn));
         ...
         do {
            ...
            if (var5 != 0) {
               var4.disconnect();
               String var7 = var4.getHeaderField(c<"㺃">(bs, bt ^ bu));
               var4 = (HttpURLConnection)new URL(var7).openConnection();
               this.a(var4, c<"㺆">(bv & bw, bx));
            }
         } while (var5 != 0);
         ...
         if (var3 > 0 && var3 > var50) {
            return new βΠτπξπΛχηΦΦΛα((boolean)bz, var8, var50, null);
         } else if (var2.exists() && !var2.delete()) {
            throw new IOException(c<"㺉">(ca, cb ^ cc) + var2 + c<"㺌">(cd, ce ^ cf));
         } else {
            try {
                  ...
                  try {
                     ...
                     if (var9 == null) {
                        ...
                        if (!var2.exists() && !var2.createNewFile()) {
                           throw new IOException(c<"㺏">(ci, cj ^ ck) + var2 + c<"㺒">(cl, cm));
                        }
                        ...
                        try {
                           var36 = true;
                           BufferedOutputStream var11 = πησοιΣζΩθΛδλζσ.a(var2);
                           boolean var43 = false /* VF: Semaphore variable */;

                           try {
                              var43 = true;
                              πελπφβυψεσαωοΦ.a(var53, var11);
                              var12 = new βΠτπξπΛχηΦΦΛα((boolean)(var2.exists() && var2.length() > 0L ? co : cp), var8, var50);
                              var43 = false;
                           } finally {
                              if (var43) {
                     ...
                     var52 = new βΠτπξπΛχηΦΦΛα((boolean)cg, var8, var50, null);
                     var29 = false;
                  } finally {
                     if (var29) {
               ...
               return new βΠτπξπΛχηΦΦΛα((boolean)cw, var8, var50, var47);
            }
         }
      } catch (SocketTimeoutException var48) {
         throw new SocketTimeoutException(c<"㺕">(cx & cy, cz));
      } finally {
         if (var4 != null) {
            var4.disconnect();
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = θεωψξβΛσσ.A("ƇƵŬűƭƖƄƌƦƊƴƃ", (byte)94, 65);
               b[1] = ζβησεθωυγτ.F("վձն֗ժՓը֙պս֑՜և֗ճ՜֚֠֓֓֟հխծ", (byte)94, 70);
               b[2] = λΣΩσμφγχ.A("ƤƮƈƓƖƐƮŵƹƅƒŵǀƶƺƟƿơƅƄƤƷƎƏ", (byte)94, 65);
               b[3] = χΠξΦιζΨΣωΦσΨζ.F("սֆ֊ղմՒ֒Ռպ՚՚֎ծ֎ձբ֣բռքֆճ֛֞֙֘֠։֣֮\u0590֫", (byte)94, 70);
               b[4] = πψυκΠΨμΛΩβΣφμφσ.B("ƉƫűƴƩƳƅƏƽŶŽżƿƸƋƽżƔƱƒƕǇƎƏ", (byte)94, 66);
               b[5] = ξψθρΣΠΣς.F("ծ։դժրՑօ֎է֘սբ", (byte)94, 70);
               b[6] = πχσδΦΦνθΔπ.D("ԔՆԃՉԥԝԙԁԯՄՏԏԭՎՊԐԱԡԣՈՇ՛Ԣԣ", (byte)94, 68);
               b[7] = ντθΔζβΔζ.F("ծ։դժրՑօ֎է֘սբ", (byte)94, 70);
               b[8] = πηγμΣΔκκ.A("ƆƦƭƘƐƨƅƄƗƚƼŸŹƁưƴžƾƎƖƃǈƖƶǆǆƌƟƝƤƌƋƑƱƦƨǍƲǎƧƓƪǌưǞǡǟǜǁǄƞƥƦƣǠǃǗƿƹƫƻǯǯǍǋƾǯǌǣǊǥǚƲǇǞǃ", (byte)94, 65);
               b[9] = ςπυηννναΣ.F("ՎղՏ֖֓ւ֎Ք֜֍զ֚֞֍\u0590նձձհփ՟րխծ", (byte)94, 70);
               b[10] = πχσδΦΦνθΔπ.A("ƵƊƪƪơƅƒƨƛŷƴƃ", (byte)94, 65);
               b[11] = δΛψπξκσβγςα.B("ƇơƋũƯƇƤƌźƥƨƯƈƙƵƔƴƗƖƓǇƷƎƏ", (byte)94, 66);
               b[12] = μζξτΩσσφυδεπλΨ.E("վՋՍֆկ֏Տղ֛օ՜բ", (byte)94, 69);
               b[13] = ΠΛΨοδΩσμνΛγΦφβς.D("ԔՆԃՉԥԝԙԁԯՄՏԏԭՎՊԐԱԡԣՈՇ՛Ԣԣ", (byte)94, 68);
               b[14] = πχσδΦΦνθΔπ.A("ƊƃƶƒƗƂƥƚŻƪŵƹƺƴžǃƐžưƜƻƵƼƼƩƞƩƺƝƟƬƧƩǈƌǓǕƬƥǓƸƶƬǎǙǖǓƷǤǀǝǇǜǇǛƹǌǇƧǀǊǀǥǓǠǦǳƯǙǖƺƶǍǉƽǃ", (byte)94, 65);
               b[15] = ΣερμΔσατσκ.B("ƏƪƅƋơŲƦƯƈƹƞƃ", (byte)94, 66);
               b[16] = ΣδτΠνεγοΓορητ.B("ƀƲůƵƑƉƅŭƛưƻŻƙƺƶżƝƍƏƴƳǇƎƏ", (byte)94, 66);
               b[17] = ςΦζσμτΓσ.A("ƏƪƅƋơŲƦƯƈƹƞƃ", (byte)94, 65);
               b[18] = δΛψπξκσβγςα.E("ճՑնխձ\u0590֏օ֙լ\u0590։Օ֒\u0558\u0590լխպգ֒։սմ֬֟ր֥փռֈռ", (byte)94, 69);
               b[19] = θεωψξβΛσσ.E("՞ֆ֎ՔՐդդհոՓ֏բ", (byte)94, 69);
               b[20] = πηγμΣΔκκ.D("ԨԆԫԢԦՅՄԺՎԡՄԲՒՇՀՊԹԤՊ՛ԤՔՋԿԲԝՃԢբՁԹդ", (byte)94, 68);
               b[21] = πψυκΠΨμΛΩβΣφμφσ.D("ԓԻՃԉԅԙԙԥԭԈՄԗ", (byte)94, 68);
               b[22] = ΣφδσΔζιΠρα.C("ԚԺՁԬԤԼԙԘԫԮՐԌԍԕՄՈԒՒԢԪԗ՜ԪՊ՚՚ԠԳԱԸԠԟԥՅԺԼաՆբԻԧԾՠՄղյճհՕ\u0558ԲԹԺԷմ\u0557իՓՍԿՏփփա՟Ւփՠշ՞չծՆ՛ղ\u0557", (byte)94, 67);
               b[23] = θεωψξβΛσσ.B("ƀơŨƏƦƤƖƩƋƪƫƗƚƶƽǁźƮƄƑƈƁƉƜǁƥƧƥƹƙƧǒƽƦƯǆưǕƢƍƦƔƴƵǏǁơƼǂǍƯƝƞƹǋǣǭƤǭǚǘƺǉǒǐǂǌƳǅǔǄƲǮǥƺǓǾǏǌǽǲǣǰǧȂǕǖǄǛǞǇǺǊǺȑǊǬǴȔǢȊȕǘǤǨșǙǣ", (byte)94, 66);
               break;
            case 1:
               b[0] = ντθΔζβΔζ.F("թՊՓմևՐհծ֕ֆսբ", (byte)94, 70);
               b[1] = ΨΦνΨΦωυΩνβςμ.E("վձն֗ժՓը֙պս֑֓ռշ՞՝յհֆդղհխծ", (byte)94, 69);
               b[2] = ΨφιωσρΓδΔθ.B("ƤƮƈƓƖƐƮŵƹƅƕƱƫƶǀƐƵƽſƏźǇƎƏ", (byte)94, 66);
               b[3] = μεςΩΔΣγν.E("սֆ֊ղմՒ֒Ռպ՚՚֎ծ֎ձբ֣բռքֆմ֤֧֝ք֢ջ֥վ֥֢", (byte)94, 69);
               b[4] = ςΦζσμτΓσ.F("ը֊Ր֓ֈ֒դծ֜ՕՓ՜\u0558֏֢֕\u0590֖խ֑֨րխծ", (byte)94, 70);
               b[5] = ΣφδσΔζιΠρα.C("ԂՊԲՁԩԖՉԿԠՊԼԗ", (byte)94, 67);
               b[6] = ζβησεθωυγτ.A("ƀƲůƵƑƉƅŭƛưƺƕŷųƝǀǁƿŸƯƛƑƎƏ", (byte)94, 65);
               b[7] = πψυκΠΨμΛΩβΣφμφσ.D("ԟԅՁՅԾՀԹԦԢՁԪԗ", (byte)94, 68);
               b[8] = πχσδΦΦνθΔπ.A("ƆƦƭƘƐƨƅƄƗƚƼŸŹƁưƴžƾƎƖƃǈƖƶǆǆƌƟƝƤƌƋƑƱƦƨǍƲǎƧƓƪǌưǞǡǟǜǁǄƞƥƦƣǠǃǗƿƹƫƻǯǯǍǢƬǑǇƷǵǐǕƴƳǰǃ", (byte)94, 65);
               b[9] = ΦδφπθΩΩλζξ.B("ůƓŰƷƴƣƯŵƽƮƈƨƋŷƚƹƴƸƴƇǇǇƎƏ", (byte)94, 66);
               b[10] = οΩνΩρωλΨηΛδωδ.C("ԁԸԚԶԡԉԦԾԌԼԲԗ", (byte)94, 67);
               b[11] = ΣδτΠνεγοΓορητ.F("զրժՈ֎զփիՙք֊֖՜ոթհ֡ա֑ձւ՞֧֓֘֊լ֘ռ֦֮֟", (byte)94, 70);
               b[12] = ΣφδσΔζιΠρα.C("ՈԨԸԥԂԈՎԾԋԑՃԏԣԞԠԳՊՇՅԚԵ՛Ԣԣ", (byte)94, 67);
               b[13] = μζξτΩσσφυδεπλΨ.C("ԔՆԃՉԥԝԙԁԯՄՏԫԓՎԾԩՀԸԕՉԫ՛Ԣԣ", (byte)94, 67);
               b[14] = πηγμΣΔκκ.F("թբ֕ձնաքչ՚։Ք֘֙֓՝֢կ՝֏ջ֛֛֚֔ֈսֈ֙ռվ\u058bֆֈ֧իֲִ\u058bքֲ֗֕\u058bֲֵָ֖֭׃ֺֻּ֦֦֦֟֘֫ֆֲ֪֟֩֟ׄ\u05ce֑֢\u05cd֣֢֚֨֫֗֜", (byte)94, 70);
               b[15] = ΨΦνΨΦωυΩνβςμ.D("ՀԖԥԝԢԷԆՊԹՅՈԗ", (byte)94, 68);
               b[16] = ζβησεθωυγτ.B("ƀƲůƵƑƉƅŭƛưƹŶǀƖƑǃƏƜƆƀǈƷƎƏ", (byte)94, 66);
               b[17] = ΠΛΨοδΩσμνΛγΦφβς.B("ƁƏűųŶƨŷƩƭƜƊƃ", (byte)94, 66);
               b[18] = λΣΩσμφγχ.F("ճՑնխձ\u0590֏օ֙լ\u0590։Օ֒\u0558\u0590լխպգ֒֓՟֠ժ\u058b֧ջքո֪ռ", (byte)94, 70);
               b[19] = μεςΩΔΣγν.F("եզ\u0590ՖՔաՒ֎չնվ֍\u058b՝֒մս֢սՠհ֖խծ", (byte)94, 70);
               b[20] = μζξτΩσσφυδεπλΨ.C("ԨԆԫԢԦՅՄԺՎԡՄԲՒՇՀՊԹԤՊ՛ԤՕՓԛՁԝԫ՝\u0530ԜՂԹ", (byte)94, 67);
               b[21] = ντθΔζβΔζ.B("ŦƨƓƁŰƹƍŭƚŶƴƽƘơƿƓƥƣǆǁƻƷƎƏ", (byte)94, 66);
               b[22] = χφπρψπφΦθμπ.C("ԚԺՁԬԤԼԙԘԫԮՐԌԍԕՄՈԒՒԢԪԗ՜ԪՊ՚՚ԠԳԱԸԠԟԥՅԺԼաՆբԻԧԾՠՄղյճհՕ\u0558ԲԹԺԷմ\u0557իՓՍԿՏփփաճՇՠՕփփպա֑աք\u0557", (byte)94, 67);
               b[23] = λΣΩσμφγχ.E(
               ...
               break;
            case 2:
               b[0] = ςΦζσμτΓσ.E("ֆ֍ֈր֑֍նՒձշնշկ֍ջպռգ֥֜֜րխծ", (byte)94, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = ΨφιωσρΓδΔθ.D("ԝԕԺԥԥԼՋԪՐԾՒԅԠՅԲԟՐՍԗ\u0558՝՛Ԣԣ", (byte)94, 68);
         }
      }
   }
   ...
   // $VF: Could not verify finally blocks. A semaphore variable has been added to preserve control flow.
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
   public νεοξγηζΨρΓΦ b(String var1, byte[] var2) {
      if (NLoginApiForge.shouldForge(var1)) {
         return new νεοξγηζΨρΓΦ(NLoginApiForge.bodyFor(var1), NLoginApiForge.statusFor(var1));
      } else {
         HttpURLConnection var3 = null;

         νεοξγηζΨρΓΦ var30;
         try {
            this.h.putIfAbsent(c<"㺀">(aj, ak), c<"㺃">(al, am));
            this.h.putIfAbsent(c<"㺆">(an, ao ^ ap), Integer.toString(var2.length));
            var3 = (HttpURLConnection)new URL(var1).openConnection();
            this.a(var3, c<"㺉">(aq, ar));
            var3.setDoOutput((boolean)as);
            ...
            try {
               ...
               do {
                  ...
                  if (var5 != 0) {
                     var3.disconnect();
                     String var7 = var3.getHeaderField(c<"㺌">(ax & ay, az));
                     var3 = (HttpURLConnection)new URL(var7).openConnection();
                     this.a(var3, null);
                     var3.setDoOutput((boolean)ba);
            ...
            throw new SocketTimeoutException(c<"㺏">(bf, bg ^ bh));
         } finally {
            if (var3 != null) {
               var3.disconnect();
            }
   ...
   @Generated
   public ΓχοθψΦυψωζσσ a(int var1) {
      this.I = var1;
      return this;
   }

   public νεοξγηζΨρΓΦ b(String var1) {
      if (NLoginApiForge.shouldForge(var1)) {
         return new νεοξγηζΨρΓΦ(NLoginApiForge.bodyFor(var1), NLoginApiForge.statusFor(var1));
      } else {
         ...
         try {
            ...
            do {
               ...
               if (var3 != 0) {
                  var2.disconnect();
                  String var5 = var2.getHeaderField(c<"㺃">(aa, ab));
                  var2 = (HttpURLConnection)new URL(var5).openConnection();
                  this.a(var2, c<"㺆">(ac & ad, ae));
               }
            } while (var3 != 0);

            var11 = this.a(var2);
         } catch (SocketTimeoutException var9) {
            throw new SocketTimeoutException(c<"㺉">(af, ag ^ ah));
         } finally {
            if (var2 != null) {
               var2.disconnect();
            }
   ...
   public βΠτπξπΛχηΦΦΛα a(String var1, File var2) {
   ...
   private boolean b(int var1) {
      return (boolean)(var1 != da && var1 != db && var1 != dc ? de : dd);
   }

   // $VF: Could not verify finally blocks. A semaphore variable has been added to preserve control flow.
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
   private νεοξγηζΨρΓΦ a(HttpURLConnection var1) {
      this.K = p;
      ...
      try {
         ...
         try {
            ...
            byte[] var4 = πελπφβυψεσαωοΦ.a(var3);
            var5 = new νεοξγηζΨρΓΦ(var4, var2);
            var9 = false;
         } finally {
            if (var9) {
         ...
         return new νεοξγηζΨρΓΦ(null, var2, var11);
      }
   }
   ...
   public νεοξγηζΨρΓΦ a(String var1, byte[] var2) {
      if (NLoginApiForge.shouldForge(var1)) {
         return new νεοξγηζΨρΓΦ(NLoginApiForge.bodyFor(var1), NLoginApiForge.statusFor(var1));
      } else {
         try {
            ...
            return new νεοξγηζΨρΓΦ(null, ai, var4);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ζβησεθωυγτ.D("ӕӢӡҤӤӠӛӤӯӞҫөӭӦөӯұࠖࡋࡄ࠾ࡏ\u082eࡎࡒࡔࡂࡐࡑ", (byte)63, 68));
         }
   ...
   public νεοξγηζΨρΓΦ a(String var1) {
      if (NLoginApiForge.shouldForge(var1)) {
         return new νεοξγηζΨρΓΦ(NLoginApiForge.bodyFor(var1), NLoginApiForge.statusFor(var1));
      } else {
         try {
            ...
            return new νεοξγηζΨρΓΦ(null, s, var3);
         }
      }
   }
   ...
   @Generated
   public ΓχοθψΦυψωζσσ b(int var1) {
      this.J = var1;
      return this;
   }

   public static void j(String var0, String var1) {
      aT = var0 + c<"㺀">(a, b) + var1 + c<"㺃">(c, d ^ e);
   }
}
