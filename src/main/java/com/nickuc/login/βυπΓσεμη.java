...
public class βυπΓσεμη {
   public static final String ck = c<"㺃">(βυπΓσεμη.g, βυπΓσεμη.h ^ βυπΓσεμη.i);
   public static final String cl = c<"㺆">(βυπΓσεμη.k, βυπΓσεμη.l);
   private static int o = Integer.reverse(1610612736);
   private static int g = Integer.reverse(Integer.MIN_VALUE);
   public static final int an = βυπΓσεμη.c;
   public static final int at = βυπΓσεμη.n;
   ...
   public static final int as = βυπΓσεμη.j;
   ...
   public static final int av = βυπΓσεμη.r;
   private static int k = (8388608 >>> 86 | 8388608 << -86) & -1;
   private static long c;
   public static final String cj = c<"㺀">(d & e, f);
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(δΛψπξκσβγςα.F("ӴԖԘӸԜԻԳՉԵԄՂԸՆՀԉԮՐՏՇՍՇԜ", (byte)16, 70), βυπΓσεμη.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(μεςΩΔΣγν.B("ĂďĎÑđčĈđĜċØĖĚēĖĜÞѢѶѲцѷѪѲѮò", (byte)16, 66) + var1 + ΣδτΠνεγοΓορητ.F("Ԇ", (byte)16, 70) + var2.toString(), var4);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣφδσΔζιΠρα.A("ŨŵŴķŷųŮŷƂűľżƀŹżƂńӈӜӘҬӝӐӘӔ", (byte)67, 65));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = οοθδΨιοΦΠβδζ.F("ԞՍեՀ՚՟զԵԺՂՊԳ", (byte)47, 70);
               b[1] = θεωψξβΛσσ.D("Ұ҆ҎѶҨҖҋҞӀҴүҊ", (byte)47, 68);
               b[2] = θεωψξβΛσσ.C("ңҲҷҎҕҋҽӂҼҙҁҵ҆ҒҤҵҸҶҙӀҿҘҕҖ", (byte)47, 67);
               break;
            case 1:
               b[0] = ξψθρΣΠΣς.C("һҐҰґҝѸҡҮѾҞҗҴҝҙһҗ҅ҪһҿӈҨҕҖ", (byte)47, 67);
               b[1] = ΣφδσΔζιΠρα.F("ԴՅԽՕ՝՚ՄԝԫՌՉ\u0557Ԩ\u0530եՂԯբՁՌԷՑԾԿ", (byte)47, 70);
               b[2] = ΣερμΔσατσκ.E("Ռ՛ՠԷԾԴզիեՂԪՀՎլՑԭՇԲՒԵեէԾԿ", (byte)47, 69);
               break;
            case 2:
               b[0] = λΣΩσμφγχ.C("ѷҗѵѹҔҗҕҍҷҜҴҐӄңҤ҄ҾҿӋһҮҘҕҖ", (byte)47, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = λΣΩσμφγχ.F("՝ԿդզԚԳէգԤծՎհԩՊԩԪՏԲՁՏզթՕժՇծոԽ՜ցՍ՛", (byte)47, 70);
         }
      }
   }
}
