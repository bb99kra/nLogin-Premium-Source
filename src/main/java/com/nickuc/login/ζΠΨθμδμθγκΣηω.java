...
public class ζΠΨθμδμθγκΣηω implements ςμκΔΣιζρΛξΨιθφΠ {
   private static int m = Integer.reverse(1073741824);
   private static String[] a = new String[m];
   private static String[] b = new String[ζΠΨθμδμθγκΣηω.n];
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ςπυηννναΣ.E("ԛԽԿԟՃբ՚հ՜ԫթ՟խէ\u0530ՕշնծմծՃ", (byte)55, 69), ζΠΨθμδμθγκΣηω.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            πχσδΦΦνθΔπ.A("ŐŝŜğşśŖşŪřĦŤŨšŤŪĬҴҟҨҹҾҷӀҽҹӁҫӀӓŅ", (byte)55, 65) + var1 + βεξΠθρρςΔΦμ.B("ħ", (byte)55, 66) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(πηγμΣΔκκ.A("ĺŇņĉŉŅŀŉŔŃĐŎŒŋŎŔĖҞ҉ҒңҨҡҪҧңҫҕҪҽ", (byte)44, 65));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ντθΔζβΔζ.D("ҠӂҼһұӜӡҿӆӚӋҴ", (byte)61, 68);
               b[1] = ΨΦνΨΦωυΩνβςμ.A("ŝńŒųĮŷĴŤŌķŰųųŖŪĻŻŻŘŒźşŌō", (byte)61, 65);
               break;
            case 1:
               b[0] = ξψθρΣΠΣς.C("ӄӅӄҰӈҴӦҢӖӘӡҬҿӊҳӥӏҰӅҴҷӂҿӀ", (byte)61, 67);
               b[1] = ξψθρΣΠΣς.E("՝ՄՒճԮշԴդՌԷծՕ\u0558տիՖԸպ՞Վօ՟ՌՍ", (byte)61, 69);
               break;
            case 2:
               b[0] = θεωψξβΛσσ.B("ŨŐŜŌŠŮŎŒŇňŏźŝŴŻŏŖļőĿŁŏŌō", (byte)61, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = δΛψπξκσβγςα.A("ţńōőŮŷŬŲŇŅŶŁ", (byte)61, 65);
         }
      }
   }
}
