...
public abstract class ΛδνδπΛζψηξαρΨ extends ΩδΦσωπηοεςβοφΛτ {
   ...
   private static String[] d = new String[ΛδνδπΛζψηξαρΨ.an];
   ...
   public ΛδνδπΛζψηξαρΨ(ΨγημιδξΓτοθαζ var1, ΓεοκπνΨωπτ var2, String var3, boolean var4) {
         ...
         if (var3 == null) {
            ...
            for (int var6 = s; var6 < var5; var6++) {
               ...
               try {
                  ...
                  ψΓωτιμωκχψΛΨ.b(c<"㺃">(t, u ^ v) + this.a.getName() + c<"㺆">(w & y, aa) + var7.getName() + c<"㺉">(ae, ag ^ aj), var12);
               } finally {
                  this.l++;
               }
            }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΣφδσΔζιΠρα.C("ՑճյՕչ֘\u0590֦֒ա֣֟֕֝զ\u058b֤֪֤֭֬չ", (byte)124, 67), ΛδνδπΛζψηξαρΨ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            οοθδΨιοΦΠβδζ.E("֛֧֨ժֵ֪֦֪֤֡ձֳֵ֯֬֯շࣤࣾईऀऍࣩअघईऐऄकࣽ\u0590", (byte)124, 69) + var1 + φδχεθοκψαλΛογλ.A("Ʊ", (byte)124, 65) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = χφπρψπφΦθμπ.B("ňōƒŮƋƒŗœſŗŻŬƃƚŠƠŸƝƥƜƋƣŵƊƚƛƂŽŤŬƜƭƪŲƥƌŰƼƵƆƌƶƖƶǃƝǂƚƔƑƓƝǅƜƃƚƣƗƩƉƋƥƼƌ", (byte)79, 66);
               d[1] = φΨαξωυθανΣφυκη.F("ՂնՅւցՠՊչիՋ՚Փ", (byte)79, 70);
               d[2] = φδχεθοκψαλΛογλ.D("ӺӜӱԆӶӯӭӽԘӽԁӪ", (byte)79, 68);
               d[3] = χΠξΦιζΨΣωΦσΨζ.A("žƘƕůŘƌƌŸƆŷƑƒŚŸŖƀƂŦƂŶŴƋƠƁƄƨƥƅơƯƂƟŵƥƈůƴƼƖƉƚƫƶƅ", (byte)79, 65);
               break;
            case 1:
               d[0] = χΠξΦιζΨΣωΦσΨζ.C("ӍӒԗӳԐԗӜӘԄӜԀӱԈԟӥԥӽԢԪԡԐԨӺԏԟԠԇԂөӱԡԲԯӷԪԑӵՁԺԋԑԻԛԻՈԢՇԟԙԖԘԢՊԥՑԚԴՄՐԱՏՎՈԢ", (byte)79, 67);
               d[1] = χΠξΦιζΨΣωΦσΨζ.F("վՀ՜փգղՃբո\u058b՚Փ", (byte)79, 70);
               d[2] = ΣφδσΔζιΠρα.C("ӴԒԘӾӑӻӿԜԏӣԀӵӹԘԛӸԈӻԞӽԚԮӵӶ", (byte)79, 67);
               d[3] = ςΦζσμτΓσ.B("žƘƕůŘƌƌŸƆŷƑƒŚŸŖƀƂŦƂŶŴƋƠƁƄƨƥƅơƯƂƟųƗƎƬƘƊƮƫƳűƠƅ", (byte)79, 66);
               break;
            case 2:
               d[0] = ΣφδσΔζιΠρα.F("ՔշշչԿք՛Օէի։րբհի֏՞ղե\u0557Պ֒չքմի֗\u0557ս\u058b֔՛", (byte)79, 70);
            case 3:
            default:
               break;
            case 4:
               d[0] = ΦδφπθΩΩλζξ.B("ųŲůƒųųƏŵŰźŨť", (byte)79, 66);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(χφπρψπφΦθμπ.D("ыјїКњіёњѥєСџѣќџѥЧޔޮ\u07b8ް\u07bdޙ\u07b5߈\u07b8߀\u07b4߅ޭ", (byte)17, 68));
         }
