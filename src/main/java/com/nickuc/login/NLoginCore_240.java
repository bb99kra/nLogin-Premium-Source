...
public class NLoginCore_240 extends NLoginType_005 {
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_240.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_384.E("ԀԢԤԄԨՇԿՕՁԐՎՄՒՌԕԺ՜՛ՓՙՓԨ", (byte)28, 69), NLoginCore_240.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_471.F("ԻՈՇԊՊՆՁՊՕՄԑՏՓՌՏՕԗ\u0892ࢢࡿࢲࢴࢢࢰࢪࢴࢭࢆԮ", (byte)28, 70) + var1 + NLoginCore_004.F("Ԓ", (byte)28, 70) + var2.toString(), var4
         );
      }
   }
   ...
   public void a(NLoginCore_277 var1, NLoginCore_509 var2) {
      NLoginCore_199 var10000 = this.a.a();
      int var10002 = aj;
      Object[] var10003 = new Object[am];
      var10003[ap] = a(ar, at ^ au);
      var10003[av] = ax;
      var10000.a(var1, var10002, var10003);
   }

   public NLoginCore_240(NLoginType_008 var1) {
      super(var1);
      this.a = var1.c();
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_559.E("֬֊էեֈֱ֢\u058b֜֕֎ջ", (byte)119, 69);
               ZKM_STR_B[1] = NLoginCore_201.A("ǞƤƿǙǅƹƿǂǄƮƨƺǨǅǊǩǫǡǀǹǻƵǘǒǈǪǾȀǹƽǬǎ", (byte)119, 65);
               ZKM_STR_B[2] = NLoginCore_110.C("֓ձՎՌկ֘։ղփռյբ", (byte)119, 67);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_092.A("ǓƷǆǙǄǦǭǉǫƷǂưƼǇǓǅǦǇƴǇǔǓǀǁ", (byte)119, 65);
               ZKM_STR_B[1] = NLoginCore_553.A("ǞƤƿǙǅƹƿǂǄƮƨƺǨǅǊǩǫǡǀǹǻƷǌǗǫǉǽǟǍȃǽȀ", (byte)119, 65);
               ZKM_STR_B[2] = NLoginCore_433.C("կՔ\u0590֊֊ՎճՖ՛յկ֊ջի֢շսղմ֥տրխծ", (byte)119, 67);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_110.A("ǧǔƸǄǔǌƦǧƿǁǑƱǂǯƭǭǦƷƮǘǭǓǀǁ", (byte)119, 65);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_138.C("ձմ֓ՌշՓ\u0558\u058bո֘֘Ֆհ\u058c֕֝՜֖վղկ֢֟֡֗֗շ֛֝֯֨֨", (byte)119, 67);
         }
      }
   }
}
