...
public class σΩΨΨΩωγΨιτοηΩ implements ΦοιυξχςΩΦψξΓΣΨ {
   private final Set<String> i;
   private static int b = Integer.reverse(-1);
   private static int m = (0 >>> 195 | 0 << ~195 + 1) & -1;
   private static String[] a = new String[σΩΨΨΩωγΨιτοηΩ.n];
   ...
   @Generated
   σΩΨΨΩωγΨιτοηΩ(String var1, Set<String> var2) {
      this.af = var1;
      this.i = var2;
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ςπυηννναΣ.A("ŉūŭōűƐƈƞƊřƗƍƛƕŞƃƥƤƜƢƜű", (byte)81, 65), σΩΨΨΩωγΨιτοηΩ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΦδφπθΩΩλζξ.C("ԋԘԗӚԚԖԑԚԥԔӡԟԣԜԟԥӧࡼࡣࡣࡤࡦࢇࡲࡨࡺࢆࢂࡻ\u086eԀ", (byte)81, 67) + var1 + ζοηκορΦνΣθγΩ.A("ś", (byte)81, 65) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΠΛΨοδΩσμνΛγΦφβς.C("ҽӊӉҌӌӈӃӌӗӆғӑӕӎӑӗҙ\u082eࠕࠕࠖ࠘࠹ࠤࠚࠬ࠸࠴࠭ࠠ", (byte)55, 67));
         }
      ...
      if (var2 instanceof Player) {
         if (!var1.getCompletions().isEmpty()) {
            if (var1.getBuffer().startsWith(c<"㺀">(a & b, d))) {
               ...
               var3.removeIf(var1x -> {
                  String[] var2x = var1x.split(c<"㺀">(e, f ^ g));
                  if (var2x.length == 0) {
                     return (boolean)h;
                  } else {
                     String var3x = var2x[i].toLowerCase(Locale.ENGLISH);
                     return (boolean)(!var3x.startsWith(j + this.af + k) && !this.i.contains(var3x) ? m : l);
                  }
               });
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΦδφπθΩΩλζξ.B("ůųŪĺſķļƃŜŞƀŋ", (byte)66, 66);
               b[1] = βθκςνθΩθυμςτκχ.A("ũŅŊŻůŮŎŐŶſŞŋ", (byte)66, 65);
               break;
            case 1:
               b[0] = ζοηκορΦνΣθγΩ.A("ĴœŴŒžżſŜŴśŁŋ", (byte)66, 65);
               b[1] = χΠξΦιζΨΣωΦσΨζ.F("խձՃձճկռՇ՟խիՆ", (byte)66, 70);
               break;
            case 2:
               b[0] = πηγμΣΔκκ.D("ҳҰӢҳӨҴӐӄӏҽӻӸҷӫӎӑӰӀҽӱӲԉӢӤӹөӚӥӼԌӼӐ", (byte)66, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = ξψθρΣΠΣς.C("ӐӊӀӑӸӬӗӎӹӊӽӫӹӰӗӬӝԃӮӐӁӳӣӂҾӹӶӋӦӎӼӓ", (byte)66, 67);
         }
      }
   }
}
