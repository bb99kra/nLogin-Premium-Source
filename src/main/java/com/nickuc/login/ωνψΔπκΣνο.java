...
public final class ωνψΔπκΣνο extends εΩχτδανΦχμΨγκως {
   private static int ab = Integer.reverse(-1);
   private static long ac = Long.reverse(3536807717277558182L);
   private static String[] f = new String[ωνψΔπκΣνο.ah];
   ...
   private static String[] e = new String[af];
   ...
   private static String a(int var0, long var1) {
      ...
      if (e[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ξψθρΣΠΣς.E("\u0557դգԦզբ՝զձՠԭիկըիձԳ࣎ࣃ࣏࢜ࣉࣄࢮࣉ࣌", (byte)56, 69));
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ςπυηννναΣ.E("Օշչՙս֪֖֜֔ե֣֧֙֡ժ֏ְֱ֮֨֨ս", (byte)113, 69), ωνψΔπκΣνο.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            οοθδΨιοΦΠβδζ.C("իոշԺպնձպօմՁտփռտօՇ\u08e2ࣣࣗࢰࣝࣘࣂࣝ࣠՜", (byte)113, 67) + var1 + ντθΔζβΔζ.C("Ղ", (byte)113, 67) + var2.toString(), var4
         );
      }
   }

   public ωνψΔπκΣνο() {
      super(c<"㺀">(d, n ^ o), c<"㺃">(x & ab, ac));
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               f[0] = ςΦζσμτΓσ.A("ƎƧƨƟƣƮƪǔǋǑǒơ", (byte)109, 65);
               f[1] = ΣφδσΔζιΠρα.E("֣ծ֝վյ֛֧֓գ֤֢ձ", (byte)109, 69);
               break;
            case 1:
               f[0] = φΨαξωυθανΣφυκη.E("ձ\u0590՟ճ֖֚՟֓֓֟գգ֨րկ\u058cֈֲ֜մֵ֥ռս", (byte)109, 69);
               f[1] = βεξΠθρρςΔΦμ.C("ձմյնշնՌ՛ըզոՏՓՖճ\u0557ցնկֈ՛ոՏՐ", (byte)109, 67);
               break;
            case 2:
               f[0] = χφπρψπφΦθμπ.B("ƬƯǕƪƟƎǁǄƒƸƨơ", (byte)109, 66);
            case 3:
            default:
               break;
            case 4:
               f[0] = φΨαξωυθανΣφυκη.B("ƮƬƲƟǐƿƶƯƩƖƤƩǗǝǉƬǛƫǞǑƮƯƬƭ", (byte)109, 66);
         }
      }
   }
}
