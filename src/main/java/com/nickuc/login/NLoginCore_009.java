...
public enum NLoginCore_009 {
   ...
   private static String[] a = new String[NLoginCore_009.f];
   private static String[] b = new String[NLoginCore_009.g];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = NLoginCore_453.A("ÞĔćĀèçÕêäĄĚá", (byte)13, 65);
               b[1] = NLoginCore_446.D("ѐяЭыУбеаёѐЩЛјїНхлѡѥічвЯа", (byte)13, 68);
               b[2] = NLoginCore_201.F("ӽՀԗԃԁԞԡӿՆՂԺԑ", (byte)13, 70);
               b[3] = NLoginCore_471.C("ФтАхеггббмщФ", (byte)13, 67);
               break;
            case 1:
               b[0] = NLoginCore_091.D("ЎѓЧъдљшМѝдѠшїѕмёѦЯклТтЯа", (byte)13, 68);
               b[1] = NLoginCore_027.C("ѐяЭыУбеаёѐЩђљіњѓлНЦѧлѨЯа", (byte)13, 67);
               b[2] = NLoginCore_451.F("ԸԮԼԵԟԜԙӿԪԃԌԠԣԗԧԱԯԩԑԿԬԟԜԝ", (byte)13, 70);
               b[3] = NLoginCore_232.D("жіЍїзЙафхозЭюяпКихихѕѨЯа", (byte)13, 68);
               break;
            case 2:
               b[0] = NLoginCore_004.C("іечРгхиЭкћЫшѕѠдѤМњОёѤтЯа", (byte)13, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = NLoginCore_138.D("ааєаЪбЗьђмКМѢвѤЛѢџѡѥїѨЯа", (byte)13, 68);
         }
      }
   }
