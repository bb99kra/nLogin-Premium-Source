...
public enum NLoginCore_009 {
   a,
   b,
   c,
   d;

   private static String[] ZKM_STR_A = new String[NLoginCore_009.f];
   private static String[] ZKM_STR_B = new String[NLoginCore_009.g];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_453.A("ÞĔćĀèçÕêäĄĚá", (byte)13, 65);
               ZKM_STR_B[1] = NLoginCore_446.D("ѐяЭыУбеаёѐЩЛјїНхлѡѥічвЯа", (byte)13, 68);
               ZKM_STR_B[2] = NLoginCore_201.F("ӽՀԗԃԁԞԡӿՆՂԺԑ", (byte)13, 70);
               ZKM_STR_B[3] = NLoginCore_471.C("ФтАхеггббмщФ", (byte)13, 67);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_091.D("ЎѓЧъдљшМѝдѠшїѕмёѦЯклТтЯа", (byte)13, 68);
               ZKM_STR_B[1] = NLoginCore_027.C("ѐяЭыУбеаёѐЩђљіњѓлНЦѧлѨЯа", (byte)13, 67);
               ZKM_STR_B[2] = NLoginCore_451.F("ԸԮԼԵԟԜԙӿԪԃԌԠԣԗԧԱԯԩԑԿԬԟԜԝ", (byte)13, 70);
               ZKM_STR_B[3] = NLoginCore_232.D("жіЍїзЙафхозЭюяпКихихѕѨЯа", (byte)13, 68);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_004.C("іечРгхиЭкћЫшѕѠдѤМњОёѤтЯа", (byte)13, 67);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_138.D("ааєаЪбЗьђмКМѢвѤЛѢџѡѥїѨЯа", (byte)13, 68);
         }
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_009.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_451.D("яѱѳѓѷҖҎҤҐџҝғҡқѤ҉ҫҪҢҨҢѷ", (byte)38, 68), NLoginCore_009.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_471.D("ҊҗҖљҙҕҐҙҤғѠҞҢқҞҤѦ߰߳\u07fb߯߮߷ߑ߶߶߳߶ߞѾ", (byte)38, 68) + var1 + NLoginCore_433.B("ą", (byte)38, 66) + var2.toString(), var4
         );
      }
   }
