...
public class ψΓςλνΣΠπεοψγΩσπ {
   ...
   private static String[] a = new String[ψΓςλνΣΠπεοψγΩσπ.w];
   ...
   private static String[] b = new String[x];
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ψΓςλνΣΠπεοψγΩσπ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(φΨαξωυθανΣφυκη.C("ӍӯӱӑӵԔԌԢԎӝԛԑԟԙӢԇԩԨԠԦԠӵ", (byte)80, 67), ψΓςλνΣΠπεοψγΩσπ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            θεωψξβΛσσ.C("ԈԕԔӗԗԓԎԗԢԑӞԜԠԙԜԢӤࡾࡊࡺࡴࡷ࡞\u085cࡽࡳࡾ࢈ࡴ\u086bࢆࢄӿ", (byte)80, 67) + var1 + βθκςνθΩθυμςτκχ.E("Ն", (byte)80, 69) + var2.toString(), var4
         );
      }
   }

   @Generated
   public ψΓςλνΣΠπεοψγΩσπ(SignatureData var1, UUID var2) {
      this.a = var1;
      this.h = var2;
   }
   ...
   public boolean a(byte[] var1, byte[] var2, long var3) {
      try {
         ...
         String var10000 = c<"㺀">(l, m ^ n);
         byte[][] var10003 = new byte[o][];
         var10003[p] = var2;
         var10003[q] = this.a(var3);
         return ηΠτΠΩΔγΦρδρ.a(var10000, var5, var1, var10003);
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(μζξτΩσσφυδεπλΨ.A("ƠƭƬůƯƫƦƯƺƩŶƴƸƱƴƺżԖӢԒԌԏӶӴԕԋԖԠԌԃԞԜ", (byte)95, 65));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = βθκςνθΩθυμςτκχ.E("Օ\u0557աևՉՁՄցՇՇՐօ֏֏֔ըՏզչձ֘։ՠա", (byte)81, 69);
               b[1] = ςΦζσμτΓσ.E("Օ\u0557աևՉՁՄցՇՇՐօ֏֏֔ըՏզչձ֘։ՠա", (byte)81, 69);
               b[2] = ντθΔζβΔζ.D("ӮԝӷӾԗԗӧԥԡԥӿԀӧӷԮԞӾ\u0530ԔԑԲԤӻӼ", (byte)81, 68);
               break;
            case 1:
               b[0] = πχσδΦΦνθΔπ.F("Օ\u0557աևՉՁՄցՇՇՂֈփՑՊկքղր\u0557ևգՠա", (byte)81, 70);
               b[1] = ΣδτΠνεγοΓορητ.C("ӰӲӼԢӤӜӟԜӢӢӝөӹԜӪӺԍөԪӿԋԤӻӼ", (byte)81, 67);
               b[2] = ζβησεθωυγτ.D("ӮԝӷӾԗԗӧԥԡԥӿԆԟԌԪӧԬԭӳԩԥԠԶԂԙԛӱӴӻԒӽԩ", (byte)81, 68);
               break;
            case 2:
               b[0] = μζξτΩσσφυδεπλΨ.D("ԠӹӽԟԎԧԈԚԡӦԉԅԢԗԘԫԟԐԇԨԖԌԦԄԗԷԩӴԅԷӸԷ", (byte)81, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = φΨαξωυθανΣφυκη.B("ŹųŷŬŶŪŸƛřŰơƑŻŢƚƩťƇƀŨƂƝŴŵ", (byte)81, 66);
         }
      }
   }
   ...
   public boolean aB() {
      ...
      if (this.h != null) {
         ...
         var4.put(var5);
         String var6 = c<"㺀">(b, d ^ e);
         PublicKey var7 = ηΠτΠΩΔγΦρδρ.a();
         byte[][] var8 = new byte[f][];
         var8[g] = var3;
         return ηΠτΠΩΔγΦρδρ.a(var6, var7, var1, var8);
      } else {
         byte[] var2 = this.a.getSignature();
         String var10000 = c<"㺃">(h, i);
         PublicKey var10001 = ηΠτΠΩΔγΦρδρ.a();
         byte[][] var10003 = new byte[j][];
         var10003[k] = var2;
         return ηΠτΠΩΔγΦρδρ.a(var10000, var10001, var1, var10003);
      }
   }
}
