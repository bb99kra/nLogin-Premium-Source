...
public final class ΩιθλξαψυθΔΔρνξτ implements Filter {
   private static int o = (262144 >>> 17 | 262144 << ~17 + 1) & -1;
   private static String[] a = new String[ΩιθλξαψυθΔΔρνξτ.n];
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ζβησεθωυγτ.B("ľŋŊčōŉńōŘŇĔŒŖŏŒŘĚҕҦҦҪҮҢҺҸҬ҉ҊҸҵҷҾ", (byte)46, 66));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΨΦνΨΦωυΩνβςμ.C("ҰӅӋұӊӴӖӖӘүӹӪӴҷӾӃӰӼӁӤԀԉԄԇӾөԆӽөԀӾӉӪӌӿӥԐӱԔӯӼԗӭԗӝӠӮӕӹԣӝԤԥӤӳӹԬӪԚԬԏԎԌԳ", (byte)66, 67);
               b[1] = πχσδΦΦνθΔπ.A("ŅŲŦŪŞĳŘŐŖķŜŒŴŃŝŦņŤŖŨƃŌŭŠŜŋƉƏŲƍŢżŸŔŦŕƠƑŷŢƙųŝū", (byte)66, 65);
               break;
            case 1:
               b[0] = ΦδφπθΩΩλζξ.B("ĸōœĹŒżŞŞŠķƁŲżĿƆŋŸƄŉŬƈƑƌƏƆűƎƅűƈƆőŲŔƇŭƘŹƜŷƄƟŵƟťŨŶŝƁƫťƬƭŰƳƏƍƌƆƓƤŵƑƌ", (byte)66, 66);
               b[1] = βεξΠθρρςΔΦμ.A("ŅŲŦŪŞĳŘŐŖķŜŒŴŃŝŦņŤŖŨƃŌŭŠŜŋƉƏŲƍŢżūŬŴŴŚƚƐƁŹƝžū", (byte)66, 65);
               break;
            case 2:
               b[0] = δΛψπξκσβγςα.A("ŊťşĻŖƁŐŵŃżżŨŃŒŵƈżňŊŇŬřŖŗ", (byte)66, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = μεςΩΔΣγν.F("եբկդԵդԸջԼՒնչՍ՟նաղՕՂՃ\u058b՝՛Մռչ֏ժխվֆե", (byte)66, 70);
         }
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ΩιθλξαψυθΔΔρνξτ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ΨφιωσρΓδΔθ.C("ӄӦӨӈӬԋԃԙԅӔԒԈԖԐәӾԠԟԗԝԗӬ", (byte)77, 67), ΩιθλξαψυθΔΔρνξτ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζβησεθωυγτ.C("ӿԌԋӎԎԊԅԎԙԈӕԓԗԐԓԙӛࡖࡧࡧ\u086b\u086fࡣࡻࡹ\u086dࡊࡋࡹࡶࡸࡿӶ", (byte)77, 67) + var1 + χφπρψπφΦθμπ.A("œ", (byte)77, 65) + var2.toString(), var4
         );
      }
   }

   @Generated
   public ΩιθλξαψυθΔΔρνξτ(Filter var1) {
      this.a = var1;
   }
   ...
   public boolean isLoggable(LogRecord var1) {
      if (var1 != null && var1.getMessage() != null && !this.ac) {
         ...
         if (!ψΓωτιμωκχψΛΨ.d().stream().noneMatch(var3 -> {
            try {
               return var3.filter(var1.getLoggerName(), var1.getMessage(), var2 == null ? c : var2);
            } catch (Throwable var5) {
               ψΓωτιμωκχψΛΨ.c(c<"㺀">(i, j), var5);
               this.ac = (boolean)l;
               return (boolean)m;
            }
         })) {
            var1.setMessage(c<"㺀">(e, f ^ g));
            return (boolean)h;
         } else {
