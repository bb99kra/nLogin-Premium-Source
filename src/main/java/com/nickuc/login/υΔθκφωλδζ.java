...
public class υΔθκφωλδζ {
   private static String[] a = new String[υΔθκφωλδζ.y];
   ...
   public static byte[] d(byte[] var0, Key var1) {
      try {
         ...
         throw new RuntimeException(c<"㺀">(r, s), var3);
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = μζξτΩσσφυδεπλΨ.A("ǠǨǜǳƱǋǈǭưƹǆƿ", (byte)124, 65);
               b[1] = ντθΔζβΔζ.D("֚֒֎֥գսպ֟բիոձ", (byte)124, 68);
               b[2] = ιΠοθΩΦξκ.B("ǉƩƬƭǡǟǣǑǖǡǉǄǜǔǙǺǲƷǻǳƶǁǄȃȃǗǝǛǆȂȄȏǺǙǠǮǯǽȊǟǐǴȈǟ", (byte)124, 66);
               b[3] = ςΦζσμτΓσ.F("ִ֡֩֝ղ\u058c։֮ձպևր", (byte)124, 70);
               b[4] = ιΠοθΩΦξκ.B("ǉƩƬƭǡǟǣǑǖǡǇƻƺǊǇǎǿǟǪǛǄȃƸǱǺǤǴǩǽǙǖǎȑȉȐǻǧǾǫȂǢǣǮǟ", (byte)124, 66);
               b[5] = φδχεθοκψαλΛογλ.D("֚֒֎֥գսպ֟բիոձ", (byte)124, 68);
               break;
            case 1:
               b[0] = ςπυηννναΣ.A("ǡǏǌǌǎǧǔǭǹǤǂƿ", (byte)124, 65);
               b[1] = δΛψπξκσβγςα.D("շւ՟շֆ֤֞՟փզ֪ձ", (byte)124, 68);
               b[2] = ΣερμΔσατσκ.E("֊ժխծ֢֤֢֠֒֗֊օֳֻ֚֝֕ոִּշւօׄׄ֘֞֜և׃ׅא\u05cbּד־֤֕\u0590֊ֲ\u0590֚֠", (byte)124, 69);
               b[3] = ΦδφπθΩΩλζξ.B("ǚưƾǔǦǧǆǎǏǹǴƿ", (byte)124, 66);
               b[4] = οΩνΩρωλΨηΛδωδ.C("ջ՛՞՟֑֓֕փֈ֓չխլռչրֱ֑֜֍նֵժ֣֖֦֛֬֯\u058bֈր׃փ֟֓ց֗ւׂ֛֦֑֔", (byte)124, 67);
               b[5] = μεςΩΔΣγν.A("ƽǢǒǐǃǔǞƩƪǡƱƿ", (byte)124, 65);
               break;
            case 2:
               b[0] = χΠξΦιζΨΣωΦσΨζ.A("ǭǌǡǞǡǲǂǲǯǊǶǧƷǅǹǷǍǹǏǴǏȀȃǴǀȇǁȋǹǗǋȃ", (byte)124, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = οΩνΩρωλΨηΛδωδ.E("֜֓կկսֱ֔օִ֖֢֪֭֩֍֊ֵ֘֍֘֟֞\u058b\u058c", (byte)124, 69);
         }
      }
   }

   public static PublicKey a(byte[] var0) {
      KeyFactory var1 = KeyFactory.getInstance(c<"㺀">(a, b ^ d));
   ...
   public static byte[] c(byte[] var0, Key var1) {
      Cipher var2 = Cipher.getInstance(c<"㺀">(o, p));
      var2.init(q, var1);
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(βεξΠθρρςΔΦμ.E("ՒմնՖպ֑֧֙֓բ֖֤֠֞է\u058c֥֥֭֮֫պ", (byte)110, 69), υΔθκφωλδζ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζβησεθωυγτ.D("բկծԱձխըձռիԸնպճնռԾࣕࢥ࣑࣊࣍ࣚࣞ࣋࣎Փ", (byte)110, 68) + var1 + χφπρψπφΦθμπ.F("դ", (byte)110, 70) + var2.toString(), var4
         );
      }
   }
   ...
   public static byte[] a(byte[] var0, Key var1) {
      try {
         ...
         throw new RuntimeException(c<"㺀">(g, h), var3);
      }
   }

   public static PrivateKey a(byte[] var0) {
      KeyFactory var1 = KeyFactory.getInstance(c<"㺀">(e, f));
   ...
   public static byte[] f(byte[] var0, Key var1) {
      Cipher var2 = Cipher.getInstance(c<"㺀">(u, v ^ w));
      var2.init(x, var1);
      return var2.doFinal(var0);
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(μεςΩΔΣγν.A("ŜũŨīūŧŢūŶťĲŰŴŭŰŶĸӏҟӄӇӔӘӋӅӈ", (byte)61, 65));
         }
