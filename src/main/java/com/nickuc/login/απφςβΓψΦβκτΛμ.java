...
public final class απφςβΓψΦβκτΛμ implements ΣΣπδβωΦδιςδςψΣς {
   private static String[] b = new String[απφςβΓψΦβκτΛμ.n];
   ...
   private static final String cw = c<"㺀">(o, p ^ q);
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΦδφπθΩΩλζξ.A("ìùø»û÷òûĆõÂĀĄýĀĆÈыћѢџѐвѨчєѝѨрѢ", (byte)5, 65));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΣερμΔσατσκ.D("ԆԨԟԁԈԅԩՊԛԮՌԉԔՒՎԎՊԴԔԪԪՇ\u0530՜՞\u0558ԿաԺԯԽԿ", (byte)94, 68);
               b[1] = ΦδφπθΩΩλζξ.B("ƱƓƨƸƳƐƖƄƚƦƆƃ", (byte)94, 66);
               b[2] = μζξτΩσσφυδεπλΨ.A("ŲƔƋŭŴűƕƶƇƚƸŵƀƾƺźƶƠƀƖƖƳƜǈǊǄƫǍƦƛƩƫ", (byte)94, 65);
               break;
            case 1:
               b[0] = ΣερμΔσατσκ.C("ԆԨԟԁԈԅԩՊԛԮՌԉԔՒՎԎՊԴԔԪԪՉՕԟՎԚ\u0558\u0558՞եզՈ", (byte)94, 67);
               b[1] = ΨφιωσρΓδΔθ.A("ƀůƆűƭŴƧƫƸŴƼƃ", (byte)94, 65);
               b[2] = λΣΩσμφγχ.C("ԆԨԟԁԈԅԩՊԛԮՌԉԔՒՎԎՊԴԔԪԪԶԹԹՊԱԔԽԷԺՆՆ", (byte)94, 67);
               break;
            case 2:
               b[0] = δΛψπξκσβγςα.D("ԣԅԛԕՁՀԠՊԛ\u0530ԤՉԾԴԍԮՃԶԵԔԧԓՓԸԞՀՕ՟ԭՃԽԙ", (byte)94, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = χφπρψπφΦθμπ.C("ԑӿԓԢԭԜԇԞԪՇԫԭՍՋԎԮ\u0530ԨՇԩԶՋԢԣ", (byte)94, 67);
         }
      }
   }
   ...
   public boolean filter(String var1, String var2, Object... var3) {
      if (var3.length == a && var2.contains(c<"㺀">(b, d ^ e))) {
         String var4 = f + (String)var3[g];
         String var5 = var4.split(c<"㺃">(h & i, j))[k].toLowerCase(Locale.ENGLISH);
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(πηγμΣΔκκ.B("ƓƵƷƗƻǚǒǨǔƣǡǗǥǟƨǍǯǮǦǬǦƻ", (byte)118, 66), απφςβΓψΦβκτΛμ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΣδτΠνεγοΓορητ.F("֢֕֡դ֤֛֤֠֯֞ի֦֭֩֩֯ձࣴऄऋईࣹࣛऑࣰࣽआऑࣩऋ֊", (byte)118, 70) + var1 + φδχεθοκψαλΛογλ.A("ƥ", (byte)118, 65) + var2.toString(), var4
         );
      }
   }
   ...
   @Generated
   private απφςβΓψΦβκτΛμ(θιοτχπσΦΩ var1) {
      this.c = var1;
   }
}
