...
public class NLoginCore_543 implements NLoginInterface_003, NLoginInterface_043 {
            ...
            if (var4 != null) {
               if (!var4.a().b(NLoginCore_077.f)) {
                  ...
                  if (var6.getType() != ChatTypes.GAME_INFO) {
                     ...
                     List var8 = var4.a(NLoginCore_567.l, var0 -> new ArrayList());
                     if (var8.size() < r) {
                        var8.add(var7);
                     }
         ...
         if (var4 == null) {
            ...
            if (!(var6 = var6.trim()).isEmpty()) {
               if (var6.charAt(b) == c) {
                  ...
                  String[] var8 = var6.substring(g).split(a(h, i ^ j));
                  if (var8.length < k) {
                     return;
                  }

                  NLoginCore_466 var9 = NLoginCore_346.a(this.c).a().a(var8[l].toLowerCase(Locale.ENGLISH));
                  if (var9 != null) {
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_543.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_004.C("јѺѼќҀҟҗҭҙѨҦҜҪҤѭҒҴҳҫұҫҀ", (byte)41, 67), NLoginCore_543.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_384.A("ĴŁŀăŃĿĺŃŎĽĊňŌŅňŎĐ҂ҞҕҞ҆Қң҄ҲҡҳҤңĩ", (byte)41, 65) + var1 + NLoginCore_433.E("ԟ", (byte)41, 69) + var2.toString(), var4
         );
      }
   }

   @Generated
   private NLoginCore_543(NLoginCore_346 var1) {
      this.c = var1;
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (ZKM_STR_A[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_433.D("ыјїКњіёњѥєСџѣќџѥЧޙ\u07b5ެ\u07b5ޝޱ\u07baޛ߉\u07b8ߊ\u07bb\u07ba", (byte)17, 68));
         }
