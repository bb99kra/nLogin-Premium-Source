...
public interface αδξΠψβΣλωΛκ<K> {
   ...
   default <T> T d(K var1) {
      ...
      try {
         ...
         throw new RuntimeException(
            ΨφιωσρΓδΔθ.B("ĒļĲŅņôĸķŊŌùĿœĿłŎœŉŐŐďĄŐŋŠĈ", (byte)40, 66)
               + var1
               + (var2 != null ? οΩνΩρωλΨηΛδωδ.F("Ԑԅ՜ՈՔ՞ՏԋՏՙՏբգԑ", (byte)40, 70) + var2.getClass().getCanonicalName() : ""),
            var4
         );
      }
   }
   ...
   default <T> T a(K var1, T var2) {
      ...
      try {
         ...
         throw new RuntimeException(
            πχσδΦΦνθΔπ.E("ԙՃԹՌՍӻԿԾՑՓԀՆ՚ՆՉՕ՚Ր\u0557\u0557Ԗԋ\u0557Ւէԏ", (byte)26, 69)
               + var1
               + (var3 != null ? ΣερμΔσατσκ.C("ЯФѻѧѳѽѮЪѮѸѮҁ҂а", (byte)26, 67) + var3.getClass().getCanonicalName() : ""),
            var5
         );
      }
   }
   ...
   default Object b(K var1, Object var2) {
      if (var2 == null) {
         throw new IllegalArgumentException(φΨαξωυθανΣφυκη.A("ķřśŗŬŤŭĚűŝũųŤĠŤţűŲŴźħŪŮĪŹƁŹźİ", (byte)58, 65));
      } else {
   ...
   default Object e(K var1) {
      if (var1 == null) {
         throw new IllegalArgumentException(χΠξΦιζΨΣωΦσΨζ.E("ԭՈ՝ԅՉՈՖ\u0557ՙ՟ԌՏՓԏ՞զ՞՟ԕ", (byte)38, 69));
      } else {
   ...
   default <T> T c(K var1) {
      Object var2 = this.e((K)var1);
      if (var2 == null) {
         throw new IllegalStateException(χφπρψπφΦθμπ.D("ҙҴӉѱ", (byte)51, 68) + var1 + ΣερμΔσατσκ.E("ԏ՞ՠզԓ՚դիե՜Ԛ", (byte)51, 69));
      } else {
         try {
            return (T)var2;
         } catch (Throwable var4) {
            throw new RuntimeException(
               πηγμΣΔκκ.E("Բ՜ՒեզԔ\u0558\u0557ժլԙ՟ճ՟բծճթհհԯԤհիրԨ", (byte)51, 69)
                  + var1
                  + (var2 != null ? ΣερμΔσατσκ.A("đĆŝŉŕşŐČŐŚŐţŤĒ", (byte)51, 65) + var2.getClass().getCanonicalName() : ""),
               var4
            );
         }
      }
