...
public class NLoginCore_023 implements NLoginInterface_003 {
   ...
   private static String[] ZKM_STR_B = new String[h];

   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_023.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_324.C("҈ҪҬҌҰӏӇӝӉҘӖӌӚӔҝӂӤӣӛӡӛҰ", (byte)57, 67), NLoginCore_023.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(NLoginCore_553.B("ŔšŠģţşŚţŮŝĪŨŬťŨŮİҴҖӈӃҬҚӐҽń", (byte)57, 66) + var1 + NLoginCore_232.C("Қ", (byte)57, 67) + var2.toString(), var4);
      }
   }

   private void a(User var1, PacketWrapper<?> var2) {
      if (NLoginCore_206.a(this.d).b().a().L()) {
         Channel var3 = (Channel)var1.getChannel();
         var2.prepareForSend(var3, (b != 0), (c != 0));
         ByteBuf var4 = (ByteBuf)var2.buffer;
         if (var4 == null) {
            throw new IllegalStateException(a(d, e ^ f));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_433.A("ĺĂĹĕąėŋŊğħĥĬĊŌĽŒĳŇďĒĚŐŏĮŕěĽĘŠńńĹ", (byte)39, 65);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_433.D("җџҖѲѢѴҨҧѼ҄҂҉ѧҩҚүҐҤѬѯѷҫҦҎҊүҪҩ҉ҫҵұѽҁҕҏӇҔҥѼҠӃӋҒ", (byte)39, 68);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_471.C("ҎҜғѦҜѵѲқҟ҈ѫ҉Ѽѯ҉ҌѲҦҧѵѳҶѽѾ", (byte)39, 67);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_027.C("ѮѬѹ҇Җ҈ѵѥ҇ҊҦҨҐҤѭѯҌѽҪҴ҈ҀҡҖҜҘҫҩғҸҸѿ", (byte)39, 67);
         }
      }
   }

   public NLoginCore_023(NLoginCore_206 var1) {
      this.d = var1;
   }
   ...
   public void a(PacketReceiveEvent var1) {
      ...
      if (var2.hasAttr(NLoginCore_096.c)) {
         ...
         if (var3 != null && var3.f == 0) {
            ...
            NLoginInterface_032 var6 = var3x -> {
               if (var3x) {
                  this.a(var5, var4);
               }
            };
            if (this.d.a(var5, var6)) {
               if (NLoginCore_206.a(this.d).L()) {
                  Object var7 = var1.getPlayer();
                  if (var7 != null) {
                     NLoginCore_277 var8 = NLoginCore_206.a(this.d).b().a(var7);
                     NLoginCore_509 var9 = NLoginCore_206.a(this.d).a().b(var8);
                     NLoginType_010 var10 = NLoginCore_206.a(this.d).c();
