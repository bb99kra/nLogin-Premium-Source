...
public class εβθλγΛχημ implements ΨΩΔξδκΛψψκφδ {
   private static String[] b = new String[εβθλγΛχημ.t];
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΦδφπθΩΩλζξ.A("ÑóõÕùĘĐĦĒáğĕģĝæċĭĬĤĪĤù", (byte)21, 65), εβθλγΛχημ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζβησεθωυγτ.F("ԴՁՀԃՃԿԺՃՎԽԊՈՌՅՈՎԐ\u0897\u0895࢜ࢠ࢙ࢂࢯࢠࢦԥ", (byte)21, 70) + var1 + ξψθρΣΠΣς.E("ԋ", (byte)21, 69) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(πψυκΠΨμΛΩβΣφμφσ.A("ŴƁƀŃƃſźƃƎŽŊƈƌƅƈƎŐӗӕӜӠәӂӯӠӦ", (byte)73, 65));
         }
   ...
   public ωΔτζχιαυΔτ a() {
      ...
      return new ΠεηΠγαςγτζλχφξ(this.a, var1, νωδΠΛσμμφζκΠ.a(var1, var1.getConsoleCommandSource()));
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΨφιωσρΓδΔθ.D("ՀԚԱԯԟԭԨՃԑՅՆԝ", (byte)96, 68);
               b[1] = ντθΔζβΔζ.F("֎֑Չ֑֘֓դ֖֍֊՞դ", (byte)96, 70);
               b[2] = ΦδφπθΩΩλζξ.B("ƖƤƪŶƏųƍſƜŽƝƣƀŽżơƤơƂǉƅƕƒƓ", (byte)96, 66);
               b[3] = ΠΛΨοδΩσμνΛγΦφβς.A("ƣƵŰƎŸƹƬŷƭŽƸƇ", (byte)96, 65);
               b[4] = ΠΛΨοδΩσμνΛγΦφβς.C("ՁՉԂՃԬԌԪՔՆԕԓԝ", (byte)96, 67);
               break;
            case 1:
               b[0] = ΣερμΔσατσκ.A("ƊƦƉƜƏƽŽƪƛƌŽƇ", (byte)96, 65);
               b[1] = ςπυηννναΣ.D("ԭԭԐԎԒԤԡՃԟՐԴԝ", (byte)96, 68);
               b[2] = βεξΠθρρςΔΦμ.B("ƖƤƪŶƏųƍſƜŽƛƾƶƹƿƁǄƂƵǋƾƥƒƓ", (byte)96, 66);
               b[3] = χΠξΦιζΨΣωΦσΨζ.A("ƢƚƊƤƫƼŷƘŹƌƢƇ", (byte)96, 65);
               b[4] = ΣδτΠνεγοΓορητ.D("ԾՉՃԎԐԮՀԯՉԫՖԝ", (byte)96, 68);
               break;
            case 2:
               b[0] = φδχεθοκψαλΛογλ.C("ԸՄՎԎՎՐՏՀՉՒԐԢԵԔԵՆՉՠԱԯՂԫԨԩ", (byte)96, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = ξψθρΣΠΣς.C("ԿԼՂԨԄԣՏՃՄԡԗԨՆ\u0557ԪՐԜԴԳԙ՟ՓԽՃՏԹԸՇԦգԸբ", (byte)96, 67);
         }
      }
   }
   ...
   @Generated
   public εβθλγΛχημ(νεΓτεκΓηζεΔλιΩ var1) {
      this.a = var1;
   }
   ...
   public θΨΛξτΠνΓυιθςσ a() {
      ...
      return new θΨΛξτΠνΓυιθςσ(
         var1.getName(), var1.getVersion(), var1.getVersion() + c<"㺀">(c, d ^ e) + var1.getVendor() + c<"㺃">(f & g, h), κιββωσγχςΣβΠΣδ.d, (boolean)i
      );
   }
      ...
      try {
         ...
         if (var1 != null && !var1.isEmpty()) {
            List var2 = var1.stream().map(var0 -> {
               ...
               return var1x.getName() + c<"㺀">(p, q ^ r) + var1x.getAddress();
            }).collect(Collectors.toList());
            this.a.c.a().a().a(c<"㺀">(j & k, l), String.join(c<"㺃">(m, n), var2));
         }
