
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = πχσδΦΦνθΔπ.B("ŁŖėőŐľŌŘĭĺĺħ", (byte)48, 66);
               b[1] = φδχεθοκψαλΛογλ.E("Ւ՚ՒԤ՝Խ՝՚ՆՈծ՟ԣդձըՋԲդՅձՒԿՀ", (byte)48, 69);
               b[2] = ΦδφπθΩΩλζξ.A("ŕňŚňĤĚĬőĨěĶħ", (byte)48, 65);
               b[3] = φδχεθοκψαλΛογλ.B("ĖįĢőŎĜĔĵęıĲŒŁĥŧŃŇĢŋŇĽŅĲĳ", (byte)48, 66);
               b[4] = βεξΠθρρςΔΦμ.D("қґқҰѻҞҗ҃Ґҕѿҍ", (byte)48, 68);
               b[5] = ΣερμΔσατσκ.E("ՑՕ՛ՉԧՓՋԫՕՂժՋ՚՟՟գձԨբՉըՂԿՀ", (byte)48, 69);
               b[6] = μεςΩΔΣγν.D("ҙҝҡҷӁңҴһ҅Ҧ҃ҍ", (byte)48, 68);
               b[7] = οΩνΩρωλΨηΛδωδ.A("įīĚňļĘŜřļęĺĳĚŦşĲŝěŢĩĺŅĲĳ", (byte)48, 65);
               b[8] = ξψθρΣΠΣς.A("ĵĕĸĳĻśĶŚšĴŐħ", (byte)48, 65);
               b[9] = ΣδτΠνεγοΓορητ.A("ĒĭŏŅĻřŉļĸķķŌŏŅŦŐŚŧģŨĩŅĲĳ", (byte)48, 65);
               b[10] = φΨαξωυθανΣφυκη.B("ĳŊĖŌőŕŒęşĝĲħ", (byte)48, 66);
               b[11] = ΣφδσΔζιΠρα.A("ĪĔħİĚŅĔĪĳĚıłĹĸĶĲŅļşħņŅĲĳ", (byte)48, 65);
               b[12] = χφπρψπφΦθμπ.A("ĎĤēŐĳĽŚĖĒĝŜħ", (byte)48, 65);
               b[13] = μεςΩΔΣγν.B("ŎīĤŐņĽĸęňĜġŚĚĹŝļţşřġūĵĲĳ", (byte)48, 66);
               b[14] = ΠΛΨοδΩσμνΛγΦφβς.E("ԯՙՓՕԻէի\u0557ՇթՙԴ", (byte)48, 69);
               b[15] = βεξΠθρρςΔΦμ.C("ҘҊҜүҿҷҲ҃ҕҷҨҍ", (byte)48, 67);
               b[16] = βθκςνθΩθυμςτκχ.E("ԴԞԙՈՇՉզ՝\u0558ԮՃԴ", (byte)48, 69);
               b[17] = ςπυηννναΣ.E("ՑԳԾԸ՚ԨՈՙՃԹԷԴ", (byte)48, 69);
               b[18] = χΠξΦιζΨΣωΦσΨζ.D("ҽҽѾҡҌѵҮѽӃҘҀӅҤҷӋҟҫӅҩҮҞқҘҙ", (byte)48, 68);
               b[19] = ζοηκορΦνΣθγΩ.F("ԯԤՕՑՃդԻ՚ԶՍԨԫլՍՔՉՠՈԵԴզըԿՀ", (byte)48, 70);
               b[20] = βθκςνθΩθυμςτκχ.A("ĤŉĲŏħŊŔŗĭļłħ", (byte)48, 65);
               b[21] = οΩνΩρωλΨηΛδωδ.B("ńĬĶĖŏŞĦİįśġħ", (byte)48, 66);
               b[22] = μεςΩΔΣγν.A("ĢŉıŎņĩŒŝĜŕŐŢŐĽŗĹũšŢīīśĲĳ", (byte)48, 65);
               b[23] = χφπρψπφΦθμπ.C("һҭҨҫҲҾҁү҄ҳҔҁҹҤҚӂҶҢҮҙҮӁҘҙ", (byte)48, 67);
               b[24] = ΦδφπθΩΩλζξ.A("ĔńŖķĳŜħŚľśŌőįŚŜŞļœŀŕŘĵĲĳ", (byte)48, 65);
               b[25] = βεξΠθρρςΔΦμ.F("՝ԵբՂԦԾԢՂԣՃ\u0557ԾՌծլ՝ԭՒԿըղոԿՀ", (byte)48, 70);
               break;
            case 1:
               b[0] = ςπυηννναΣ.D("ҧѿҠѺҘҶҤґҹҥҖҦҙӊҢҙӌҬҞҤӇҫҘҙ", (byte)48, 68);
               b[1] = μζξτΩσσφυδεπλΨ.C("ҫҳҫѽҶҖҶҳҟҡӇӃҦҕӈҬҬҎңӀҞӁҘҙ", (byte)48, 67);
               b[2] = οΩνΩρωλΨηΛδωδ.C("҈ҞҹҵҪқҐӁҁҼҔҍ", (byte)48, 67);
               b[3] = ςΦζσμτΓσ.B("ĖįĢőŎĜĔĵęıĲŜśŞŗœŧœŊŉŀĵĲĳ", (byte)48, 66);
               b[4] = δΛψπξκσβγςα.C("ѽҎҨүѽүҗӀҰґӉ҃ҶҚҜҌҨӁһ҈ҋҫҘҙ", (byte)48, 67);
               b[5] = ΨφιωσρΓδΔθ.A("ńňŎļĚņľĞňĵŞŤŚİŒŐţœĶţťūĲĳ", (byte)48, 65);
               b[6] = ΠΛΨοδΩσμνΛγΦφβς.B("ŖŌĨıĨĳĩŗŜįĭĠŔŦģŜŜłńŇŋśĲĳ", (byte)48, 66);
               b[7] = ζοηκορΦνΣθγΩ.B("įīĚňļĘŜřļęļŕķĲŐİŚŀĪŀĞśĲĳ", (byte)48, 66);
               b[8] = ΣδτΠνεγοΓορητ.E("ՙԶԷԧԽՔ՝ԺԵդՇՁՍԼՌԬխըժՉաՒԿՀ", (byte)48, 69);
               b[9] = ΨφιωσρΓδΔθ.F("ԟԺ՜ՒՈզՖՉՅՄՅՅՒՀիէկՉՏգՇըԿՀ", (byte)48, 70);
               b[10] = ΠΛΨοδΩσμνΛγΦφβς.F("աՓԣՅԧՇ՛Ԟ՞եգՙգԾՉԽՄծՅԯշըԿՀ", (byte)48, 70);
               b[11] = οΩνΩρωλΨηΛδωδ.B("ĪĔħİĚŅĔĪĳĚİģŠŞťġğķũŋŇūĲĳ", (byte)48, 66);
               b[12] = ΠΛΨοδΩσμνΛγΦφβς.A("ňłŔņĽĹĴķŜŁěęŝŗĵőĸŁķśŌśĲĳ", (byte)48, 65);
               b[13] = βθκςνθΩθυμςτκχ.D("ҴґҊҶҬңҞѿҮ҂ѾӆҥҋҨӋӌӌҨҼӐӑҘҙ", (byte)48, 68);
               b[14] = ζοηκορΦνΣθγΩ.A("ĬĹĢŚĺĖĻĴŎŒŒĳĞĶŇńİŨŗŇģśĲĳ", (byte)48, 65);
               b[15] = βεξΠθρρςΔΦμ.D("҆ҘҼѳҳҷҬѾҦқҜҜѼҸҙӂ҈ҢҜң҈ҫҘҙ", (byte)48, 68);
               b[16] = μζξτΩσσφυδεπλΨ.D("ҝҽѸҲқҫґҟ҅ӁҺҍ", (byte)48, 68);
               b[17] = λΣΩσμφγχ.D("ҩѸҳҢѿҢҮһҕҒқѿӆӈӃҪҧӈӄҠӈӑҘҙ", (byte)48, 68);
               b[18] = χφπρψπφΦθμπ.A("ŗŗĘĻĦďňėŝĲĜŜŕĭĴńĞĸĸŊōśĲĳ", (byte)48, 65);
               b[19] = μζξτΩσσφυδεπλΨ.D("҈ѽҮҪҜҽҔҳҏҦ҂҈ҨҳҬқҺһӆӉұҫҘҙ", (byte)48, 68);
               b[20] = μεςΩΔΣγν.B("łĐŘōĨŒŖĕœĪĠŝĮĲļĴŉŅœĹŋĵĲĳ", (byte)48, 66);
               b[21] = δΛψπξκσβγςα.D("ҜѷѸҮѼѾҝӅҺҰҧ҅ӆҊӇҺҩҞҩҭӊӑҘҙ", (byte)48, 68);
               b[22] = πψυκΠΨμΛΩβΣφμφσ.E("ԯՖԾ՛ՓԶ՟ժԩբ՟ՙծԲՋ\u0530ծԿԶյՁըԿՀ", (byte)48, 69);
               b[23] = φΨαξωυθανΣφυκη.E("բՔՏՒՙեԨՖԫ՚ԼԸբղՌղծՓգոԶըԿՀ", (byte)48, 69);
               b[24] = ιΠοθΩΦξκ.F("ԡՑգՄՀթԴէՋը՛ԩ\u0530ՠԿծեձԷիՔըԿՀ", (byte)48, 70);
               b[25] = λΣΩσμφγχ.E("՝ԵբՂԦԾԢՂԣՃՏՠ՜՟ԥՐ՞ՠզՔդըԿՀ", (byte)48, 69);
               break;
            case 2:
               b[0] = μεςΩΔΣγν.F("ՆԸԧՉՖզԝ՝ԿՅԡ\u0530՞\u0530\u0530ՔթԯՀՁդըԿՀ", (byte)48, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = φδχεθοκψαλΛογλ.E("ԡՖԹԞՊ՝ՊԺՍՌՙ՜ՄԾթՃլժՓՙՑՋդճծնկըՙՁՀՕ", (byte)48, 69);
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ιΠοθΩΦξκ.B("ãąćçċĪĢĸĤóıħĵįøĝĿľĶļĶċ", (byte)30, 66), πζιθΛΔρχΨυΔ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            μεςΩΔΣγν.F("ԽՊՉԌՌՈՃՌ\u0557ՆԓՑՕՎՑ\u0557ԙࢫࢢࢦࢦࢊࢄࢲࢹ࢛ࢹࢉ\u0530", (byte)30, 70) + var1 + πηγμΣΔκκ.D("щ", (byte)30, 68) + var2.toString(), var4
         );
      }
   }
   ...
   @Generated
   private πζιθΛΔρχΨυΔ(String var3, boolean var4) {
      this.ag = var3;
      this.J = var4;
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(φδχεθοκψαλΛογλ.B("ƺǇǆƉǉǅǀǉǔǃƐǎǒǋǎǔƖԨԟԣԣԇԁԯԶԘԶԆ", (byte)108, 66));
         }
