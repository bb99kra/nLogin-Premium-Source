...
public class NLoginCore_124 implements NLoginInterface_035 {
   ...
   private static String[] a = new String[NLoginCore_124.aj];
   private static int ag = '耀' >>> '\r' | 32768 << ~13 + 1;
   private static int z = (128 >>> 71 | 128 << -71) & -1;
   private static String[] b = new String[NLoginCore_124.ak];
   ...
   public boolean a(NLoginType_008 var1, NLoginCore_277 var2, NLoginCore_509 var3) {
      ...
      if (var6 == null) {
         ...
         return (boolean)(var1.a().a().a(a(c, d), (boolean)e) || !var1.a().a().ac() && (!var5.ad() || var7.ah()) ? g : f);
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = NLoginCore_387.C("҈ѶҠќѿѼѬѽѳҒҏҀѽ҉Ѧ҆Ҧ҈҂үѺҊѷѸ", (byte)37, 67);
               b[1] = NLoginCore_446.C("ј҈ҐѨњѡҐңѷ҆ҙѴҦѩ҂ҧ҅ѷҭ҃ҜґҊҁҌҏ҉Ҍңҍѵҝ", (byte)37, 67);
               b[2] = NLoginCore_092.F("ՍԨՅԩԩԽԨԱՂԿԬԩ", (byte)37, 70);
               b[3] = NLoginCore_232.A("ėłďĻĤÿĿĵģņĤđ", (byte)37, 65);
               b[4] = NLoginCore_397.C("Ѿ҇ҞѺѠҚҀҝҁѲѷѬ", (byte)37, 67);
               break;
            case 1:
               b[0] = NLoginCore_141.C("҈ѶҠќѿѼѬѽѳҒ҈ҡѧҊҔѶѦѹѻҥѺҊѷѸ", (byte)37, 67);
               b[1] = NLoginCore_127.F("ԕՅՍԥԗԞՍՠԴՃՖԱգԦԿդՂԴժՀՙՐԬզղՌՐՒկգէԱպՃձԸ՚ՊՒՓՁջ՜Չ", (byte)37, 70);
               b[2] = NLoginCore_110.D("ҜѨѪҗѹҡҍҜѡҒҥѬ", (byte)37, 68);
               b[3] = NLoginCore_004.A("ĠęĚķėĘİĸĆěĿČīĺęĥļŇēŌčŕĜĝ", (byte)37, 65);
               b[4] = NLoginCore_241.C("ҐѼёѹѿѡѿѬѣҧҙҁ҉ҞѫҗҦҎѡҁ҅ѺѷѸ", (byte)37, 67);
               break;
            case 2:
               b[0] = NLoginCore_521.E("ՃՔ\u0558ԧԭԵՉԾՕԞՠԥԘՙԻՀԺՌդ՟ԪՇԴԵ", (byte)37, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = NLoginCore_433.E("ՉԸ\u0558ՏԨԑԺԲԿԝ\u0558ՔգՏ՟ՈԳՃՄաԤԷԴԵ", (byte)37, 69);
         }
      }
   }
