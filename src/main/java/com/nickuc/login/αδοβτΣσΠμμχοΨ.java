...
public class αδοβτΣσΠμμχοΨ {
   ...
   private static String[] b = new String[αδοβτΣσΠμμχοΨ.l];
   ...
   private static String[] a = new String[αδοβτΣσΠμμχοΨ.k];
   private static final Method o;
   public final ζολχΓοφσοκομπ a = new ζολχΓοφσοκομπ(this, null);
   ...
   @Generated
   private static final Logger c = LoggerFactory.getLogger(αδοβτΣσΠμμχοΨ.class);
   ...
   private static final String bX = c<"㺀">(m, n);
   public final ψΩδωωΠΔνΠθπμζυ a = new ψΩδωωΠΔνΠθπμζυ(this, null);
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(χφπρψπφΦθμπ.A("»Ýß¿ãĂúĐüËĉÿčćÐõėĖĎĔĎã", (byte)10, 65), αδοβτΣσΠμμχοΨ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ιΠοθΩΦξκ.D("жутЅхсмхѐпЌъючъѐВޕޙޥޙެތޭދިީ\u07b5ޮޘЫ", (byte)10, 68) + var1 + ζοηκορΦνΣθγΩ.A("Í", (byte)10, 65) + var2.toString(), var4
         );
      }
   }
   ...
   static {
      ...
      Method var0;
      if ((var0 = ΓΛθσφζςηκ.a(var10000, null, null, var10003)) == null) {
         var10000 = SpigotReflectionUtil.NETWORK_MANAGER_CLASS;
         var10003 = new Class[q];
         var10003[r] = Cipher.class;
         var10003[s] = Cipher.class;
         var0 = ΓΛθσφζςηκ.a(var10000, null, null, var10003);
         if (var0 == null) {
            throw new IllegalArgumentException(c<"㺃">(t & u, v));
         }

         String[] var4 = new String[w];
         var4[x] = c<"㺆">(y, z ^ aa);
         var4[ab] = c<"㺉">(ac & ad, ae);
         var4[af] = c<"㺌">(ag, ah);
         var4[ai] = c<"㺏">(aj & ak, al);
         Class var2 = ζδΩςΣΓζτχ.a(var4);
         if (var2 == null) {
            throw new IllegalArgumentException(c<"㺒">(am & an, ao));
         }

         var10003 = new Class[ap];
         var10003[aq] = int.class;
         var10003[ar] = Key.class;
         var1 = ΓΛθσφζςηκ.a(var2, null, null, var10003);
         if (var1 == null) {
            throw new IllegalArgumentException(c<"㺕">(as, at ^ au));
         }
      }
   ...
   @Generated
   private αδοβτΣσΠμμχοΨ(nLoginBukkit var1, ΨγημιδξΓτοθαζ var2, KeyPair var3) {
      this.t = var1;
      this.y = var2;
      this.b = var3;
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = πχσδΦΦνθΔπ.D("ԺԀԦԳԕԡԣՈԭԤԤԑՅԋՀԦՖԳՄՑԜՑԨՏԠԺԘԣԾՖԵՑՖԡԿԵԷ՜ՌԦՊՂլԷ", (byte)94, 68);
               b[1] = πχσδΦΦνθΔπ.C("ԟԗԥԫԋԵՄԽՄԱԻԫԑՊՖԭՈԺԒԣՉԔԝԱԜԽՔԣդԡԸԟԱԥԼԿՠԫԤՙԯԹԪզ՞ՁԾԴԴդճՎԴիՂՃ", (byte)94, 67);
               b[2] = θεωψξβΛσσ.A("ƥƓƦũƍŴƭƄƓƏƖƃ", (byte)94, 65);
               b[4] = χΠξΦιζΨΣωΦσΨζ.B("ƝƀơƪųūƱƃƬƕżƙžƁŸƁƷƮƟƶƽƾƂƈƶƊƼƠưǁǆǄƌƽǕƩǃƬǆǉƜǐǆƳǠƭƝǝƺǞǎǥǦƻǉǨǂƽǆǦƻƨǯƱ", (byte)94, 66);
               b[5] = ντθΔζβΔζ.C("ԱԔԵԾԇӿՅԗՀԩԐԭԒԕԌԕՋՂԳՊՑ\u0557ԔԝԾՊԞաՀԲՕե\u0530ԾՠՠԩԬԪԾկԫլԷ", (byte)94, 67);
               b[6] = χΠξΦιζΨΣωΦσΨζ.D("ԱԔԵԾԇӿՅԗՀԩԐԭԒԕԌԕՋՂԳՊՑ\u0557ԔԝԾՊԞաՀԲՕե՟ՒեԹՍ՜ՅհԮկթծճՔԮԴՆՖԬԻՆՅՂՃ", (byte)94, 68);
               b[7] = πψυκΠΨμΛΩβΣφμφσ.A("ƊŽƓŭƋƫŸŸƆƚƾƏƽƳƴƕƀƁƘƆǈƈǂǉƼǁǄǎƊƱƽƏƎƨǂǔƕƙǄƶƼƮǐƣ", (byte)94, 65);
               b[8] = ΨΦνΨΦωυΩνβςμ.D("ՈԀԟԠՄՍՏԠԜԢԑԾԭԐՊ\u0530ԥՓ\u0557ՇՓ\u0530ՍԧԞԽբԬ՜ՆՕ՝ՖՀՄԤՋԶՉԹլ՜ԩՅՅՂժՑՑԲ\u0530ՈՔժթՐՐսգՂՐխՙՑ", (byte)94, 68);
               b[9] = ζοηκορΦνΣθγΩ.F("֓Ջժի֏֚֘իէխ՝֍հս՜ւջց֍֘դ֠֔ժ֠\u058bժ֯֏պֆլ֒ռ֏ֱղְ֬օ֪ջ֥֨վ֪֩֡֕֙շֵֶ֜ׄ։։ְֿ֦֢֟֨֡֬גְֵ֥֠֔כֵ׆ד֪֕לֽןםֶׇ֭֮׀֭֮", (byte)94, 70);
               break;
            case 2:
               b[0] = ξψθρΣΠΣς.E("ՓՏՒՈՖշօ֘փ\u0558֝հլ֕֟փ\u058cդ֢՜֖֑֠֝֟֜խ֢֚֡֠դ", (byte)94, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = ντθΔζβΔζ.B("ŲƮƊƑƂŵƤŴƑưƬŵźƟƣƽƣƳƕƞƕƑƎƏ", (byte)94, 66);
         }
      }
   }
   ...
   private static KeyPair a(Server var0) {
      ...
      if (var2 != null) {
         Field var3 = ΓΛθσφζςηκ.a(SpigotReflectionUtil.MINECRAFT_SERVER_CLASS, KeyPair.class, a);
         if (var3 != null) {
            try {
               var1 = (KeyPair)var3.get(var2);
            } catch (ReflectiveOperationException var5) {
               throw new RuntimeException(c<"㺀">(b, d ^ e), var5);
            }
         }
      }

      if (var1 == null) {
         var1 = ηΠτΠΩΔγΦρδρ.a(f);
      }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(μζξτΩσσφυδεπλΨ.E("Ւ՟՞ԡա՝\u0558ալ՛ԨզժգզլԮࢱࢵࣁࢵࣈࢨࣉࢧࣄࣅ࣑࣊ࢴ", (byte)51, 69));
         }
