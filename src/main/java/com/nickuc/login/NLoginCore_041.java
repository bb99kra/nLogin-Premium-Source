...
public class NLoginCore_041 implements NLoginInterface_003 {
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_041.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_530.C("ӄӦӨӈӬԋԃԙԅӔԒԈԖԐәӾԠԟԗԝԗӬ", (byte)77, 67), NLoginCore_041.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(NLoginCore_427.A("żƉƈŋƋƇƂƋƖƅŒƐƔƍƐƖŘӍӓӪӫӑӏӓӚӶŭ", (byte)77, 65) + var1 + NLoginCore_223.B("œ", (byte)77, 66) + var2.toString(), var4);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (ZKM_STR_A[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_004.B("ǊǗǖƙǙǕǐǙǤǓƠǞǢǛǞǤƦԛԡԸԹԟԝԡԨՄ", (byte)116, 66));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_076.F("ՐԪԙ\u0558ԥՎ՟՛ԯ\u0558ԚՒԤՃՂԠՖԟ\u0557՛Չ՛ՌՂԨՆՎՏդՑՅշՏՈիճԳՏԼլճսովրքգշմթն\u0558նՕՒՓ", (byte)35, 70);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_138.C("ҏѩјҗѤҍҞҚѮҗљґѣ҂ҁџҕўҖҚ҈Қҋҁѧ҅ҍҎңҐ҄ҶҎ҇ҪҲѲҎѻҫҲҼҸҭҋҀ҅ҜҲҷҳӀ҂ҔґҒ", (byte)35, 67);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_183.C("҇ѦѨ҉Ҝ҆ҎҍҒҙҒҚ҂ѾѡҦҡѤ҆ҔѷѦ҂ҀҌѬ҉ѾҴҢѫҍ", (byte)35, 67);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_427.B("ĔđĹīùėłĤĄăĶŇňĬėļĠĦČăŋŁĘę", (byte)35, 66);
         }
      }
   }
   ...
   private static Object a(Channel var0) {
      ...
      throw new IllegalArgumentException(a(h, i ^ j) + var0);
   }
   ...
   public void a(PacketReceiveEvent var1) {
      ...
      var3.attr(NLoginCore_306.d).set(new NLoginCore_306(var2.getProtocolVersion(), z(var2.getServerAddress()), a(var3)));
   }
}
