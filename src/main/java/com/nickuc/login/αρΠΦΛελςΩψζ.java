...
public class αρΠΦΛελςΩψζ implements ρΣνμχγΨοΔΦ {
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(βθκςνθΩθυμςτκχ.A("çĉċëďĮĦļĨ÷ĵīĹĳüġŃłĺŀĺď", (byte)32, 65), αρΠΦΛελςΩψζ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            μζξτΩσσφυδεπλΨ.C("Ѹ҅҄ч҇҃Ѿ҇ҒҁюҌҐ҉ҌҒєߗߨ߈ߏ߅ߠߧ߯ߗ߷ߦѫ", (byte)32, 67) + var1 + φδχεθοκψαλΛογλ.F("Ԗ", (byte)32, 70) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(οοθδΨιοΦΠβδζ.A("ĖģĢåĥġĜĥİğìĪĮħĪİòѵ҆ѦѭѣѾ҅ҍѵҕ҄", (byte)26, 65));
         }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return (boolean)n;
      } else if (!(var1 instanceof αρΠΦΛελςΩψζ)) {
         return (boolean)o;
      } else {
         αρΠΦΛελςΩψζ var2 = (αρΠΦΛελςΩψζ)var1;
         if (!var2.b(this)) {
            return (boolean)p;
   ...
   public αρΠΦΛελςΩψζ(String var1, String var2, String var3, @Nullable String var4, ΔΣλυΓΨΓβθςξη... var5) {
      this(var1, var2, var3, var4, (boolean)a, (boolean)b, var5);
   }

   public αρΠΦΛελςΩψζ(String var1, String var2, String var3, @Nullable String var4, boolean var5, boolean var6, ΔΣλυΓΨΓβθςξη... var7) {
      this.aD = var1.replace(c<"㺀">(c, d ^ e), c<"㺃">(f, g ^ h));
      this.aE = var2.replace(c<"㺆">(i, j ^ k), c<"㺉">(l, m));
      this.aF = var3;
      this.aG = var4;
      this.T = var5;
      this.U = var6;
   ...
   protected boolean b(Object var1) {
      return var1 instanceof αρΠΦΛελςΩψζ;
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = λΣΩσμφγχ.B("ƈƪƚūƩƬƪƭƲűƨŻ", (byte)90, 66);
               b[1] = βθκςνθΩθυμςτκχ.D("ԄԫԛԙӻԏԠӽԄԥԅԋ", (byte)90, 68);
               b[2] = φδχεθοκψαλΛογλ.D("ԘԺԪӻԹԼԺԽՂԁԸԋ", (byte)90, 68);
               b[3] = οοθδΨιοΦΠβδζ.D("ԄԫԛԙӻԏԠӽԄԥԅԋ", (byte)90, 68);
               break;
            case 1:
               b[0] = ζοηκορΦνΣθγΩ.D("ԐӳԒԵԩԿԖԸԄ\u0530ԁԋ", (byte)90, 68);
               b[1] = ΣφδσΔζιΠρα.B("ƨƎƖƬƫƝơŽƐƈƖŻ", (byte)90, 66);
               b[2] = ΠΛΨοδΩσμνΛγΦφβς.D("ԴӷԞԗӶԘԍԏՄԘԦԋ", (byte)90, 68);
               b[3] = ΨφιωσρΓδΔθ.E("ֆպեՎՉձ֍\u058cմմՔ՞", (byte)90, 69);
               break;
            case 2:
               b[0] = ΠΛΨοδΩσμνΛγΦφβς.D("ӺԼԝԔԭԀՂՁԝԠӽԿԕԃԖՄԚԗՍԢՐԩԖԗ", (byte)90, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = βεξΠθρρςΔΦμ.D("ԒԹԛԊԙԑԺԔՅԤԎԛՃՁԻԘԼՉԟԻԪԿԖԗ", (byte)90, 68);
         }
      }
   }
