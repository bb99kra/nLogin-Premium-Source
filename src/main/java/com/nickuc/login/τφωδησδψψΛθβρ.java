...
public class τφωδησδψψΛθβρ implements χιςζΓθωφρο {
   ...
   private static String[] a = new String[τφωδησδψψΛθβρ.ca];
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(
                     πψυκΠΨμΛΩβΣφμφσ.F("ՇթիՋկ֎ֆ֜ֈ\u0557֕\u058b֙֓՜ց֣֢֚֚֠կ", (byte)99, 70), τφωδησδψψΛθβρ.class.getClassLoader()
                  )
               )
               .asType(var2)
         );
         ...
         throw new RuntimeException(
            μεςΩΔΣγν.D("ՁՎՍԐՐՌՇՐ՛ՊԗՕՙՒՕ՛ԝࢳࢶࢺࢦࢪࢷࢩࢾࢿ\u0893ࢱࢬࢼԶ", (byte)99, 68) + var1 + πχσδΦΦνθΔπ.E("ՙ", (byte)99, 69) + var2.toString(), var4
         );
      }
   }
         ...
         if (var2 instanceof ProxiedPlayer) {
            ...
            if (!var3.isEmpty()) {
               ...
               try {
                  ...
                  ψΓωτιμωκχψΛΨ.c(c<"㺀">(e, f ^ g) + var1.getClass().getSimpleName() + c<"㺃">(h, i) + var4.getName() + c<"㺆">(j, k), var7);
                  var1.setCancelled((boolean)m);
                  var4.disconnect(TextComponent.fromLegacyText(c<"㺉">(n, o)));
               }
            }
         }
      }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΨφιωσρΓδΔθ.C("ծ՟ՠ֑՝Սծ֑մ՟\u058b֎ղ֘էլղխ՞թ՝բհց֥՞ո֓պ֟։ջ", (byte)117, 67);
               b[1] = ξψθρΣΠΣς.C("րՖ\u0590ձ՚՜֍\u058c֔մ\u0590\u0558Ւ֕հՓձ՞\u0557֞\u058bժէը", (byte)117, 67);
               b[2] = ΣδτΠνεγοΓορητ.E("֖ւզո֫ժ֦տ֪֦֔չ", (byte)117, 69);
               b[3] = μεςΩΔΣγν.D(
                  "ր՛։\u058cօՠ՞ցլճհոՙ֖ժֈ֎ևոց֏ոսդ֧֑֚ագ֚է֛֚զ֑֫խ֢֩֓\u058c\u0590կկָֺօֱֱֺ֪֘ռ֬վ֎׀տֵָ֚֔׀֮ׄ־ֿ֗֟֡֊֥ևִַׁ֖֒יטאדֳ\u05c8ִּם֠חפסֽכׂש֤", (byte)117, 68
               );
               b[4] = βθκςνθΩθυμςτκχ.B("ǟƶǣƣǆưǥƾǈǉǈǡƼǤǋǋǂǴǥǓǅǅǫǦǰǛǒǈǘǕƾǴ", (byte)117, 66);
               b[5] = ΦδφπθΩΩλζξ.E("ֆ։ըְ֭֝պպ֢ժ։ֳ֯ղ֥֘֎֤֧־֞֗քօ", (byte)117, 69);
               b[6] = ΦδφπθΩΩλζξ.B("ǃƴƵǦƲƢǃǦǉƴǠǣǇǭƼǁǇǂƳƾƲƷǅǖǺƳǍǨǏǴǞǐ", (byte)117, 66);
               b[7] = θεωψξβΛσσ.B("ǕƫǥǆƯƱǢǡǩǉǥƭƧǪǅƨǆƳƬǳǠƿƼƽ", (byte)117, 66);
               b[8] = δΛψπξκσβγςα.B("ǎƺƞưǣƢǞƷǢǞǌƱ", (byte)117, 66);
               b[9] = χφπρψπφΦθμπ.F(
                  "֝ո֦֢֩սջ֞։\u0590֍֕նֳև֥֤֚֫֕֞֬֕ցַ֮ׄվրַքַָփ\u05c8֮֊׆ְֿ֭֩\u058c\u058cחוֵ֢חׇ\u05ce\u05ce֙\u05c9֛֫ם֜וֱַגםס\u05cbכִלּ־ֳׂ֧֤במה֯\u05f6\u05f5\u05edװאץיב\u05faֽ״\u0601\u05feך\u05f8ן؆ׁ",
                  (byte)117,
                  70
               );
               b[10] = ιΠοθΩΦξκ.C("ծ՟ՠ֑՝Սծ֑մ՟\u058b֎ղ֘էլղխ՞թ՝բհց֥՞ո֓պ֟։ջ", (byte)117, 67);
               b[11] = πχσδΦΦνθΔπ.C("րՖ\u0590ձ՚՜֍\u058c֔մ\u0590\u0558Ւ֕հՓձ՞\u0557֞\u058bժէը", (byte)117, 67);
               b[12] = πχσδΦΦνθΔπ.A("ǎƺƞưǣƢǞƷǢǞǌƱ", (byte)117, 65);
               b[13] = θεωψξβΛσσ.C(
                  "ր՛։\u058cօՠ՞ցլճհոՙ֖ժֈ֎ևոց֏ոսդ֧֑֚ագ֚է֛֚զ֑֫խ֢֩֓\u058c\u0590կկָֺօֱֱֺ֪֘ռ֬վ֎׀տֵָ֚֔׀֮ׄ־ֿ֗֟֡֊֥ևִַׁ֖֒יטאדֳ\u05c8ִּם֠חפסֽכׂש֤", (byte)117, 67
               );
               b[14] = ιΠοθΩΦξκ.F("նգ֘֗֊ռ֍֪֎կֆ֎ְ֖շճ֊֦\u058bֲֶ֔֍ճ֕ջց֎֔׆օ֛֦֠֗֗ֆ\u05c8֣א\u05cdֱֲ֩֬֍אׁט֥֭֩ןַ֤֥", (byte)117, 70);
               b[15] = ΣερμΔσατσκ.A("ƪƢơǦƾǄƷǂǚǁƧƱ", (byte)117, 65);
               b[16] = λΣΩσμφγχ.D("խ\u0557ֈէ\u058c։֒\u058bՋ֒կ՜", (byte)117, 68);
               b[17] = ΨφιωσρΓδΔθ.F("ղժթ֮ֆ\u058cտ֊֢։կչ", (byte)117, 70);
               b[18] = φδχεθοκψαλΛογλ.A("ǂƬǝƼǡǞǧǠƠǧǄƱ", (byte)117, 65);
               break;
            case 1:
               b[0] = φΨαξωυθανΣφυκη.E("\u058bռս֮պժ\u058b֑֮ռ֨֫֏ֵք։֏֊ջֆպչ׀֎֒ջ֚֓־ֲֽ֟", (byte)117, 69);
               b[1] = φΨαξωυθανΣφυκη.F("֝ճ֭֎շչֱ֪֑֭֩ծծ֟ֈ\u058bֶ֛յֲֽ֩քօ", (byte)117, 70);
               b[2] = φδχεθοκψαλΛογλ.D("բփՆՂՉՠ\u058bլբնշ՜", (byte)117, 68);
               b[3] = ΣερμΔσατσκ.A(
                  "ǕưǞǡǚƵƳǖǁǈǅǍƮǫƿǝǣǜǍǖǤǍǒƹǯǼǦƶƸǯƼǰǯƻȀǦǂǾǷǨǡǥǄǄȏȍǚǭȏǿȆȆǑȁǓǣȕǔȍǩǯȊȕșȃȓǬȔǴǶǟǺǜǫȉȖȌǧȮȭȥȨȈȝȑȎȫȴȇȕȥǵǹȝǸȺȜȲȖȍȎɀȘɆȸȴȜȑ", (byte)117, 65
               );
               b[4] = ΣφδσΔζιΠρα.F("֧վ֫ի֎ո֭ֆ\u0590֑\u0590֩ք֬֓֓֊ּ֛֭֍\u058c\u058b֚֠֠֍ׁ֝սվջֺ֓օ\u05c8ׇ֜א֏ד\u05ceִ֙", (byte)117, 70);
               b[5] = ΠΛΨοδΩσμνΛγΦφβς.F("ֆ։ըְ֭֝պպ֢ժ֊էְմְְ֦֕ճշոֽքօ", (byte)117, 70);
               b[6] = πχσδΦΦνθΔπ.C("ծ՟ՠ֑՝Սծ֑մ՟\u058b֎ղ֘էլղխ՞թ՝՞ր֧֟֔֒գ֥տ֪ի֫֠֊֘պձփ\u058b\u058c֯֗ռ", (byte)117, 67);
               b[7] = βθκςνθΩθυμςτκχ.C("րՖ\u0590ձ՚՜֍\u058c֔մ֍ը\u0557ւյ֑ֈ֏֛հ֙ժէը", (byte)117, 67);
               b[8] = ζοηκορΦνΣθγΩ.B("ǛƚǝǤǘǥǨǒƾǥƧƱ", (byte)117, 66);
               b[9] = χφπρψπφΦθμπ.D(
                  "ր՛։\u058cօՠ՞ցլճհոՙ֖ժֈ֎ևոց֏ոսդ֧֑֚ագ֚է֛֚զ֑֫խ֢֩֓\u058c\u0590կկָֺօֱֱֺ֪֘ռ֬վ֎׀տֵָ֚֔׀֮ׄ־ֿ֗֟֡֊֥ևִַׁ֖֒יטאדֳ\u05c8ֵַּׅ֫מכִׇ֢ץ\u05cd֧\u05cdן\u05ecבגׄ\u05ca\u05f6֬ױּ",
                  (byte)117,
                  68
               );
               b[10] = ζβησεθωυγτ.A("ǃƴƵǦƲƢǃǦǉƴǠǣǇǭƼǁǇǂƳƾƲƮǪǱƹƲǓǾǒƸǌǾ", (byte)117, 65);
               b[11] = φΨαξωυθανΣφυκη.E("֝ճ֭֎շչֱ֪֑֤֩֬մֹ֧֪֖֒ֈյշ֗քօ", (byte)117, 69);
               b[12] = ΣφδσΔζιΠρα.C("ՙ։ռևհ֒բկծվշ՜", (byte)117, 67);
               b[13] = ΣερμΔσατσκ.E(
                  "֝ո֦֢֩սջ֞։\u0590֍֕նֳև֥֤֚֫֕֞֬֕ցַ֮ׄվրַքַָփ\u05c8֮֊׆ְֿ֭֩\u058c\u058cחוֵ֢חׇ\u05ce\u05ce֙\u05c9֛֫ם֜וֱַגםס\u05cbכִלּ־ֳׂ֧֤במה֯\u05f6\u05f5\u05edװאץיהּֿ\u05cf\u05f7יי\u0603ׄכר\u05f7ףתן\u0603ט؎ך؈ؑלי",
                  (byte)117,
                  69
               );
               b[14] = ΣερμΔσατσκ.E("նգ֘֗֊ռ֍֪֎կֆ֎ְ֖շճ֊֦\u058bֲֶ֔֍ճ֕ջց֎֔׆օ֛֦֠֗֗ֆ\u05c8֣א\u05cdְ֩ׄ֔֕֫ך׃֤ג׆\u0590֧֤֥", (byte)117, 69);
               b[15] = ΣδτΠνεγοΓορητ.B("ǛǄǓǑƻƶǜǠƜǛǢƱ", (byte)117, 66);
               b[16] = πχσδΦΦνθΔπ.D("չ՛ՌՉլբթքխ։֘զ֔ըզև՜֔՟֑պպէը", (byte)117, 68);
               b[17] = ΦδφπθΩΩλζξ.C("բ՞փծՉ\u0590ՊՔի։֍՜", (byte)117, 67);
               b[18] = ΣερμΔσατσκ.C("՞ւՇՍՈքլ\u058bտիՕմ֒փե֔պ՞սն։ժէը", (byte)117, 67);
               break;
            case 2:
               b[0] = μζξτΩσσφυδεπλΨ.E("ջօ֡֫\u058b֚֝վկֈ֜֏ևֶփձփֺֈ֏պ։ֽ֞׀ָ֠ր֧֛֥ֈ", (byte)117, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = ΣδτΠνεγοΓορητ.D("եՀ֊տգաձՒ֕ւՏխհ\u0557ՙթ֓֎թ֗՝ժէը", (byte)117, 68);
         }
      }
   }
   ...
   private boolean a(String var1) {
      if (!var1.isEmpty() && var1.charAt(bd) == be) {
         String[] var2 = var1.split(c<"㺀">(bf, bg ^ bh));
         if (var2.length > bi) {
            String var3 = var2[bj].toLowerCase(Locale.ENGLISH);
            return var3.equals(c<"㺃">(bk & bl, bm));
         }
      }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣερμΔσατσκ.E("ԣ\u0530ԯӲԲԮԩԲԽԬӹԷԻԴԷԽӿ\u0895࢘࢜࢈ࢌ࢙ࢋࢠࢡࡵ\u0893ࢎ࢞", (byte)4, 69));
         }
   ...
   @Generated
   public τφωδησδψψΛθβρ(nLoginBungee var1, ΨγημιδξΓτοθαζ var2) {
      this.c = var1;
      this.B = var2;
   }
      ...
      if (!var1.isCancelled()) {
         ...
         if (var2 instanceof ProxiedPlayer) {
            ...
            try {
               ...
               ΨαχΨχΣλεΠψΦ var6 = this.c.b().a(var3);
               if (var6.S()) {
                  return;
               }

               int var7 = !var6.i(c<"㺀">(r, s ^ t)) && !var6.i(c<"㺃">(u, v ^ w)) ? y : x;
               var4.removeIf(var3x -> {
                  if (var3x.trim().isEmpty()) {
                     ...
                     String[] var4x = var3x.split(c<"㺀">(bs, bt ^ bu));
                     String var5x = var4x[bv].toLowerCase(Locale.ENGLISH);
                     if (!var7 && var5x.equals(c<"㺃">(bw, bx))) {
                        return (boolean)by;
                     } else {
               ...
               ψΓωτιμωκχψΛΨ.c(c<"㺆">(z, aa ^ ab) + var1.getClass().getSimpleName() + c<"㺉">(ac, ad ^ ae) + var3.getName() + c<"㺌">(af, ag), var8);
               var1.setCancelled((boolean)ai);
               var3.disconnect(TextComponent.fromLegacyText(c<"㺏">(aj, ak ^ al)));
            }
         }
      }
   }
   ...
   public void a(ServerKickEvent var1) {
      if (!var1.isCancelled()) {
         ...
         if (var2.equalsIgnoreCase(c<"㺀">(ay & az, ba))) {
   ...
   public void a(SettingsChangedEvent var1) {
      ...
      if (var2 instanceof UserConnection) {
         try {
            ...
            εθσξξτΛακπΣ var5 = εθσξξτΛακπΣ.c(var4.getLocale());
            if (var5 != null) {
               ιηοψσγξςΩγδ var6 = this.B.a().a(var3);
               if (var6 != null) {
                  var6.a(πβκνλοΛκΠδΦτφλ.i, var5);
               }
            }
         } catch (Throwable var7) {
            ψΓωτιμωκχψΛΨ.c(c<"㺀">(am, an) + var1.getClass().getSimpleName() + c<"㺃">(ao & ap, aq) + var2.getName() + c<"㺆">(ar, as ^ at), var7);
            var2.disconnect(TextComponent.fromLegacyText(c<"㺉">(av, aw ^ ax)));
         }
      }
   }
}
