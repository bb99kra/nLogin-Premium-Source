...
public class γξτΩΛχΣΓπμΠσΓγφ {
   ...
   private static int do = (0 >>> 118 | 0 << -118) & -1;
   ...
   private final κγωΩζξΔμβνςπΓσ a;
   private static String[] b = new String[γξτΩΛχΣΓπμΠσΓγφ.gw];
   ...
   private final Map<PacketTypeCommon, θβορΛτηατθΨτΠτΦ> k = new HashMap<>();
   ...
   private static String[] a = new String[γξτΩΛχΣΓπμΠσΓγφ.gv];
   private static long cl = Long.reverse(1801487379071171387L);
   private final αλμΣΩτψφγζηθξψ a;
   ...
   private final Map<PacketTypeCommon, μθοδηοΠνΦΛνξΛ> l = new HashMap<>();
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = θεωψξβΛσσ.F("ԾԝԟԞՁԩԤՉԭԬԾԝԯԨԸՖԳԜԺէԞՀԭԮ", (byte)30, 70);
               b[1] = βεξΠθρρςΔΦμ.C("҈ѨћѤњѺ҅ьѣћњҁѵѫѳѢҏѶҌѴќҍѬҐѵ҉ҔѝҝҎѝҦ", (byte)30, 67);
               b[2] = μζξτΩσσφυδεπλΨ.A("ĭĴĈąĨïĲòĳİĬă", (byte)30, 65);
               b[3] = βεξΠθρρςΔΦμ.C("Ѧ҈џјѩѡ҅ѫѢѬѬѲѥ҇ѩђѡя҄њ҆їҙ҇їғќҗѢѠџѳѠ҇ќѥҊҦҊѿҊ҇ѱѷ", (byte)30, 67);
               b[4] = ζοηκορΦνΣθγΩ.E(
               ...
               b[5] = ΨφιωσρΓδΔθ.B("ĒìĥíĪĄðöĔĘûĩīÿôĹö÷ďĨĠĒŀŅŉăęŃĝŋĄŐĒčŐīĲŌĮĩĜņņĮĨİĽĸŏőťŖğņţŋŧŁţĸŌŬłŦĿŇŀŷŐĸŰŤŶŷŕľŠőšŏŭŖųšŰƃŽńƀŉŌŬŚƒśƁŢƊƎƘŭƕƔŧŬƊŦţ", (byte)30, 66);
               b[6] = φΨαξωυθανΣφυκη.C("ѵ҆҆ѩхњћх҂ѻѩхғҒэҕђѫҊ҃ҋѵѢѣ", (byte)30, 67);
               b[7] = ΦδφπθΩΩλζξ.C("тѤшѬ҆ўҌѯѼѿҀї", (byte)30, 67);
               b[8] = ΨφιωσρΓδΔθ.D("ѵ҆҆ѩхњћх҂ѻѧ҂ѤҍҁѯѣҋњѪѬјҘѺҋҊҋѭҀѵҧѡ", (byte)30, 68);
               b[9] = βεξΠθρρςΔΦμ.C(
                  "ѦрѹсѾјфъѨѬяѽѿѓшҍъыѣѼѴѦҔҙҝїѭҗѱҟјҤѦѡҤѿ҆Ҡ҂ѽѰҚҚ҂Ѽ҄ґҌңҥҹҪѳҚҷҟһҕҷҌҠӀҖҺғқҔӋҤҌӄҸӊӋҩҒҴҥҵңӁҪӇҵӄӗӑҘӔҝҠӀҮӦүӕҶӞӢӬӁөӨһӀӞҺҷ", (byte)30, 67
               );
               b[10] = οοθδΨιοΦΠβδζ.B("ïħĲĶāĔĶĉĺôĻıėŀĞĽĿįĂĆĺķĎď", (byte)30, 66);
               b[11] = ΣερμΔσατσκ.D("ђлєѸљњќ҈ѭѽѯҁ҃чҌґѰѯњҍ҇ѥѢѣ", (byte)30, 68);
               b[12] = οοθδΨιοΦΠβδζ.A("îĐôĘĲĊĸěĨīĬă", (byte)30, 65);
               b[13] = ΣφδσΔζιΠρα.D("ђлєѸљњќ҈ѭѽѰҍѰѵэҒѯљѵѨюҔғҌҌқѳѽҐҥѦҝ", (byte)30, 68);
               b[14] = ΣφδσΔζιΠρα.F(
                  "ԱԋՄԌՉԣԏԕԳԷԚՈՊԞԓ\u0558ԕԖԮՇԿԱ՟դըԢԸբԼժԣկԱԬկՊՑիՍՈԻեեՍՇՏ՜\u0557ծհքյԾեւժֆՠւ\u0557ի\u058bաօ՞զ՟֖կ\u0557֏փ֖֕մ՝տհրծ\u058cյ֒ր֏֢֜գ֟ըի\u058bչֱպ֠ցַ֭֩\u058cֳִֆ\u058b֩օւ",
                  (byte)30,
                  70
               );
               b[15] = δΛψπξκσβγςα.B("ïħĲĶāĔĶĉĺôĻıėŀĞĽĿįĂĆĺķĎď", (byte)30, 66);
               b[16] = μζξτΩσσφυδεπλΨ.A("ġĲĲĕñĆćñĮħēĶĳĮĒĻþĄĝĽÿėĶĥŋĠŇĸĦĎŏŇŒľĵłŌŔĳŌĜŒŐģ", (byte)30, 65);
               b[17] = ΨΦνΨΦωυΩνβςμ.F("ՀՑՑԴԐԥԦԐՍՆԴԐ՞՝ԘՠԝԶՕՎՖՀԭԮ", (byte)30, 70);
               b[18] = οΩνΩρωλΨηΛδωδ.D("ђлєѸљњќ҈ѭѽѯҁ҃чҌґѰѯњҍ҇ѥѢѣ", (byte)30, 68);
               b[19] = μζξτΩσσφυδεπλΨ.A("ëĳċĪāĳăĉĹęĒă", (byte)30, 65);
               b[20] = ΣφδσΔζιΠρα.F("ԣԮՔԎՅԒԡԹԬ՝ԶՌԘՌԳՃԛԵՃԶՂ\u0557ԢԨՉեՄԪծ՛ԣ՝թճԵՠզգՆՍՅմ՝Ղ", (byte)30, 70);
               b[21] = ΨΦνΨΦωυΩνβςμ.F("ԝՑԪԑԳՌՈԥՒԭԫՎՀԠԺԜԕԴՑԞԵՁ՟ԦԵՃԸՂՃԹՃՎ", (byte)30, 70);
               b[22] = θεωψξβΛσσ.A("ëĳċĪāĳăĉĹęĒă", (byte)30, 65);
               b[23] = πψυκΠΨμΛΩβΣφμφσ.C("єѥѾѻьѾѼшҌѯѰѧҍѡєѨҊяѴґѼќҞҚқ҉ѵҁѿѵѢѼҁҩѦҡҜѫҦҬҊҍңҪҡѭҴҏҕѹ҆ѶѻҫҝҊҒҙҕҋҔӂұ҅ҩӀҶҊҤҠҾҨӋґҿӂҿӁҡҎҫҔәӐҲҵҢң", (byte)30, 67);
               b[24] = μεςΩΔΣγν.C(
               ...
               b[25] = θεωψξβΛσσ.B("ĒìĥíĪĄðöĔĘûĩīÿôĹö÷ďĨĠĒŀŅŉăęŃĝŋĄŐĒčŐīĲŌĮĩĜņņĮĨİĽĸŏőťŖğņţŋŧŁţĸŌŬłŦĿŇŀŷŐĸŰŤŶŷŕľŠőšŏŭŖųšŰƃŽńƀŉŌŬŚƒśƁŢƊƎƘŭƕƔŧŬƊŦţ", (byte)30, 66);
               b[26] = οΩνΩρωλΨηΛδωδ.F("ԊՒԪՉԠՒԢԨ\u0558ԸԱԢ", (byte)30, 70);
               b[27] = φΨαξωυθανΣφυκη.C("҉ѓҁѾ҄ѠѣћѥѪѝѢ҈ѣўіѕѡғѓ҄ѽўѹҝѠњѳќѹѠҙѽѿѼғҭ҂Ҋ҂ѼҧҨѽңҨҩҩҘѲҐѻѸѻҸѺҌұҗҘѶүҵҦҵҸҳҼҩ҄ӂҰӀҡҪҗ", (byte)30, 67);
               b[28] = χφπρψπφΦθμπ.E("ԊՒԪՉԠՒԢԨ\u0558ԸԱԢ", (byte)30, 69);
               b[29] = δΛψπξκσβγςα.C("п҇џѾѕ҇їѝҍѭѦї", (byte)30, 67);
               b[30] = οοθδΨιοΦΠβδζ.A("ēìĎĊģīĕįĮĶĦĹđĢúĮŅŃėņĶĹėģĕŀĿħĠġĮčĦĦōĢİċĵŅĮİŜĹŐĴŃŋŢŔĥŐŁŗĮį", (byte)30, 65);
               b[31] = δΛψπξκσβγςα.A("ëĳċĪāĳăĉĹęĒă", (byte)30, 65);
               b[32] = χφπρψπφΦθμπ.E("ՐԾԵԩԓԧՖԔ\u0558ԪՓԳԷԶԷՊԙՅՒԠբԣԱՕԵՊԿՠՄՍՑԫՄՓԭբՁԮՋոՑհՖզՓԼՑ\u0557ցտ՛քՒՔ՝ՕֈքՄշպ՛հզ", (byte)30, 69);
               b[33] = χΠξΦιζΨΣωΦσΨζ.F(
                  "ԱԋՄԌՉԣԏԕԳԷԚԙԕԖԼաՁԣԾՕԺԶԨԵՈՊԶեՍՆԭՓզՏՋէՁձաԬԲղպշՔՓչժՒՙԽջ՝ՓՉթՙՋպըծպՏջՅ֍ղ֔թփ\u0590\u058cՔ֙ճկկրն֝՝օ՛փբ՞և֘֊ֈև֛զ֮պ֫։֮կ֕ղ։յ֗ֈջּհչֳ֒֓յֵ֖֣֢֦֘ֈָֆ\u05cd־ָ֩֯ք֎ְִ֒֏ְ֯֫׆֯֏֞ז\u05cbבעעאס֝זג֠ךָךך֫ס\u05ca֯נ",
                  (byte)30,
                  70
               );
               b[34] = οΩνΩρωλΨηΛδωδ.C(
                  "ѦрѹсѾјфъѨѬяѽѿѓшҍъыѣѼѴѦҔҙҝїѭҗѱҟјҤѦѡҤѿ҆Ҡ҂ѽѰҚҚ҂Ѽ҄ґҌңҥҹҪѳҚҷҟһҕҷҌҠӀҖҺғқҔӋҤҌӄҸӊӋҩҒҴҥҵңӁҪӇҵӄӗӑҘӔҝҠӀҮӦүӕҶӞӢӬӁөӨһӀӞҺҷ", (byte)30, 67
               );
               b[35] = ΦδφπθΩΩλζξ.A("ëĳċĪāĳăĉĹęĒă", (byte)30, 65);
               b[36] = θεωψξβΛσσ.C("ѽѨѲѓҍѪѡїѐыћѭё҄ѵѤҏјҘҙҍѪҝѰѵҏќѢќҝѺҁҐғѩѤҫѧҭҋҊҪґҒҨүѳҬҤҷҺѹѸ҇ҹҫҙҒһҡҺҳҤҷ҇ҕҗҟӂҹӎҌ҈ӅһҭҵҥҳӄӂүӉәҗҵҢң", (byte)30, 67);
               b[37] = ΣφδσΔζιΠρα.A("ëĳċĪāĳăĉĹęĒă", (byte)30, 65);
               b[38] = ζβησεθωυγτ.E("ԛԡՖՋՆԳԸԫՍԔՇԱԘ\u0558ԩգԢԡՕՏՔԱՆԿլՠՊ՜եՋգՁդԬՇՌՏՊԫՈԻղԸվԶն՝բվցվևշԺֈՓ\u058cՕՈւՇ֍Սբ", (byte)30, 69);
               b[39] = ΠΛΨοδΩσμνΛγΦφβς.E("ԤՇ\u0530ՕԴԔԖՑՓՎՅԗԺԮՔՓԫՐԼդ՜ԥԴԣ՞բՈաժԨԧղԬԪՕՓՖշէԵեՙՉՂ", (byte)30, 69);
               b[40] = θεωψξβΛσσ.D("ѿѶўќџпю҇ҏњѲї", (byte)30, 68);
               b[41] = ντθΔζβΔζ.C("љѼѥҊѩщы҆҈҃ѻћѯѶҁҔѯҔҘ҆ѺҝҊѼѫѹѢѻҚѝѽѲҕғҕ҈ҘҊҍҋ҉ҡѭѷ", (byte)30, 67);
               b[42] = ΣφδσΔζιΠρα.B("īĢĊĈċëúĳĻĆĞă", (byte)30, 66);
               b[43] = λΣΩσμφγχ.F("ԤՇ\u0530ՕԴԔԖՑՓՎԽՉԵԱՐԭԞԮԼՄԺԨԲԻբԧՋժՂ՟՞ՋձյՇՋ\u0557ՂԸՔԸՌՙՂ", (byte)30, 70);
               b[44] = φδχεθοκψαλΛογλ.B("ąċĔğĢĵďĚįįļă", (byte)30, 66);
               b[45] = βθκςνθΩθυμςτκχ.D("љѼѥҊѩщы҆҈҃ѲѾѪѦ҅ѢѓѣѱѹѯѝѧѰҗќҀҟѷҔғҀҦҪѼҀҌѷѭ҉ѭҁҎѷ", (byte)30, 68);
               b[46] = πηγμΣΔκκ.F("ԤԪԳԾՁՔԮԹՎՎ՛Ԣ", (byte)30, 70);
               b[47] = ζοηκορΦνΣθγΩ.A("óħðĊĕĮôĜęįěĉļďĠĚěĢķĥŀħĦĢČŊĹńŁćœĜĽœįħīĭīńŊŌŕōŖĳŘŗĲťŃłĽŁħŋĥīŬŐŅĪŅœįţŏŃİőŪŵŏŚĶŘŗŢűĺťżŷŃŻżŗƊŞŗƅŝŋŎŭƌ", (byte)30, 65);
               b[48] = βεξΠθρρςΔΦμ.B("ĝĖĳķĀčĶģİúįÿīċĿġĴġĥþĈĽĽĵľĤŃĎŁőŊĭĤğŕŗĒįĳńĤŔĺŕŀşšĠģİŤńŞĺşŞŁŧšŝŃŉŜŤ", (byte)30, 66);
               b[49] = ΠΛΨοδΩσμνΛγΦφβς.B("óħðĊĕĮôĜęįĚøĨÿĢĽğĺŅĞŀĚŊğĶĚŀčĦĞģċňŊčĸİĲģěĲŌĻĨĺįŁŘĠšļĞŧũĦġļŕŗśŁĬľĬűŪĲĮŋİĳıŕŇŴŔŊƂĺƀłşſššŃŃĽƄƈźŏſūſō", (byte)30, 66);
               b[50] = ςΦζσμτΓσ.A("ğċČġĢĶòįīĔĹñľėĢĖığüŅúŃľĠėĨĸğıĭĞİČĐœĪĭďŏōŖŚŔŖŔōŔİŒĥĤĞĺġĵŘŇņŀŊŇŦŀŐŀĮİŬţĸŅųŊįĽľſŌƂľśŶŮŐŇŷŪƂņŋńŦƌŻūū", (byte)30, 65);
               break;
            case 1:
               b[0] = ΣφδσΔζιΠρα.A("ğþĀÿĢĊąĪĎčğĲĠĻďĲÿ÷ęĨĂġĎď", (byte)30, 65);
               b[1] = ΣερμΔσατσκ.F("ՓԳԦԯԥՅՐԗԮԦԥՌՀԶԾԭ՚Ձ\u0557Կԧ՚ՃՄՇզՉ՚ՃՋՏ՚", (byte)30, 70);
               b[2] = πψυκΠΨμΛΩβΣφμφσ.C("ѱ҇ј҃ѵѻѩќ҂ћҊѬќҀ҆ѫҖҁѺѵѱқѢѣ", (byte)30, 67);
               b[3] = ντθΔζβΔζ.C("Ѧ҈џјѩѡ҅ѫѢѬѬѲѥ҇ѩђѡя҄њ҆їҙ҇їғќҗѢѠџѳѣҙѻҟѨѣѫѦҀ҉Ҩѷ", (byte)30, 67);
               b[4] = ντθΔζβΔζ.D(
               ...
               b[6] = ΨΦνΨΦωυΩνβςμ.E("ՀՑՑԴԐԥԦԐՍՆԴԮԻԟՂՐԱԳՆԴԷ\u0530ԭԮ", (byte)30, 69);
               b[7] = πψυκΠΨμΛΩβΣφμφσ.F("ԏԞԌԵ\u0557ԱԧԭԯՕԹԢ", (byte)30, 70);
               b[8] = ΦδφπθΩΩλζξ.E("ՀՑՑԴԐԥԦԐՍՆԲՍԯ\u0558ՌԺԮՖԥԵԷթ՝ԽՃ՛ՋՅՂկդՄ", (byte)30, 69);
               b[9] = ςΦζσμτΓσ.E(
                  "ԱԋՄԌՉԣԏԕԳԷԚՈՊԞԓ\u0558ԕԖԮՇԿԱ՟դըԢԸբԼժԣկԱԬկՊՑիՍՈԻեեՍՇՏ՜\u0557ծհքյԾեւժֆՠւ\u0557ի\u058bաօ՞զ՟֖կ\u0557֏փ֖֕մ՝տհրծ\u058cյ֒ր֏֢֜գ֟ըի\u058bչֱպִֶ֦֪֠֏֦֮֕ֈօնոֶ֖֤֚֭֨րַ׃ֶ֍֎",
                  (byte)30,
                  69
               );
               b[10] = χφπρψπφΦθμπ.B("ïħĲĶāĔĶĉĺôĻöĶĝĭĭĤĐĜıłŇĎď", (byte)30, 66);
               b[11] = ΠΛΨοδΩσμνΛγΦφβς.D("ђлєѸљњќ҈ѭѽѰюь҉ѲѪҔђҔёњҋѢѣ", (byte)30, 68);
               b[12] = βεξΠθρρςΔΦμ.A("ąċîíġøıĘùķõă", (byte)30, 65);
               b[13] = πχσδΦΦνθΔπ.F("ԝԆԟՃԤԥԧՓԸՈԻ\u0558ԻՀԘ՝ԺԤՀԳԙ՝էԧՆ՞ԨխհՉՈՊԽՈԴԨ\u0530ՓՓխպԻճՂ", (byte)30, 70);
               b[14] = χΠξΦιζΨΣωΦσΨζ.B(
               ...
               b[15] = βθκςνθΩθυμςτκχ.B("ïħĲĶāĔĶĉĺôĹċĝďĜęăĎĮėĨķĎď", (byte)30, 66);
               b[16] = ΦδφπθΩΩλζξ.B("ġĲĲĕñĆćñĮħēĶĳĮĒĻþĄĝĽÿėĶĥŋĠŇĸĦĎŏŇČŒĭŗİĸįļŚĽĲģ", (byte)30, 66);
               b[17] = λΣΩσμφγχ.B("ġĲĲĕñĆćñĮħĒĳŀĉľńĐŃĶĂąġĎď", (byte)30, 66);
               b[18] = ντθΔζβΔζ.E("ԝԆԟՃԤԥԧՓԸՈԼՌԻՓՖՕԛԳԹԳՀՖԭԮ", (byte)30, 69);
               b[19] = ΠΛΨοδΩσμνΛγΦφβς.D("њѿѿ҄ѣљѶѝњ҆ёї", (byte)30, 68);
               b[20] = ΣερμΔσατσκ.F("ԣԮՔԎՅԒԡԹԬ՝ԶՌԘՌԳՃԛԵՃԶՂ\u0557ԢԨՉեՄԪծ՛ԣ՝կԴլմՋԪմԴՈճթՕձԼՁբՕպՁՂ\u0557ՠՍՎ", (byte)30, 70);
               b[21] = βεξΠθρρςΔΦμ.E("ԝՑԪԑԳՌՈԥՒԭԫՎՀԠԺԜԕԴՑԞԵՉԷԧ՝ՍԦզծՑՅԻ", (byte)30, 69);
               b[22] = οοθδΨιοΦΠβδζ.C("Ѣхшѹшх҃љ҅ўҐї", (byte)30, 67);
               b[23] = βθκςνθΩθυμςτκχ.A("ĀđĪħøĪĨôĸěĜēĹčĀĔĶûĠĽĨĈŊņŇĵġĭīġĎĨĭŕĒōňėŒŘĶĹŏŖōęŠĻŁĥĲĢħŗŉĶľŅŁķŀŮŝıŕŬŢĶŐŌŪŔŷĽŪōŋŜźŽŔůŹſŲőŎŏ", (byte)30, 65);
               b[24] = δΛψπξκσβγςα.C(
               ...
               b[26] = φδχεθοκψαλΛογλ.C("ќѦѩҋуѶхѯцҐѮї", (byte)30, 67);
               b[27] = ΦδφπθΩΩλζξ.D("҉ѓҁѾ҄ѠѣћѥѪѝѢ҈ѣўіѕѡғѓ҄ѽўѹҝѠњѳќѹѠҙѽѿѼғҭ҂Ҋ҂ѼҧҨѽңҨҩҩҘѲҐѻѸѻҸѺҌұҗҘѶүҵҦҥ҂҃ӀҶҩҷҼҝӉҼҗ", (byte)30, 68);
               b[28] = ΣφδσΔζιΠρα.E("ՎԽՎԶԏՐԒԭ\u0558ԲԱԢ", (byte)30, 69);
               b[29] = ζβησεθωυγτ.C("шѣ҃Ѵ҃ҍѶѬѪҊѪї", (byte)30, 67);
               b[30] = ζοηκορΦνΣθγΩ.D("ѧрѢўѷѿѩ҃҂ҊѺҍѥѶю҂ҙҗѫҚҊҍѫѷѩҔғѻѴѵ҂ѡѺѺҡѶ҄џ҉ҙ҂҄ұҮѬҒҀѲѲҵ҄ҏҎҕ҂҃", (byte)30, 68);
               b[31] = ιΠοθΩΦξκ.F("ԞԴԫՍՎԴԕԴ\u0558ԭԔԢ", (byte)30, 70);
               b[32] = πηγμΣΔκκ.B("ığĖĊôĈķõĹċĴĔĘėĘīúĦĳāŃĄĒĶĖīĠŁĥĮĲČĥĴĎŃĢďĬřĲőķŇĴĝĲĸŢŠļťĳĲģŬĥśĿĨŰśŇĭĿšĴİœņİťĳŵŎŃ", (byte)30, 66);
               b[33] = χΠξΦιζΨΣωΦσΨζ.F(
               ...
               b[34] = πψυκΠΨμΛΩβΣφμφσ.F(
                  "ԱԋՄԌՉԣԏԕԳԷԚՈՊԞԓ\u0558ԕԖԮՇԿԱ՟դըԢԸբԼժԣկԱԬկՊՑիՍՈԻեեՍՇՏ՜\u0557ծհքյԾեւժֆՠւ\u0557ի\u058bաօ՞զ՟֖կ\u0557֏փ֖֕մ՝տհրծ\u058cյ֒ր֏֢֜գ֟ըի\u058bչֱպ֠ծ։֎կ\u058cֶ֣֨։պֳ֑֮։ջչֵׁׂ׆֒׆֍֎",
                  (byte)30,
                  70
               );
               b[35] = ιΠοθΩΦξκ.C("ѺѥѨ҂҇їѺѥҐ҂Ѽї", (byte)30, 67);
               b[36] = χφπρψπφΦθμπ.C("ѽѨѲѓҍѪѡїѐыћѭё҄ѵѤҏјҘҙҍѪҝѰѵҏќѢќҝѺҁҐғѩѤҫѧҭҋҊҪґҒҨүѳҬҤҷҺѹѸ҇ҹҫҙҒһҡҺҳҤҷ҇ҕҗҟӂҹӎҌ҈ӅҺӎҿҕӊҕүүҶӄҧӛҢң", (byte)30, 67);
               b[37] = ΣερμΔσατσκ.B("ħāĀĵĐøİĤĔĆùă", (byte)30, 66);
               b[38] = μζξτΩσσφυδεπλΨ.C("ѐіҋҀѻѨѭѠ҂щѼѦэҍўҘїіҊ҄҉ѦѻѴҡҕѿґҚҀҘѶҙѡѼҁ҄ѿѠѽѰҧѭҳѫҫҒҗҳҶҳҼҬѷҝҫҟҡҠӂѺҏӂ҇", (byte)30, 67);
               b[39] = πψυκΠΨμΛΩβΣφμφσ.D("љѼѥҊѩщы҆҈҃Ѻьѯѣ҉҈Ѡ҅ѱҙґњѩјғҗѽҖҟѝќҧњћѷѪҪѼҀѻҟ҆Ҋѷ", (byte)30, 68);
               b[40] = χΠξΦιζΨΣωΦσΨζ.B("ĀčăĠĭĉĺĹôĸùă", (byte)30, 66);
               b[41] = μζξτΩσσφυδεπλΨ.E("ԤՇ\u0530ՕԴԔԖՑՓՎՆԦԺՁՌ՟Ժ՟գՑՅըՕՇԶՄԭՆեԨՈԽՒՁԮմՒՕ\u0558ԹՅթՑՂ", (byte)30, 69);
               b[42] = θεωψξβΛσσ.D("шҊҊҁҀҍѾѩюќѲї", (byte)30, 68);
               b[43] = ςπυηννναΣ.F("ԤՇ\u0530ՕԴԔԖՑՓՎԽՉԵԱՐԭԞԮԼՄԺԨԲԻբԧՋժՂ՟՞ՋմԽծՏԲլՏ\u0557ՆԹլջ՝ՀԳշա՛ղՂընՍՎ", (byte)30, 70);
               b[44] = ςΦζσμτΓσ.F("ՑՅԠԞԦ\u0530ՉԕՑԚՐՓԱՖԙաԼՒԛԤԷՖԭԮ", (byte)30, 70);
               b[45] = μζξτΩσσφυδεπλΨ.F("ԤՇ\u0530ՕԴԔԖՑՓՎԽՉԵԱՐԭԞԮԼՄԺԨԲԻբԧՋժՂ՟՞Ջ\u0530ԼԯՊՇՆԳԳՙԳՒՐ\u0558՟ԿչդռմչՔՠՍՎ", (byte)30, 70);
               b[46] = ζοηκορΦνΣθγΩ.F("ԽՕՃՔՀՅԙԙԫԷ՝՚ՙ՜ԼԵԴԖԺԟՀՖԭԮ", (byte)30, 70);
               b[47] = βεξΠθρρςΔΦμ.D(
                  "чѻфўѩ҂шѰѭ҃ѯѝҐѣѴѮѯѶҋѹҔѻѺѶѠҞҍҘҕћҧѰґҧ҃ѻѿҁѿҘҞҠҩҡҪ҇Ҭҫ҆ҹҗҖґҕѻҟѹѿӀҤҙѾҙҧ҃ҷңҗ҄ҥҾӉңҮҊҬҫҶӅҎҹӐӋҗӏӑҧҩӁӂӛҭӂҼҜӇӝӢӆҽӖӆҸӂҢҮӨҷ", (byte)30, 68
               );
               b[48] = ιΠοθΩΦξκ.D("ѱѪ҇ҋєѡҊѷ҄ю҃ѓѿџғѵ҈ѵѹђќґґ҉ҒѸҗѢҕҥҞҁѸѳҩҫѦ҃҇ҘѸҨҎҩҔҳҵѴѷ҄ҸҘҲҍҵҌѶғқғҷҢҶ҇", (byte)30, 68);
               b[49] = χΠξΦιζΨΣωΦσΨζ.D(
                  "чѻфўѩ҂шѰѭ҃ѮьѼѓѶґѳҎҙѲҔѮҞѳҊѮҔѡѺѲѷџҜҞѡҌ҄҆ѷѯ҆ҠҏѼҎ҃ҕҬѴҵҐѲһҽѺѵҐҩҫүҕҀҒҀӅҾ҆҂ҟ҄҇҅ҩқӈҨҞӖҎӔҖҳӓҵҵғӚӇҴҹӊӁӡҸӒӈҼӖӢӬӈӕӌӎһӀҭҷ", (byte)30, 68
               );
               b[50] = πηγμΣΔκκ.A("ğċČġĢĶòįīĔĹñľėĢĖığüŅúŃľĠėĨĸğıĭĞİČĐœĪĭďŏōŖŚŔŖŔōŔİŒĥĤĞĺġĵŘŇņŀŊŇŦŀŐŀĮİŬţĸŅųŊįĽľſŌƂľśŶŮŐŇƀūƄŪŢƉŌŹƃŨŎŌŤŭŎţƉƅƅƋƐƔţ", (byte)30, 65);
               break;
            case 2:
               b[0] = φδχεθοκψαλΛογλ.A("ĄĎĦėċĆõćûąûÿčĶĶğĔİĽĵĆęŊėĺīĮļľČĝĒ", (byte)30, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = ζοηκορΦνΣθγΩ.E("ԼԯԏՍԴՐԣԐԛԬԥԪԝ՞՛ԙ՝ԝՔՕՂդՊ՚է՟լԦ\u0558ԸՁ՝", (byte)30, 69);
         }
      }
   }
   ...
   private void aD() {
      this.aE();
      Filter var1 = var0 -> (boolean)(!ψΓωτιμωκχψΛΨ.aj() && (var0.getLevel().intValue() < Level.WARNING.intValue() || c<"㺀">(gr, gs).equals(var0.getMessage()))
         ? gu
         : gt);
      PacketEventsSettings var2 = new PacketEventsSettings()
         .debug((boolean)b)
         .checkForUpdates((boolean)c)
         .kickOnPacketException((boolean)d)
         .reEncodeByDefault((boolean)e)
         .timeStampMode(TimeStampMode.MILLIS)
         .logFilter(var1);
      PacketEventsAPI var3;
      switch (ρριΦωΩγπςκψς.K[this.t.b().a().ordinal()]) {
         case 1:
         ...
         case 3:
            ...
            break;
         default:
            throw new IllegalStateException(c<"㺀">(f & g, h) + this.t.b().a() + c<"㺃">(i & j, k));
      }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣφδσΔζιΠρα.F("՞իժԭխթդխոէԴղնկղոԺࢿ࣒࣋ࢸࢫࣘࢵࢦ࣑ࣔࢶࣚࢫ࣌࣠", (byte)63, 70));
         }
   ...
   public void k(ΨαχΨχΣλεΠψΦ var1) {
      if (this.a == null) {
         throw new IllegalStateException(c<"㺀">(ge, gf ^ gg));
      } else {
   ...
   private void aE() {
      if (!c<"㺀">(l, m ^ n).equalsIgnoreCase(System.getenv(c<"㺃">(o, p ^ q)))) {
         String var1 = c<"㺆">(r, s ^ t);
         String var2 = c<"㺉">(u, v ^ w);
         boolean[] var10000 = new boolean[x];
         var10000[y] = (boolean)z;
         var10000[aa] = (boolean)ab;
         boolean[] var3 = var10000;
         int var4 = ac;
         ωΛσΦΔτβωυυτθθΓυ var5 = this.t.b().a(c<"㺌">(ad, ae));
         if (var5 != null && var5.s() != null) {
            String[] var6 = var5.s().split(c<"㺏">(af, ag), ah);
            int var7 = Integer.parseInt(var6[ai]);
            int var8 = Integer.parseInt(var6[aj]);
            if (var7 < ak || var7 == al && var8 < am) {
               File var9 = πησοιΣζΩθΛδλζσ.a(var5.e().getClass());
               File var10 = new File(this.t.c().getParentFile(), c<"㺒">(an, ao ^ ap));
               βΠτπξπΛχηΦΦΛα var11 = ΓχοθψΦυψωζσσ.a().a(c<"㺕">(aq, ar), var10);
               if (var11.af()) {
                  File var12 = πησοιΣζΩθΛδλζσ.a(var9, πησοιΣζΩθΛδλζσ.c(var9) + c<"㺘">(as, at));
         ...
         ωΛσΦΔτβωυυτθθΓυ var14 = this.t.b().a(c<"㺛">(ax, ay));
         if (var14 != null && var14.s() != null) {
            int var15 = Integer.parseInt(var14.s().split(c<"㺞">(az, ba ^ bb), bc)[bd]);
            if (var15 < be) {
               File var17 = πησοιΣζΩθΛδλζσ.a(var14.e().getClass());
               File var18 = new File(this.t.c().getParentFile(), c<"㺡">(bf, bg ^ bh));
               βΠτπξπΛχηΦΦΛα var19 = ΓχοθψΦυψωζσσ.a().a(c<"㺤">(bi, bj), var18);
               if (var19.af()) {
                  File var20 = πησοιΣζΩθΛδλζσ.a(var17, πησοιΣζΩθΛδλζσ.c(var17) + c<"㺧">(bk, bl ^ bm));
         ...
         String var16 = var3[bq] && var3[br] ? c<"㺪">(bs, bt ^ bu) : (var3[bv] ? c<"㺭">(bw & bx, by) : c<"㺰">(bz, ca ^ cb));
         boolean[] var10001 = new boolean[cc];
         var10001[cd] = (boolean)ce;
         var10001[cf] = (boolean)cg;
         if (!Arrays.equals(var3, var10001)) {
            if (εδδΠηδξΛΣχ.j()) {
               ψΓωτιμωκχψΛΨ.d(c<"㺳">(ch, ci));
               ψΓωτιμωκχψΛΨ.d(c<"㺶">(ck, cl) + var16 + c<"㺹">(cm, cn ^ co));
               ψΓωτιμωκχψΛΨ.d(c<"㺼">(cq, cr ^ cs));
               ψΓωτιμωκχψΛΨ.d(c<"㺿">(cu, cv));
               if (var3[cx]) {
                  ψΓωτιμωκχψΛΨ.d(c<"㻂">(cy, cz ^ da));
               }

               if (var3[dc]) {
                  ψΓωτιμωκχψΛΨ.d(c<"㻅">(dd, de ^ df));
               }

               ψΓωτιμωκχψΛΨ.d(c<"㻈">(dh, di ^ dj));
               ψΓωτιμωκχψΛΨ.d(c<"㻋">(dl & dm, dn));
               ψΓωτιμωκχψΛΨ.d(c<"㻎">(dp & dq, dr));
            } else {
               ψΓωτιμωκχψΛΨ.d(c<"㻑">(dt, du));
               ψΓωτιμωκχψΛΨ.d(var16 + c<"㻔">(dw, dx));
               ψΓωτιμωκχψΛΨ.d(c<"㻗">(dz, ea ^ eb));
               ψΓωτιμωκχψΛΨ.d(c<"㻚">(ed, ee ^ ef));
               if (var3[eh]) {
                  ψΓωτιμωκχψΛΨ.d(c<"㻝">(ei, ej ^ ek));
               }

               if (var3[em]) {
                  ψΓωτιμωκχψΛΨ.d(c<"㻠">(en & eo, ep));
               }

               ψΓωτιμωκχψΛΨ.d(c<"㻣">(er & es, et));
               ψΓωτιμωκχψΛΨ.d(c<"㻦">(ev, ew));
               ψΓωτιμωκχψΛΨ.d(c<"㻩">(ey & ez, fa));
            }

            try {
               Thread.sleep(fc);
            } catch (InterruptedException var13) {
               ψΓωτιμωκχψΛΨ.a(var13);
            }
         }

         if (var4 != 0) {
            this.t.b().c();
            throw new IllegalStateException(c<"㻬">(fd, fe ^ ff) + var16);
         }
      }
   }

   public User a(ΨαχΨχΣλεΠψΦ var1) {
      User var2 = PacketEvents.getAPI().getPlayerManager().getUser(var1.c());
      if (var2 == null) {
         throw new IllegalArgumentException(c<"㺀">(fg, fh ^ fi) + var1.getName() + c<"㺃">(fj & fk, fl) + var1.a());
      } else {
         return var2;
      }
   }

   public αλμΣΩτψφγζηθξψ a() {
      if (this.a == null) {
         throw new IllegalStateException(c<"㺀">(gi, gj ^ gk));
      } else {
         return this.a;
      }
   }

   public γξτΩΛχΣΓπμΠσΓγφ(ΨγημιδξΓτοθαζ var1) {
      this.a = new κγωΩζξΔμβνςπΓσ(this);
      this.ay = (boolean)a;
      this.t = var1;
      this.aD();
      if (var1.b().a() == κιββωσγχςΣβΠΣδ.b && var1.i()) {
         this.a = null;
      } else {
         ΓΩηκψγΓεςσγΓ var2 = new ΓΩηκψγΓεςσγΓ(var1);
         ...
         this.k.put(Client.KEEP_ALIVE, new ΛεσΨΛδωμς(var1));
         this.a = new αλμΣΩτψφγζηθξψ(var1);
         if (var1.b().a().L()) {
      ...
      if (var1.b().a() == κιββωσγχςΣβΠΣδ.b) {
         ...
         this.a = new ΛΠωσρζυχη(var1);
         this.l.put(Server.SET_SLOT, this.a.a);
         this.l.put(Server.WINDOW_ITEMS, this.a.a);
         if (var1.i()) {
            this.k.put(com.nickuc.login.lib.packetevents.api.protocol.packettype.PacketType.Login.Client.LOGIN_START, new ωεΓτςηκλλζκγΩ());
            οουτχΛκΣηΓψοΔ var3 = new οουτχΛκΣηΓψοΔ(var4);
            ...
            αδοβτΣσΠμμχοΨ var6 = new αδοβτΣσΠμμχοΨ(var4);
            ...
            this.k.put(Client.CLIENT_SETTINGS, new ΛγψΛεΦγτΩααγοξχ(var4));
            this.k.put(com.nickuc.login.lib.packetevents.api.protocol.packettype.PacketType.Handshaking.Client.HANDSHAKE, new ΣΨξξΣΠΣΩτ());
         }
      } else {
         this.a = null;
         λφΠΩερκλΣ var5 = new λφΠΩερκλΣ(var1);
   ...
   public Channel a(Object var1, Object var2) {
      try {
         ...
         if (var3 == null) {
            ψΓωτιμωκχψΛΨ.d(c<"㺀">(fr, fs ^ ft) + var1.getClass().getCanonicalName() + c<"㺃">(fu, fv ^ fw));
         }

         return var3;
      } catch (Exception var4) {
         ψΓωτιμωκχψΛΨ.c(c<"㺆">(fy, fz ^ ga) + var1.getClass().getCanonicalName() + c<"㺉">(gb, gc), var4);
         return null;
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  γξτΩΛχΣΓπμΠσΓγφ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(πψυκΠΨμΛΩβΣφμφσ.C("ѡ҃҅ѥ҉ҨҠҶҢѱүҥҳҭѶқҽҼҴҺҴ҉", (byte)44, 67), γξτΩΛχΣΓπμΠσΓγφ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΣερμΔσατσκ.E("Ջ\u0558\u0557Ԛ՚ՖՑ՚եՔԡ՟գ՜՟եԧࢬࢸࢿࢥ࢘ࣅࢢ\u0893ࣁࢾࢣࣇ࢘ࢹ࣍Ղ", (byte)44, 69) + var1 + φΨαξωυθανΣφυκη.C("ѳ", (byte)44, 67) + var2.toString(), var4
         );
      }
   }

   public ClientVersion a(User var1) {
      if (this.t.b().a() == κιββωσγχςΣβΠΣδ.b) {
         if (this.ay) {
   ...
   public Channel a(ΨαχΨχΣλεΠψΦ var1) {
      Object var2 = PacketEvents.getAPI().getPlayerManager().getChannel(var1.c());
      if (var2 == null) {
         throw new IllegalArgumentException(c<"㺀">(fm, fn ^ fo) + var1.getName() + c<"㺃">(fp, fq) + var1.a());
      } else {
         return (Channel)var2;
      }
   }
   ...
   public boolean a(ΨαχΨχΣλεΠψΦ var1, Component var2) {
      ...
      if (var3 != null) {
         ...
         if (var4.isNewerThanOrEquals(ClientVersion.V_1_19)) {
            var5 = new WrapperPlayServerSystemChatMessage((boolean)gp, var2);
         } else {
   ...
   public boolean a(ΨαχΨχΣλεΠψΦ var1, String var2, byte[] var3) {
      if (this.t.L()) {
         throw new IllegalStateException(c<"㺀">(gl, gm ^ gn));
      } else {
