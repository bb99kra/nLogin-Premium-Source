...
public enum τΩχιβοΠσΩςο {
   a,
   b;

   private static String[] a = new String[τΩχιβοΠσΩςο.d];
   private static String[] b = new String[τΩχιβοΠσΩςο.e];
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ιΠοθΩΦξκ.F("՝տցաօֲ֤֜֞խ֫֡֯֩ղְְֶָֹ֗օ", (byte)121, 70), τΩχιβοΠσΩςο.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ξψθρΣΠΣς.E("֥֤֘էֲ֧֣֧֞֡ծְֲ֬֩֬մऊࣰएंࣼऊ࣬ऐࣷऑए\u058b", (byte)121, 69) + var1 + ςΦζσμτΓσ.B("ƫ", (byte)121, 66) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ξψθρΣΠΣς.E("ӱԌԳԐԄԨԌԒԵӿԔԅ", (byte)1, 69);
               b[1] = ΣερμΔσατσκ.D("БϮЮЊУЃЋиАЂ϶Ѐ", (byte)1, 68);
               break;
            case 1:
               b[0] = ζοηκορΦνΣθγΩ.B("¬êÚæÇÐöÜÙóÙÍáăĈõÙØ÷ÕØçÔÕ", (byte)1, 66);
               b[1] = ντθΔζβΔζ.C("ЅϬЌϳϽбФЅкϳЫϹϹЪкЮϷϻПЏддЋЌ", (byte)1, 67);
               break;
            case 2:
               b[0] = πψυκΠΨμΛΩβΣφμφσ.D("ϺЌϲϮТбЬТІЬеЀ", (byte)1, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = οοθδΨιοΦΠβδζ.B("¬¸äæÇìòÞíÔÔÉ", (byte)1, 66);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΨφιωσρΓδΔθ.E("֤֣֗զֱ֦֢֦֝֠խֱ֫֯֨֫ճउ࣯ऎँࣻउ࣫एࣶऐऎ", (byte)120, 69));
         }
