...
public class NLoginCore_403 implements NLoginInterface_048 {
   private static int m = (201326592 >>> 154 | 201326592 << -154) & -1;
   ...
   private static int f = (1024 >>> 138 | 1024 << -138) & -1;
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_403.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_232.A("ŽƟơƁƥǄƼǒƾƍǋǁǏǉƒƷǙǘǐǖǐƥ", (byte)107, 65), NLoginCore_403.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_232.B("ƸǅǄƇǇǃƾǇǒǁƎǌǐǉǌǒƔԙԥԠԬԜԫԒԕƨ", (byte)107, 66) + var1 + NLoginCore_471.A("Ə", (byte)107, 65) + var2.toString(), var4
         );
      }
   }

   private static void b() {
      c = 6577050607956088073L;
      long var0 = c ^ 4077558349996226714L;
   ...
   public NLoginCore_403 a(Plugin var1, long var2, long var4, TimeUnit var6) {
      if (this.a != null) {
         throw new IllegalStateException(a(i, j ^ k));
      } else {
         this.a = var1.getProxy().getScheduler().schedule(var1, this.c, var2, var4, var6);
         return this;
      }
   }

   NLoginCore_403(NLoginCore_578 var1, Consumer<NLoginInterface_048> var2) {
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_241.C("ӕӢӡҤӤӠӛӤӯӞҫөӭӦөӯұ࠶ࡂ࠽ࡉ࠹ࡈ\u082f࠲", (byte)63, 67));
         }
   ...
   public NLoginCore_403 a(Plugin var1) {
      if (this.a != null) {
         ...
         this.a = var1.getProxy().getScheduler().runAsync(var1, this.c);
         return this;
      }
   }

   NLoginCore_403(NLoginCore_578 var1, Runnable var2) {
   ...
   public NLoginCore_403 a(Plugin var1, long var2, TimeUnit var4) {
      if (this.a != null) {
         throw new IllegalStateException(a(f, g ^ h));
      } else {
         this.a = var1.getProxy().getScheduler().schedule(var1, this.c, var2, var4);
         return this;
      }
   }
