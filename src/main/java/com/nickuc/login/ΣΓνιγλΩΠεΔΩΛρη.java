...
public class ΣΓνιγλΩΠεΔΩΛρη implements θβορΛτηατθΨτΠτΦ {
   private static int d = 33554432 >>> 185 | 33554432 << -185;
   private static String[] b = new String[ΣΓνιγλΩΠεΔΩΛρη.e];
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(μεςΩΔΣγν.E("ՅՒՑԔՔՐՋՔ՟Վԛՙ՝Ֆՙ՟ԡ\u0896ࢇࢲࢯࢪࢳࢢ࢚ࢰ\u0890ࢦ࢙ࣀࢷ", (byte)38, 69));
         }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ΣΓνιγλΩΠεΔΩΛρη.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ζοηκορΦνΣθγΩ.D("ҦӈӊҪӎӭӥӻӧҶӴӪӸӲһӠԂԁӹӿӹӎ", (byte)67, 68), ΣΓνιγλΩΠεΔΩΛρη.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            χφπρψπφΦθμπ.F("բկծԱձխըձռիԸնպճնռԾࢳࢤ࣏࣌ࣇ࣐ࢿࢷ࣍ࢭࣃࢶࣝࣔ\u0558", (byte)67, 70) + var1 + λΣΩσμφγχ.A("Ŀ", (byte)67, 65) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ςπυηννναΣ.B("ĆķüĝĄľĚōħĉĒĩċĿńĸēċČŊĩśĢģ", (byte)40, 66);
               break;
            case 1:
               b[0] = πψυκΠΨμΛΩβΣφμφσ.B("ĆķüĝĄľĚōħĉĒĉŉłīħŔĮĳĹśśĢģ", (byte)40, 66);
               break;
            case 2:
               b[0] = ΣφδσΔζιΠρα.E("՞ԚՙԞՐԠբՌԜԯԣ\u0530ԦԴԽԧԵ՜ԫՌՂՠԷԸ", (byte)40, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = θεωψξβΛσσ.B("ĥĉēŋňĦŀģħıŉġĔĐğőġħńėīĵĢģ", (byte)40, 66);
         }
      }
   }

   public ΣΓνιγλΩΠεΔΩΛρη(οουτχΛκΣηΓψοΔ var1) {
      this.a = var1;
   }
   ...
   public void a(PacketReceiveEvent var1) {
      ...
      if (var3.equals(c<"㺀">(a, b))) {
         Player var4 = (Player)var1.getPlayer();
         if (var4 != null) {
            var1.setCancelled((boolean)c);
            οουτχΛκΣηΓψοΔ.a(this.a).a().a(οουτχΛκΣηΓψοΔ.a(this.a).b().a(var4), var2.getData());
         }
      }
   }
}
