...
class εςζψιΠφΛξβλ extends JedisPubSub implements Closeable, Runnable {
   private static long c;
   private static long d = Long.reverse(-8720754023362920150L);
   private static long g = Long.reverse(-8720754023362920150L);
   private static String[] b = new String[εςζψιΠφΛξβλ.aj];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ςΦζσμτΓσ.E("ԄՅԨԁԗԇԇԡՈԨԏԕ", (byte)17, 69);
               b[1] = πψυκΠΨμΛΩβΣφμφσ.C("бўяуєѐФгТджѢѕХѠплпабрџэѪЯѕѓѴлкѶэҁѷѵсѠнѾјѼ҂҉ыѝљ҄щѿѰѼҎѫѲҀҌѕѧѦќѬѳҜҍ", (byte)17, 67);
               b[2] = ΣδτΠνεγοΓορητ.D("ПѠуМвТТмѣуЪа", (byte)17, 68);
               b[3] = βεξΠθρρςΔΦμ.E(
                  "ԖՃԴԨԹԵԉԘԇԙԛՇԺԊՅԤԠԤԕԖԥՄԲՏԔԺԸՙԠԟ՛ԲԼԵՠԷԼԷՇԣ՞ՎՎԽըձՀՕիյՓի\u0557՛ՏԸշշԷԾԹի\u0558ֆ՟զ՟գվճ\u0558րըկՏՠա֒րխլՕքկ֍շՓկէր՛֚֟֞֝ծ", (byte)17, 69
               );
               b[4] = ντθΔζβΔζ.E("ԯԕԥԲԼՃԘԤԊԜԩՄ\u0530ԦՓՁԤԤԱՅՇԗԼԯՍԫԚ\u0557ԙԹՀՙ", (byte)17, 69);
               b[5] = ΠΛΨοδΩσμνΛγΦφβς.B("ØęüÕëÛÛõĜüãé", (byte)17, 66);
               b[6] = ςΦζσμτΓσ.D("бўяуєѐФгТдеѩьХшрѩѱѣЭсѵѸщѲњѻѮѴѫјѝѕыѰѮѢѶѾџчѷ҈ъўѪѹэьэћ҉҉Ѯћќ", (byte)17, 68);
               break;
            case 1:
               b[0] = πηγμΣΔκκ.A("ċøëýĒęýßòððé", (byte)17, 65);
               b[1] = ΣφδσΔζιΠρα.D("бўяуєѐФгТджѢѕХѠплпабрџэѪЯѕѓѴлкѶэҁѷѵсѠнѾјѼ҂҉ыѝљ҄щѿѰѼҎѫѳѶєѤҐҌѬѦҎёѸ", (byte)17, 68);
               b[2] = πηγμΣΔκκ.D("РзЭкѦйгуѪљѕа", (byte)17, 68);
               b[3] = ζοηκορΦνΣθγΩ.B("êėĈüčĉÝìÛíïěĎÞęøôøéêùĘĆģèĎČĭôóįĆĐĉĴċĐċě÷ĲĢĢđļŅĔĩĿŉħĿīįģČŋŋċĒčĿĬŚĳĺĳķŒŇĬŔļŃģĴĵŦŔŁŀĩŘŃšŉŤűīńťńŇĳĴŶ", (byte)17, 66);
               b[4] = δΛψπξκσβγςα.F("ԯԕԥԲԼՃԘԤԊԜԩՄ\u0530ԦՓՁԤԤԱՅՇ՜ԸԜԺԞՊաԔԺԽԺԻԷՖզըԼիադԪզԵ", (byte)17, 70);
               b[5] = ςπυηννναΣ.C("жлєјОћгўјјуа", (byte)17, 67);
               b[6] = πηγμΣΔκκ.A("êėĈüčĉÝìÛíîĢąÞāùĢĪĜæúĮıĂīēĴħĭĤđĖĎĄĩħěįķĘĀİľĦĽĀēŇĉĿþŊŉĽĔĕ", (byte)17, 65);
               break;
            case 2:
               b[0] = πψυκΠΨμΛΩβΣφμφσ.B("ĎÙĎÏÿøďñĎôĠûĢĥúĨĪąěĕăĝôõ", (byte)17, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = φΨαξωυθανΣφυκη.A("ÒÙďĎÞÝÒûìüęàĐ÷ĠăúĘçãčćôõ", (byte)17, 65);
         }
      }
   }

   private boolean ak() {
      UnifiedJedis var1 = ΓυετνΛζΠιΓζΣ.a(this.b);
      if (var1 instanceof JedisPooled) {
         ...
         throw new RuntimeException(c<"㺀">(x & y, z) + var1.getClass().getName());
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΦδφπθΩΩλζξ.C("јѺѼќҀҟҗҭҙѨҦҜҪҤѭҒҴҳҫұҫҀ", (byte)41, 67), εςζψιΠφΛξβλ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            χΠξΦιζΨΣωΦσΨζ.C("ғҠҟѢҢҞҙҢҭҜѩҧҫҤҧҭѯ߶ࠄ߹ࠌ߾ߦࠍߣࠇ\u07fcࠆ҆", (byte)41, 67) + var1 + ςΦζσμτΓσ.E("ԟ", (byte)41, 69) + var2.toString(), var4
         );
      }
   }

   @Generated
   private εςζψιΠφΛξβλ(ΓυετνΛζΠιΓζΣ var1, String var2, Consumer<String> var3) {
      this.b = var1;
      this.bm = var2;
      this.b = var3;
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ςΦζσμτΓσ.E("Ւ՟՞ԡա՝\u0558ալ՛ԨզժգզլԮࢵࣃࢸ࣋ࢽࢥ࣌ࢢࣆࢻࣅ", (byte)51, 69));
         }
      ...
      while (!this.ae && !Thread.interrupted() && this.ak()) {
         try {
            if (var1 != 0) {
               ...
               ψΓωτιμωκχψΛΨ.e(c<"㺀">(c, d ^ e) + this.bm + c<"㺃">(f, g ^ h));
            }

            UnifiedJedis var10000 = ΓυετνΛζΠιΓζΣ.a(this.b);
            ...
            ψΓωτιμωκχψΛΨ.b(c<"㺆">(l & m, n) + this.bm + c<"㺉">(o, p ^ q), var6);
   ...
   public void close() {
      ...
      try {
         ...
         ψΓωτιμωκχψΛΨ.b(c<"㺀">(ab, ac ^ ad) + this.bm + c<"㺃">(ae & af, ag), var2);
      }
   }
}
