...
public class ξρΨυφεθεβντναΣυ implements θβορΛτηατθΨτΠτΦ, μθοδηοΠνΦΛνξΛ {
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(οοθδΨιοΦΠβδζ.B("ĴŁŀăŃĿĺŃŎĽĊňŌŅňŎĐҠҤҌҪҬҜҠҞҜҨҰҪҟҒҵ", (byte)41, 66));
         }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ξρΨυφεθεβντναΣυ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(οοθδΨιοΦΠβδζ.A("íďđñĕĴĬłĮýĻıĿĹĂħŉňŀņŀĕ", (byte)35, 65), ξρΨυφεθεβντναΣυ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΣερμΔσατσκ.E("ՂՏՎԑՑՍՈՑ՜ՋԘՖ՚ՓՖ՜Ԟࢮࢲ࢚ࢸࢺࢪࢮࢬࢪࢶࢾࢸࢭࢠࣃԹ", (byte)35, 69) + var1 + ιΠοθΩΦξκ.E("ԙ", (byte)35, 69) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΣερμΔσατσκ.D("ӳӞӊӵӠӖԁӖԆԋԏԋԍӱөӽӡԁӳӠӰԜԆԡԘӺԈԬԜԙԍԣԳӰӦӱӶӱԃԶӷӷԇӳԌԱԲԒԪԎӽӽԜԓԞԩԇԘՈԮԩԯԸԝ", (byte)76, 68);
               b[1] = ζβησεθωυγτ.B("ŦƏũŲƋƔŢƃƙřƉŖūƝŷŞŗƢơƐŵŠƙƇŨűƈŤƦƉƙƩƙƒƜƤŽƤƃũƠƆƅƃƻƙŸŸƔƳƭžƌƯƘƤƳƟƓƶƿƽƣƋ", (byte)76, 66);
               b[2] = θεωψξβΛσσ.E(
               ...
               b[3] = πηγμΣΔκκ.A("ƊůƀŌŨůőšƋƅőş", (byte)76, 65);
               b[4] = δΛψπξκσβγςα.D("ӚӱӟԏӧԖӭӱԂӫӰӡ", (byte)76, 68);
               b[5] = οΩνΩρωλΨηΛδωδ.F("բՍԹդՏՅհՅյպվեշՌխչՠֆՎ՝յըշֈձ։֍֚՛՚֠ձ\u0558ր֢՝դտֆ֧֚վժհ", (byte)76, 70);
               b[6] = ΠΛΨοδΩσμνΛγΦφβς.F("բԺՏՐՔՒրՐղՁՁ\u058bյէփՐՑՌ֒։ճծ՛՜", (byte)76, 70);
               break;
            case 1:
               b[0] = μεςΩΔΣγν.B("űŜňųŞŔſŔƄƉƍƉƋůŧŻşſűŞŮƚƄƟƖŸƆƪƚƗƋơƱŮŤůŴůƁƴŵŵƅűƊƯưƐƨƌŻŻƚƒƒƽƿǀƷƗƛƾǎƨǌƪƐƪǒǒƓǀơǁƙƟ", (byte)76, 66);
               b[1] = οοθδΨιοΦΠβδζ.B("ŦƏũŲƋƔŢƃƙřƉŖūƝŷŞŗƢơƐŵŠƙƇŨűƈŤƦƉƙƩƙƒƜƤŽƤƃũƠƆƅƃƻƙŸŸƔƳƭžƌƱƃƾźƴƳǂƇƷƛƿ", (byte)76, 66);
               b[2] = δΛψπξκσβγςα.B(
               ...
               b[3] = δΛψπξκσβγςα.A("ňŇƒŭōƕũƇŹƒŪş", (byte)76, 65);
               b[4] = ΨφιωσρΓδΔθ.F("աՕդԿԼՀշՒ՜՟օՐ", (byte)76, 70);
               b[5] = πχσδΦΦνθΔπ.D("ӳӞӊӵӠӖԁӖԆԋԏӶԈӝӾԊӱԗӟӮԆӹԈԙԂԚԞԫӬӫԱԂӪӱԨԍӬԀӶԋԈԨԗԊԫԨԑՀԂԿԠӽԽՅԌԍ", (byte)76, 68);
               b[6] = πψυκΠΨμΛΩβΣφμφσ.A("űŉŞşţšƏşƁŐŐũŽƒśŖƝźƌƑƚŭŪū", (byte)76, 65);
               break;
            case 2:
               b[0] = ΣερμΔσατσκ.B("šşƋŤŽŤňƕŲźŕş", (byte)76, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = χΠξΦιζΨΣωΦσΨζ.F("աՀդւՄմվփՖՂՉզտՋզՙՠբ՟է֔֔՛՜", (byte)76, 70);
         }
      }
   }
         ...
         if (var2.hasAttr(ωΩμΩχδοωδΔΠΔδ.c)) {
            ...
            if (var3 != null) {
               if (var3.f == a) {
                  ...
                  ψΓωτιμωκχψΛΨ.c(c<"㺀">(b, d ^ e) + βδΔφμπθθγ.a() + c<"㺃">(f, g ^ h));
                  ψΓωτιμωκχψΛΨ.c(c<"㺆">(j, k ^ l) + ΣλνΨουΩΔοθεβ.al.a().a()[m] + c<"㺉">(n & o, p) + ΠβππΓωΛΦυβΩμΔ.d + c<"㺌">(q, r));
                  ψΓωτιμωκχψΛΨ.c(c<"㺏">(t, u ^ v) + ΠβππΓωΛΦυβΩμΔ.d + c<"㺒">(w, x ^ y));
               }
            }
         }
      }
