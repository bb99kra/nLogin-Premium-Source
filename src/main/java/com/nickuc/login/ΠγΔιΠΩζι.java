...
public class ΠγΔιΠΩζι implements εςοεωζφπωΨ {
   ...
   public static ΠγΔιΠΩζι a(ProxyServer var0, CommandSender var1) {
      return new ΠγΔιΠΩζι(var0, var1);
   }
   ...
   @Generated
   private ΠγΔιΠΩζι(ProxyServer var1, CommandSender var2) {
      this.b = var1;
      this.a = var2;
   }
