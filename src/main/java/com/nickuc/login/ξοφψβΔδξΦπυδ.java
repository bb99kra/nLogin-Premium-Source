...
public class ξοφψβΔδξΦπυδ implements ΨαχΨχΣλεΠψΦ {
   private static int bf = Integer.reverse(-1342177280);
   private static String[] b = new String[ξοφψβΔδξΦπυδ.ci];
   ...
   private static String[] a = new String[ξοφψβΔδξΦπυδ.ch];
   ...
   static final Map<Player, ξοφψβΔδξΦπυδ> j = new ConcurrentHashMap<>();
   ...
   public CompletableFuture<Void> a(String var1) {
      ...
      this.a.disconnect(ΩτωνοφχεΠ.a(var1));
      var2.complete(null);
      return var2;
   }

   @Generated
   private ξοφψβΔδξΦπυδ(νεΓτεκΓηζεΔλιΩ var1, Player var2, ProxyServer var3, boolean var4) {
      this.b = var1;
      this.a = var2;
      this.c = var3;
      this.aq = var4;
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(φδχεθοκψαλΛογλ.C("ӫԍԏӯԓԲԪՀԬӻԹԯԽԷԀԥՇՆԾՄԾԓ", (byte)90, 67), ξοφψβΔδξΦπυδ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζβησεθωυγτ.C("ԦԳԲӵԵԱԬԵՀԯӼԺԾԷԺՀԂ\u0892\u0894࢜࢟ࢊ\u086dࢎ࢙ࢂ࢝ࢣ\u0893Ԛ", (byte)90, 67) + var1 + ΨΦνΨΦωυΩνβςμ.B("ŭ", (byte)90, 66) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΦδφπθΩΩλζξ.F("ԩԶԵӸԸԴԯԸՃԲӿԽՁԺԽՃԅ\u0895\u0897࢟ࢢࢍࡰ\u0891࢜ࢅࢠࢦ\u0896", (byte)10, 70));
         }
   ...
   private static ξοφψβΔδξΦπυδ a(νεΓτεκΓηζεΔλιΩ var0, ProxyServer var1, Player var2) {
      ξοφψβΔδξΦπυδ var3 = j.get(var2);
      if (var3 != null) {
         return var3;
      } else {
         if (ψΓωτιμωκχψΛΨ.aj()) {
            StackTraceElement[] var4 = new Exception().getStackTrace();
            String var5 = var4.length > 0 ? var4[Math.min(ba, var4.length - bb)].toString() : c<"㺀">(bc, bd ^ be);
            String var10000 = c<"㺃">(bf & bg, bh);
   ...
   public void a(String var1, String var2, int var3, int var4, int var5) {
      this.a
         .showTitle(
            Title.title(
               ΩτωνοφχεΠ.a(var1), ΩτωνοφχεΠ.a(var2), Times.times(Duration.ofMillis(var3 * j), Duration.ofMillis(var4 * k), Duration.ofMillis(var5 * l))
            )
         );
   }
   ...
   public void n(String var1) {
      throw new UnsupportedOperationException(c<"㺀">(a & b, d));
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ιΠοθΩΦξκ.A("ûĎðċõýûüġÝðĎñğĤóáęĈġþĭôõ", (byte)17, 65);
               b[1] = χφπρψπφΦθμπ.B("òíÓðóğĒñăÿíĥĐħĢğäġĈĖďďĪģèþđĔĔÿõôįõĤĕčĩŁěįúĺĉ", (byte)17, 66);
               b[2] = βεξΠθρρςΔΦμ.F("ԃԄԞԪԉԾԥԿԬՐՊԕ", (byte)17, 70);
               b[3] = θεωψξβΛσσ.E("ӽԻԧԴԲՉՆԟԤ\u0530Ԭԕ", (byte)17, 69);
               b[4] = οοθδΨιοΦΠβδζ.C("ИгѝбяЮѓѠЩпзфцѭѦхйШхўѐгѤъвљѺѱжемъћыѶѾѸѤѣ҄҅Ѿѫѐ", (byte)17, 67);
               b[5] = χΠξΦιζΨΣωΦσΨζ.D("ОПйхФљрњчѫѥа", (byte)17, 68);
               b[6] = μζξτΩσσφυδεπλΨ.E("ԞԙӿԜԟՋԾԝԯԫԚԃԺԍԆԬԩԲԡՌԔԳԔՍ\u0530ԘՔԩ՛ՓՁԭ", (byte)17, 69);
               b[7] = ςπυηννναΣ.C("ћѢжхгѧкКФШѓЬПЪзооѯщбѩхѳѫьфшщьѭѷѓѷѐљэѵѴчјѿѻѹѐ", (byte)17, 67);
               b[8] = ΣδτΠνεγοΓορητ.D("ѕѡЫѣЗолџѤмзкќШѬиЬѢчѮпѤлм", (byte)17, 68);
               b[9] = φΨαξωυθανΣφυκη.F("ԞԙӿԜԟՋԾԝԯԫԚԜՓՍՁԨԡՔԮԓԕԵՅԴԷԞ\u0557Ր՟ԶԢՕԵՔԽԽՃՈՂ՛ՆԬ՚Ե", (byte)17, 70);
               b[10] = βεξΠθρρςΔΦμ.C("ОПйхФљрњчѫѥа", (byte)17, 67);
               b[11] = βεξΠθρρςΔΦμ.C("ўефѝбчСѩСУѝа", (byte)17, 67);
               b[12] = ςπυηννναΣ.C("иНїСмчУшбфуа", (byte)17, 67);
               b[13] = ζοηκορΦνΣθγΩ.C("џѢѤєкѦхиПѫцТоЦЦТфоѲђѬѠяѮѺљхѯѧкљѾѫјѝѸо҅ѯоѩѡјќѻѪѸшҐ҈ьѿҒ҄ѱғғ҈ѪґҐҊѼҕѓѲћўѺ҄Қҥ҂ѵѿѣѼѥѻѬҏҥҟҰѭҞѩѲѶѷқҔѯѷҖҴ", (byte)17, 67);
               b[14] = ςΦζσμτΓσ.D("ѡлѕгћМўношљѭмћйѝѮќЮђѪолм", (byte)17, 68);
               b[15] = φδχεθοκψαλΛογλ.F("ӿՈԽՀԞԫՉԩԄՇԸԠԽԡԲԯԷՓՌՐՕԳԠԡ", (byte)17, 70);
               b[16] = οΩνΩρωλΨηΛδωδ.A("ė÷üðæÕğēöÞğĖćÙþòäúČĈććôõ", (byte)17, 65);
               b[17] = θεωψξβΛσσ.D("ѐТуѕбУЙѐтСЪШыщЬсхщћыоѴлм", (byte)17, 68);
               b[18] = ΣερμΔσατσκ.C("ѝтїЬвПѥѝжЪчѕитцѥѢѠрЫѡѤлм", (byte)17, 67);
               break;
            case 1:
               b[0] = ΣερμΔσατσκ.B("ûĎðċõýûüġÝñöđġßēĝûĥĈĥĊçĭďħĩİĤÿİĦ", (byte)17, 66);
               b[1] = φΨαξωυθανΣφυκη.D("йдКзкѦљиъцдѬїѮѩѦЫѨяѝііѱѪЯхјћћцмлћю҃рѲсҁј҈ѷ҅ѐ", (byte)17, 68);
               b[2] = ΦδφπθΩΩλζξ.F("ԆԂԹԆԜԖԨԚԶԣԘԕ", (byte)17, 70);
               b[3] = ςΦζσμτΓσ.D("ИиЬМјеУнърТа", (byte)17, 68);
               b[4] = ςπυηννναΣ.B("ÑìĖêĈçČęâøðýÿĦğþòáþėĉìĝăëĒĳĪïîõăĶĻĺïĿĊĜþċùĞįĞĦĆħĒŉĨġčōĔĕ", (byte)17, 66);
               b[5] = μζξτΩσσφυδεπλΨ.E("ӸԁԽԇՇԴԩՂԹԟԏԕ", (byte)17, 69);
               b[6] = πχσδΦΦνθΔπ.A("òíÓðóğĒñăÿî×ĎáÚĀýĆõĠèęěĜēċæĵĶĀė÷ĐčĳýĮĎīČĢĲĐĉ", (byte)17, 65);
               b[7] = ιΠοθΩΦξκ.D("ћѢжхгѧкКФШѓЬПЪзооѯщбѩхѳѫьфшщьѭѷѓпђєуѳѺіѨўѩ҉ѐ", (byte)17, 68);
               b[8] = ΣδτΠνεγοΓορητ.F("ԺՆԐՈӼԣԠՄՉԡԜՒԐՑԼՈԏ\u0530ԲՐ՚ՙԠԡ", (byte)17, 70);
               b[9] = θεωψξβΛσσ.E("ԞԙӿԜԟՋԾԝԯԫԚԜՓՍՁԨԡՔԮԓԕԵՅԴԷԞ\u0557Ր՟ԶԢՕԶԥԴՠբ՟Ո՜՟ՙզԵ", (byte)17, 69);
               b[10] = χΠξΦιζΨΣωΦσΨζ.A("ï×æêďÿÞðôßĖé", (byte)17, 65);
               b[11] = μζξτΩσσφυδεπλΨ.B("Öě×ėíÚøÓêâðé", (byte)17, 66);
               b[12] = ζοηκορΦνΣθγΩ.C("вТрМђѥяаСъјпѪзѝњѫбфџѲолм", (byte)17, 67);
               b[13] = ξψθρΣΠΣς.D("џѢѤєкѦхиПѫцТоЦЦТфоѲђѬѠяѮѺљхѯѧкљѾѫјѝѸо҅ѯоѩѡјќѻѪѸшҐ҈ьѿҒ҄ѱғғ҈ѪґҐҊѼҕѓѲћўѺ҄Қҥ҂ѵѿѣѼѥѻѬҏҥҟҰѭҢ҉ҴҙѴҴѷҨҐҠҭ", (byte)17, 68);
               b[14] = θεωψξβΛσσ.B("ĚôĎìĔÕėö÷āĔðĤüþĢĕĕûĜćĪĂĬăðĐāĄčĒñ", (byte)17, 66);
               b[15] = ιΠοθΩΦξκ.B("ÓĜđĔòÿĝýØěČåøôèöĝõêģĜěĩéĭħīĎēđĮĤ", (byte)17, 66);
               b[16] = φδχεθοκψαλΛογλ.E("ՃԣԨԜԒԁՋԿԢԊՌԼՓԌՂԩՎԶԎՊԕՙԠԡ", (byte)17, 69);
               b[17] = ΣδτΠνεγοΓορητ.A("ĉÛüĎêÜÒĉûÚãĐę÷ÿēĞĕ÷ĞìĤûĪéěĠĵèĔõĪ", (byte)17, 65);
               b[18] = πψυκΠΨμΛΩβΣφμφσ.B("ĖûĐåëØĞĖïãāïüåóø÷ĊĞħċĝôõ", (byte)17, 66);
               break;
            case 2:
               b[0] = χΠξΦιζΨΣωΦσΨζ.D("ѠљЮёЯжХђчѓѪзўќтцсшгЮсѤлм", (byte)17, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = ζοηκορΦνΣθγΩ.B("æĊąñùęØ×ûĤġýģāûááÿõęæ÷ôõ", (byte)17, 66);
         }
      }
   }
   ...
   public String toString() {
      return c<"㺀">(ak & al, am) + this.a + c<"㺃">(an, ao ^ ap) + this.f + aq;
   }
   ...
   public boolean equals(Object var1) {
      if (var1 != null && this.getClass() == var1.getClass()) {
         ξοφψβΔδξΦπυδ var2 = (ξοφψβΔδξΦπυδ)var1;
         return (boolean)(Objects.equals(this.f, var2.f) && Objects.equals(this.a, var2.a) ? af : ag);
      } else {
         return (boolean)ae;
      }
   }
   ...
   public void d(Object var1) {
      if (var1 instanceof String) {
         this.a.sendMessage(ΩτωνοφχεΠ.b((String)var1, (boolean)e));
      } else {
         if (!(var1 instanceof Component)) {
            throw new IllegalArgumentException(c<"㺀">(f, g) + var1 + c<"㺃">(h, i) + var1.getClass().getCanonicalName());
         }
   ...
   public void a(εηχβγρΦβΦΛκγΦοδ<?> var1, γΦΠυρρρπη var2, Object var3, byte[] var4) {
      ...
      if (var3 instanceof String) {
         ...
         String[] var7 = var6.split(c<"㺀">(m & n, o));
         ...
         if (!(var3 instanceof ChannelIdentifier)) {
            throw new IllegalArgumentException(c<"㺃">(s, t) + var3 + c<"㺆">(u, v) + var3.getClass().getCanonicalName());
         }

         var5 = (ChannelIdentifier)var3;
      }

      switch (αξζΓαςμΣννμ.t[var2.ordinal()]) {
         case 1:
         ...
         case 2:
            ...
            break;
         default:
            throw new IllegalArgumentException(c<"㺉">(w & x, y) + var2);
      }
   }

   public static ξοφψβΔδξΦπυδ a(νεΓτεκΓηζεΔλιΩ var0, ProxyServer var1, Object var2) {
      if (var2 instanceof String) {
         ...
         throw new IllegalArgumentException(
            c<"㺀">(ar, as ^ at) + var2 + c<"㺃">(au & av, aw) + (var2 != null ? var2.getClass().getCanonicalName() : c<"㺆">(ax & ay, az))
         );
      }
   }

   static ξοφψβΔδξΦπυδ b(νεΓτεκΓηζεΔλιΩ var0, ProxyServer var1, Player var2) {
      Channel var4 = τΩζτετνεθ.a(c<"㺀">(bl, bm ^ bn), var2);
      int var3;
      if (var4 != null) {
         ...
         switch (var5.hashCode()) {
            case -904795186:
               if (var5.equals(c<"㺆">(bt & bu, bv))) {
                  var6 = bw;
               }
               break;
            case -217013511:
               if (var5.equals(c<"㺃">(bp, bq ^ br))) {
                  var6 = bs;
               }
               break;
            case 1894246043:
               if (var5.equals(c<"㺉">(bx, by ^ bz))) {
                  var6 = ca;
               }
         }
      ...
      return new ξοφψβΔδξΦπυδ(var0, var2, var1, (boolean)var3);
   }
   ...
   public κκψασΩψμωΩυθ a() {
      if (this.a == null) {
         this.a = (var0, var1) -> {
            throw new UnsupportedOperationException(c<"㺀">(ce & cf, cg));
         };
      }
   ...
   public void o(String var1) {
      this.a.sendActionBar(ΩτωνοφχεΠ.a(var1));
   }
