...
public class ΛωΓτπθδκνκθψβπκ {
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ΛωΓτπθδκνκθψβπκ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ΣφδσΔζιΠρα.C("ҩӋӍҭӑӰӨӾӪҹӷӭӻӵҾӣԅԄӼԂӼӑ", (byte)68, 67), ΛωΓτπθδκνκθψβπκ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ιΠοθΩΦξκ.A("ŪŷŶĹŹŵŰŹƄųŀžƂŻžƄņҳӢҭӟӜӕӒәӝӛӚӫӖӥӠš", (byte)68, 65) + var1 + ΨΦνΨΦωυΩνβςμ.A("Ł", (byte)68, 65) + var2.toString(), var4
         );
      }
   }
   ...
   public static MappingNode a(Yaml var0, File var1) {
      ...
      if (!(var2 instanceof MappingNode)) {
         throw new IllegalStateException(c<"㺀">(n, o ^ p) + var2.getClass().getCanonicalName());
      } else {
   ...
   public static void a(MappingNode var0, String var1, BiFunction<String, Node, Node> var2) {
      ...
      for (int var4 = a; var4 < var3.size(); var4++) {
         ...
         if (!(var6 instanceof ScalarNode)) {
            throw new IllegalStateException(c<"㺀">(b & c, d) + var6.getClass().getCanonicalName() + c<"㺃">(e, f ^ g) + var6);
         }

         ScalarNode var7 = (ScalarNode)var6;
         String var8 = var1 + (var1.isEmpty() ? c<"㺆">(h, i ^ j) : c<"㺉">(k & l, m)) + var7.getValue();
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(χφπρψπφΦθμπ.F("ԦԳԲӵԵԱԬԵՀԯӼԺԾԷԺՀԂ\u086f࢞ࡩ࢛࢘\u0891ࢎ\u0895࢙\u0897\u0896ࢧ\u0892ࢡ࢜", (byte)7, 70));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΦδφπθΩΩλζξ.B("ƅŘłţŢƐƁſŽƍųőƍŪƅŴŕƅƖŔƉƍƙƟƊŽųƦƄƥŽƀŜſŶŸƩƏũŨƞƦƢŹ", (byte)73, 66);
               b[1] = μζξτΩσσφυδεπλΨ.A("ŴĽŵŪšŌſƊůŦŠř", (byte)73, 65);
               b[2] = λΣΩσμφγχ.B("ŉŷŽŶņŠŋňƁżƎř", (byte)73, 66);
               b[3] = ΣφδσΔζιΠρα.B("ũŚśƂƄƊżřűŢœř", (byte)73, 66);
               b[4] = πψυκΠΨμΛΩβΣφμφσ.A("ƅŘłţŢƐƁſŽƍűƖƈŗƔŹƋƊƚœżƎŗũšŴƜţşųƝƊƅŻŴţƁšƞžƜƃƮŹ", (byte)73, 65);
               break;
            case 1:
               b[0] = πψυκΠΨμΛΩβΣφμφσ.B("ƅŘłţŢƐƁſŽƍųőƍŪƅŴŕƅƖŔƉƍƙƟƊŽųƦƄƥŽƀƖŵƥơťƫżƊơƓƈŹ", (byte)73, 66);
               b[1] = πχσδΦΦνθΔπ.A("ŗŊŌƅţŉŘŏźŉƆř", (byte)73, 65);
               b[2] = πψυκΠΨμΛΩβΣφμφσ.E("տչտ՟հՑԻՒՔկղՍ", (byte)73, 69);
               b[3] = ΠΛΨοδΩσμνΛγΦφβς.D("ӔӢԂөԌԄӻԌӱӜӯӘ", (byte)73, 68);
               b[4] = ζβησεθωυγτ.D("ԄӗӁӢӡԏԀӾӼԌӰԕԇӖԓӸԊԉԙӒӻԍӖӨӠӳԛӢӞӲԜԉԈөԤԘԌӤӺӧԞԜԝӸ", (byte)73, 68);
               break;
            case 2:
               b[0] = ΨφιωσρΓδΔθ.A("ńťŖŹŦŦŏřŮƒŲšŌƎŒŤŨƒƖƜƌƐŵŶƂſƗŹšŝƈƅ", (byte)73, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = χΠξΦιζΨΣωΦσΨζ.C("ӖӧӺԌӗӚԌԀӼӲӧԊӏӪӸԕԖԑӼөԞӦӣӤ", (byte)73, 67);
         }
      }
   }
}
