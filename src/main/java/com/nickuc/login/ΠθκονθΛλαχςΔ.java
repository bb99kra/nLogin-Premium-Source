...
public class ΠθκονθΛλαχςΔ extends ΣμςΠΔυσθ {
   private static long o;
   private static String[] f = new String[ΠθκονθΛλαχςΔ.af];
   ...
   public ΠθκονθΛλαχςΔ(ΨγημιδξΓτοθαζ var1, ΓεοκπνΨωπτ var2, String var3, String var4, String var5, String var6) {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               f[0] = φΨαξωυθανΣφυκη.D("ԊԮՅՈԚԾԮԵՁՍԓԝ", (byte)96, 68);
               break;
            case 1:
               f[0] = χΠξΦιζΨΣωΦσΨζ.B("ƲƬźƭƉƳƴƜƝƼƸƇ", (byte)96, 66);
               break;
            case 2:
               f[0] = ΣερμΔσατσκ.A("ƇƹƆƍƶƔƍƚƫƬƁƞƟƑƮƓƶƠƸƆƘƕƒƓ", (byte)96, 65);
            case 3:
            default:
               break;
            case 4:
               f[0] = ΣδτΠνεγοΓορητ.F("մ֍֖գն՚միշիչիկմփ՞ւջ֟ն՛ղկհ", (byte)96, 70);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (e[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(οοθδΨιοΦΠβδζ.A("òÿþÁāýøāČûÈĆĊăĆČÎрљќѢѡѝсѢљѰѬп", (byte)8, 65));
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΣερμΔσατσκ.E("Ԏ\u0530ԲԒԶՕՍգՏԞ՜Ւՠ՚ԣՈժթաէաԶ", (byte)42, 69), ΠθκονθΛλαχςΔ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            χφπρψπφΦθμπ.A("ĶŃłąŅŁļŅŐĿČŊŎŇŊŐĒ҄ҝҠҦҥҡ҅ҦҝҴҰ҃Ī", (byte)42, 65) + var1 + πχσδΦΦνθΔπ.B("č", (byte)42, 66) + var2.toString(), var4
         );
      }
   }
}
