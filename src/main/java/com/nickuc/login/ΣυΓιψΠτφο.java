...
public class ΣυΓιψΠτφο extends ΨιβιψκωΓγ {
   private static String[] c = new String[ΣυΓιψΠτφο.g];
   ...
   public ΣυΓιψΠτφο(αΨμχΛΩΠωιν var1) {
      this.a = var1;
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(μεςΩΔΣγν.A("ĚħĦéĩĥĠĩĴģðĮĲīĮĴöѫҎѝ҄ҔѭҒҕҏ", (byte)28, 65));
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ιΠοθΩΦξκ.B("ƇƩƫƋƯǎǆǜǈƗǕǋǙǓƜǁǣǢǚǠǚƯ", (byte)112, 66), ΣυΓιψΠτφο.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            πψυκΠΨμΛΩβΣφμφσ.F("֏֛֜՞֚֞֕֞֩֘ե֣֧֣֠֩ի࣠ः࣒ࣹउ\u08e2इऊऄր", (byte)112, 70) + var1 + δΛψπξκσβγςα.B("ƙ", (byte)112, 66) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = ζοηκορΦνΣθγΩ.C("ҧѯҝҖҧ҉ҬҊҢҼҗҘҾҔұқүҘ҄Ҿ҅ҵҌҍ", (byte)44, 67);
               break;
            case 1:
               d[0] = δΛψπξκσβγςα.F("ՖԞՌՅՖԸ՛ԹՑիՃՌգՠզզեՅՔՋ\u0530մՌՐյթղձԻԾ՜ց", (byte)44, 70);
               break;
            case 2:
               d[0] = ςπυηννναΣ.F("Ռՠ\u0530ԹԯՁԴԼԶ\u0557ԪՉԧՎԦԧխՆԾՈխՎԻԼ", (byte)44, 70);
            case 3:
            default:
               break;
            case 4:
               d[0] = ξψθρΣΠΣς.D("ҎҪҏ҄ҷҎҕҲ҃҆ѹҘҺҮѸҾҜҚҔҔҰҏҌҍ", (byte)44, 68);
         }
      }
   }
