...
public abstract class ΓδψΩκαδδμηβφυδ implements εηχβγρΦβΦΛκγΦοδ<Object>, ψνρωκλαΓςσλζςΣ {
   ...
   private static String[] a = new String[ΓδψΩκαδδμηβφυδ.n];
   ...
   public String toString() {
      return this.a.q() + c<"㺀">(a, b ^ d) + this.a.s() + (this.a.a() == null ? c<"㺃">(e, f ^ g) : c<"㺆">(h & i, j) + this.a.a().G() + c<"㺉">(k, l ^ m));
   }

   void a(εηχβγρΦβΦΛκγΦοδ<?> var1) {
      this.a = var1;
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ΓδψΩκαδδμηβφυδ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(
                     ΣδτΠνεγοΓορητ.E("ԳՕ\u0557Է՛պղֈմՃցշօտՈխ֏֎ֆ\u058cֆ՛", (byte)79, 69), ΓδψΩκαδδμηβφυδ.class.getClassLoader()
                  )
               )
               .asType(var2)
         );
         ...
         throw new RuntimeException(
            βθκςνθΩθυμςτκχ.D("ԅԒԑӔԔԐԋԔԟԎӛԙԝԖԙԟӡࡆࡨࡽ\u085fࡱࡩ\u086d\u086eࡷࡳ\u086fࢄࢄࡴӻ", (byte)79, 68) + var1 + πηγμΣΔκκ.D("Ӝ", (byte)79, 68) + var2.toString(),
            var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(πψυκΠΨμΛΩβΣφμφσ.A("ƚƧƦũƩƥƠƩƴƣŰƮƲƫƮƴŶӛӽԒӴԆӾԂԃԌԈԄԙԙԉ", (byte)92, 65));
         }
   ...
   @Override
   public void a(μΓμρΨπζνιφφβΩΛΓ var1, μΓμρΨπζνιφφβΩΛΓ... var2) {
      this.a.a(var1, var2);
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = μζξτΩσσφυδεπλΨ.E("ԴԶՆՉթ՝իԨզծ\u0530Ժ", (byte)54, 69);
               b[1] = ΨφιωσρΓδΔθ.A("ĮőĵňħŖĤţŗķŘĳ", (byte)54, 65);
               b[2] = ΨΦνΨΦωυΩνβςμ.F("ՓԪեԨեՐահՑՑԵԴ\u0530Ն\u0557\u0558ԲէեԶռծՅՆ", (byte)54, 70);
               b[3] = φΨαξωυθανΣφυκη.F("՛ԼՍախԫղ՛ե՜ԴԺ", (byte)54, 70);
               break;
            case 1:
               b[0] = ζβησεθωυγτ.F("՛ԶԩԤ՞գՆազԭէԺ", (byte)54, 70);
               b[1] = ιΠοθΩΦξκ.F("դ՜ՅՖԿՈՃգՁէՉԺ", (byte)54, 70);
               b[2] = πχσδΦΦνθΔπ.D("ҸҏӊҍӊҵӆӕҶҶҐүӚӍҳҚҽһҰҠҾӓҪҫ", (byte)54, 68);
               b[3] = ΣφδσΔζιΠρα.C("ҟҧҢӒҟҲҍҕӀҘҶҟ", (byte)54, 67);
               break;
            case 2:
               b[0] = ςπυηννναΣ.B("ŜŅĜŢĨŇœŝŀŁħľŚśňŋőŢŬũťŁľĿ", (byte)54, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = ζοηκορΦνΣθγΩ.D("ҋ҇ҍқӌӋҿӑӊӆӋһӚӅҭҿӝҬҮҫӘӣҪҫ", (byte)54, 68);
         }
      }
   }
   ...
   @Override
   public void a(ιχρΨκεπυξ<?> var1, ιχρΨκεπυξ<?>... var2) {
      this.a.a(var1, var2);
   }
}
