...
public enum NLoginCore_460 {
   b((NLoginCore_460 != 0).n),
   c((NLoginCore_460 != 0).s),
   d((NLoginCore_460 != 0).x),
   e((NLoginCore_460 != 0).ac);

   private final boolean aQ;
   private static String[] ZKM_STR_A = new String[NLoginCore_460.h];
   private static String[] ZKM_STR_B = new String[NLoginCore_460.i];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_451.F("րՔը՞Ջբ՞և՜Մօ\u0558", (byte)84, 70);
               ZKM_STR_B[1] = NLoginCore_553.E("Իւը\u058cֈևևՌվթէ\u0558", (byte)84, 69);
               ZKM_STR_B[2] = NLoginCore_091.F("վՖ֊իպՠ֊Ջժռ։\u0558", (byte)84, 70);
               ZKM_STR_B[3] = NLoginCore_232.F("քՔ֊֍չն՜ռ\u0590֓֍\u0558", (byte)84, 70);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_138.F("պ֊քՔչֆիՇեռբզֈՐ\u058cՑկ։փֈձ֜գդ", (byte)84, 70);
               ZKM_STR_B[1] = NLoginCore_232.C("ӼԤԀӧԍԙԈӹԁԒ\u0530ӽԫӲӵԙӰԺԚԓԦԗԄԅ", (byte)84, 67);
               ZKM_STR_B[2] = NLoginCore_521.E("՛Ք\u0558։ֆշՆ՟ՎՊՅփՒխֈմՏՌհ\u0557պնգդ", (byte)84, 69);
               ZKM_STR_B[3] = NLoginCore_453.F("ձՖ՚\u0558լ՟ՎՐը֎Վ\u0558", (byte)84, 70);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_127.E("ցևւ\u058cժՠա\u0558ՙ֒ս\u0590֓թ֒Փ֏֗Ւևէզգդ", (byte)84, 69);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_446.E("զցը՚գռջֈ\u0590ևլ֎օխՖ֙ձՒյխխխշՒ֞\u058c֖֤֝֠փա", (byte)84, 69);
         }
      }
   }
