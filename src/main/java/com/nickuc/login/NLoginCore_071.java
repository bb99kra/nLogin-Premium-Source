...
public class NLoginCore_071 {
   ...
   private static String[] ZKM_STR_B = new String[NLoginCore_071.ac];
   ...
   public static final NLoginCore_071 b;
   ...
   public static final NLoginCore_071 c;
   ...
   public static final NLoginCore_071 a;
   ...
   private static String a(int var0, long var1) {
      ...
      if (ZKM_STR_A[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_530.F("ֆ֓֒Օ֑֕\u058c֕֠֏՜֚֚֞֗֠բࣲࣺࣧऀࣹ࣡ࣴ࣬ࣵ", (byte)103, 70));
         }
   ...
   public NLoginCore_071(String var1) {
      String[] var2 = var1.split(a(a, b));
      String var3;
      if (var2.length == c) {
         var3 = var2[d];
      ...
      if (this.a instanceof Inet4Address) {
         this.ap = ((var2.length == g && this.ad != h ? j : i) != 0);
      } else {
         if (!(this.a instanceof Inet6Address)) {
            throw new IllegalArgumentException(a(o, p ^ q) + this.a.getClass().getCanonicalName());
         }

         this.ap = ((var2.length == k && this.ad != l ? n : m) != 0);
      }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_071.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_127.D("ϸКМϼРпзэйЈцмъфЍвєѓыёыР", (byte)9, 68), NLoginCore_071.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(NLoginCore_173.C("грпЂтойтэмЉчыфчэЏޔޟާޭގޡޙޢަФ", (byte)9, 67) + var1 + NLoginCore_521.A("Ë", (byte)9, 65) + var2.toString(), var4);
      }
   }
   ...
   public boolean b(InetAddress var1) {
      if (!this.a.getClass().equals(var1.getClass())) {
         ...
         if (var4 != 0) {
            return (((var2[this.ae] & var4) != 0) == (var3[this.ae] & var4) ? y : z);
         } else {
            return (aa != 0);
         }
      }
   ...
   static {
      ...
      try {
         a = new NLoginCore_071(a(af, ag ^ ah));
         b = new NLoginCore_071(a(ai, aj));
         c = new NLoginCore_071(a(ak & al, am));
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_092.A("ƿƠǁƽƞƜƔƸƼƝƶƑ", (byte)101, 65);
               ZKM_STR_B[1] = NLoginCore_138.E("֎գֆֆը֛֒՟րչդ֙ա֒։օե\u058b֟թռ֑֧֘կլֲ֝֬֒֫\u0590ְօօ֘\u058c\u058b֢֤֜֘־։", (byte)101, 69);
               ZKM_STR_B[2] = NLoginCore_559.D("ՈՊԪԟԞԽԳԞԛԲԻԢԵԲՇէՌԮ՟ՍՇՊԷԸ", (byte)101, 68);
               ZKM_STR_B[3] = NLoginCore_575.B("ƂǄƱǀƮŽƻƗƺƧƛǀǈƬƪƜǐƑǁƬƕǅƜƝ", (byte)101, 66);
               ZKM_STR_B[4] = NLoginCore_183.F("օռծՖչՑ֝֠կՠ֥֝հ֒֞տ֗֝֡զւ֝մյ", (byte)101, 70);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_223.A("ƍžǂƞƟƥƶƈƶƝƶƑ", (byte)101, 65);
               ZKM_STR_B[1] = NLoginCore_553.A("ƶƋƮƮƐƺǃƇƨơƌǁƉƺƱƭƍƳǇƑƤǀƹǏƗƔǅǔƺǓǚƸƵǤƿƿƱǏǧƟǔƢǚƱ", (byte)101, 65);
               ZKM_STR_B[2] = NLoginCore_141.E("օևէ՜՛պհ՛\u0558կջ֓֗֝ֆռ֢պգ֧և֭մյ", (byte)101, 69);
               ZKM_STR_B[3] = NLoginCore_173.D("ԝ՟Ռ՛ՉԘՖԲՕՂԳՀՑԡԹԢԹԹՀՂխխՋՋ\u0530ՐՏծՍՖէթ", (byte)101, 68);
               ZKM_STR_B[4] = NLoginCore_427.E("օռծՖչՑ֝֠կՠ֚փֆ֦֜֩ր֔ֆ֢֎֟ի֢հ֝֜իֈֹ֓շ", (byte)101, 69);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_232.A("ƙƏƐƮƞǃǄƛƸƢƻƪƘƣƯǉǏǇƬƾǕƎǈƧƧƫǓƜƨƱƠƵ", (byte)101, 65);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_530.D("ՒԜՠՋԙԮԴՐԻԿԽՀժԤԷ՚ԼՄԸբԺհԷԸ", (byte)101, 68);
         }
      }
   }
}
