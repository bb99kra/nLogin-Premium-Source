...
public class ΛΠωσρζυχη {
   ...
   private static String[] a = new String[ΛΠωσρζυχη.h];
   private static final int ai = ΛΠωσρζυχη.j;
   private static int o = (94371840 >>> 85 | 94371840 << ~85 + 1) & -1;
   private static String[] b = new String[ΛΠωσρζυχη.i];
   ...
   public final σδΔξιονΦσΔΨπ a = new σδΔξιονΦσΔΨπ(this);
   ...
   @Generated
   public ΛΠωσρζυχη(ΨγημιδξΓτοθαζ var1) {
      this.w = var1;
   }

   private boolean az() {
      return (boolean)(!ΣλνΨουΩΔοθεβ.x.ar() ? a : b);
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΠΛΨοδΩσμνΛγΦφβς.C("ӹԆԅӈԈԄӿԈԓԂӏԍԑԊԍԓӕࡂࡈࡲ\u086d\u086cࡢࡲࡵࡦ", (byte)75, 67));
         }
   ...
   static {
      ...
      a = new WrapperPlayServerWindowItems(ΛΠωσρζυχη.p, ΛΠωσρζυχη.q, Arrays.asList(var0), null);
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ζβησεθωυγτ.B("ßāăãćĦĞĴĠïĭģıīôęĻĺĲĸĲć", (byte)28, 66), ΛΠωσρζυχη.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(πηγμΣΔκκ.F("ԻՈՇԊՊՆՁՊՕՄԑՏՓՌՏՕԗࢄࢊࢴࢯࢮࢤࢴࢷࢨԬ", (byte)28, 70) + var1 + βεξΠθρρςΔΦμ.E("Ԓ", (byte)28, 69) + var2.toString(), var4);
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΣφδσΔζιΠρα.E("գթռց՟ղ՛\u058bՋ\u058cՎ֒իթ֊օթ\u0590Ֆ֘՜տ֕պղ֣֞բրֈ֙շֈրպ\u0590փֲ\u058bղְֈְַոոպ֧֤֦֪֜\u0590֎ַ֖׀֏ׇ\u05c8ֹׁ֙ց", (byte)87, 69);
               break;
            case 1:
               b[0] = ξψθρΣΠΣς.A("ŽƃƖƛŹƌŵƥťƦŨƬƅƃƤƟƃƪŰƲŶƙƯƔƌƸƽżƚƢƳƑƢƚƔƪƝǌƥƌǊƢǊǑƒƒƔǁƾǀǄƶƪƨǕƲƗƻƫưǣǒǛǦƣƙǀǢƽǄǪǄǎƧǚƵ", (byte)87, 65);
               break;
            case 2:
               b[0] = ζοηκορΦνΣθγΩ.D("ԑԦԁԍԧԸԴԔԄԍӺԏԒԯՁԑӹԒԱ\u0530\u0530ԐԑԼԔԔՇԉԇԥՇԝ", (byte)87, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = φδχεθοκψαλΛογλ.E("֊փՠլՂ֑՞ր՞֎ՑՎՠխբՕ\u0557֏չՖՠ֟զէ", (byte)87, 69);
         }
      }
   }
