...
public class ξξψγξπιω implements απνηβηψθσΣγοξ {
   ...
   private static String[] b = new String[ξξψγξπιω.t];
   ...
   public ξξψγξπιω a(JavaPlugin var1, long var2, TimeUnit var4) {
      if (var1.isEnabled()) {
         if (this.a != null) {
   ...
   public ξξψγξπιω a(JavaPlugin var1) {
      if (var1.isEnabled()) {
         if (this.a != null) {
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣερμΔσατσκ.C("ѵ҂ҁф҄Ҁѻ҄ҏѾы҉ҍ҆҉ҏёߡߢ߭ߙߥߨߢ߳", (byte)31, 67));
         }
   ...
   ξξψγξπιω(boolean var1, θυυΔΓΨνεπς var2, Consumer<απνηβηψθσΣγοξ> var3) {
   ...
   public ξξψγξπιω a(JavaPlugin var1, long var2, long var4, TimeUnit var6) {
      if (var1.isEnabled()) {
         if (this.a != null) {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ξψθρΣΠΣς.A("÷ĤĉėúĎüĘĘĒĎēāġıāĄĿĦĺČĦŋĤİıĞĠĩŅĲŊ", (byte)33, 65);
               b[1] = βεξΠθρρςΔΦμ.E("ԓՀԥԳԖԪԘԴԴԮԪԯԝԽՍԝԠ՛ՂՖԨՂէՀՌՍԺԼՅաՎզ", (byte)33, 69);
               b[2] = μεςΩΔΣγν.B("÷ĤĉėúĎüĘĘĒĎēāġıāĄĿĦĺČĦŋĤİıĞĠĩŅĲŊ", (byte)33, 66);
               break;
            case 1:
               b[0] = θεωψξβΛσσ.F("ԓՀԥԳԖԪԘԴԴԮԪԯԝԽՍԝԠ՛ՂՖԨԽ՚ԸՖԽԮ՛աձկՇԾԷԳՎՖՆՌՏԼղվՅ", (byte)33, 70);
               b[1] = φΨαξωυθανΣφυκη.F("ԓՀԥԳԖԪԘԴԴԮԪԯԝԽՍԝԠ՛ՂՖԨԴ\u0557ԶՁԪհՃԮՓԿաՓՒնղԬՈինՐԵծՅ", (byte)33, 70);
               b[2] = λΣΩσμφγχ.D("юѻѠѮёѥѓѯѯѩѥѪјѸ҈јћҖѽґѣѵѾҨҥѡҫ҃ѹҢҊқҌҢѭѿѳѲҗѮ҂҈ѲҀ", (byte)33, 68);
               break;
            case 2:
               b[0] = ντθΔζβΔζ.D("ѽҍѫѠҏэѶђѬҚҍѠ", (byte)33, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = ςΦζσμτΓσ.B("ðąĮúüĈĈŁĖľĔĉ", (byte)33, 66);
         }
      }
   }

   ξξψγξπιω(boolean var1, θυυΔΓΨνεπς var2, Runnable var3) {
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(χΠξΦιζΨΣωΦσΨζ.A("ŅŧũŉŭƌƄƚƆŕƓƉƗƑŚſơƠƘƞƘŭ", (byte)79, 65), ξξψγξπιω.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(ςπυηννναΣ.D("ԅԒԑӔԔԐԋԔԟԎӛԙԝԖԙԟӡࡱࡲࡽࡩࡵࡸࡲࢃӵ", (byte)79, 68) + var1 + ΦδφπθΩΩλζξ.A("ŗ", (byte)79, 65) + var2.toString(), var4);
      }
   }
}
