...
public abstract class NLoginType_030 implements NLoginInterface_039, NLoginInterface_044 {
   ...
   private final NLoginCore_311 b;
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginType_030.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_232.C("ӨԊԌӬԐԯԧԽԩӸԶԬԺԴӽԢՄՃԻՁԻԐ", (byte)89, 67), NLoginType_030.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_076.E("ոօքՇևփվև֒ցՎ\u058c\u0590։\u058c֒Քࣱ࣮ࣥ࣠ࣅࣦ࣮࣫ࣗ࣬ࣸի", (byte)89, 69) + var1 + NLoginCore_110.D("Ӻ", (byte)89, 68) + var2.toString(), var4
         );
      }
   }
   ...
   public GUIButtonContainer[] a(NLoginType_008 var1, NLoginCore_277 var2, NLoginCore_509 var3, NLoginInterface_024 var4) {
      ...
      NLoginInterface_038 var6 = this.b.a(var1);
      ...
      var3.a(NLoginCore_567.A, NLoginCore_477.E.r() * m);
      var6.a(var5, var2);
      String var8 = NLoginCore_150.a(this.a, var2).replace(a(o & p, q), var2.ac());
      var4.a(var8);
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_471.E("ՇՔՓԖՖՒՍՖաՐԝ՛՟\u0558՛աԣࢴࢽࣀࢯ\u0894ࢵࢽࢺࢦࢻࣇ", (byte)40, 69));
         }
   ...
   @Generated
   NLoginType_030(NLoginCore_211 var1, NLoginCore_311 var2, NLoginCore_487 var3) {
      this.ap = var1;
      this.b = var2;
      this.a = var3;
   }
