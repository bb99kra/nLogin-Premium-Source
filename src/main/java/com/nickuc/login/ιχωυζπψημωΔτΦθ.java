...
public class ιχωυζπψημωΔτΦθ {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = μεςΩΔΣγν.E("ԎՄՏԴԣ\u0530ՆՏԣԘՈԙՖ\u0557ԙԽՌՔ՚ՔԹՂԻե՟՚ՍբԬզՉՠԥՠՈճղզդՍԻԺԼՂ", (byte)30, 69);
               b[1] = ξψθρΣΠΣς.C("҉ҊѵѸјчѺюѢѾѩѼ҆ѽѩѸҁҕѤѷѼҔѩғѪҐҁ҃҂ғјҥҠ҅ѪѥѻҊҟѭ҃ҥѱѷ", (byte)30, 67);
               b[2] = πχσδΦΦνθΔπ.B("ćõèòīøĥ÷ĹüĴĮĳüďĽıčĕňĔľćĠķčĨĞņįńŉĥŉğħĕďňĻļěĕģ", (byte)30, 66);
               break;
            case 1:
               b[0] = ξψθρΣΠΣς.D("уѹ҄ѩјѥѻ҄јэѽюҋҌюѲҁ҉ҏ҉ѮѷѰҚҔҏ҂җѡқѾҕҁҧҚѫѧҁ҉ҟѹҁұҋҦғҵҥҶҡѵҊҤһ҂҃", (byte)30, 68);
               b[1] = θεωψξβΛσσ.D("҉ҊѵѸјчѺюѢѾѩѼ҆ѽѩѸҁҕѤѷѼҔѩғѪҐҁ҃҂ғјҥѷѨ҉ҖѷѪҏѹҥ҄ѭѪҥ҅ҡҠ҅ҺҎҊҴҕ҂҃", (byte)30, 68);
               b[2] = ΨΦνΨΦωυΩνβςμ.B("ćõèòīøĥ÷ĹüĴĮĳüďĽıčĕňĔľćĠķčĨĞņįńŉħłňıŁŐňŊĨŖĺģ", (byte)30, 66);
               break;
            case 2:
               b[0] = ΣδτΠνεγοΓορητ.A("ðĭĪĭęĦēíĩĵćööĩĪěāăŀĀĜđĎď", (byte)30, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = ζοηκορΦνΣθγΩ.E("ԥՅՁՕՂԊՕԳԩԒՓԢ", (byte)30, 69);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ξψθρΣΠΣς.D("ӧӴӳҶӶӲӭӶԁӰҽӻӿӸӻԁӃࡎ\u085dࡠ\u085dࡏ࡚ࡣࡓ࡙ࡧ࠳ࡤࡇ࡚", (byte)69, 68));
         }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ιχωυζπψημωΔτΦθ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(
                     ςπυηννναΣ.E("ԯՑՓԳ\u0557նծքհԿսճցջՄթ\u058b֊ւֈւ\u0557", (byte)75, 69), ιχωυζπψημωΔτΦθ.class.getClassLoader()
                  )
               )
               .asType(var2)
         );
         ...
         throw new RuntimeException(
            πχσδΦΦνθΔπ.A("ŸƅƄŇƇƃžƇƒƁŎƌƐƉƌƒŔӟӮӱӮӠӫӴӤӪӸӄӵӘӫŮ", (byte)75, 65) + var1 + πηγμΣΔκκ.B("ŏ", (byte)75, 66) + var2.toString(), var4
         );
      }
   }

   public static String a(βλυςΓυφγζπΩΣΠΨτ var0, int var1) {
      return a(βλυςΓυφγζπΩΣΠΨτ.a(var0), var1);
   }
   ...
   public static int a(int var0, int var1) {
      if (var0 == var1) {
         ...
         throw new IllegalArgumentException(c<"㺃">(f, g ^ h));
      } else if (var1 <= 0) {
