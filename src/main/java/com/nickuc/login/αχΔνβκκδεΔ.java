...
public class αχΔνβκκδεΔ extends ξυνξβμχε<νεΓτεκΓηζεΔλιΩ> {
   private static long x = Long.reverse(-4738291147680419599L);
   private static int o = Integer.reverse(-1);
   private static String[] c = new String[αχΔνβκκδεΔ.ap];
   ...
   private static String[] d = new String[αχΔνβκκδεΔ.aq];
   ...
   public αχΔνβκκδεΔ(νεΓτεκΓηζεΔλιΩ var1) {
      super(var1);
   }
   ...
   public void c(Object var1) {
      ...
      if (var1 instanceof String) {
         ...
         String[] var4 = var3.split(c<"㺀">(ac, ad));
         ...
         if (!(var1 instanceof ChannelIdentifier)) {
            throw new IllegalArgumentException(c<"㺃">(ah, ai ^ aj) + var1 + c<"㺆">(ak, al ^ am) + var1.getClass().getCanonicalName());
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ςΦζσμτΓσ.D("ԀԢԤԄԨՇԿՕՁԐՎՄՒՌԕԺ՜՛ՓՙՓԨ", (byte)97, 68), αχΔνβκκδεΔ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            δΛψπξκσβγςα.A("ƤƱưųƳƯƪƳƾƭźƸƼƵƸƾƀԃԚӨԒԈԑԒԍԏӯƖ", (byte)97, 65) + var1 + μζξτΩσσφυδεπλΨ.D("Ԓ", (byte)97, 68) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = οΩνΩρωλΨηΛδωδ.C("ҊҞҶҒӌӖӑӕҰӕӊҸҜӞҜӎһҠӠҞҡӛӗҶӌӠӋӛӨӄӋӂ", (byte)55, 67);
               d[1] = χΠξΦιζΨΣωΦσΨζ.B("ŘőĵĸţĥŖĶĩūŚĵ", (byte)55, 66);
               d[2] = οοθδΨιοΦΠβδζ.B("ĝıŉĥşũŤŨŃŨŚıŲŤűőłũŕŨŴūŏŜřŻŐŵĺƁŰĽŏŞźłƊŦŤťŉſŋŕ", (byte)55, 66);
               d[3] = ιΠοθΩΦξκ.F("ԫըՏեՈ՟լհԽծԭԻ", (byte)55, 70);
               d[4] = ΣφδσΔζιΠρα.D("ӅҾҢҥӐҒӃңҖӘӇҢ", (byte)55, 68);
               d[5] = ΦδφπθΩΩλζξ.C("ҊҞҶҒӌӖӑӕҰӕӇҞӟӑӞҾүӖӂӕӡӘҼӉӆӨҽӢҧӮӝҪҼӋӧүӷӓӑӒҶӬҸӂ", (byte)55, 67);
               d[6] = ςΦζσμτΓσ.F("ԫըՏեՈ՟լհԽծԭԻ", (byte)55, 70);
               break;
            case 1:
               d[0] = ΨΦνΨΦωυΩνβςμ.A("ĝıŉĥşũŤŨŃŨŝŋįűįšŎĳųıĴűŇĹŧŐŞŀļŏŶł", (byte)55, 65);
               d[1] = χφπρψπφΦθμπ.C("ӍҏҠӔғҤҺһүҰұҢ", (byte)55, 67);
               d[2] = μεςΩΔΣγν.B("ĝıŉĥşũŤŨŃŨŚıŲŤűőłũŕŨŴūŏŜřŻŐŵĺƁŰĽŞƅŠŖƂŸŖŌƁŧōƂůŉŭŨųŒŒŶƖţŠš", (byte)55, 66);
               d[3] = ΠΛΨοδΩσμνΛγΦφβς.E("Քգա՞՚ըՂ՟ԽիՎԻ", (byte)55, 69);
               d[4] = θεωψξβΛσσ.D("ҠӔҪӅҗәҤҚҰӚҹҢ", (byte)55, 68);
               d[5] = ΦδφπθΩΩλζξ.C("ҊҞҶҒӌӖӑӕҰӕӇҞӟӑӞҾүӖӂӕӡӘҼӉӆӨҽӢҧӮӝҪҮүӝҾӠӂӎӯӣҵҸӉҾӖԀӼәӯӣӚӘԆӍӎ", (byte)55, 67);
               d[6] = ΨΦνΨΦωυΩνβςμ.C("ӈӊҒҡҤҷӈҷӘӉҭҢ", (byte)55, 67);
               break;
            case 2:
               d[0] = ΦδφπθΩΩλζξ.A("įŦšĽĩŇĤŦĬĻňőłĲŌōūŴŷŉŚĸŉŜŧũŴŮŁŶŜœ", (byte)55, 65);
            case 3:
            default:
               break;
            case 4:
               d[0] = ΨφιωσρΓδΔθ.B("ĞĴĽŅłĳĺĽĪŰŮŨŎņŁŁšŦťťŢŕĴűŔŉĿŹŋĿŖť", (byte)55, 66);
         }
      }
   }
   ...
   public void a(Object var1, Object var2) {
      if (var2 != null && !(var2 instanceof ωΩΩαομοΣψΩ)) {
         throw new IllegalArgumentException(c<"㺀">(b, i ^ j) + var2.getClass().getCanonicalName());
      } else {
         Object var3;
         if (var1 instanceof String) {
            String var4 = (String)var1;
            String[] var5 = var4.split(c<"㺃">(n & o, p));
            var3 = var5.length == q ? MinecraftChannelIdentifier.create(var5[r], var5[s]) : new LegacyChannelIdentifier(var4);
         } else {
            if (!(var1 instanceof ChannelIdentifier)) {
               throw new IllegalArgumentException(c<"㺆">(t & u, v) + var1 + c<"㺉">(w, x ^ y) + var1.getClass().getCanonicalName());
            }
         ...
         if (var2 != null) {
            this.h.a((μΓμρΨπζνιφφβΩΛΓ)var2, new μΓμρΨπζνιφφβΩΛΓ[ab]);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(μεςΩΔΣγν.A("ĮĻĺýĽĹĴĽňķĄłņĿłňĊҍҤѲҜҒқҜҗҙѹ", (byte)38, 65));
         }
