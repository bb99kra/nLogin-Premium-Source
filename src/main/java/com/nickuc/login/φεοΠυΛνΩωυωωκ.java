...
enum φεοΠυΛνΩωυωωκ {
   ...
   private static String[] a = new String[φεοΠυΛνΩωυωωκ.l];
   private static String[] b = new String[φεοΠυΛνΩωυωωκ.m];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ςπυηννναΣ.C("ԣԫՀԻդդ՜՝ՔճհԻ", (byte)106, 67);
               b[1] = χφπρψπφΦθμπ.F("՚՝\u0558տ֢֒ռզ֖֥յծ", (byte)106, 70);
               b[2] = ιΠοθΩΦξκ.F("թ֊֔փՙ՚֜\u0590կՠ֗ծ", (byte)106, 70);
               b[3] = φΨαξωυθανΣφυκη.A("žƗƤƽƹƛƠƳƵǆƍƛ", (byte)106, 65);
               break;
            case 1:
               b[0] = χΠξΦιζΨΣωΦσΨζ.D("Ԩխ՛ԸԦ՜իԭեԲՖԻ", (byte)106, 68);
               b[1] = χφπρψπφΦθμπ.F("՚ծՠ֣ռ֖֠յ֛բդծ", (byte)106, 70);
               b[2] = οΩνΩρωλΨηΛδωδ.E("էֈ֛մծ֢֛ր֝բ֓ծ", (byte)106, 69);
               b[3] = ξψθρΣΠΣς.A("ǇǆƟƭǇƍƑǃƲǒƑƛ", (byte)106, 65);
               break;
            case 2:
               b[0] = ιΠοθΩΦξκ.B("ƕǇơƫǍƥƪǐƱǀƭƉƗǏǈƤǗǜƹƞǏǏƦƧ", (byte)106, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = βεξΠθρρςΔΦμ.F("մ֑՚ճ֣՛րռֆ֙զռ֘֘ֆ֮֜\u058bօֵֻּ֖֑֭֯֞֨֔֯־֚", (byte)106, 70);
         }
      }
   }

   private static φεοΠυΛνΩωυωωκ a(String var0, int var1) {
      boolean var2 = c<"㺀">(a, b ^ d).equalsIgnoreCase(var0);
      φεοΠυΛνΩωυωωκ[] var3 = values();
      int var4 = var3.length;

      for (int var5 = e; var5 < var4; var5++) {
         φεοΠυΛνΩωυωωκ var6 = var3[var5];
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ςπυηννναΣ.A("ƺǇǆƉǉǅǀǉǔǃƐǎǒǋǎǔƖԮԞԩԋԱԈԫԘԹԶԻԼԮ", (byte)108, 65));
         }
   ...
   @Generated
   private φεοΠυΛνΩωυωωκ(int var3) {
      this.aG = var3;
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΣερμΔσατσκ.A("ƓƵƷƗƻǚǒǨǔƣǡǗǥǟƨǍǯǮǦǬǦƻ", (byte)118, 65), φεοΠυΛνΩωυωωκ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            μζξτΩσσφυδεπλΨ.E("֢֕֡դ֤֛֤֠֯֞ի֦֭֩֩֯ձउࣹऄࣦऌࣣआࣳऔऑखगउ֊", (byte)118, 69) + var1 + ΣερμΔσατσκ.D("Ց", (byte)118, 68) + var2.toString(), var4
         );
      }
   }
}
