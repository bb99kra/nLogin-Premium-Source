...
public final class γπευΦΛιιηθς implements οηΔΦθκορ, CommandExecutor, TabCompleter {
   ...
   private static String[] a = new String[al];
   ...
   public void W() {
      ...
      if (this.a != null) {
         try {
            ...
            Field var2 = ΓΛθσφζςηκ.a(var1.getClass(), c<"㺀">(b, d ^ e));
            ...
            ψΓωτιμωκχψΛΨ.c(c<"㺃">(f, g) + var5.getLocalizedMessage(), var5);
         }
      }
   }
   ...
   private PluginCommand a() {
      try {
         ...
         Constructor var1 = ΓΛθσφζςηκ.b(PluginCommand.class, var10001);
         ...
         var2.setDescription(var3 == null ? c<"㺀">(ae & af, ag) : var3);
         var2.setExecutor(this);
         var2.setTabCompleter(this);
         return var2;
      } catch (Exception var4) {
         ψΓωτιμωκχψΛΨ.c(c<"㺃">(ah & ai, aj) + var4.getLocalizedMessage(), var4);
         return null;
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣδτΠνεγοΓορητ.E("ԸՅՄԇՇՃԾՇՒՁԎՌՐՉՌՒԔ࢙ࢧ࢝ࢮ\u0890ࢆࢥࢦࢥࢧࢲ", (byte)25, 69));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΨφιωσρΓδΔθ.A("ƘƞǁƘƠƟƠƞƣƎǋƅƵǆƒǒƬƲƲƹǑǛƢƣ", (byte)104, 65);
               b[1] = ΣερμΔσατσκ.C("ԽԯԟէԡՔՍԭՁԬՂԱԫ՟ՠԿԾԯՈՙհմռԼնՠկԸլբԿնՐՇրևՅթսնէՙլՕ", (byte)104, 67);
               b[2] = ιΠοθΩΦξκ.C("ԶԼ՟ԶԾԽԾԼՁԬթԣՓդ\u0530հՊՐՐ\u0557կչՀՁ", (byte)104, 67);
               b[3] = ζοηκορΦνΣθγΩ.A("ưƶƹƶƼƿƪƽƛƼƥƼƓƞǖƥƑƫƥǄǅǋƢƣ", (byte)104, 65);
               b[4] = χφπρψπφΦθμπ.F("զ՛֒ս֗֕պաջ֟֝լ", (byte)104, 70);
               b[5] = πηγμΣΔκκ.B("ƑƆƽƨǂǀƥƌƦǊǈƗ", (byte)104, 66);
               b[6] = ντθΔζβΔζ.E("մզՖ֞\u0558\u058bքդոգշա֛֥՝սվվ֡պցտց֎ք֎֯կղփֻ֦֪հ֛րַ֬֙֫փ׃ֆ\u058c", (byte)104, 69);
               b[7] = βθκςνθΩθυμςτκχ.E("֛֓֏ծ֚֚ռ֢֟֟ս֑աղց՞֩֘ի\u058bչ֪ց֡ք֑֊֏ָն֥։ֵհ׀֩։ֿ֕քրֆֵ֟ք֓քּ֦֨ׄ׃\u05cfֽ־֡֫\u05c9ׄ֓֩\u05ccל֕", (byte)104, 69);
               b[8] = μζξτΩσσφυδεπλΨ.C("ԽԯԟէԡՔՍԭՁԬՁՀԽԮՊզՕՇՙեժԳՈեսՐձՙխփձԻվֈ\u0557շտբյ\u058cՆ֎֊Օ", (byte)104, 67);
               break;
            case 1:
               b[0] = ςπυηννναΣ.A("ƘƞǁƘƠƟƠƞƣƎǈƿǏƕƞƒǁƭƓǌƷƥƢƣ", (byte)104, 65);
               b[1] = ΨΦνΨΦωυΩνβςμ.E("մզՖ֞\u0558\u058bքդոգչըբ֖֗նյզտ\u0590ֳ֧֫ճ֦֭֗կ֣֙ն֭\u058bֲֽ֟չֽ֢֑֥ւֹ\u058c", (byte)104, 69);
               b[2] = ΣδτΠνεγοΓορητ.C("ԶԼ՟ԶԾԽԾԼՁԬզ՟՚իՠԳՏՊյհգՃՀՁ", (byte)104, 67);
               b[3] = φδχεθοκψαλΛογλ.B("ưƶƹƶƼƿƪƽƛƼƤƢǐƽƴƓƏƩƬƓƛǛƢƣ", (byte)104, 66);
               b[4] = ΣερμΔσατσκ.A("ƆǄƛƫǌƦƋƧƠǌǌƗ", (byte)104, 65);
               b[5] = ΦδφπθΩΩλζξ.C("ԟըԼՈՃՂՌԸԠՠԯԵ", (byte)104, 67);
               b[6] = δΛψπξκσβγςα.A("ƟƑƁǉƃƶƯƏƣƎƢƌǆǐƈƨƩƩǌƥƬƪƬƹƯƹǚƚƝƮǑǦƨƧǙǜƴƟƼƺǣƨǇǞǣǈǟƮƴǢǛǌǥǕǂǃ", (byte)104, 65);
               b[7] = οΩνΩρωλΨηΛδωδ.C("՜դ\u0558ԷգգՅըիըՆ՚ԪԻՊԧղաԴՔՂճՊժՍ՚Փ\u0558ցԿծՒվԹ։ղՒֈ՞ՍՉՏվըՍ՜Սօկձ֍\u058c֘օ֎թ֕ժ\u0558՚֝\u058bհֆ", (byte)104, 67);
               b[8] = βεξΠθρρςΔΦμ.C("ԽԯԟէԡՔՍԭՁԬՁՀԽԮՊզՕՇՙեժԳՈեսՐձՙխփձԻէզյՑ։ՅսռՠՆդՕ", (byte)104, 67);
               break;
            case 2:
               b[0] = ΨφιωσρΓδΔθ.A("ǇſǀƸƛƥƺƥƭƠƧƮƍƓƣƳƢƳǌưǍƴƾƝƞƽƾƶǀǕơǜ", (byte)104, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = φΨαξωυθανΣφυκη.C("ՐԵՇՃՅԩԪԭՙբՏԻՊլ՟ՇըղիաջԹԲՓՖպմվլհՐւ", (byte)104, 67);
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(πψυκΠΨμΛΩβΣφμφσ.E("բքֆզ֊ַ֣֩֡ղְִ֦֮շ֜־ֵֵֻֽ֊", (byte)126, 69), γπευΦΛιιηθς.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            χΠξΦιζΨΣωΦσΨζ.E("֪֝֩լַ֣֦֬֨֬ճֱֱֵַ֮չࣾऌंओࣵ࣫ऊऋऊऌग\u0590", (byte)126, 69) + var1 + ΣδτΠνεγοΓορητ.F("մ", (byte)126, 70) + var2.toString(), var4
         );
      }
   }
   ...
   public synchronized void X() {
      if (this.a != null) {
         try {
            PluginManager var1 = this.a.getPluginManager();
            Field var2 = ΓΛθσφζςηκ.a(var1.getClass(), c<"㺀">(i, j ^ k));
            Object var3 = var2.get(var1);
            if (var3 instanceof CommandMap) {
               CommandMap var4 = (CommandMap)var3;
               ...
               if (var4 instanceof SimpleCommandMap) {
                  Field var6 = ΓΛθσφζςηκ.a(SimpleCommandMap.class, c<"㺃">(l, m ^ n));
                  Map var7 = (Map)var6.get(var4);
                  String var8 = this.b.a().q().toLowerCase(Locale.ENGLISH);
                  String var9 = this.a.getName();
                  var7.remove(var8 + c<"㺆">(o, p ^ q) + var9);
                  var7.remove(var9);

                  for (String var11 : var5) {
                     var7.remove(var8 + c<"㺉">(r, s ^ t) + var11);
                     var7.remove(var11);
                  }
               }
            }
         } catch (Exception var12) {
            ψΓωτιμωκχψΛΨ.c(c<"㺌">(u, v ^ w) + var12.getLocalizedMessage(), var12);
         }
      }
   }
   ...
   @Generated
   public γπευΦΛιιηθς(Server var1, ιχρΨκεπυξ<?> var2) {
      this.a = var1;
      this.b = var2;
   }
}
