...
public final class ΔσΓπΠβιτξΦΔχ extends πνπφδλΛπνψ {
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ζοηκορΦνΣθγΩ.E("ղտվՁցսոց\u058cջՈֆ֊փֆ\u058cՎࢴࣤࢵࣣࣄࣦ࣏ࣗࣟ࣫ࢾࣲ", (byte)83, 69));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = οΩνΩρωλΨηΛδωδ.D("ԖԤ\u0557ԧԬ\u0557\u0530ՊԽԗԭԦ", (byte)99, 68);
               d[1] = ςπυηννναΣ.D("ԣԏԮ՚ԩ՝ԙԝ\u0530ՏԱԦ", (byte)99, 68);
               d[2] = ντθΔζβΔζ.F("֗ւյ֚֜֙ֆշ֠ժ֜է", (byte)99, 70);
               d[3] = θεωψξβΛσσ.D("ՖՁԴ՛ՙ\u0558ՅԶ՟ԩ՛Ԧ", (byte)99, 68);
               d[4] = φδχεθοκψαλΛογλ.E("իՏ֕֍թ֊նէրշպէ", (byte)99, 69);
               d[5] = ΦδφπθΩΩλζξ.F("\u0557ե֘ըխ֘ձ\u058bվ\u0558ծէ", (byte)99, 70);
               d[6] = ΨφιωσρΓδΔθ.A("ƱƺƕŸƺƶŶŷǆƏƕǈƫǉǉƽǆƽƛƠƝƏƴǁǆǍǘǅƖƹǊƪƨǍƳƷǖǓǌƶƯǏƱǪǃǜƿǞǞǨǧǩǬǋƸƹ", (byte)99, 65);
               break;
            case 1:
               d[0] = ιΠοθΩΦξκ.A("ƬƼŸƬŽƟƴƅƵƻƜƍ", (byte)99, 65);
               d[1] = πψυκΠΨμΛΩβΣφμφσ.A("ƫƍƒƶǃƺƒƄǀƜƗƹǇƔƟƚƀǈǏƿǑǁƘƙ", (byte)99, 65);
               d[2] = πηγμΣΔκκ.E("ոբօջ֕֗յ֍\u058b֙֜է", (byte)99, 69);
               d[3] = λΣΩσμφγχ.E("զօ֍Ս\u0557ղո֓ի֡֠է", (byte)99, 69);
               d[4] = ζοηκορΦνΣθγΩ.B("żƶƳǀƟưƐǄƧƐƃƍ", (byte)99, 66);
               d[5] = μεςΩΔΣγν.B("ƸƯƱƾƾƙƺƎƐƂƇƍ", (byte)99, 66);
               d[6] = πψυκΠΨμΛΩβΣφμφσ.F("\u058b֔կՒ֔\u0590ՐՑ֠թկ֢օ֣֣֗֠֗յպշթ֎ֲ֛֧֠֟հ֤֓քւ֧֍ְ֑֦֭\u0590։֩\u058cր֑փֻׁ֢֖֤֓։ֺք֥־גֳ֢֭֓חֲ", (byte)99, 70);
               break;
            case 2:
               d[0] = ΨφιωσρΓδΔθ.B("ƼƘƺŻƒǃƾƲƁƤƐƟƂǉƻƨƌǉƞƜǇǁƘƙ", (byte)99, 66);
            case 3:
            default:
               break;
            case 4:
               d[0] = χφπρψπφΦθμπ.B("ŴƳƎƌƟƖƢƁưƼƸŻƓƓƇƾƯƤǊơǐƫƘƙ", (byte)99, 66);
         }
      }
   }
   ...
   public boolean i(String var1, String var2) {
      if (var2.contains(c<"㺀">(r & s, t))) {
         var2 = var2.split(c<"㺃">(u, v))[w];
      }

      String[] var3 = var2.split(c<"㺆">(x, y ^ z));
      if (var3.length != aa && var3.length != ab) {
         return (boolean)ac;
      } else {
         String var4 = var3[ad];
         if (!var4.equalsIgnoreCase(c<"㺉">(ae, af ^ ag))) {
            return (boolean)ah;
         } else {
            String var5 = var3[ai];
            ...
            switch (var3.length) {
               ...
               default:
                  throw new IllegalArgumentException(c<"㺌">(ak, al) + var3.length);
            }
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ςπυηννναΣ.D("ԪՌՎԮՒձթտիԺոծռնԿդֆօսփսՒ", (byte)111, 68), ΔσΓπΠβιτξΦΔχ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            πχσδΦΦνθΔπ.F("֎֛֚՝֝֙֔֝֨֗դ֢֦֢֟֨ժ࣐ऀ࣑ࣿ࣠ࣳࣻइं࣫ࣚऎւ", (byte)111, 70) + var1 + ζοηκορΦνΣθγΩ.F("ե", (byte)111, 70) + var2.toString(), var4
         );
      }
   }
