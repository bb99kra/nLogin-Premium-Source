...
public class θρδΣβΔωΣΛ {
   ...
   public String a(TimeUnit var1, long var2, int var4) {
      return βιχγΓλχΠσπ.a(this.a(var1, var2), var4);
   }
   ...
   public static θρδΣβΔωΣΛ a(long var0) {
      return new θρδΣβΔωΣΛ(var0);
   }

   public String a(TimeUnit var1, int var2) {
      return βιχγΓλχΠσπ.a(this.a(var1), var2);
   }
   ...
   public double a(TimeUnit var1, long var2) {
      ...
      switch (ΨπξΣευΣΠγςτ.s[var1.ordinal()]) {
         case 1:
            return var4;
         case 2:
            return var4 / a;
