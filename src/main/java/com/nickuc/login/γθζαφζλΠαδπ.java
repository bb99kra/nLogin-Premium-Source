...
public class γθζαφζλΠαδπ implements θβορΛτηατθΨτΠτΦ {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = χφπρψπφΦθμπ.B("ŕęĹšŠĹŞĝĢŕšœŜśĬřĩŪŐĬųųĺĻ", (byte)52, 66);
               break;
            case 1:
               b[0] = χΠξΦιζΨΣωΦσΨζ.E("՞ԢՂժթՂէԦԫ՞թի\u0530նՁգՋԹդ\u0558՚ՆՃՄ", (byte)52, 69);
               break;
            case 2:
               b[0] = θεωψξβΛσσ.C("ӆӄ҈ҧҚҊҾҤӌҩӕӀҍӉҨҮҨҍҭҬҦҧҤҥ", (byte)52, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = πηγμΣΔκκ.E("ԼՕԸԧՀդԺ՛ՑՈթԸ", (byte)52, 69);
         }
      }
   }

   public γθζαφζλΠαδπ(οουτχΛκΣηΓψοΔ var1) {
      this.b = var1;
   }
   ...
   public void a(PacketReceiveEvent var1) {
      ...
      if (var3.equals(c<"㺀">(a & b, d))) {
         Player var4 = (Player)var1.getPlayer();
         if (var4 != null) {
            var1.setCancelled((boolean)e);
            οουτχΛκΣηΓψοΔ.a(this.b).a().a(οουτχΛκΣηΓψοΔ.a(this.b).b().a(var4), var2.getData());
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣερμΔσατσκ.B("ĎěĚÝĝęĔĝĨėäĢĦğĢĨêѯѵѴѰ҆ѷѽѣѵѹ҆", (byte)22, 66));
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΦδφπθΩΩλζξ.B("ùěĝýġŀĸŎĺĉŇĽŋŅĎĳŕŔŌŒŌġ", (byte)41, 66), γθζαφζλΠαδπ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΨφιωσρΓδΔθ.F("ՈՕՔԗ\u0557ՓՎ\u0557բՑԞ՜ՠՙ՜բԤࢩࢯࢮࢪࣀࢱࢷ࢝ࢯࢳࣀԻ", (byte)41, 70) + var1 + οοθδΨιοΦΠβδζ.E("ԟ", (byte)41, 69) + var2.toString(), var4
         );
      }
   }
