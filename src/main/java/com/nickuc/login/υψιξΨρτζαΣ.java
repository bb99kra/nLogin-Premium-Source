...
public class υψιξΨρτζαΣ implements λιμριγδβψ {
   private static int ab = Integer.reverse(0);
   private static String[] a = new String[υψιξΨρτζαΣ.ax];
   ...
   private static final char[] d = c<"㺆">(υψιξΨρτζαΣ.bf, υψιξΨρτζαΣ.bg).toCharArray();
   private static int am = Integer.reverse(0);
   private static int aa = (0 >>> 206 | 0 << ~206 + 1) & -1;
   public static final String cr = c<"㺃">(υψιξΨρτζαΣ.bc & bd, υψιξΨρτζαΣ.be);
   ...
   private static final String cs = c<"㺀">(az, ba);
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(λΣΩσμφγχ.F("ӫԍԏӯԓԲԪՀԬӻԹԯԽԷԀԥՇՆԾՄԾԓ", (byte)7, 70), υψιξΨρτζαΣ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(ξψθρΣΠΣς.C("ЭкйϼмигмчжЃсхосчЉޠޤޖޜއޡޥޘޔއП", (byte)7, 67) + var1 + ΣφδσΔζιΠρα.D("Є", (byte)7, 68) + var2.toString(), var4);
      }
   }
   ...
   public boolean i(String var1, String var2) {
      var2 = var2.substring(a, var2.length() - c<"㺀">(b, d ^ e).length());
      String[] var3 = var2.split(c<"㺃">(f, g ^ h));
      String var4 = var3[i];
      Pattern var5 = Pattern.compile(c<"㺆">(j, k) + var4 + c<"㺉">(l & m, n));
      if (var4.length() <= o) {
         var5 = Pattern.compile(c<"㺌">(p, q ^ r) + var4 + c<"㺏">(s & t, u));
      }
   ...
   private static byte[] a(char[] var0, byte[] var1, int var2) {
      ...
      try {
         SecretKeyFactory var4 = SecretKeyFactory.getInstance(c<"㺀">(ag, ah ^ ai));
         return var4.generateSecret(var3).getEncoded();
      } catch (InvalidKeySpecException var5) {
         ψΓωτιμωκχψΛΨ.c(c<"㺃">(aj & ak, al), var5);
      } catch (NoSuchAlgorithmException var6) {
         ψΓωτιμωκχψΛΨ.c(c<"㺆">(an, ao ^ ap), var6);
      }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(δΛψπξκσβγςα.E("ֈ֕֔\u0557֗֓֎֢֑֗՞֢֜֠֙֜դࣱࣻࣿࣷ\u08e2ࣼऀ࣯ࣳ\u08e2", (byte)105, 69));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ςπυηννναΣ.A("ŲĻŎŲŌŜſŏůŝŃŧŝŔśŕŃņŠūƄřŖŗ", (byte)66, 65);
               b[1] = μζξτΩσσφυδεπλΨ.E("յճ՚՚ԶԵՉ՚՞ՍճՆ", (byte)66, 69);
               b[2] = πχσδΦΦνθΔπ.F("յճ՚՚ԶԵՉ՚՞ՍճՆ", (byte)66, 70);
               b[3] = ιΠοθΩΦξκ.E("ԵիՐՅհեԹՆՇ՝ՓիՓՏՖծշքՅբ՛֊֊խՅկ֒֊կզհշ", (byte)66, 69);
               b[4] = ΦδφπθΩΩλζξ.B("źŸşşĻĺŎşţŒŸŋ", (byte)66, 66);
               b[5] = πψυκΠΨμΛΩβΣφμφσ.B("ĺŰŕŊŵŪľŋŌŢŘŰŘŔśųżƉŊŧŠƏƏŲŊŴƗƏŴūŵż", (byte)66, 66);
               b[6] = ΣερμΔσατσκ.B("œŪſŵůůźżƄľŜŀŅųƇƈŠũťżƈƀƃţŌŋƏŠŗŲƚż", (byte)66, 66);
               b[7] = πχσδΦΦνθΔπ.E("եեԱՑ՛ԮԶ\u0558ԷՋն՜ԽՎ\u0557ծջձքՂդժգՉՁՂ֎իֈ՟ացօև֍Օ֏Փ՝ֈտ֝֙֍֤֟՝֤֑դ֛֙֟֞գնթխ֟լ֑֒֞\u0590", (byte)66, 69);
               b[8] = λΣΩσμφγχ.B("ŪŪĶŖŠĳĻŝļŐŻšłœŜųƀŶƉŇũźƅōŊƃŠōƈƊŴűŔƎũƞƘźžŮƖŹƖŦƣſŤƜŧžƆƗƙƢƄƤƫƵƊƉƪƤƤƚźƒƬƏŽƻƿǁƵƾƐƴǅƹƖƤžƜƝǃƿǏƖƗ", (byte)66, 66);
               b[9] = ντθΔζβΔζ.F("ճճՔ՛խԴշԹԸՋՀՆ", (byte)66, 70);
               b[10] = δΛψπξκσβγςα.B("œŪſŵůůźżƄľŜŀŅųƇƈŠũťżƈƀƃţŌŋƏŠŗŲƚż", (byte)66, 66);
               b[11] = ςΦζσμτΓσ.B("ŲĻŎŲŌŜſŏůŝŃŧŝŔśŕŃņŠūƄřŖŗ", (byte)66, 66);
               b[12] = ιΠοθΩΦξκ.C("ӓӮҭӸӳӓӐӖәӬӷӸӵӔҾӔӝӥӤӾӜҿӡӫӇӻӊӨԈԆӒӉӔӡӯӢӭԚԇӪӤԐӾӰӾԗӔӽӠԦԦԜԣԣԃӢԝԮӺԗӫӪӾԓӮԵԈӷԮԳԵӲԱԈԸԮԯԑԟԋӿԎՆԥԣԑԎԏ", (byte)66, 67);
               break;
            case 1:
               b[0] = μεςΩΔΣγν.B("ŲĻŎŲŌŜſŏůŝńƇľŢūłŪƃŞŸƈũŖŗ", (byte)66, 66);
               b[1] = ΠΛΨοδΩσμνΛγΦφβς.B("ŐĳŵŷŨųŽŹżĻƀŋ", (byte)66, 66);
               b[2] = ιΠοθΩΦξκ.E("ՒչզՙՃժՏԹԻ\u0557ՕՆ", (byte)66, 69);
               b[3] = ΨΦνΨΦωυΩνβςμ.D("ҲӨӍӂӭӢҶӃӄӚӐӨӐӌӓӫӴԁӂӟӘӂӊӿӴӹӗԎӜӼӭӒԎԔӭӦӵԌӦӶӪԔӲӣ", (byte)66, 68);
               b[4] = λΣΩσμφγχ.B("ŐĳŵŷŨųŽŹżĻƀŋ", (byte)66, 66);
               b[5] = θεωψξβΛσσ.D("ҲӨӍӂӭӢҶӃӄӚӐӨӐӌӓӫӴԁӂӟӘӃӇӆӢӷԇӬӌӝԄԀӰӐӶӨԂӦԃԙԆӷӦӣ", (byte)66, 68);
               b[6] = δΛψπξκσβγςα.F("ՎեպհժժյշտԹ\u0557ԻՀծւփ՛դՠշփև\u058c՜ջՏցքգ֎փդ", (byte)66, 70);
               b[7] = ΣφδσΔζιΠρα.D("ӢӢҮӎӘҫҳӕҴӈӳәҺӋӔӫӸӮԁҿӡӧӠӆҾҿԋӨԅӜӞӾԂԄԊӒԌӐӚԅӼԚԖԊԡԜӚԡԎӡԖԘԜԣԔӦӽԈԚԩԙԦԧԯԃԎԷӲԲӱԛӺӹԧ\u0530ԃ", (byte)66, 68);
               b[8] = πχσδΦΦνθΔπ.C("ӢӢҮӎӘҫҳӕҴӈӳәҺӋӔӫӸӮԁҿӡӲӽӅӂӻӘӅԀԂӬөӌԆӡԖԐӲӶӦԎӱԎӞԛӷӜԔӟӶӾԏԑԚӼԜԣԭԂԁԢԜԜԒӲԊԤԇӵԳԷԹԭԶԉԟՀԁԞԋԯԒՇԶԺՇԎԏ", (byte)66, 67);
               b[9] = μεςΩΔΣγν.E("ՐԲժԹՆՙ՛ԺռցյԼյարՁւջ՜ֆքպՑՒ", (byte)66, 69);
               b[10] = δΛψπξκσβγςα.E("ՎեպհժժյշտԹ\u0557ԻՀծւփ՛դՠշփփդկրսֈիղֈմդ", (byte)66, 69);
               b[11] = φδχεθοκψαλΛογλ.D("ӪҳӆӪӄӔӷӇӧӕһӠҺһһҺӥӐӦӿәӷӎӏ", (byte)66, 68);
               b[12] = πχσδΦΦνθΔπ.A("śŶĵƀŻśŘŞšŴſƀŽŜņŜťŭŬƆŤŇũųŏƃŒŰƐƎŚőŜũŷŪŵƢƏŲŬƘƆŸƆƟŜƅŨƮƮƤƫƫƋŪƥƶƂƟųŲƆƛŶƽƐſƶƻƽźƹƐǃƘƶƂƤǋƌƆǁƘƆǏƖƗ", (byte)66, 65);
               break;
            case 2:
               b[0] = θεωψξβΛσσ.F("Կ\u0558ՙՖյղ՞ԺռվՕՆ", (byte)66, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = βεξΠθρρςΔΦμ.F("ՋՀպՉէՒս\u0558\u0558սԽՎւջԽՏՕՄժիՙս֊լևցձկժՠփտ", (byte)66, 70);
         }
      }
   }
   ...
   private static int b(int var0) {
      if ((var0 & as) != 0) {
         throw new IllegalArgumentException(c<"㺀">(at, au ^ av) + var0);
      } else {
         return aw << var0;
      }
   }
