...
public class NLoginCore_086 {
   ...
   private static String[] ZKM_STR_B = new String[aa];
   ...
   private static String[] ZKM_STR_A = new String[NLoginCore_086.z];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_127.A("ÈĀýÝąďæąÍÎôďÕåčĕĘÒēÔùØû÷ėÛìĥąüāąýĪĭČç÷îįêăēĊîéĕùėİĈĉĳñďĵĒļĹığĘĄĹķĸėĠĹćĘŎņŅĮĠįņĲĴĐĚĭĻĩķĤĥ", (byte)9, 65);
               ZKM_STR_B[1] = NLoginCore_451.B("ĄÆçăçÏÐĂĊÓĈĔĐĂĊêěĆēĔéčäå", (byte)9, 66);
               ZKM_STR_B[2] = NLoginCore_446.D("хвЇЈНЙЪЧтцэИ", (byte)9, 68);
               ZKM_STR_B[3] = NLoginCore_076.D("ЉФгЊжМомвщёИ", (byte)9, 68);
               ZKM_STR_B[4] = NLoginCore_241.C("ϻгЁЉЋмймМяНФбЍиСтХѕдяжУФ", (byte)9, 67);
               ZKM_STR_B[5] = NLoginCore_384.F("ԵԒӽԓԖԋԮԘՁԾՂԍ", (byte)9, 70);
               ZKM_STR_B[6] = NLoginCore_559.F("ӹԖԓԠԁӾԬԖՇԸԺԍ", (byte)9, 70);
               ZKM_STR_B[7] = NLoginCore_110.B("ÞĄÿÄèèĀäÄÉĆÙ", (byte)9, 66);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_110.C("ЇпмМфюХфЌЍгюДФьєїБђГиЗкжіКЫѤфлрфмѩѬыЦжЭѮЩтђщЭШєиіѯчшѲаюѴёѻѸѰўїуѸѶѷіџѸцїҍ҅҄ѭѤѯ҄ѸҌѺѶѰѦѧҜѣѤ", (byte)9, 67);
               ZKM_STR_B[1] = NLoginCore_324.A("ĄÆçăçÏÐĂĊÓĈéîāÎĐôïÒéěçäå", (byte)9, 65);
               ZKM_STR_B[2] = NLoginCore_091.B("åØúċýËäÑÈÜëýéàÕČíûæĉýčäå", (byte)9, 66);
               ZKM_STR_B[3] = NLoginCore_433.D("лчодЋыЪкцЩєпдѓїЩїЭћЩИќУФ", (byte)9, 68);
               ZKM_STR_B[4] = NLoginCore_453.A("¼ôÂÊÌýúýÝĐÞĐÖăęĎĄĎĄþìçäå", (byte)9, 65);
               ZKM_STR_B[5] = NLoginCore_076.A("âÂċÈÞìÛĉÍßâĖĊêèñéćêĈç÷äå", (byte)9, 65);
               ZKM_STR_B[6] = NLoginCore_232.B("àĀËÌÞäíòâþðÏĊöĈāÌĈùĝþçäå", (byte)9, 66);
               ZKM_STR_B[7] = NLoginCore_183.A("āćýÝčþĈæĒĆĆÙ", (byte)9, 65);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_223.E("ԐԪԳԴӺԺӼԍԢԶԇԍ", (byte)9, 69);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_530.D("ІвФЈнНЉрЌьПИ", (byte)9, 68);
         }
      }
   }
}
