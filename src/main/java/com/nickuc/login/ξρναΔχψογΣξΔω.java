...
public class ξρναΔχψογΣξΔω {
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣφδσΔζιΠρα.E("ՂՏՎԑՑՍՈՑ՜ՋԘՖ՚ՓՖ՜Ԟࢮࢲࢯࢤ࢈ࢼࢾࢶࢫ࢜ࢸ\u088fࣅ", (byte)35, 69));
         }
   ...
   public static String ae() {
      return System.getProperty(c<"㺀">(p, q ^ r));
   }
   ...
   public static void c(int var0) {
      try {
         String var10001 = c<"㺀">(s & t, u).concat(c<"㺃">(v, w ^ x)).concat(c<"㺆">(y, z));
         Class[] var10002 = new Class[aa];
         var10002[ab] = int.class;
         Method var10000 = ΓΛθσφζςηκ.a(System.class, var10001, var10002);
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΣερμΔσατσκ.F("ԚԼԾԞՂաՙկ՛Ԫը՞լզԯՔնյխճխՂ", (byte)54, 70), ξρναΔχψογΣξΔω.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            πχσδΦΦνθΔπ.C("ҺӇӆ҉ӉӅӀӉӔӃҐӎӒӋӎӔҖࠦࠪࠧࠜࠀ࠴࠶\u082eࠣࠔ࠰ࠇ࠽ү", (byte)54, 67) + var1 + φΨαξωυθανΣφυκη.D("ґ", (byte)54, 68) + var2.toString(), var4
         );
      }
   }
   ...
   public static int u() {
      String var0 = ae();
      if (var0.startsWith(c<"㺀">(a, b ^ d))) {
         var0 = var0.substring(e, f);
      } else {
         int var1 = var0.indexOf(c<"㺃">(g, h ^ i));
         if (var1 != j) {
      ...
      if (var4.length() == 0) {
         throw new RuntimeException(c<"㺆">(m, n ^ o) + ae());
      } else {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = μζξτΩσσφυδεπλΨ.C("ё҄йїѕс҉ъ҅ѿ҅є", (byte)29, 67);
               b[1] = πηγμΣΔκκ.F("ԍՏԎԢԐԮԳԧՙՑՊԡ", (byte)29, 70);
               b[2] = ξψθρΣΠΣς.D("јѯѿѻѵ҄ѴфѬ҈ъ҆ыяҀѴѵѥєїҊђѱљҌғѰҔҍҕѻѾҥјѥҀқҗҔқ҆Үң҆҈ҤҮѯұҏ҆ҶҶҒѿҀ", (byte)29, 68);
               b[3] = πηγμΣΔκκ.F("ԐԠԐԾԦՌՐԶԶՕՋՓՓ՝ՏՒԭԵԾԿԺՕԬԭ", (byte)29, 70);
               b[4] = φΨαξωυθανΣφυκη.C("ѢњѨффѓѨљѮѭює", (byte)29, 67);
               b[5] = δΛψπξκσβγςα.A("ĳćďģģóıĴĒôĔā", (byte)29, 65);
               b[6] = πηγμΣΔκκ.D("ѓфф҆҄҈҆тїѶѧє", (byte)29, 68);
               break;
            case 1:
               b[0] = ΨΦνΨΦωυΩνβςμ.F("ԌԬԍԮԌԳՂԧԲԚՆԡ", (byte)29, 70);
               b[1] = βθκςνθΩθυμςτκχ.A("òćþìČēðĢĘęČā", (byte)29, 65);
               b[2] = βεξΠθρρςΔΦμ.E("ԥԼՌՈՂՑՁԑԹՕԗՓԘԜՍՁՂԲԡԤ\u0557ԟԾԦՙՠԽա՚բՈՋղԥԲՍըդաըՓջձՇՔ\u0558խոՠՏԿծ՛ՐփաՁֆփիֈՁ\u0558Չ", (byte)29, 69);
               b[3] = χφπρψπφΦθμπ.A("ðĀðĞĆĬİĖĖĵĭĎđķĞĘďĕěĄłĵČč", (byte)29, 65);
               b[4] = δΛψπξκσβγςα.B("īĳāĂğðćĊĮĐĶā", (byte)29, 66);
               b[5] = πχσδΦΦνθΔπ.E("ԛԬՑՂԦՁԷՊԨ՚Լԡ", (byte)29, 69);
               b[6] = ΠΛΨοδΩσμνΛγΦφβς.B("êĳāđčĔĩĆñĬĐā", (byte)29, 66);
               break;
            case 2:
               b[0] = ςΦζσμτΓσ.B("ģÿĮĶāïĤĊõĺĩöĮĐĎđĂďÿąļĵČč", (byte)29, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = ςπυηννναΣ.F("ԲՃԽՇԕԑԥԯՐԕ\u0530\u0530ԙՑԙԟԛ\u0557ԬԾզԵԷՙԡըԤլՈԻՊՀ", (byte)29, 70);
         }
      }
   }
}
