...
public class ξπχιβρμογιω {
   ...
   private static String[] a = new String[ξπχιβρμογιω.n];
   ...
   private static String[] b = new String[ξπχιβρμογιω.o];
   ...
   private static final οΨημζξξνς a = new οΨημζξξνς();
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(πηγμΣΔκκ.A("ŤűŰĳųůŪųžŭĺŸżŵŸžŀӐӓӛӎӈӘӔӘӍӔӥ", (byte)65, 65));
         }
   ...
   public static Location a(String var0) {
      try {
         ...
         throw new RuntimeException(c<"㺀">(k, l ^ m), var17);
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = οΩνΩρωλΨηΛδωδ.C("ӣӟӇӻӟӝӛԍԍӰԌԐӚԈӝԕӓӠӶӯӵӵӭԈӫԝӫөӶԤӹԏӵӦӽԝԞԘԘԉԘԂӫӵ", (byte)72, 67);
               b[1] = πχσδΦΦνθΔπ.A("ťšŉŽšşŝƏƏŲƌŦƏſƕƋŹŔţƄƛŰƔųƉƀŰƖŜŴƎƤŧſƙŵũƕƛƚŰƃưŷ", (byte)72, 65);
               break;
            case 1:
               b[0] = ξψθρΣΠΣς.A("ťšŉŽšşŝƏƏŲƎƒŜƊşƗŕŢŸűŷŷůƊŭƟŭūŸƦŻƑűƃƞƆƤƗƇƐƬƚƎŷ", (byte)72, 65);
               b[1] = ςπυηννναΣ.A("ťšŉŽšşŝƏƏŲƌŦƏſƕƋŹŔţƄƛŰƔųƉƀŰƖŜŴƎƤŤťƠƫƥƍƄƈżŨưŷ", (byte)72, 65);
               break;
            case 2:
               b[0] = ΨφιωσρΓδΔθ.C("ӂӱӗԊӔәӛԁӢӎԍӢӎӤӨӫԋӶӳӲӰӣӠӡ", (byte)72, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = πχσδΦΦνθΔπ.F("ՖսՙՔնտջ՜ե՟Ղջ։ՔՋՙնՖէՇթ՚֑֒ւֈօՐՑ\u0590ջ՜", (byte)72, 70);
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ξψθρΣΠΣς.B("íďđñĕĴĬłĮýĻıĿĹĂħŉňŀņŀĕ", (byte)35, 66), ξπχιβρμογιω.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ξψθρΣΠΣς.C("ҁҎҍѐҐҌ҇ҐқҊїҕҙҒҕқѝ߭߰߸߫ߥߵ߱ߵߪ߱ࠂѴ", (byte)35, 67) + var1 + οΩνΩρωλΨηΛδωδ.F("ԙ", (byte)35, 70) + var2.toString(), var4
         );
      }
   }
   ...
   public static String a(Location var0) {
      try {
         ...
         throw new RuntimeException(c<"㺀">(e, f), var16);
      }
   }
}
