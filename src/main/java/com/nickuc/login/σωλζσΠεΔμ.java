...
public class σωλζσΠεΔμ extends ξΠτΣτγαψηρψΓΠτξ {
   ...
   private static String[] e = new String[σωλζσΠεΔμ.gg];
   ...
   private static String[] f = new String[σωλζσΠεΔμ.gh];
   ...
   private static String a(int var0, long var1) {
      ...
      if (e[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(δΛψπξκσβγςα.B("ƒƟƞšơƝƘơƬƛŨƦƪƣƦƬŮԃԊӽӹԇӥӻӛԄ", (byte)88, 66));
         }
   ...
   @Override
   protected File b() {
      return this.m.b().a() == κιββωσγχςΣβΠΣδ.c ? new File(this.m.c().getParentFile().getParentFile(), c<"㺀">(ao & ar, at)) : super.b();
   }
   ...
   protected void c(τφθχΔαΣγτφς var1) {
      String var2 = var1.a(c<"㺀">(bd, be ^ bh), c<"㺃">(bi, bk ^ bm)).toUpperCase(Locale.ENGLISH);
      int var4 = bn;
      switch (var2.hashCode()) {
         case -1841605620:
            if (var2.equals(c<"㺆">(bp, br ^ bs))) {
               var4 = bu;
            }
            break;
         case 73844866:
      ...
      switch (var4) {
         case 0:
            File var5 = new File(this.b(), c<"㺌">(cc, cd ^ cf));
            this.d = ΩαυΩξτκΛ.a(this.m, var5, new Properties());
            break;
         case 1:
            int var6 = var1.a(c<"㺏">(cg & ch, ci), cj);
            String var7 = var1.b(c<"㺒">(cm, cn ^ cp));
            String var8 = var1.b(c<"㺕">(cr, ct));
            String var9 = var1.b(c<"㺘">(cv, cw ^ cx));
            String var10 = var1.b(c<"㺛">(cy, cz ^ dc));
            boolean var11 = var1.d(c<"㺞">(dd & de, df));
            Properties var12 = new Properties();
            var12.put(c<"㺡">(dh, di ^ dj), Boolean.toString(var11));
            this.d = ςιγρτΩλαγπβρ.b(this.m, ΔγΨνςχιδκτςες.a(var7, var6, var8, var9, var10, var12));
      }

      this.E = var1.d(c<"㺤">(dk, dm ^ dp));
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               f[0] = πηγμΣΔκκ.E("յ֝թ֚֝՛֝հփ՞֚չ֊֙քսժզէ\u058cֲ֦չպ", (byte)106, 69);
               f[1] = ςΦζσμτΓσ.D("ԽԹՈՌՈԣՇԿԼՁՁՇթնԳ՛՚ձԺՙյՙՆՇ", (byte)106, 68);
               f[2] = πψυκΠΨμΛΩβΣφμφσ.F("Ֆ՞֘՜֢֥մֆև֧֚ծ", (byte)106, 70);
               f[3] = ντθΔζβΔζ.D("ՈԭՆԬգաՐՍՈՎԲԯԷԫԲձթՕՎՇցտՆՇ", (byte)106, 68);
               f[4] = μζξτΩσσφυδεπλΨ.B("ƻǉƊƤǃƐƩƠƼƟǈƛ", (byte)106, 66);
               f[5] = οοθδΨιοΦΠβδζ.F("։ս֎ի֏֓՝ց֔ց֛ծ", (byte)106, 70);
               f[6] = ςπυηννναΣ.F("պ՟\u058c֣֖֗֡ադ\u0590֣ծ", (byte)106, 70);
               f[7] = θεωψξβΛσσ.B("ƟǌƙƎƠǀƞƨƔƓǇƎƦǙǍǐƫƦƻǇƾǓǟǕǙǀƴǟưǙơǌ", (byte)106, 66);
               f[8] = ςΦζσμτΓσ.B("ƨƍƦƌǃǁưƭƨƮƒƖǐǁƴƦǋƔƲƱǎƩƦƧ", (byte)106, 66);
               f[9] = ΣδτΠνεγοΓορητ.A("ƨƍƦƌǃǁưƭƨƮƑǍǅƣǊƤƗǉǚƽƼƮǡƴǖǑǎƻƿƷǔƤ", (byte)106, 65);
               f[10] = ΨΦνΨΦωυΩνβςμ.B("ƨƍƦƌǃǁưƭƨƮƓƑǂƫƫƶƺǘƬƙǝƹǠƢǅƟǟƤƟƥƽǚ", (byte)106, 66);
               f[11] = ςπυηννναΣ.A("ƨƍƦƌǃǁưƭƨƮƒǃƔǗƯǚƶǖǜǚƙƹƦƧ", (byte)106, 65);
               f[12] = φΨαξωυθανΣφυκη.F("ջՠչ՟֖֔փրջցզ֘շթզժք֊֑֫֯֠֍ձձ֒յִָֻ֜֞", (byte)106, 70);
               f[13] = οοθδΨιοΦΠβδζ.A("ƨƍƦƌǃǁưƭƨƮƔơǑưǓƗǝƾƪƹƲǙǐǣƽǁǗǟǛǘƵǄ", (byte)106, 65);
               f[14] = ΣερμΔσατσκ.D("գԼԺԬՆ՟ՠգՂյըԻ", (byte)106, 68);
               f[15] = βθκςνθΩθυμςτκχ.A("ƌƮƫƚǐǌƈǎǉƬƕƮƊƩƌƤǉƚǔƙƭƳǗǋƼǢǏǆƞƢǧƴǈǈǆǚǏƣǬǅǜǋƾǦƱǑǎǖǪǖǖƺǀǉǆǇ", (byte)106, 65);
               f[16] = ΦδφπθΩΩλζξ.C("\u0558՜դխգկԼԬԭՈԱԻ", (byte)106, 67);
               f[17] = δΛψπξκσβγςα.C("զ\u0558զՏՈժՓԮլՒՆԻ", (byte)106, 67);
               f[18] = χφπρψπφΦθμπ.B("ƼƖƝƋƏǍǅǌƿǔǄƛ", (byte)106, 66);
               f[19] = ΣερμΔσατσκ.D("Ս\u0557ԪԡՆԱՆհՋյԵՓՓՕՉՆ՝չնչպՙՆՇ", (byte)106, 68);
               f[20] = ςπυηννναΣ.F("֚ՠ֡փք֞՜փկ֖֔֔ց֡֬֎֧֟իֆ֪\u058cչպ", (byte)106, 70);
               f[21] = οΩνΩρωλΨηΛδωδ.A("ǄƕƛƯƘƣƎǉƧƽǗƿƲǅƮǖƯƸǘƜƗƩƦƧ", (byte)106, 65);
               f[22] = θεωψξβΛσσ.E("տՖ՜Քկւ֦֒ևղցծ", (byte)106, 69);
               f[23] = βθκςνθΩθυμςτκχ.D("ԻՖԩէդՌեՅ՞ԿԱԻ", (byte)106, 68);
               f[24] = θεωψξβΛσσ.A("ƛƉƣƅƎƮƱƞƎǀƞƛ", (byte)106, 65);
               f[25] = ΨΦνΨΦωυΩνβςμ.C("ԸբԿՉԾ՟ԯՓԳաԲթգէՊխշնՎԿԽՉՆՇ", (byte)106, 67);
               f[26] = ιΠοθΩΦξκ.D("ժԵկ՛ԢժՋժՔնՖԻ", (byte)106, 68);
               break;
            case 1:
               f[0] = ιΠοθΩΦξκ.B("ƢǊƖǊǇƈǊƝưƋǄǕƶǍƣǔƻǑǚǓǀƩƦƧ", (byte)106, 66);
               f[1] = ΠΛΨοδΩσμνΛγΦφβς.A("ƝƙƨƬƨƃƧƟƜơƞơƫƵǈƩƺǗƙǟƻǑƘƿǣǎƱǨǤǩƼǡ", (byte)106, 65);
               f[2] = πψυκΠΨμΛΩβΣφμφσ.C("Ձԭլ\u0557ԩԾժՌՍԳըԻ", (byte)106, 67);
               f[3] = δΛψπξκσβγςα.F("ջՠչ՟֖֔փրջցդ֟\u058bփ֠պ֙չջ֧ղְ\u058bղ֥֚֡ֈշ֊ջ֓", (byte)106, 70);
               f[4] = οοθδΨιοΦΠβδζ.F("՜ռ֗՚֣տչ՝֕գգջ֝դ֪\u058bէ֥իլփ֢չպ", (byte)106, 70);
               f[5] = οΩνΩρωλΨηΛδωδ.C("ԾԪՠԹՈկՇ՞՝ՁեՈՏՑՅռՕճԴնՍտՆՇ", (byte)106, 67);
               f[6] = ζοηκορΦνΣθγΩ.E("թպ\u0558՜Օ֛վօ֏֛՟բյտ՟ե֑֣֡֫֊ֲչպ", (byte)106, 69);
               f[7] = ντθΔζβΔζ.B("ƟǌƙƎƠǀƞƨƔƓǇƎƦǙǍǐƫƦƻǇƾǝưǜƣƹǡƦǇǁƴǥ", (byte)106, 66);
               f[8] = πηγμΣΔκκ.B("ƨƍƦƌǃǁưƭƨƮƔƗƸƓƖǐǜƱǑƽǒƴǎǎǥǄƯƶǢƻƷƵ", (byte)106, 66);
               f[9] = βεξΠθρρςΔΦμ.D("ՈԭՆԬգաՐՍՈՎԱխեՃժՄԷթպ՝՜\u0558Թի՚Լդ\u0557։ռՆճ", (byte)106, 68);
               f[10] = μζξτΩσσφυδεπλΨ.E("ջՠչ՟֖֔փրջցզդ֕վվ։֍֫տլְֶ֟ևն֨֘֎֕նֵ֜", (byte)106, 69);
               f[11] = ΣερμΔσατσκ.B("ƨƍƦƌǃǁưƭƨƮƒƑƳǙǅƸưǎƮƮǐǒǎƺǜƵǁǓǂƟƜƣ", (byte)106, 66);
               f[12] = ςπυηννναΣ.C("ՈԭՆԬգաՐՍՈՎԳեՄԶԳԷՑ\u0557ոռ՞ՠՂԼւխՄփ\u0557ՙՆլ", (byte)106, 67);
               f[13] = χΠξΦιζΨΣωΦσΨζ.E("ջՠչ՟֖֔փրջցէմ֤փ֦ժְ֑ս\u058cօ֪֢֓֍ֺ֣յֶ\u0590֫ֈ", (byte)106, 69);
               f[14] = ΣδτΠνεγοΓορητ.B("ǀǄǇƞƉǐƉƋǏƵƲơǃưƸƖǆƳǛƷƬƹƦƧ", (byte)106, 66);
               f[15] = ΨφιωσρΓδΔθ.B("ƌƮƫƚǐǌƈǎǉƬƕƮƊƩƌƤǉƚǔƙƭƳǗǋƼǢǏǆƞƢǧƴǈǈǆǚǏƣǬǅǜǋǁǔǤǚǪǸǬǻǚǚǯǯǆǇ", (byte)106, 66);
               f[16] = ΦδφπθΩΩλζξ.C("ԢծՌԼԾԣԪՇԫՊմԻ", (byte)106, 67);
               f[17] = ΨφιωσρΓδΔθ.B("ƝƊƋƧƜǅǒƉƎǁƌƳǓƒǍǇƛƏƘǓƽǏƦƧ", (byte)106, 66);
               f[18] = ζοηκορΦνΣθγΩ.D("ԵԻծԨԢ՝Փմՠդ\u0530լՇՊԴՌ\u0557ԷվԱժՉՆՇ", (byte)106, 68);
               f[19] = ζοηκορΦνΣθγΩ.C("Ս\u0557ԪԡՆԱՆհՋյԶկԮնԺդղխ՟շՕՙՆՇ", (byte)106, 67);
               f[20] = ΨΦνΨΦωυΩνβςμ.B("ǇƍǎưƱǋƉưƜǃǂƷƴƭǘƔǅƝƵƫƞƹƦƧ", (byte)106, 66);
               f[21] = ΨΦνΨΦωυΩνβςμ.D("դԵԻՏԸՃԮթՇ՝նԴչլիՕՙ՚ԾչյՙՆՇ", (byte)106, 68);
               f[22] = πψυκΠΨμΛΩβΣφμφσ.B("ƺơƘƸƼǑƺƤǏƍƕƛ", (byte)106, 66);
               f[23] = ΨφιωσρΓδΔθ.E("՚֗\u0590֔բձկ\u0558֜֕ՠդնեְ֪֤֚ֈտճ֢չպ", (byte)106, 69);
               f[24] = πψυκΠΨμΛΩβΣφμφσ.D("Ո՜գիԫԣՁդբԾԵԻ", (byte)106, 68);
               f[25] = ΨΦνΨΦωυΩνβςμ.F("ի֕ղռձ֒բֆզ֔ե֛զռշժֱ֣ը֜ճռչպ", (byte)106, 70);
               f[26] = ζβησεθωυγτ.E("ղ\u0590֢֝֍վֆևմՠ֛ծ", (byte)106, 69);
               break;
            case 2:
               f[0] = χΠξΦιζΨΣωΦσΨζ.F("՛խ֙րհ֔\u0557ո֖ճ֩րճ֠գ֊։֛վ֒֜ռչպ", (byte)106, 70);
            case 3:
            default:
               break;
            case 4:
               f[0] = οοθδΨιοΦΠβδζ.B("ƥƿƧƺǂƈƪƽƵƪƈƵƑƥƴǋƎƾƕǚƱƹƦƧ", (byte)106, 66);
         }
      }
   }
   ...
   protected void b(ResultSet var1) {
      this.r = var1.getString(c<"㺀">(dq, ds));
      String var2 = var1.getString(c<"㺃">(dt, dv ^ dy));
      if (!var2.isEmpty() && var2.charAt(var2.length() - dz) == ea) {
         var2 = var2.substring(ec, var2.length() - ed);
      }

      UUID var3 = λΣσΣκΓβΠΨ.c(var2);
      boolean var4 = var1.getBoolean(c<"㺆">(ek, el ^ eo));
      String var5 = var1.getString(c<"㺉">(eq, es));
      if (!var5.isEmpty() && var5.charAt(var5.length() - eu) == ex) {
         var5 = var5.substring(ey, var5.length() - fa);
      }

      UUID var6 = var4 ? λΣσΣκΓβΠΨ.c(var5) : null;
      String var7 = var1.getBoolean(c<"㺌">(fb, fc)) ? var1.getString(c<"㺏">(fd, ff)) : null;
      if (var7 != null && !var7.startsWith(c<"㺒">(fh, fi ^ fj))) {
         if (!var7.startsWith(c<"㺕">(fl, fn ^ fo))) {
            this.e(this.r, var7, null);
            return;
         }

         String[] var8 = var7.split(c<"㺘">(fp, fq ^ ft));
         String var9 = var8[fv];
         String var10 = var8[fw];
         var7 = c<"㺛">(fz, ga ^ gb) + var10 + c<"㺞">(gc, ge ^ gf) + var9;
      }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΦδφπθΩΩλζξ.C("ңӅӇҧӋӪӢӸӤҳӱӧӵӯҸӝӿӾӶӼӶӋ", (byte)66, 67), σωλζσΠεΔμ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            οΩνΩρωλΨηΛδωδ.E("ածխ\u0530հլէհջժԷյչղյջԽ࣒ࣙ࣌ࣈࣖࢴ࣊ࢪ࣓Ւ", (byte)66, 69) + var1 + μεςΩΔΣγν.B("Ľ", (byte)66, 66) + var2.toString(), var4
         );
      }
   }

   public σωλζσΠεΔμ(ΨγημιδξΓτοθαζ var1) {
      super(var1, ΓεοκπνΨωπτ.r, c<"㺀">(e, p ^ q), c<"㺃">(y, ab));
      this.E = (boolean)al;
   }
}
