...
public enum ηεΓβΦχΩψςηδΠ {
   b((boolean)ηεΓβΦχΩψςηδΠ.n),
   c((boolean)ηεΓβΦχΩψςηδΠ.s),
   d((boolean)ηεΓβΦχΩψςηδΠ.x),
   e((boolean)ηεΓβΦχΩψςηδΠ.ac);

   private final boolean aQ;
   private static String[] a = new String[ηεΓβΦχΩψςηδΠ.h];
   private static String[] b = new String[ηεΓβΦχΩψςηδΠ.i];
   ...
   @Generated
   private ηεΓβΦχΩψςηδΠ(boolean var3) {
      this.aQ = var3;
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΨΦνΨΦωυΩνβςμ.D("ӮԐԒӲԖԵԭՃԯӾԼԲՀԺԃԨՊՉՁՇՁԖ", (byte)91, 68), ηεΓβΦχΩψςηδΠ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            χφπρψπφΦθμπ.F("պևֆՉ։օր։֔փՐ֎֒\u058b֎֔Ֆࣟࣞࢽࣲ࣒ࣦ࣓ࣝࣴࣗࣷࣨծ", (byte)91, 70) + var1 + μεςΩΔΣγν.C("Ԁ", (byte)91, 67) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣφδσΔζιΠρα.D("ғҠҟѢҢҞҙҢҭҜѩҧҫҤҧҭѯ߸߷ߖ߶߫ࠍ߰ࠐࠋࠁ߿߬", (byte)41, 68));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΣφδσΔζιΠρα.F("րՔը՞Ջբ՞և՜Մօ\u0558", (byte)84, 70);
               b[1] = λΣΩσμφγχ.E("Իւը\u058cֈևևՌվթէ\u0558", (byte)84, 69);
               b[2] = ΠΛΨοδΩσμνΛγΦφβς.F("վՖ֊իպՠ֊Ջժռ։\u0558", (byte)84, 70);
               b[3] = ΦδφπθΩΩλζξ.F("քՔ֊֍չն՜ռ\u0590֓֍\u0558", (byte)84, 70);
               break;
            case 1:
               b[0] = πηγμΣΔκκ.F("պ֊քՔչֆիՇեռբզֈՐ\u058cՑկ։փֈձ֜գդ", (byte)84, 70);
               b[1] = ΦδφπθΩΩλζξ.C("ӼԤԀӧԍԙԈӹԁԒ\u0530ӽԫӲӵԙӰԺԚԓԦԗԄԅ", (byte)84, 67);
               b[2] = μεςΩΔΣγν.E("՛Ք\u0558։ֆշՆ՟ՎՊՅփՒխֈմՏՌհ\u0557պնգդ", (byte)84, 69);
               b[3] = φΨαξωυθανΣφυκη.F("ձՖ՚\u0558լ՟ՎՐը֎Վ\u0558", (byte)84, 70);
               break;
            case 2:
               b[0] = ΨΦνΨΦωυΩνβςμ.E("ցևւ\u058cժՠա\u0558ՙ֒ս\u0590֓թ֒Փ֏֗Ւևէզգդ", (byte)84, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = μζξτΩσσφυδεπλΨ.E("զցը՚գռջֈ\u0590ևլ֎օխՖ֙ձՒյխխխշՒ֞\u058c֖֤֝֠փա", (byte)84, 69);
         }
      }
   }

   public static ηεΓβΦχΩψςηδΠ a(String var0) {
      String var1 = var0.toLowerCase();
      boolean var2 = c(βδΔφμπθθγ.k(), var1);
      boolean var3 = c(βδΔφμπθθγ.l(), var1);
      if (var2 && var3) {
         return e;
      } else if (var2) {
         return b;
