...
public abstract class πργηπνπτΨζξσΓΓ implements LoaderBootstrap, ΦΦδΓθΣηεΦποχθ, εηχβγρΦβΦΛκγΦοδ<BungeeLoader> {
   ...
   private static String[] b = new String[πργηπνπτΨζξσΓΓ.bk];
   ...
   private static Method l = ΓΛθσφζςηκ.a(ProxyServer.class, c<"㺀">(πργηπνπτΨζξσΓΓ.bl, πργηπνπτΨζξσΓΓ.bm ^ bn));
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣδτΠνεγοΓορητ.C("ԂԏԎӑԑԍԈԑԜԋӘԖԚԓԖԜӞࡰࡲࡥࡪࡴࡲࡶࡻࡠ\u086fࡸࡾࡏࡐ", (byte)78, 67));
         }
   ...
   public void c() {
      this.Q = (boolean)d;
      ΔοΠΓλψγβςοΦ.a(this.a);
   }

   public πργηπνπτΨζξσΓΓ(BungeeLoader var1, String var2, καΦζθθυυεφΦγ var3) {
      this.a = var1;
      this.a = new ωγΔυΣΛωρΓν(this);
      this.b = new πηλΣρηΛρλΨβχλ(var2, var1.getVersion(), var3, this);
      this.b = new ΔασςΦψΨΩσσξκκμω(var1.getLogger());
   }

   protected void O() {
      if (this.b.am()) {
         this.b.<ΓδψΩκαδδμηβφυδ>a().O();
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΠΛΨοδΩσμνΛγΦφβς.F("֏ր֑՞ֈ֗ձհհ֓ժոզ\u0557֍՜֛ժ֜դֆծիլ", (byte)92, 70);
               b[1] = ΠΛΨοδΩσμνΛγΦφβς.D("ԌԯԁՄԝӿՀՁԖԕԋԑ", (byte)92, 68);
               b[2] = φδχεθοκψαλΛογλ.C("ԓԙԵԼԎԔԹԆԳԝԌԸԩԬՂԎԠՔԤՆԕԯԜԝ", (byte)92, 67);
               b[3] = θεωψξβΛσσ.A("ƤƈƇƭƲƁŮƀŲƌƛƗƥźƾƨŸƽƠǂſƍƊƋ", (byte)92, 65);
               b[4] = χΠξΦιζΨΣωΦσΨζ.F("սՐր֑ՑդզՒեքէՠ", (byte)92, 70);
               b[5] = λΣΩσμφγχ.A("ƀƙŭŽƃųƨƅƃƉƸſ", (byte)92, 65);
               b[6] = οΩνΩρωλΨηΛδωδ.A("ƛƈƅƱſſƉƖƕŹƸſ", (byte)92, 65);
               b[7] = οΩνΩρωλΨηΛδωδ.C("ԶԸԾӾԿԤԽԙԦԬԾԑ", (byte)92, 67);
               b[8] = θεωψξβΛσσ.F("ՃՎբթխհյֆՋՖ֑ՠ", (byte)92, 70);
               b[9] = βεξΠθρρςΔΦμ.E("֏ր֑՞ֈ֗ձհհ֓ժոզ\u0557֍՜֛ժ֜դֆծիլ", (byte)92, 69);
               b[10] = θεωψξβΛσσ.B("ƃƂƮƛŬůƫƘƧƥƧƬƊůƆƯŲƚƌưƽƳƊƋ", (byte)92, 66);
               b[11] = ςΦζσμτΓσ.D("ԿԮԎԓԡԦԣՆԶԺՊԑ", (byte)92, 68);
               b[12] = φΨαξωυθανΣφυκη.B("ƜůƟưŰƃƅűƄƣƆſ", (byte)92, 66);
               b[13] = βεξΠθρρςΔΦμ.E("ՍՋճ՝֏՟ՏիճՔլ֓պՕ֕֓\u058bբփ֓՞֔իլ", (byte)92, 69);
               b[14] = ΨφιωσρΓδΔθ.A("ŬŪƒżƮžŮƊƒųƌŹƙƙƓƩƟƞƠưƤƝƊƋ", (byte)92, 65);
               b[15] = πηγμΣΔκκ.E(
               ...
               break;
            case 1:
               b[0] = ΨΦνΨΦωυΩνβςμ.A("ƮƟưŽƧƶƐƏƏƲƆűƖƺƼƧƽƢſƜƘǃƊƋ", (byte)92, 65);
               b[1] = ξψθρΣΠΣς.F("՞օևՐ֑֒ՒծխղփզխՕ֏՛ի֡ի֖֞վիլ", (byte)92, 70);
               b[2] = ςΦζσμτΓσ.E("բըք\u058b՝գֈՕւլՍՕհ֓ՙֈւ՜ձա՞վիլ", (byte)92, 69);
               b[3] = πψυκΠΨμΛΩβΣφμφσ.D("ԶԚԙԿՄԓԀԒԄԞԴԮԢԟԎՅԭԊՐԋԴԟԜԝ", (byte)92, 68);
               b[4] = φδχεθοκψαλΛογλ.C("ԠԺԄՁՁԢԤԝԁԘԠԑ", (byte)92, 67);
               b[5] = ζβησεθωυγτ.D("ԻԿԡԗԀӽՈԺԖԹԜԑ", (byte)92, 68);
               b[6] = βθκςνθΩθυμςτκχ.E("՞\u058c֏հվց֏ՐՐեշՠ", (byte)92, 69);
               b[7] = πηγμΣΔκκ.A("ƥƩũƋƍƋƊƮƉƈƚƻƆưƟƪžźƼƱƟƍƊƋ", (byte)92, 65);
               b[8] = φΨαξωυθανΣφυκη.D("ӸԾӼԐԹӾԹӻՈՈԾԑ", (byte)92, 68);
               b[9] = οΩνΩρωλΨηΛδωδ.A("ƮƟưŽƧƶƐƏƏƲƆƛƝƕƊƬƚźưƴƮƍƊƋ", (byte)92, 65);
               b[10] = ΣφδσΔζιΠρα.E("դգ֏ռՍՐ\u058cչֈֆօք֏Րֈ՛֗փ֤֑նվիլ", (byte)92, 69);
               b[11] = ΣερμΔσατσκ.C("ԘӼԬԂԜԽԝԻՈՋԠԑ", (byte)92, 67);
               b[12] = ΨΦνΨΦωυΩνβςμ.B("ƤƊƜƝƞƠƭŷűŲƴſ", (byte)92, 66);
               b[13] = μζξτΩσσφυδεπλΨ.B("ŬŪƒżƮžŮƊƒųƌƦƳƗƆƘǁŸƔƠƁƎƝƺƘƞǅǊƊƝǆƪ", (byte)92, 66);
               b[14] = πχσδΦΦνθΔπ.B("ŬŪƒżƮžŮƊƒųƊƏŶƊƾƑƎžƯƸƲƍƊƋ", (byte)92, 66);
               b[15] = φδχεθοκψαλΛογλ.E(
               ...
               break;
            case 2:
               b[0] = οΩνΩρωλΨηΛδωδ.A("ŦżƌƋŲƵƍƅơƸƍŵƶƇƼƵƙƻƷƕưƍƊƋ", (byte)92, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = πχσδΦΦνθΔπ.F("՝՜՟էյ֖ծքՒ֑֛֔վջ՝֍\u0557֒՚֥սվիլ", (byte)92, 70);
         }
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  πργηπνπτΨζξσΓΓ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ΦδφπθΩΩλζξ.F("ԝԿՁԡՅդ՜ղ՞ԭիակթԲ\u0557չոհնհՅ", (byte)57, 70), πργηπνπτΨζξσΓΓ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζοηκορΦνΣθγΩ.B("ŔšŠģţşŚţŮŝĪŨŬťŨŮİӂӄҷҼӆӄӈӍҲӁӊӐҡҢŊ", (byte)57, 66) + var1 + οΩνΩρωλΨηΛδωδ.A("ī", (byte)57, 65) + var2.toString(), var4
         );
      }
   }
   ...
   public ΠμυΛλδπι a(boolean var1) {
      return (ΠμυΛλδπι)this.b.b(var1);
   }
   ...
   static {
      b();
      if (l == null) {
         l = ΓΛθσφζςηκ.a(ProxyServer.class, c<"㺃">(bp, bq ^ br));
      }

      if (l == null) {
         throw new IllegalArgumentException(c<"㺆">(bt & bu, bv));
      }
   }
   ...
   public Object a(int var1) {
      switch (var1) {
         case 0:
            ...
            try {
               τφθχΔαΣγτφς var14 = new τφθχΔαΣγτφς(new File(this.c().getParentFile().getParentFile(), c<"㺀">(e & f, g)));

               for (String var18 : var14.a(c<"㺃">(h & i, j))) {
                  String var6 = var14.b(c<"㺆">(k & l, m) + var18 + c<"㺉">(n, o ^ p));
                  if (var6 != null && !var6.isEmpty()) {
                     String[] var7 = var6.split(c<"㺌">(q, r ^ s));
                     String var8 = var7[t];
                     int var9 = var7.length > u ? ελληλφαΔλα.a(var7[v], w) : x;
            ...
            for (InetSocketAddress var19 : var13.values()) {
               ...
               if (!var19.isUnresolved()) {
                  ...
                  var21 = !var22.isLoopbackAddress() && !var22.isAnyLocalAddress() && !γντωΩλβκν.a.b(var22) && !γντωΩλβκν.b.b(var22) && !γντωΩλβκν.c.b(var22)
                     ? ac
                     : ab;
               ...
               if (var15.length() > 0) {
                  var15.append(c<"㺒">(ag, ah ^ ai));
               }

               if (var21 != 0) {
                  var15.append(c<"㺕">(aj, ak ^ al));
               } else {
                  var15.append(var20);
               }

               var15.append(c<"㺘">(am, an ^ ao));
         ...
         case 1:
            try {
               τφθχΔαΣγτφς var2 = new τφθχΔαΣγτφς(new File(this.c().getParentFile().getParentFile(), c<"㺛">(ap, aq ^ ar)));
               Collection var3 = var2.d(c<"㺞">(as & at, au));
               if (var3 != null && !var3.isEmpty()) {
                  String var4 = (String)((Map)var3.iterator().next()).get(c<"㺡">(aw, ax ^ ay));
                  if (var4 != null && !var4.isEmpty()) {
                     String[] var5 = var4.split(c<"㺤">(ba, bb ^ bc));
                     return var5.length > bd ? ελληλφαΔλα.a(var5[be], bf) : bg;
                  }
   ...
   protected void i() {
      if (this.b.am()) {
         this.b.<ΓδψΩκαδδμηβφυδ>a().i();
      }
   }

   protected void T() {
      if (this.b.am()) {
         this.b.<ΓδψΩκαδδμηβφυδ>a().T();
      }
   }
}
