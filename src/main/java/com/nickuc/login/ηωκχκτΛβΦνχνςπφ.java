...
public class ηωκχκτΛβΦνχνςπφ implements Iterator<AccountData> {
   ...
   private static String[] b = new String[ηωκχκτΛβΦνχνςπφ.ah];
   ...
   private static String[] a = new String[ηωκχκτΛβΦνχνςπφ.ag];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΣδτΠνεγοΓορητ.D("Ѩях҆ѓҔѡѯ҈ѥ҇ѸѳѾҒҖ҂ҞѰѬѳѾѲѥҚѿҪ҃ѬҖҍҬҁ҅Ҟң҃҄ѲҹҗѳҖҌҬҫҺ҈ғҪҾҬҵҜҨӅ҆҄ҙӀҟҙҎ҉", (byte)33, 68);
               b[1] = χΠξΦιζΨΣωΦσΨζ.E("ՌԔՌԩԩԺԬՓՕԪՈԞԱ՛\u0530ՄաՐ\u0557ՙՓիԨԨ\u0557ԿՌ՜եկիՔ", (byte)33, 69);
               b[2] = ΣφδσΔζιΠρα.B("ñģĥûēħþīĪēöĘĳŁİĴĦŊĚŋĥĺĈĐőěīĤĔīŇįİđĭĜľŋĬĚŒōńĩ", (byte)33, 66);
               b[3] = χΠξΦιζΨΣωΦσΨζ.C("Ѩях҆ѓҔѡѯ҈ѥ҇ѸѳѾҒҖ҂ҞѰѬѳѾѲѥҚѿҪ҃ѬҖҍҬҝҞ҆ѮҝѳҤѳ҆ҰғѸѵҝҒҡҸғҴҷҭҞҋҌ", (byte)33, 67);
               b[4] = ιΠοθΩΦξκ.D("҇я҇ѤѤѵѧҎҐѥ҃љѬҖѫѿҜҋҒҔҎҦѣѣҒѺ҇җҠҪҦҏ", (byte)33, 68);
               b[5] = οΩνΩρωλΨηΛδωδ.B("ñģĥûēħþīĪēöĘĳŁİĴĦŊĚŋĥĺĈĐőěīĤĔīŇįİđĭĜľŋĬĚŒōńĩ", (byte)33, 66);
               break;
            case 1:
               b[0] = πψυκΠΨμΛΩβΣφμφσ.F("ԭԔԊՋԘՙԦԴՍԪՌԽԸՃ\u0557՛ՇգԵԱԸՃԷԪ՟ՄկՈԱ՛ՒձՆՊգըՈՉԷվ՜Ը՛ՑձհտՍ\u0558կփձպ\u0557իՇտ֏՚ՏտՎ֍Շ", (byte)33, 70);
               b[1] = μεςΩΔΣγν.F("ՌԔՌԩԩԺԬՓՕԪՈԞԱ՛\u0530ՄաՐ\u0557ՙՓԨաՆԼբԭԭդԿԿԮԶՖոըգճՑՏԾհղՅ", (byte)33, 70);
               b[2] = ΠΛΨοδΩσμνΛγΦφβς.A("ñģĥûēħþīĪēöĘĳŁİĴĦŊĚŋĥĺĈĐőěīĤĔīŇįēħĦŐřĖœęĿŖŕŃĴŖņśŝŗřŝĦķĴĵ", (byte)33, 65);
               b[3] = ςΦζσμτΓσ.A("đøîįüĽĊĘıĎİġĜħĻĿīŇęĕĜħěĎŃĨœĬĕĿĶŕņŇįėņĜōĜįřĿĲłŞŇĩŃĤţŊĬŝĴĵ", (byte)33, 65);
               b[4] = βεξΠθρρςΔΦμ.C("҇я҇ѤѤѵѧҎҐѥ҃љѬҖѫѿҜҋҒҔҎѤѝѤ҅ҕѴѸѼҥ҉қ", (byte)33, 67);
               b[5] = ΨΦνΨΦωυΩνβςμ.B("ñģĥûēħþīĪēöĘĳŁİĴĦŊĚŋĥĺĈĐőěīĤĔīŇįŚŚœďĩĘĮŒĿİţřĞğĠĻŧĵŪňŬŝĴĵ", (byte)33, 66);
               break;
            case 2:
               b[0] = ζοηκορΦνΣθγΩ.F("ԪՅՍՄԐԘԘԴԻԵԶ\u0557ԛՄՕԞՠ\u0530ԲԥՕԳ\u0530Ա", (byte)33, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = λΣΩσμφγχ.D("҃ьѫѭѵѤёїҌҖѳѠ", (byte)33, 68);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(βθκςνθΩθυμςτκχ.F("\u058b֘֗՚֖֑֥֚֚֔ա֣֥֟֜֟էࣰःࣵःࣷंࣲࣚࣧࣿऊँइआऍ", (byte)108, 70));
         }
   ...
   public AccountData next() {
      ...
      try {
         ΨδΨξξοζεΦεςνδς var10000 = this.a;
         String var10001 = c<"㺀">(c & d, e);
         Object[] var10002 = new Object[f];
         var10002[g] = ΣλνΨουΩΔοθεβ.e.a(new Object[h]);
         var10002[i] = ξξοηλξνΨ.a.getName();
         var10001 = String.format(var10001, var10002);
         var10002 = new Object[j];
         var10002[k] = this.b;
         ΔτιηητηζΔ var1 = var10000.a(var10001, var10002);
         ...
         label56: {
            try {
               ...
               if (var2.next()) {
                  στΩξξχκι var3 = this.a.a(var2);
                  if (var3 != null) {
                     var4 = ΛΣββυψΔμκΣζΣχΦτ.from(var3);
                     break label56;
                  }

                  throw new RuntimeException(c<"㺃">(l & m, n));
               }
         ...
         throw new RuntimeException(c<"㺆">(o, p), var8);
      }
   }
   ...
   public void forEachRemaining(Consumer<? super AccountData> var1) {
      try {
         ...
         var10002[u] = ΣλνΨουΩΔοθεβ.e.a(new Object[v]);
         var10002[w] = ξξοηλξνΨ.a.getName();
         var10001 = String.format(var10001, var10002);
         var10002 = new Object[x];
         var10002[y] = this.b;
         πεζΣφιησπξφζ var2 = var10000.a(var10001, var10002);
         ...
         try {
            ...
            try {
               while (var4.next()) {
                  στΩξξχκι var5 = this.a.a(var4);
                  if (var5 == null) {
                     throw new RuntimeException(c<"㺃">(aa & ab, ac));
                  }

                  var1.accept(ΛΣββυψΔμκΣζΣχΦτ.from(var5));
               }
         ...
         throw new RuntimeException(c<"㺆">(ad & ae, af), var12);
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ηωκχκτΛβΦνχνςπφ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ΣφδσΔζιΠρα.A("×ùûÛÿĞĖĬĘçĥěĩģìđĳĲĪİĪÿ", (byte)24, 65), ηωκχκτΛβΦνχνςπφ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΠΛΨοδΩσμνΛγΦφβς.D("ѠѭѬЯѯѫѦѯѺѩжѴѸѱѴѺм߅ߘߊߘߌߗޯ߇\u07bcߔߟߖߜߛߢї", (byte)24, 68) + var1 + ςπυηννναΣ.F("Ԏ", (byte)24, 70) + var2.toString(), var4
         );
      }
   }

   @Generated
   public ηωκχκτΛβΦνχνςπφ(ςθΓωΩπγΩΩΔβΨω var1, ΨδΨξξοζεΦεςνδς var2, long var3) {
      this.a = var1;
      this.a = var2;
      this.a = var3;
   }
