...
public class πελπφβυψεσαωοΦ {
   ...
   public static InputStream a(String var0, boolean var1) {
      ClassLoader var2 = πελπφβυψεσαωοΦ.class.getClassLoader();
      if (!(var2 instanceof MemClassLoader)) {
         throw new IllegalArgumentException(c<"㺀">(p, q) + var2.getClass().getCanonicalName());
      } else {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ιΠοθΩΦξκ.D("ѢќѺѼтуѠѝѯљьѧҒ҃ҒѥҕѥѥқҙѴѮѶѽќѼѰѠҚ҃ѿ", (byte)30, 68);
               break;
            case 1:
               b[0] = βεξΠθρρςΔΦμ.B("ĎĈĦĨîïČĉěąøēľįľđŁđđŇŅĜĥĘĈĢĖłőļīģņŏĔĔĊĴŌĵĜŅŐģ", (byte)30, 66);
               break;
            case 2:
               b[0] = μεςΩΔΣγν.B("êĔčīĪôùčđďĨă", (byte)30, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = ιΠοθΩΦξκ.C("ѹѨѲѹѾѕїѾҌѮ҄ї", (byte)30, 67);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(χΠξΦιζΨΣωΦσΨζ.E("ֆ֓֒Օ֑֕\u058c֕֠֏՜֚֚֞֗֠բࣱࣴ࣪ࣷࣾ࣫ࣿःࣱऀ࣯ईࣿࣧ", (byte)103, 69));
         }
   ...
   public static byte[] a(Consumer<ψειτΣξψγδωβΠε> var0) {
      ByteArrayOutputStream var1 = new ByteArrayOutputStream();
      ψειτΣξψγδωβΠε var2 = new ψειτΣξψγδωβΠε(new DataOutputStream(var1));
      var0.accept(var2);
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  πελπφβυψεσαωοΦ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ΨΦνΨΦωυΩνβςμ.E("\u0558պռ՜ր֭֟֗֙ը֦֪֤֜խֱֳִ֒֫֫ր", (byte)116, 69), πελπφβυψεσαωοΦ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΣδτΠνεγοΓορητ.D("մցրՃփտպփ֎սՊֈ\u058cօֈ֎Ր\u08e2ࣱ࣭࣮ࣶ࣭ࣘࣟࣥ࣬ࣙࣟࣝࣕժ", (byte)116, 68) + var1 + ντθΔζβΔζ.C("Ջ", (byte)116, 67) + var2.toString(), var4
         );
      }
   }
