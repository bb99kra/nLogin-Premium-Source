...
public class NLoginCore_128 implements NLoginInterface_009 {
   ...
   private static String a(int var0, long var1) {
      ...
      if (ZKM_STR_A[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_451.B("ŐŝŜğşśŖşŪřĦŤŨšŤŪĬҿӅӄҸҼӁҹҼӏҼҼӇӒӌӔ", (byte)55, 66));
         }
   ...
   @Generated
   protected NLoginCore_128(Hasher var1) {
      this.a = var1;
   }

   @Override
   public String w(String var1) {
      return this.a.hashToString(NLoginCore_477.ac.r(), var1.toCharArray());
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_128.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_232.C("ԀԢԤԄԨՇԿՕՁԐՎՄՒՌԕԺ՜՛ՓՙՓԨ", (byte)97, 67), NLoginCore_128.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_027.B("ƤƱưųƳƯƪƳƾƭźƸƼƵƸƾƀԓԙԘԌԐԕԍԐԣԐԐԛԦԠԨƛ", (byte)97, 66) + var1 + NLoginCore_201.D("Ԓ", (byte)97, 68) + var2.toString(), var4
         );
      }
   }
}
