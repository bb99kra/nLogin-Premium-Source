...
public class ρμςχΦβνδιδΦπ implements ωυββακσδτιΠΣν {
   ...
   private static String[] a = new String[ρμςχΦβνδιδΦπ.aj];
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ζοηκορΦνΣθγΩ.A("ê÷ö¹ùõðùĄóÀþĂûþĄÆљѕќѢтяћѓљѕшѣ", (byte)4, 65));
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ζοηκορΦνΣθγΩ.F("ՂդզՆժ։ց֗փՒ\u0590ֆ֔֎\u0557ռ֛֞֝֕֕ժ", (byte)94, 70), ρμςχΦβνδιδΦπ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΣδτΠνεγοΓορητ.C("ԲԿԾԁՁԽԸՁՌԻԈՆՊՃՆՌԎࢡ࢝ࢤࢪࢊ\u0897ࢣ࢛ࢡ࢝\u0890ࢫԦ", (byte)94, 67) + var1 + ΨφιωσρΓδΔθ.C("ԉ", (byte)94, 67) + var2.toString(), var4
         );
      }
   }
   ...
   public void a(Player var1, String var2, String var3, int var4, int var5, int var6) {
      if (var2.isEmpty() && var3.isEmpty()) {
         ...
         try {
            ...
            throw new RuntimeException(c<"㺆">(ad & ae, af) + var1.getName() + c<"㺉">(ag, ah ^ ai), var8);
         }
      }
   }

   public ρμςχΦβνδιδΦπ() {
      Class var1 = Class.forName(c<"㺀">(a, b ^ d));
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ζβησεθωυγτ.D("ѮсќЪѬѭѬѦззёѨќѪіѱжѡћѠѻсѴѽѠњ҃ѺѣѸ҃҈ҀюѯѤѴ҄Ғ҆іѥёџ", (byte)22, 68);
               b[1] = ΣδτΠνεγοΓορητ.C("ЩѝмѢъэѷѸхѬѦкжнњѺёѮҀѷлѳъы", (byte)22, 67);
               b[2] = ζοηκορΦνΣθγΩ.A("÷óàÝĄèĩóĠëĎó", (byte)22, 65);
               b[3] = πηγμΣΔκκ.A("÷óàÝĄèĩóĠëĎó", (byte)22, 65);
               b[4] = ΨΦνΨΦωυΩνβςμ.B("ñùĚçÿāēăġĕĭèĀêīĪğĳėďĳĔøøüĝĜĻùğĵú", (byte)22, 66);
               b[5] = ΨφιωσρΓδΔθ.C("ѦўўёѭѴѬЩѶэѸп", (byte)22, 67);
               break;
            case 1:
               b[0] = ΨφιωσρΓδΔθ.E("ՉԜԷԅՇՈՇՁԒԒԬՃԷՅԱՌԑԼԶԻՖԜՏ\u0558ԻԵ՞ՕԾՓ՞գզՉՖՌիԻՄՀՒՇՐծկմԳպԶԵ\u0558՞՜վՅՆ", (byte)22, 69);
               b[1] = ΠΛΨοδΩσμνΛγΦφβς.E("ԄԸԗԽԥԨՒՓԠՇՀԎՑ\u0557ՙՊԤԖ՞՞ԶՎԥԦ", (byte)22, 69);
               b[2] = λΣΩσμφγχ.F("ӽՄԧԚԣԛԯՂԲԽԐԚ", (byte)22, 70);
               b[3] = χΠξΦιζΨΣωΦσΨζ.C("ЬЬшєгѰіѤјѹѬп", (byte)22, 67);
               b[4] = ςΦζσμτΓσ.D("нхѦгыэџяѭѡѹдьжѷѶѫѿѣћѿѮхѳ҄҈Ѿѿ҄ѧҌѪ҈ҀѺѱъҌѥяҎѦѮџ", (byte)22, 68);
               b[5] = βθκςνθΩθυμςτκχ.B("ÖĖĠúĜĖĘôīçĂó", (byte)22, 66);
               break;
            case 2:
               b[0] = βεξΠθρρςΔΦμ.C("уоѓрѤѰѳѳчЫђп", (byte)22, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = μεςΩΔΣγν.F("ԹՍԖԿԘԐԊԬՅՇԔԞԱՂԖԒԥԽԺՈԻԸԥԦ", (byte)22, 70);
         }
      }
   }
