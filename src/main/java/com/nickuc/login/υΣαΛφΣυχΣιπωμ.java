...
public enum υΣαΛφΣυχΣιπωμ {
   a,
   b,
   c,
   d;

   private static String[] a = new String[υΣαΛφΣυχΣιπωμ.f];
   private static String[] b = new String[υΣαΛφΣυχΣιπωμ.g];
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(λΣΩσμφγχ.A("¹ÛÝ½áĀøĎúÉćýċąÎóĕĔČĒČá", (byte)9, 65), υΣαΛφΣυχΣιπωμ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΨΦνΨΦωυΩνβςμ.F("ԨԵԴӷԷԳԮԷՂԱӾԼՀԹԼՂԄ࢛ࡺࢉࡴࢠࡾࢡࢤࢁ࢘ࢠࢪ࢞ԝ", (byte)9, 70) + var1 + ζοηκορΦνΣθγΩ.C("Њ", (byte)9, 67) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΦδφπθΩΩλζξ.A("ęøĚýüĄĖéĀĆüñ", (byte)21, 65);
               b[1] = μζξτΩσσφυδεπλΨ.E("ԤԨԊՃՌՎԝԃՓԐՊՂԴԕԥՙԻԸԵԭԴՍԤԥ", (byte)21, 69);
               b[2] = ιΠοθΩΦξκ.B("ëĎóğěġĒþĠĆãñ", (byte)21, 66);
               b[3] = πηγμΣΔκκ.E("ԺԨԞՈԝԢԼՏ\u0530ԢԬԙ", (byte)21, 69);
               break;
            case 1:
               b[0] = ιΠοθΩΦξκ.A("ýģěĚćïçğöęùúāçÿýĳĢìĭĔĵüý", (byte)21, 65);
               b[1] = πχσδΦΦνθΔπ.B("üĀâěĤĦõÛīèģßèČêĨĐēİĕóĵüý", (byte)21, 66);
               b[2] = δΛψπξκσβγςα.D("ѨќышцѧцѦЫђїЮїѮжќшѨќпѮҀчш", (byte)21, 68);
               b[3] = βθκςνθΩθυμςτκχ.F("ԓՅӾՇԢԨՂՆԒԬՓԨԳՋԘՈԺՃԯ\u0530ԯԧԤԥ", (byte)21, 70);
               break;
            case 2:
               b[0] = χΠξΦιζΨΣωΦσΨζ.E("ԥԾԈԙԝԆԂԟԫԑՌՆԣԠԗԗԙՕԴ՞ԻԷԤԥ", (byte)21, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = χφπρψπφΦθμπ.D("щэѪЪыяѳрыыѩм", (byte)21, 68);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(οοθδΨιοΦΠβδζ.F("ԤԱ\u0530ӳԳԯԪԳԾԭӺԸԼԵԸԾԀ\u0897ࡶࢅࡰ࢜ࡺ࢝ࢠࡽ\u0894࢜ࢦ࢚", (byte)5, 70));
         }
