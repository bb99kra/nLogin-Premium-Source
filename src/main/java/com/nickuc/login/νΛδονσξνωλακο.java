...
public class νΛδονσξνωλακο extends ιΓαΩλςηναΩλγδΓ {
   private static int j = Integer.reverse(-1);
   private static long e = Long.reverse(2793422078774879394L);
   private static String[] a = new String[νΛδονσξνωλακο.u];
   ...
   public void b(θΦγνΩερριδκ var1, String[] var2) {
      String var10001 = c<"㺀">(i & j, k);
      Object[] var10002 = new Object[l];
      var10002[m] = c<"㺃">(n, o ^ p);
      var10002[q] = c<"㺆">(r, s ^ t);
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣφδσΔζιΠρα.A("ƎƛƚŝƝƙƔƝƨƗŤƢƦƟƢƨŪӹӘӲӾӽԄԀԀԍԀӷԁԇ", (byte)86, 65));
         }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(
                     δΛψπξκσβγςα.C("\u0530ՒՔԴ\u0558շկօձՀվմւռՅժ\u058c\u058bփ։փ\u0558", (byte)113, 67), νΛδονσξνωλακο.class.getClassLoader()
                  )
               )
               .asType(var2)
         );
         ...
         throw new RuntimeException(
            ΣερμΔσατσκ.E("\u0590֝֜՟֛֖֪֟֟֙զ֤֤֪֨֡լࣻࣚࣴऀࣿआंंएंࣹःउօ", (byte)113, 69) + var1 + ΠΛΨοδΩσμνΛγΦφβς.D("Ղ", (byte)113, 68) + var2.toString(), var4
         );
      }
   }

   public νΛδονσξνωλακο(ΨγημιδξΓτοθαζ var1) {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΣδτΠνεγοΓορητ.F("ԷՌիեՎԩՒՏՖՊՃԼ", (byte)56, 70);
               b[1] = χΠξΦιζΨΣωΦσΨζ.C("ҵӒҲүӏӘҎӎҪҹҼҸәӁӁұҦӔҽӗӋӢӡӖӥҬӂӚҭӤӋӏӳӵӍӈӥӯӄҶӛәһӠԂҽҺәӖӔӇӦӴӚӾӄӠӁӇԌӰԒӟӡ", (byte)56, 67);
               b[2] = χφπρψπφΦθμπ.A("ĨĥūśĶĵłŚŞŃşŰųōŌųřĹűĵřŅłŃ", (byte)56, 65);
               b[3] = πχσδΦΦνθΔπ.E("ԧլգԸՏզի՟ԫԳԮթԲիՇձղտՊՉԿհՇՈ", (byte)56, 69);
               break;
            case 1:
               b[0] = πηγμΣΔκκ.D("ҏӅҷҷҧҰҩӏӈҟҩқұҶҚҝҟҼӔҦӦөҰұ", (byte)56, 68);
               b[1] = φΨαξωυθανΣφυκη.C("ҵӒҲүӏӘҎӎҪҹҼҸәӁӁұҦӔҽӗӋӢӡӖӥҬӂӚҭӤӋӏӳӵӍӈӥӯӄҶӛәһӠԂҽҺәӖӔӇӦӴӟӨӦӖӋӻԋӢӟԔӠ", (byte)56, 67);
               b[2] = ΦδφπθΩΩλζξ.B("ĨĥūśĶĵłŚŞŃŜņņŖŵńťİřźŏŕłŃ", (byte)56, 66);
               b[3] = δΛψπξκσβγςα.A("ĢŧŞĳŊšŦŚĦĮĩōŌŐŢūķŷŭőůŅłŃ", (byte)56, 65);
               break;
            case 2:
               b[0] = οΩνΩρωλΨηΛδωδ.D("ӍҗҶҕҒӋӆҧһҫҨҴҷҭұӒҴҿӃҽӞөҰұ", (byte)56, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = ιΠοθΩΦξκ.C("ҢҖӈҬҚӗӚӎҖҰҠҝһҴҾқӤӅҦӕӃҳҰұ", (byte)56, 67);
         }
      }
   }
}
