...
public class σζτΦεΣΠΠζΛυ extends ξΠτΣτγαψηρψΓΠτξ {
   ...
   private static int do = (-1 >>> 200 | -1 << ~200 + 1) & -1;
   ...
   private static String[] e = new String[σζτΦεΣΠΠζΛυ.hk];
   private static int hh = (268435456 >>> 249 | 268435456 << -249) & -1;
   private static String[] f = new String[σζτΦεΣΠΠζΛυ.hm];
   ...
   protected void c(τφθχΔαΣγτφς var1) {
      String var2 = var1.a(c<"㺀">(ar & bd, be), c<"㺃">(bf, bh ^ bk)).toLowerCase(Locale.ROOT);
      int var4 = bl;
      switch (var2.hashCode()) {
         case -2105481388:
            if (var2.equals(c<"㺌">(cc, cd ^ cf))) {
               var4 = cg;
            }
            break;
         case -894935028:
            if (var2.equals(c<"㺆">(bn, bo ^ br))) {
               var4 = bu;
            }
            break;
         case 104382626:
            if (var2.equals(c<"㺉">(bw, by ^ ca))) {
               var4 = cb;
            }
      }
      ...
      switch (var4) {
         case 0:
            this.d = ΩαυΩξτκΛ.a(this.m, new File(var1.d().getParentFile(), c<"㺏">(ch, ci ^ ck)), new Properties());
            return;
         case 1:
         case 2:
            int var5 = var1.a(c<"㺒">(cm, cn ^ cp), cr);
            String var6 = var1.a(c<"㺕">(cs & cv, cw), c<"㺘">(cy, cz ^ dc));
            String var7 = var1.a(c<"㺛">(dd, df ^ dg), c<"㺞">(dh & dk, dm));
            String var8 = var1.a(c<"㺡">(dn & do, dp), c<"㺤">(dq, ds ^ dv));
            String var9 = var1.a(c<"㺧">(dw, dy), c<"㺪">(dz & ea, eb));
            Properties var10 = new Properties();
            int var12 = ec;
            switch (var2.hashCode()) {
               case -2105481388:
                  if (var2.equals(c<"㺰">(em, eo ^ ep))) {
                     var12 = eq;
                  }
                  break;
               case 104382626:
                  if (var2.equals(c<"㺭">(ed, ee ^ ef))) {
                     var12 = ek;
                  }
            }
            ...
            switch (var12) {
               case 0:
                  this.d = ςιγρτΩλαγπβρ.b(this.m, ΔγΨνςχιδκτςες.a(var6, var5, var9, var7, var8, var10));
                  return;
               case 1:
                  this.d = ΨΠζπΔμςνιγτιαιΓ.b(this.m, ΔγΨνςχιδκτςες.a(var6, var5, var9, var7, var8, var10));
                  return;
               default:
                  return;
            }
         default:
            throw new UnsupportedOperationException(c<"㺳">(er, es ^ et) + var2);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (e[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(μεςΩΔΣγν.E("ԺՇՆԉՉՅՀՉՔՃԐՎՒՋՎՔԖࢫ࢟ࢮ\u0891ࢡ\u0890ࢎ\u088fࢦࢌࢷ", (byte)27, 69));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               f[0] = πχσδΦΦνθΔπ.B("ưǫǪǬǖǦƳǸǹǯƹǮǾǕǍǁȂǿǕǐǯǏǌǍ", (byte)125, 66);
               f[1] = οοθδΨιοΦΠβδζ.A("ǜƪǐǅǞǗǑǱǴǬǤǎǲǒȀƺǱǴǽǯǵǏǌǍ", (byte)125, 65);
               f[2] = ςπυηννναΣ.A("ǠǌǉƿǨǃǒǆƵǱǙǽǽȀǫǾǻǜǬǀƽǟǌǍ", (byte)125, 65);
               f[3] = πηγμΣΔκκ.D("֕՜՟ողէ֤պոցփմ", (byte)125, 68);
               f[4] = ΣδτΠνεγοΓορητ.E("֢թլօտմֱևօ֎\u0590ց", (byte)125, 69);
               f[5] = ΦδφπθΩΩλζξ.E("ևֲ֤սնְַ֑֬։ֺց", (byte)125, 69);
               f[6] = ςΦζσμτΓσ.E("ִ֮ֈ֬֎֘֯ֈհֵնս\u058c֍ֿ\u0590վְׁ֥֭֟\u058c֍", (byte)125, 69);
               f[7] = θεωψξβΛσσ.B("ǜƪǐǅǞǗǑǱǴǬǝǳǋǕȁǚǻǚȁǔȂǡƾǠǓȋȁȁǞǝȄǬ", (byte)125, 66);
               f[8] = ΦδφπθΩΩλζξ.F("֠\u058c։տ֨փ֒ֆյֱ֚պ֔ս֠ոֻ֯֟֎ֽׅ\u058c֍", (byte)125, 70);
               f[9] = ΣδτΠνεγοΓορητ.F("֠\u058c։տ֨փ֒ֆյֱָ֛֊չֱֻֻ־նֻվֽ֛֩օ֧\u05c9֨\u05ce֍֦֙", (byte)125, 70);
               f[10] = δΛψπξκσβγςα.B("ǪǩǴǕǮǳǍǆƳǹǯǭƸǠǈǹǂǌǐǿǰǟǌǍ", (byte)125, 66);
               f[11] = μεςΩΔΣγν.E("֠\u058c։տ֨փ֒ֆյֱ֛֚֏ս֖֊ֿ֢֛֥֫\u05c8ֹ֧֧֒ֈֶֻֆ\u058c֠", (byte)125, 69);
               f[12] = φΨαξωυθανΣφυκη.B("ƤǋǣǡƭƮǢǍǉǘǘǁ", (byte)125, 66);
               f[13] = ςΦζσμτΓσ.C("֓տռղ֛նօչը֤֎֣տ֫։֬քձֵ֦֭֩֘օּմֵ֑֓֊֒֬", (byte)125, 67);
               f[14] = μεςΩΔΣγν.E("֢֟և֯ծֆճկ֯։֯֜֍֗֔։ֵ֓֫֝֗֒\u058c֍", (byte)125, 69);
               f[15] = οοθδΨιοΦΠβδζ.B("ǠǌǉƿǨǃǒǆƵǱǘǗǮƿƽǮǷǿǷǢǐǿȇǈǻǘȆǊȄǸȊǝ", (byte)125, 66);
               f[16] = μεςΩΔΣγν.D("խր֟եովփը֍֎֥մ", (byte)125, 68);
               f[17] = ΨφιωσρΓδΔθ.B("ǇǤǲƽƶǬǷǰǑǉǺǁ", (byte)125, 66);
               f[18] = ΦδφπθΩΩλζξ.B("ǮǴǈǬǎǘǯǈưǵƶƽǌǍǿǐƾǭǰȁǥǟǌǍ", (byte)125, 66);
               f[19] = μεςΩΔΣγν.C("֥շո՟֦վ֤֝\u058bտփ֚֩հկռէ֤֗ր֯լն֎ս֚ռֱֶֹׂׂ֑֠֨֩־֩֠׀֛֬\u05cd֔", (byte)125, 67);
               f[20] = ΨΦνΨΦωυΩνβςμ.F("֜֨֔ևև֘֏ִֺ֔֨ց", (byte)125, 70);
               f[21] = πψυκΠΨμΛΩβΣφμφσ.E("֢֟և֯ծֆճկ֯։֯֜֍֗֔։ֵ֓֫֝֗֒\u058c֍", (byte)125, 69);
               f[22] = πχσδΦΦνθΔπ.C("֚դեմ֪օբտ֫֍֭մ", (byte)125, 67);
               f[23] = ξψθρΣΠΣς.D("֝վճ֡։֢֘֜թ֥եւխְլ֪֖ծֹ֕օ֥֚֓նսջն֟־ֲֶֺ׀ׇ֢ր׃ַֺ֜\u05cbׁ֔", (byte)125, 68);
               f[24] = ιΠοθΩΦξκ.B("ƿǍƭǫƲƵǦǰǎƷǛǙǳǚƻǰǔǱȃǔǖǏǌǍ", (byte)125, 66);
               f[25] = λΣΩσμφγχ.F("֏֑֦֪֫֯֬֕\u058c֥շց", (byte)125, 70);
               f[26] = πχσδΦΦνθΔπ.B("ƤǁƮǳǔǊǸǒǓǨǱƸƹƱȁǎƾǾǙǂǄǏǌǍ", (byte)125, 66);
               f[27] = πηγμΣΔκκ.F("֨ծִ֯\u0590ֈ\u058cָ֍֚֍֦֎ּ֞־ׂ֟֍ׁ֥ׅ\u058c֍", (byte)125, 70);
               break;
            case 1:
               f[0] = ζβησεθωυγτ.A("ưǫǪǬǖǦƳǸǹǯƸǝǇȀƷǑǺǂǿǢǮǏǌǍ", (byte)125, 65);
               f[1] = βεξΠθρρςΔΦμ.B("ǜƪǐǅǞǗǑǱǴǬǝǪǜǵǝǮǟƾǜǃǧȅǌǍ", (byte)125, 66);
               f[2] = πχσδΦΦνθΔπ.F("֠\u058c։տ֨փ֒ֆյֱ֙֓֊֔ջ\u058cְ֙֜֔֗ևֱׇֹֽ֪օ\u058cׅ֠\u05ca", (byte)125, 70);
               f[3] = βεξΠθρρςΔΦμ.C("ջձջ֩է֧ֆ֠֊լֆ֣ժս֦զ\u058cղ֣֓նָտր", (byte)125, 67);
               f[4] = βεξΠθρρςΔΦμ.D("ռ֘֙֘֓վ֣֠րշ֦ոխ֦֮֝֔֕խո\u0590֒տր", (byte)125, 68);
               f[5] = πηγμΣΔκκ.D("մյւուփք֊յ֠փմ", (byte)125, 68);
               f[6] = μζξτΩσσφυδεπλΨ.B("ǮǴǈǬǎǘǯǈưǵƳǳǓƱǟǟǼǎȂȂǮǟǌǍ", (byte)125, 66);
               f[7] = ΨΦνΨΦωυΩνβςμ.C("֏՝փո֑֊ք֤֧֟\u0590֦վֈִ֍֮֍ִևֵ֦ջ֎֛֮֘տ֊մַվ", (byte)125, 67);
               f[8] = ΣδτΠνεγοΓορητ.A("ǠǌǉƿǨǃǒǆƵǱǚǻǚǞǷǢǰǲǀȄǢǠȁƻƼȊǦǛǻǫȁǑ", (byte)125, 65);
               f[9] = βθκςνθΩθυμςτκχ.B("ǠǌǉƿǨǃǒǆƵǱǛǸǊƹǻǻǱǾƶǻƾǞǑǆǈǗǪǶǪǜǹǽ", (byte)125, 66);
               f[10] = ΨφιωσρΓδΔθ.B("ǪǩǴǕǮǳǍǆƳǹǮǋǐǘƿǞƺǌǡǴǟǵǌǍ", (byte)125, 66);
               f[11] = ξψθρΣΠΣς.C("֓տռղ֛նօչը֤֎֍ւհ։ս֕֞֎ֲ֘պ֛֎ն֬֔֝֊ֳִֺ", (byte)125, 67);
               f[12] = ΣερμΔσατσκ.C("ր֢մռօ֣ցնրժծմ", (byte)125, 67);
               f[13] = ΣερμΔσατσκ.A("ǠǌǉƿǨǃǒǆƵǱǛǰǌǸǖǹǑƾǶȂǥǿǜȅǘǪȌȃǇȀǭǼ", (byte)125, 65);
               f[14] = χφπρψπφΦθμπ.D("֒֕պ֢աչզբ֢ռ֥֡ր֊֥ֆտֶնղց֨տր", (byte)125, 68);
               f[15] = ΦδφπθΩΩλζξ.A("ǠǌǉƿǨǃǒǆƵǱǘǗǮƿƽǮǷǿǷǢǐǸǾǅǞǿȅǈǌǊȍǃ", (byte)125, 65);
               f[16] = ςπυηννναΣ.E("փ֦֨֒յֱևղք։֔ց", (byte)125, 69);
               f[17] = ςπυηννναΣ.B("ƲǒǌƿưƴƶƳǙƸƷǁ", (byte)125, 66);
               f[18] = ΣφδσΔζιΠρα.C("֧֡ջ֟ց\u058b֢ջգ֨ը֝խ֤֍հֶ֝ֆ֖֥֒տր", (byte)125, 67);
               f[19] = φδχεθοκψαλΛογλ.F("ֲքօլֳ\u058bֱ֪֘\u058c\u0590ֶ֧սռ։մֱ֤֍ּչփ֛֊֧։֞\u05cf׆׃ֲ֭\u05ca\u05cfִ֤֫֕ב֥טג֡", (byte)125, 70);
               f[20] = φδχεθοκψαλΛογλ.B("ƺƳƳǮǎƯǗǫǰǖƻǁ", (byte)125, 66);
               f[21] = πχσδΦΦνθΔπ.A("ǟǢǇǯƮǆƳƯǯǉǱǳǋƸƶǎǑǙƺƽǛȅǌǍ", (byte)125, 65);
               f[22] = ΦδφπθΩΩλζξ.F("ֲճֶ֔ը֎րօ֛֙ջց", (byte)125, 70);
               f[23] = πχσδΦΦνθΔπ.B("ǪǋǀǮǖǯǥǩƶǲƲǏƺǽƹǷǣƻǢȆǒǧǠǲǃǊǈǃǬȋǿȃȃǯǔǌȗǓǮǐǧǷǗǡ", (byte)125, 66);
               f[24] = δΛψπξκσβγςα.C("ղրՠ֞եը֣֙ցժ\u058bֱ֝֨֒ղև֔ֈֹիָտր", (byte)125, 67);
               f[25] = χΠξΦιζΨΣωΦσΨζ.D("֎ա՞֞ֈթ֣փթ֣֩խ֤֪֑֯֞կ֧֖֯֒տր", (byte)125, 68);
               f[26] = ςΦζσμτΓσ.C("\u0557մա֦ևս֫օֆ֛֣֠֎վջկ֧ճք֥ւ֒տր", (byte)125, 67);
               f[27] = δΛψπξκσβγςα.E("֨ծִ֯\u0590ֈ\u058cָ֍֚֍մ֮֩֜־֎ִֵ֮֡֕\u058c֍", (byte)125, 69);
               break;
            case 2:
               f[0] = βθκςνθΩθυμςτκχ.C("գւ֧֤֢ժբչ֧շ\u058b֍ժ\u058bֆռ֟֯֫ճցֹ֤֯օ֙׀ׁ֭պִ֞", (byte)125, 67);
            case 3:
            default:
               break;
            case 4:
               f[0] = βεξΠθρρςΔΦμ.F("ցִ֥֣֑֯ծ֥մօ֗֨֍ֽ֭֯֯֏ռֹֹׂׄ֙֜֨ւ֜\u05cfֺׁ֨", (byte)125, 70);
         }
      }
   }
   ...
   public σζτΦεΣΠΠζΛυ(ΨγημιδξΓτοθαζ var1) {
      super(var1, ΓεοκπνΨωπτ.j, c<"㺀">(e, p ^ q), c<"㺃">(y & z, ab), (boolean)(var1.b().a() == κιββωσγχςΣβΠΣδ.b ? al : ao));
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΣερμΔσατσκ.E("\u0557չջ՛տ֖֞֬֘է֥֛֣֩լְֲֳ֑֪֪տ", (byte)115, 69), σζτΦεΣΠΠζΛυ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΠΛΨοδΩσμνΛγΦφβς.C("ձվսՀրռշր\u058bպՇօ։ւօ\u058bՍ\u08e2ࣖࣥࣈࣘࣇࣅࣆࣝࣃ࣮դ", (byte)115, 67) + var1 + πηγμΣΔκκ.E("թ", (byte)115, 69) + var2.toString(), var4
         );
      }
   }
   ...
   protected void b(ResultSet var1) {
      UUID var2 = λΣσΣκΓβΠΨ.c(var1.getString(c<"㺀">(eu, ev)));
      OfflinePlayer var3 = this.m.b().<Server>c().getOfflinePlayer(var2);
      this.r = var3.getName();
      String var4 = var1.getString(c<"㺃">(ex, ez ^ fc));
      byte[] var5 = Base64.getDecoder().decode(var1.getString(c<"㺆">(fd & fe, ff)));
      String var6 = Base64.getEncoder().withoutPadding().encodeToString(var5);
      String var10000 = c<"㺉">(fh & fl, fn);
      Object[] var10001 = new Object[fp];
      var10001[fr] = c<"㺌">(fs, ft ^ fu);
      var10001[fv] = fw;
      var10001[fz] = gc;
      var10001[gd] = gg;
      var10001[gh] = gj;
      ...
      String var8 = var1.getString(c<"㺏">(gq, gr));
      String var9 = a(var1.getLong(c<"㺒">(gs & gt, gu)));
      long var10 = var1.getLong(c<"㺕">(gv, gx ^ ha));
