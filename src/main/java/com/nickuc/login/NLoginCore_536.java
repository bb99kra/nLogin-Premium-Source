...
public enum NLoginCore_536 {
   a,
   b;

   private static String[] ZKM_STR_A = new String[NLoginCore_536.d];
   private static String[] ZKM_STR_B = new String[NLoginCore_536.e];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_110.D("ДювЛдксѐѕЯЧЭ", (byte)16, 68);
               ZKM_STR_B[1] = NLoginCore_575.C("џЕѠёПрЖўждіѩмсЧоъїкѡфыий", (byte)16, 67);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_471.C("їзсрџвэРУхѠѨѨѝѣіжўТѠѩлий", (byte)16, 67);
               ZKM_STR_B[1] = NLoginCore_433.D("џЕѠёПрЖўждїѥѩшѫЫщѨѫѲуѱий", (byte)16, 68);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_553.E("ԳԦԳ\u0530ՇՂՋՌԡՄԧ\u0530Մԯ\u0530ՓԓԳԥՁԘՔՏՉ՜ԐՐԚ\u0530Լ՛Է", (byte)16, 69);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_575.B("ĄĎęĐÙėïûāýČç", (byte)16, 66);
         }
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_536.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_183.A("ƅƧƩƉƭǌǄǚǆƕǓǉǗǑƚƿǡǠǘǞǘƭ", (byte)111, 65), NLoginCore_536.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_559.B("ǀǍǌƏǏǋǆǏǚǉƖǔǘǑǔǚƜԷԪԋԮԳԭԫԛԭԩԮƳ", (byte)111, 66) + var1 + NLoginCore_183.C("Լ", (byte)111, 67) + var2.toString(), var4
         );
      }
   }
