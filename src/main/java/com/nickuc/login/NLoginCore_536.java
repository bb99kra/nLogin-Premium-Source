...
public enum NLoginCore_536 {
   ...
   private static String[] a = new String[NLoginCore_536.d];
   private static String[] b = new String[NLoginCore_536.e];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = NLoginCore_110.D("ДювЛдксѐѕЯЧЭ", (byte)16, 68);
               b[1] = NLoginCore_575.C("џЕѠёПрЖўждіѩмсЧоъїкѡфыий", (byte)16, 67);
               break;
            case 1:
               b[0] = NLoginCore_471.C("їзсрџвэРУхѠѨѨѝѣіжўТѠѩлий", (byte)16, 67);
               b[1] = NLoginCore_433.D("џЕѠёПрЖўждїѥѩшѫЫщѨѫѲуѱий", (byte)16, 68);
               break;
            case 2:
               b[0] = NLoginCore_553.E("ԳԦԳ\u0530ՇՂՋՌԡՄԧ\u0530Մԯ\u0530ՓԓԳԥՁԘՔՏՉ՜ԐՐԚ\u0530Լ՛Է", (byte)16, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = NLoginCore_575.B("ĄĎęĐÙėïûāýČç", (byte)16, 66);
         }
      }
   }
