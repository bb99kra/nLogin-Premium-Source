...
public abstract class ζαξρυωβζπ {
   ...
   private static String[] b = new String[ζαξρυωβζπ.ac];
   ...
   protected static byte[] a(String var0, char[] var1, byte[] var2, int var3, int var4) {
      ...
      try {
         SecretKeyFactory var6 = SecretKeyFactory.getInstance(c<"㺀">(j, k) + var0);
         return var6.generateSecret(var5).getEncoded();
      } catch (InvalidKeySpecException var7) {
         throw new RuntimeException(c<"㺃">(l & m, n), var7);
      } catch (NoSuchAlgorithmException var8) {
         throw new RuntimeException(c<"㺆">(o, p ^ q) + var0 + c<"㺉">(r, s), var8);
      }
   }
         ...
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(
                     ντθΔζβΔζ.E("\u0530ՒՔԴ\u0558շկօձՀվմւռՅժ\u058c\u058bփ։փ\u0558", (byte)76, 69), ζαξρυωβζπ.class.getClassLoader()
                  )
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(ςπυηννναΣ.B("źƇƆŉƉƅƀƉƔƃŐƎƒƋƎƔŖӞӚӨӬӱӶӠӥӰū", (byte)76, 66) + var1 + ζβησεθωυγτ.E("Ղ", (byte)76, 69) + var2.toString(), var4);
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = βθκςνθΩθυμςτκχ.B("ġþěĀġĪôĎčİĔĘıòôĳċėĪĽŀĜûŀğþĳĖłňłąįĹňćĿďŏĩŕİŖĝ", (byte)27, 66);
               b[1] = δΛψπξκσβγςα.A("äĤëČĨÿĕíõĲĈý", (byte)27, 65);
               b[2] = μζξτΩσσφυδεπλΨ.C("ѵѨҁѡѾњѭѾѱ҄ђїѸоѤҁѥѦ҉ѣѳќљњ", (byte)27, 67);
               b[3] = ΣερμΔσατσκ.A("ġþěĀġĪôĎčİĖĳõöēùıėĐŀþĖĹĕļĘĠŇĄīĴğħĉļĦńĩňĢŁŎīŐĮŔŒĨĩŐĭłľšĨĩ", (byte)27, 65);
               b[4] = ντθΔζβΔζ.A("ġþěĀġĪôĎčİĔĘıòôĳċėĪĽŀĜûŀğþĳĖłňłąįĹňćĿďŏĩŕİŖĝ", (byte)27, 65);
               b[5] = ξψθρΣΠΣς.D("еѵмѝѹѐѦоц҃љю", (byte)27, 68);
               b[6] = οοθδΨιοΦΠβδζ.B("ĀîħďğĤďĒîĸĭĤõõĖęĘĖ÷ęľıĈĉ", (byte)27, 66);
               break;
            case 1:
               b[0] = ΠΛΨοδΩσμνΛγΦφβς.E("ՃԠԽԢՃՌԖ\u0530ԯՒԶԺՓԔԖՕԭԹՌ՟բԾԝբՁԠՕԸդժդԧՀԺճծեՍ\u0530ԮՌըՇոեկ՚խ՛ճճքտ՝ՊՋ", (byte)27, 69);
               b[1] = ιΠοθΩΦξκ.E("ՆԤԥՀԧԲԒԐԴՁՄԟ", (byte)27, 69);
               b[2] = ΨφιωσρΓδΔθ.E("ՆԹՒԲՏԫԾՏՂՕԤՏ՜ԦԭՕ\u0557ԭՋԞԱԭԪԫ", (byte)27, 69);
               b[3] = βθκςνθΩθυμςτκχ.F("ՃԠԽԢՃՌԖ\u0530ԯՒԸՕԗԘԵԛՓԹԲբԠԸ՛Է՞ԺՂթԦՍՖՁՉԫ՞ՈզՋժՄգհՋռթչժՇՍՙՠվ՜ճՊՋ", (byte)27, 70);
               b[4] = ξψθρΣΠΣς.C("ѲяѬёѲѻхџўҁѥѩ҂ух҄ќѨѻҎґѭьґѰя҄ѧғҙғіљѼҙќҎѱҝҠҘ҉ѨѮ", (byte)27, 67);
               b[5] = πχσδΦΦνθΔπ.E("ԉԐԄԲԓՉԞԢԨՐԲԟ", (byte)27, 69);
               b[6] = ςΦζσμτΓσ.F("ԢԐՉԱՁՆԱԴԐ՚ՏՈՕԥՍԨԝԬՌՠԵԭԪԫ", (byte)27, 70);
               break;
            case 2:
               b[0] = φΨαξωυθανΣφυκη.F("ԯԡԈԍՆՄԎՁՖՉԪԴԖԦՑՉԾՠԢՄԤՂՎՈԦՈԻՊՅՎՉՅ", (byte)27, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = μεςΩΔΣγν.D("лѶѰяіѺн҂ѣҁѥю", (byte)27, 68);
         }
      }
   }
   ...
   protected static int b(String var0) {
      try {
         ...
         throw new RuntimeException(c<"㺀">(e, f ^ g) + var0 + c<"㺃">(h, i), var2);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ξψθρΣΠΣς.C("֏֛֜՞֚֞֕֞֩֘ե֣֧֣֠֩ի࣯ࣳࣽँआऋࣺࣵअ", (byte)125, 67));
         }
