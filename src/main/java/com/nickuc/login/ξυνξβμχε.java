...
public abstract class ξυνξβμχε<V extends εηχβγρΦβΦΛκγΦοδ<?>> implements θαΩΦνυψγ {
   ...
   private static String[] a = new String[ξυνξβμχε.l];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΣφδσΔζιΠρα.B("ƬǅƱưƵƉƇǊƹƨǍƆƨƿƬƍƠǓǎƗƗƩƮƷǘǚǈƵǁǒǓǛ", (byte)102, 66);
               b[1] = ΠΛΨοδΩσμνΛγΦφβς.C("ՈաՍՌՑԥԣզՕՄթԢՄ՛ՈԩԼկժԳԳՁղԲեՖպՒՅ՞ՆԸԿՠս\u0558ԶԼ՚աքֈժՏ", (byte)102, 67);
               b[2] = λΣΩσμφγχ.F("ֈխլձ֜ՠջ՜շ֕յղտս֑֩ջ֭թ֢լւ֢֮֓֍ֱ֨֔֊ָյַ\u0590֔ֈָ֖֯չ֭֙ր֊", (byte)102, 70);
               break;
            case 1:
               b[0] = οοθδΨιοΦΠβδζ.E("փ֜ֈև\u058cՠ՞֡\u0590տ֤՝տ֖փդշ֪֥ծծր֍֧֠֕֨֍ղկիֶ֖յַׁ֩֞֫֒֜ն֕֊", (byte)102, 69);
               b[1] = μζξτΩσσφυδεπλΨ.B("ƬǅƱưƵƉƇǊƹƨǍƆƨƿƬƍƠǓǎƗƗƥǖƖǉƺǞƶƩǂƪƜƽǐƵǞƲơǀǉǜǍƶƳ", (byte)102, 66);
               b[2] = ΨΦνΨΦωυΩνβςμ.E("ֈխլձ֜ՠջ՜շ֕յղտս֑֩ջ֭թ֢լւ֢֮֓֍ֱ֨֔֊ָյ֍ֲַַֽ֑֪մ\u0590ւ֍֊", (byte)102, 69);
               break;
            case 2:
               b[0] = βθκςνθΩθυμςτκχ.F("Օռկ֖\u0558՛տպ՛֣վչձ֔եղ֘բռ֍֚֞յն", (byte)102, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = λΣΩσμφγχ.E("֙Վ։՞֖֜՝խ\u058b֢ցժ", (byte)102, 69);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(βθκςνθΩθυμςτκχ.C("ӀӍӌҏӏӋӆӏӚӉҖӔӘӑӔӚҜࠬ࠴࠭\u082fࠤ\u082f࠻ࠪ", (byte)56, 67));
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΠΛΨοδΩσμνΛγΦφβς.B("ŏűųœŷƖƎƤƐşƝƓơƛŤƉƫƪƢƨƢŷ", (byte)84, 66), ξυνξβμχε.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            βεξΠθρρςΔΦμ.D("ԔԡԠӣԣԟԚԣԮԝӪԨԬԥԨԮӰࢀ࢈ࢁࢃࡸࢃ\u088fࡾԄ", (byte)84, 68) + var1 + ΨφιωσρΓδΔθ.F("Պ", (byte)84, 70) + var2.toString(), var4
         );
      }
   }

   @Generated
   public ξυνξβμχε(V var1) {
      this.h = (V)var1;
   }
   ...
   public boolean a(ΨαχΨχΣλεΠψΦ var1, γΦΠυρρρπη var2, Object var3, byte[] var4) {
      if (var3 == null) {
         ...
         throw new IllegalArgumentException(c<"㺃">(c, d ^ e));
      } else if (var4 == null) {
         throw new IllegalArgumentException(c<"㺆">(f, g ^ h));
      } else if (var1 != null) {
         var1.a(this.h, var2, var3, var4);
         return (boolean)i;
      } else {
         for (ΨαχΨχΣλεΠψΦ var6 : this.h.b().c()) {
            if (var6.R()) {
