...
public class θΛζνβΣΦγωΓη {
   ...
   private static String[] a = new String[θΛζνβΣΦγωΓη.i];
   private static String[] b = new String[θΛζνβΣΦγωΓη.j];
   ...
   public static τιπυΦδΩνβ a() {
      try {
         InputStream var0 = πελπφβυψεσαωοΦ.a(c<"㺀">(a, b), (boolean)c);
         ...
         label126: {
            try {
               ...
               if (var0 != null) {
                  ...
                  try {
                     var12 = true;
                     var2 = τιπυΦδΩνβ.a(var1.readLine());
                     var12 = false;
                  } finally {
                     if (var12) {
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(λΣΩσμφγχ.E("ԬՎՐ\u0530ՔճիցխԼպհվոՁզֈևտօտՔ", (byte)72, 69), θΛζνβΣΦγωΓη.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ξψθρΣΠΣς.D("ӰӽӼҿӿӻӶӿԊӹӆԄԈԁԄԊӌࡖ࠺ࡖ࡞ࡔࡆࡊࡘ\u086f࠺\u085fӣ", (byte)72, 68) + var1 + πψυκΠΨμΛΩβΣφμφσ.E("Ծ", (byte)72, 69) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ξψθρΣΠΣς.A("ǊǒƿƶƴǖǧǚǃƽǤǨƾƬǙǬǛǥǩǎǪǯǵǤǤǪǕǰưǱǝǐ", (byte)117, 65);
               break;
            case 1:
               b[0] = πηγμΣΔκκ.F("֚֒ևվռ֢֞֯\u058bօְ֬ֆմֱֲִֶ֣֖֭֡պ֬֏ִ֛֚֙սֵ֞", (byte)117, 70);
               break;
            case 2:
               b[0] = ΦδφπθΩΩλζξ.F("֢ևւ֘օֈֱ֥֢֝֡լֵֶծւ֣ղֽ֩֕֬քօ", (byte)117, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = μζξτΩσσφυδεπλΨ.A("ƛƯƾǖǛǐưƣǓǡƸǟƻǜǄǙƬǉǢǥǂǥƼƽ", (byte)117, 65);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(χφπρψπφΦθμπ.C("њѧѦЩѩѥѠѩѴѣаѮѲѫѮѴж߀ޤ߀߈\u07beް\u07b4߂ߙޤ߉", (byte)22, 67));
         }
