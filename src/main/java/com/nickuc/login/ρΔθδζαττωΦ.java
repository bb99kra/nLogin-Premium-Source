...
public class ρΔθδζαττωΦ extends ΨιβιψκωΓγ {
   private static long e;
   private static String[] d = new String[ρΔθδζαττωΦ.j];
   private static long f = Long.reverse(-3696541810282931093L);
   private static int c = Integer.reverse(0);
   private static String[] c = new String[ρΔθδζαττωΦ.g];
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΦδφπθΩΩλζξ.C("ԾՋՊԍՍՉՄՍ\u0558ՇԔՒՖՏՒ\u0558Ԛࢭࢁࢦࢣࢦࢢࢶࢷࢽ࢛", (byte)98, 67));
         }
   ...
   public ρΔθδζαττωΦ(χχνρψΔςΓΦφΛΔ var1) {
      this.a = var1;
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = πηγμΣΔκκ.D("ҴӉӐӍөӧӇӼӐӱӚӵӾӴӴӢӯӦӸӓӃӺӑӒ", (byte)67, 68);
               break;
            case 1:
               d[0] = ςΦζσμτΓσ.C("ҴӉӐӍөӧӇӼӐӱӚӁӫӺӮӺӔӁӨӀԆөӵӈԂԏӠӑԎӏӋӲ", (byte)67, 67);
               break;
            case 2:
               d[0] = ΣφδσΔζιΠρα.D("ӡӅӤӰӼӍҹӌӲӊӉәӷӱӀӏӀԇӸӂӢӔӑӒ", (byte)67, 68);
            case 3:
            default:
               break;
            case 4:
               d[0] = χΠξΦιζΨΣωΦσΨζ.C("ӅӠӒӬӘҳӑәҼӡӎһӬӓӲҸԂӲӚԊӾӨӼԈӜӏӻԎӳӔԈӭ", (byte)67, 67);
         }
      }
   }
      ...
      if (var2 == 0) {
         ...
         switch (var3) {
            ...
            case 2:
               ...
               break;
            default:
               throw new IllegalArgumentException(c<"㺀">(c, f) + var2);
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ζβησεθωυγτ.B("ėĹĻěĿŞŖŬŘħťśũţĬőųŲŪŰŪĿ", (byte)56, 66), ρΔθδζαττωΦ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            βεξΠθρρςΔΦμ.C("ӀӍӌҏӏӋӆӏӚӉҖӔӘӑӔӚҜ\u082fࠃࠨࠥࠨࠤ࠸࠹\u083fࠝҲ", (byte)56, 67) + var1 + οοθδΨιοΦΠβδζ.F("Ԯ", (byte)56, 70) + var2.toString(), var4
         );
      }
   }
