...
public class ωλραΩΩκοΔυσψ {
   ...
   @Generated
   public ωλραΩΩκοΔυσψ(String var1, String var2) {
      this.aY = var1;
      this.aZ = var2;
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ντθΔζβΔζ.C("ԡԹӶՃԝԏԻԘԜԣԶՈՊՊՆԝՒԊԥԡԶՕԜԝ", (byte)92, 67);
               break;
            case 1:
               b[0] = ςΦζσμτΓσ.F("հֈՅ֒լ՞֊էիղօ֑֖֕ձռՙլսդնվիլ", (byte)92, 70);
               break;
            case 2:
               b[0] = λΣΩσμφγχ.C("ԴԾԥԯԁԃԆԛԤԄՊԑ", (byte)92, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = οΩνΩρωλΨηΛδωδ.A("ƟƊƌƈƴƯƊƘƙƁƣƐƙƾƛƗŷƕƭƾƘƾƚǁƤǁƢƩƚǅƎǊ", (byte)92, 65);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΨΦνΨΦωυΩνβςμ.E("֒֟֞ա֛֡֝֘֡֬ը֦֪֣֦֬ծउࣼः࣭࣮ࣴऀआࣜऎऍओ", (byte)115, 69));
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(βθκςνθΩθυμςτκχ.D("ҦӈӊҪӎӭӥӻӧҶӴӪӸӲһӠԂԁӹӿӹӎ", (byte)67, 68), ωλραΩΩκοΔυσψ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            χφπρψπφΦθμπ.F("բկծԱձխըձռիԸնպճնռԾ࣓ࣙ࣌ࣄࢽࢾ࣐ࣖࢬࣣࣞࣝՖ", (byte)67, 70) + var1 + μζξτΩσσφυδεπλΨ.E("Թ", (byte)67, 69) + var2.toString(), var4
         );
      }
   }
}
