...
public abstract class πβΛφΨΦφδαΔηπχς implements ΨδΨξξοζεΦεςνδς {
   ...
   static {
      ...
      try {
         Class.forName(c<"㺀">(bf, bg ^ bh));
      } catch (ClassNotFoundException var1) {
         throw new RuntimeException(c<"㺃">(bi, bj ^ bk), var1);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(μζξτΩσσφυδεπλΨ.B("ĈĕĔ×ėēĎėĢđÞĜĠęĜĢäѶѩѓѿѢѡ҂ѱѯѓѷҁ҉҅", (byte)19, 66));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = δΛψπξκσβγςα.B("ÞìÅþçæÚÒĊÿĉéĈĐúÒčĕõÞÞéæç", (byte)10, 66);
               b[1] = δΛψπξκσβγςα.C("ЌНЛЉЪЮЍПАФепётјЦэјъчЛџЪанЛдЧѕеѨь", (byte)10, 67);
               b[2] = θεωψξβΛσσ.F("ԎԐԛԬԲԭԖՆՇՁԢԔՅԄԬԶՁՎԈԄԤԬԙԚ", (byte)10, 70);
               b[3] = ΨΦνΨΦωυΩνβςμ.F("ԋԹԶԍԒԟӽӿԑԚԈԎ", (byte)10, 70);
               b[4] = θεωψξβΛσσ.D("зРХчэкПЭгѕшбуювгГШЬКрЬбглмОвујѨй", (byte)10, 68);
               b[5] = δΛψπξκσβγςα.B("çþďÅČåèíïáÍÛ", (byte)10, 66);
               b[6] = πχσδΦΦνθΔπ.D("ЉКьШРЇЫлбэгррюДзЕъоЬдяЦЧ", (byte)10, 68);
               b[7] = ιΠοθΩΦξκ.C("РЌУУццЩоОШТпВЭюЗеЪЖћлйЦЧ", (byte)10, 67);
               b[8] = πψυκΠΨμΛΩβΣφμφσ.C("еЧрИийбНІєѐєШФйИєэЖѠЙЯПзѠеИїѤџзыоѨѨЩѧтрѥѕєѕђЪѹѨвяѷжязщцч", (byte)10, 67);
               b[9] = μζξτΩσσφυδεπλΨ.B("àÌããĆĆéþÞèâÿÒíĎ×õêÖěûùæç", (byte)10, 66);
               b[10] = βθκςνθΩθυμςτκχ.A("÷ÄéÞĊĐÚþëĄÕÍčåÌÛĝĒýñ×ÙģÿĞþĤ÷ĤĕõĥýĘęĈïĭıĠôÿĠû", (byte)10, 65);
               b[11] = ζοηκορΦνΣθγΩ.A("÷êËýĉÙïĉēâöÛ", (byte)10, 65);
               b[12] = ΨφιωσρΓδΔθ.B("öâêèÛäüĆÊĔĎóÐęĊîÚ÷êþėùæç", (byte)10, 66);
               b[13] = λΣΩσμφγχ.D("чОкШИЙкШЍАщВБъзфЎШЮіКмпрюяѕфсХъш", (byte)10, 68);
               b[14] = ΣφδσΔζιΠρα.B("ÞìÅþçæÚÒĊÿĉéĈĐúÒčĕõÞÞéæç", (byte)10, 66);
               b[15] = πηγμΣΔκκ.F("ӷԶԒԬԑԵՃԳԧԄԒԀԝԸԽԋԸԩԻԐՉԜԙԚ", (byte)10, 70);
               b[16] = λΣΩσμφγχ.A("ĆÿýþÊÊâóòÏĕÔćâøôüÙìċàďæç", (byte)10, 65);
               b[17] = φΨαξωυθανΣφυκη.A("ÞÜÚëăčđĆÞï÷ďáĊëÚÖĈċÛĈÿčáďáðĖèþĔĥ", (byte)10, 65);
               b[18] = θεωψξβΛσσ.E("ӾԕԱԎԬӺԃԥԱԡԪՂԇՀԍԄԦԼԋՓՌԾՕՀՏԣՌՏԻԤ\u0558Չ՛ԙՎԲՍԟՎ՟բ՟՜ԼԳ\u0557էՉԽԻՙԱ՝ղԹԺ", (byte)10, 69);
               break;
            case 1:
               b[0] = δΛψπξκσβγςα.F("ԑԟӸԱԚԙԍԅԽԲԾԘԃՋԘՈԹՍԾՊԮՌՕՌԬԑ\u0530՛ԓԖԚԼ", (byte)10, 70);
               b[1] = χφπρψπφΦθμπ.E("ӿԐԎӼԝԡԀԒԃԗԨԲՄԵՋԙՀՋԽԺԎԊՀՊՈԔՑՅՆԹԕՇ", (byte)10, 69);
               b[2] = λΣΩσμφγχ.B("ÛÝèùÿúãēĔĎîÿõĈěêÛĊćÖïéæç", (byte)10, 66);
               b[3] = φΨαξωυθανΣφυκη.A("øìÚĂìÚßàñÓĈÛ", (byte)10, 65);
               b[4] = ζοηκορΦνΣθγΩ.C("зРХчэкПЭгѕшбуювгГШЬКрдЮНікнѦЦўыѝ", (byte)10, 67);
               b[5] = πηγμΣΔκκ.A("õêÍĐØÌÑáæČâÛ", (byte)10, 65);
               b[6] = μζξτΩσσφυδεπλΨ.E("ӼԍԿԛԓӺԞԮԤՀԧԫՈԵԾԋԫՋՉԞՀՒԙԚ", (byte)10, 69);
               b[7] = ΠΛΨοδΩσμνΛγΦφβς.A("àÌããĆĆéþÞèåāāąûĉæĕĒČĀěðãßĒĘģĥæåá", (byte)10, 65);
               b[8] = μζξτΩσσφυδεπλΨ.C("еЧрИийбНІєѐєШФйИєэЖѠЙЯПзѠеИїѤџзыоѨѨЩѧтрѥѕєєцѹгзѴчѫњбѵљцч", (byte)10, 67);
               b[9] = ΣφδσΔζιΠρα.A("àÌããĆĆéþÞèäĕÔúûĄä÷ýúïúĘăĤöĦĝáãåë", (byte)10, 65);
               b[10] = φΨαξωυθανΣφυκη.B("÷ÄéÞĊĐÚþëĄÕÍčåÌÛĝĒýñ×ÙģÿĞþĤ÷ĤĕõĥèĊāĭĨİđĈĒįĒû", (byte)10, 66);
               b[11] = βθκςνθΩθυμςτκχ.B("íîÜÊđëÝéĔðêÛ", (byte)10, 66);
               b[12] = μεςΩΔΣγν.E("ԩԕԝԛԎԗԯԹӽՇԿԽԙԧՂԠՄՈԚԭԌԬԙԚ", (byte)10, 69);
               b[13] = οΩνΩρωλΨηΛδωδ.A("ćÞúèØÙúèÍÐĉÒÑĊ÷ĄÎèîĖÚýóîĖôēûĢĈúī", (byte)10, 65);
               b[14] = ΦδφπθΩΩλζξ.E("ԑԟӸԱԚԙԍԅԽԲԽԊԡԃՉԄԻՇՅԣՉԐՑԾԉԲՄՑԻԼՖԺ", (byte)10, 69);
               b[15] = πψυκΠΨμΛΩβΣφμφσ.F("ӷԶԒԬԑԵՃԳԧԄԔԫԛӾԷՍՍՄՊԭԢԬԙԚ", (byte)10, 70);
               b[16] = ζοηκορΦνΣθγΩ.D("цпноЊЊТгвЏєЯиюкуКюипЪЛТёѣХхѨкцои", (byte)10, 68);
               b[17] = ΦδφπθΩΩλζξ.D("ОМКЫуэёцОЯзяСъЫКЖшыЛшпњићСѠѧѧўѝѧ", (byte)10, 68);
               b[18] = ζοηκορΦνΣθγΩ.D("ЋТоЛйЇАвоЮзяДэКБгщИѠљыѢэќаљќшбѥіѨЦћпњЬћѬѯѬѨьѳѕаейѝнкиљцч", (byte)10, 68);
               break;
            case 2:
               b[0] = ΠΛΨοδΩσμνΛγΦφβς.B("çÞÞÝĆûČĎĔÿíð×ô÷÷ýėėėĒďæç", (byte)10, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = ΠΛΨοδΩσμνΛγΦφβς.E("ӺԿԀԖԳԂՂԑԇԧԟԀԴԥԸԈԙԢԞՐ\u0530ԜԙԚ", (byte)10, 69);
         }
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  πβΛφΨΦφδαΔηπχς.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ιΠοθΩΦξκ.A("ÃåçÇëĊĂĘĄÓđćĕďØýğĞĖĜĖë", (byte)14, 65), πβΛφΨΦφδαΔηπχς.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(ςΦζσμτΓσ.A("þċĊÍčĉĄčĘćÔĒĖďĒĘÚѬџщѵјїѸѧѥщѭѷѿѻô", (byte)14, 65) + var1 + ιΠοθΩΦξκ.F("Ԅ", (byte)14, 70) + var2.toString(), var4);
      }
   }

   protected πβΛφΨΦφδαΔηπχς(ρΣππμζθμπνοΣ var1, εηχβγρΦβΦΛκγΦοδ<?> var2, ΔγΨνςχιδκτςες var3, @Nullable Consumer<HikariConfig> var4, ωλΛνρκηΦηβζ var5) {
      ΔυΠωθαψδΣΣαδψω var10000 = var2.a();
      ρΣνμχγΨοΔΦ[] var10001 = new ρΣνμχγΨοΔΦ[a];
      var10001[b] = var1.a();
      if (!var10000.a(var10001)) {
         throw new RuntimeException(c<"㺀">(c, d ^ e) + var1.v() + c<"㺃">(f, g));
      } else {
         Properties var6 = var3.a();
         var6.putIfAbsent(c<"㺆">(h, i ^ j), c<"㺉">(k, l ^ m));
         var6.putIfAbsent(c<"㺌">(n, o ^ p), c<"㺏">(q & r, s));
         switch (var5) {
            case a:
               HikariConfig var12 = new HikariConfig();
               var12.setPoolName(var2.q().toLowerCase(Locale.ENGLISH) + c<"㺒">(t, u ^ v));
               this.a(var12, var3);
               ...
               τπχωρμσκμΓασ var13 = new τπχωρμσκμΓασ(var12);
               this.g = new ΨΛωγρΛζχνβΠωπω(var1, var13, null);
               break;
            case b:
               ...
               try {
                  ...
                  throw new RuntimeException(c<"㺕">(ab, ac ^ ad) + this.w() + c<"㺘">(ae, af) + var8.getClass().getCanonicalName());
               } catch (IllegalAccessException | InstantiationException var11) {
                  throw new RuntimeException(c<"㺛">(ag & ah, ai) + this.w() + c<"㺞">(aj, ak), var11);
               }

               var6.putIfAbsent(c<"㺡">(al, am ^ an), var3.z());
               var6.putIfAbsent(c<"㺤">(ao, ap), var3.j());
               this.a(var6, (boolean)aq);
               this.a(var3);
               String var9 = this.a(var3);
               this.g = new Πρπμαθδθρυθ(var1, var7, var9, var6, null);
               break;
            default:
               throw new UnsupportedOperationException(c<"㺧">(ar, as) + var5);
         }
   ...
   protected void a(Properties var1, boolean var2) {
      if (var2) {
         var1.putIfAbsent(c<"㺀">(az, ba ^ bb), String.valueOf(TimeUnit.SECONDS.toMillis(bc)));
      }
   }
   ...
   protected void a(ΔγΨνςχιδκτςες var1) {
      try {
         Class.forName(this.w());
      } catch (ClassNotFoundException var3) {
         throw new RuntimeException(c<"㺀">(at, au ^ av) + this.a().v() + c<"㺃">(aw, ax ^ ay), var3);
      }
   }
