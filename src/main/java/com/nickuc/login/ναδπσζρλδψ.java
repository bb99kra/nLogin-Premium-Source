...
enum ναδπσζρλδψ {
   ...
   private static String[] a = new String[ναδπσζρλδψ.f];
   private static String[] b = new String[ναδπσζρλδψ.g];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = φΨαξωυθανΣφυκη.E("ԀӿԏӾԣՉԹԬԡԈՀԓ", (byte)15, 69);
               b[1] = θεωψξβΛσσ.D("ХюзѐєНаЛіПхЪ", (byte)15, 68);
               b[2] = ιΠοθΩΦξκ.E("ԞԐԒԡԺՊԆԊԋՎԚԓ", (byte)15, 69);
               b[3] = ΠΛΨοδΩσμνΛγΦφβς.F("ԸԷԲԙԣՃՂԡԖԫԾԦԭԍԫԢԣԒՁ\u0558Ԙ\u0557Ԟԟ", (byte)15, 70);
               break;
            case 1:
               b[0] = οΩνΩρωλΨηΛδωδ.C("фкЪиБвљљѡОнЪ", (byte)15, 67);
               b[1] = ντθΔζβΔζ.C("алШвџЛНЛЯјѦяђојѦгїќњЫшеж", (byte)15, 67);
               b[2] = ΦδφπθΩΩλζξ.D("юшьэђљпРіьѠчесгкТўеЬюиеж", (byte)15, 68);
               b[3] = δΛψπξκσβγςα.D("яющакњљиЭтєПФлШолрншѨўеж", (byte)15, 68);
               break;
            case 2:
               b[0] = ΣδτΠνεγοΓορητ.A("ĔÔîđúóėìĉĝĔĂÝïĤĄĤúþĈęęðñ", (byte)15, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = ιΠοθΩΦξκ.E("ԂԅԸԸՀԩԕԅԪԶԜԌԧԽԝԾԳԵՄԬԴ\u0557Ԟԟ", (byte)15, 69);
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(βεξΠθρρςΔΦμ.C("ҎҰҲҒҶӕӍӣӏҞӜӒӠӚңӈӪөӡӧӡҶ", (byte)59, 67), ναδπσζρλδψ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(ςΦζσμτΓσ.B("ŘťŤħŧţŞŧŲšĮŬŰũŬŲĴӃҸҼӉӍӁӍӈӂӗŊ", (byte)59, 66) + var1 + ζοηκορΦνΣθγΩ.F("Ա", (byte)59, 70) + var2.toString(), var4);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ςΦζσμτΓσ.B("ŀōŌďŏŋņŏŚŉĖŔŘőŔŚĜҫҠҤұҵҩҵҰҪҿ", (byte)47, 66));
         }
