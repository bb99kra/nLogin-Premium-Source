...
public enum γοηλιμεπη {
   ...
   private static String[] a = new String[γοηλιμεπη.r];
   private static String[] b = new String[γοηλιμεπη.s];
   ...
   public λθΩζιΣΔεΔθτβ a(ΨαχΨχΣλεΠψΦ var1) {
      return εδδΠηδξΛΣχ.a(this.a, var1);
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(δΛψπξκσβγςα.B("ūƍƏůƓƲƪǀƬŻƹƯƽƷƀƥǇǆƾǄƾƓ", (byte)98, 66), γοηλιμεπη.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            φδχεθοκψαλΛογλ.D("ԾՋՊԍՍՉՄՍ\u0558ՇԔՒՖՏՒ\u0558Ԛ࢟ࢬࢥࢪࢩࢭࢧࢳࢫԯ", (byte)98, 68) + var1 + οΩνΩρωλΨηΛδωδ.A("Ž", (byte)98, 65) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(χφπρψπφΦθμπ.B("ƢƯƮűƱƭƨƱƼƫŸƶƺƳƶƼžԃԐԉԎԍԑԋԗԏ", (byte)96, 66));
         }
   ...
   @Nullable
   public static γοηλιμεπη a(int var0) {
      γοηλιμεπη[] var1 = values();
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = μζξτΩσσφυδεπλΨ.D("ЫЦѭеЩѩѷЬђхчюѼѐѰѫнѬѐуў҆эю", (byte)23, 68);
               b[1] = ςΦζσμτΓσ.D("ќнџўѧѤѺхиіѻт", (byte)23, 68);
               b[2] = ζοηκορΦνΣθγΩ.F("ԵԶԢԫԍԐԮԭԥԝՐԛ", (byte)23, 70);
               b[3] = ΣδτΠνεγοΓορητ.B("ĢĐÚġąīĊãĦĂïďīéëċĔĈòĆķăĀā", (byte)23, 66);
               b[4] = πχσδΦΦνθΔπ.B("ĀĜæõéăīöêāÿĞĜıĦĖāîčĸĺĹĀā", (byte)23, 66);
               b[5] = οΩνΩρωλΨηΛδωδ.B("ĄħĩàĩĈāĕüĎĚģēĲĜčè÷òġēĹĀā", (byte)23, 66);
               b[6] = πηγμΣΔκκ.A("ûûðĩçħĈöåħüõ", (byte)23, 65);
               b[7] = λΣΩσμφγχ.F("ԻԻԺՆԹԡԦՐԆՏՔԛ", (byte)23, 70);
               b[8] = ςπυηννναΣ.F("ԄԩԷԎԼՊԫՓԜԠԷԳՑԧ՚ԱՆՙԨՒԜԹԦԧ", (byte)23, 70);
               b[9] = βεξΠθρρςΔΦμ.F("ԇԢԽԧԦ\u0530ԟԐԍԴԲԛ", (byte)23, 70);
               b[10] = ζβησεθωυγτ.E("ՋԭԭՈԬԡԦԣԆԝՌԛ", (byte)23, 69);
               b[11] = ζοηκορΦνΣθγΩ.C("цэЧгѡфѣгйѴёт", (byte)23, 67);
               b[12] = μεςΩΔΣγν.D("отўюжѸѧѐѼшмжѽѐѩњјѹ҄ѴѠ҆эю", (byte)23, 68);
               b[13] = ξψθρΣΠΣς.D("ќьЬыѯвѩшќѝмѸѭоѻѾѮпѶѱј҆эю", (byte)23, 68);
               b[14] = ΣφδσΔζιΠρα.C("ѴѮЫтхщїћиыдт", (byte)23, 67);
               b[15] = φΨαξωυθανΣφυκη.F("ԄՁԪԝԹՐՆՉԏՄԢԛ", (byte)23, 70);
               break;
            case 1:
               b[0] = φδχεθοκψαλΛογλ.C("ЫЦѭеЩѩѷЬђхцѵѰк҂Ѭѓѝѷ҅ѓѠэю", (byte)23, 67);
               b[1] = θεωψξβΛσσ.E("ԕԶԗԛԾԜՍՅԬՔԲԛ", (byte)23, 69);
               b[2] = ΠΛΨοδΩσμνΛγΦφβς.D("ѥЭыстѰјєѨѷѕт", (byte)23, 68);
               b[3] = ΨΦνΨΦωυΩνβςμ.D("ѯѝЧѮђѸїаѳяЯѿъяытҁѕѷњѾѶэю", (byte)23, 68);
               b[4] = βεξΠθρρςΔΦμ.C("эѩгтжѐѸузюьдѼйѕыџѿѽѣѨѺѕѫєѪѭѪљћѫ҅", (byte)23, 67);
               b[5] = μζξτΩσσφυδεπλΨ.E("ԪՍՏԆՏԮԧԻԢԴՃԷԫԑՆԨԸԷԾ\u0558Ԯ՟Ԧԧ", (byte)23, 69);
               b[6] = πηγμΣΔκκ.B("ĔòûĂėĉğĠĦġøĎēĊĲĂġĄĥģĲĹĀā", (byte)23, 66);
               b[7] = ξψθρΣΠΣς.C("ѥщѕѵёьэцёѹиїэѿѽџісѿќѓѠэю", (byte)23, 67);
               b[8] = ζοηκορΦνΣθγΩ.D("ЫѐўеѣѱђѺучѦўѺѼјѯѶѠѣ҇р҆эю", (byte)23, 68);
               b[9] = φΨαξωυθανΣφυκη.C("ёѡѭеѕђзбьвѮѾѕѕъъѼљюѸѼѶэю", (byte)23, 67);
               b[10] = πχσδΦΦνθΔπ.D("ЫђщюѶчЫјєіѳт", (byte)23, 68);
               b[11] = ντθΔζβΔζ.E("ӾԙԊՉԤԻԬԴՏԫԏԲՓՍԐՋԎՏԪԾԾԩԦԧ", (byte)23, 69);
               b[12] = χφπρψπφΦθμπ.F("ԗԛԷԧԏՑՀԩՕԡԕԎՃՖՑԓԼ\u0558ԲԯԞԩԦԧ", (byte)23, 70);
               b[13] = χΠξΦιζΨΣωΦσΨζ.F("ԵԥԅԤՈԋՂԡԵԶԖԲՏԺԩՕԫՖԲՇՎԹԦԧ", (byte)23, 70);
               b[14] = λΣΩσμφγχ.D("џвЫхѐёььѺѝўћїѷѫѺтѲѽѢѹ҆эю", (byte)23, 68);
               b[15] = βθκςνθΩθυμςτκχ.E("ԅԩՀԽՄԞՅԤԔՖԦԛ", (byte)23, 69);
               break;
            case 2:
               b[0] = θεωψξβΛσσ.F("ՃՁԶԁԜԡԣԍԋԪՄԛ", (byte)23, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = ΠΛΨοδΩσμνΛγΦφβς.B("ėýÞĩĨćĖý÷ĥýĦĪħčçĵăĖįıĵļüĶĖįďĭēĘģ", (byte)23, 66);
         }
      }
   }
   ...
   @Generated
   private γοηλιμεπη(ΨΓΩωΨΔξει var3) {
      this.a = var3;
   }

   public αΠαβσΠτΦ a(ΨαχΨχΣλεΠψΦ var1) {
      return new αΠαβσΠτΦ(this, this.a(var1));
   }
}
