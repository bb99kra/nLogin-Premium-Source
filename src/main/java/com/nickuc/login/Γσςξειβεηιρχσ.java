...
public class Γσςξειβεηιρχσ {
   ...
   private static String[] b = new String[Γσςξειβεηιρχσ.aj];
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(λΣΩσμφγχ.D("ӫԍԏӯԓԲԪՀԬӻԹԯԽԷԀԥՇՆԾՄԾԓ", (byte)90, 68), Γσςξειβεηιρχσ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            φΨαξωυθανΣφυκη.F("չֆօՈֈքտֈ֓ւՏ֍֑֊֍֓Օࢺࣲࣣࣦࣩࣹࣶ࣫࣫ࣨ࣠ࣥࣟծ", (byte)90, 70) + var1 + ΣερμΔσατσκ.F("Ր", (byte)90, 70) + var2.toString(), var4
         );
      }
   }
   ...
   private void aC() {
      if (this.bI == null) {
         this.bI = this.x(c<"㺀">(a, b ^ d));
         this.bJ = this.x(c<"㺃">(e, f ^ g));
         this.bK = this.x(c<"㺆">(h, i ^ j));
         this.bL = this.x(c<"㺉">(k, l ^ m));
         this.bM = this.x(c<"㺌">(n, o ^ p));
         this.bN = this.x(c<"㺏">(q, r ^ s));
         this.bO = this.x(c<"㺒">(t & u, v));
         this.bP = this.x(c<"㺕">(w, x));
      }
   }
   ...
   public Γσςξειβεηιρχσ(long var1, Locale var3) {
      this.w = var1;
      this.a = var3;
   }
   ...
   public Γσςξειβεηιρχσ(long var1) {
      this(var1, Locale.getDefault());
   }

   public Γσςξειβεηιρχσ(Locale var1) {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = φδχεθοκψαλΛογλ.A("žƀŞţžťƓŶƚŽƈű", (byte)85, 65);
               b[1] = ΨΦνΨΦωυΩνβςμ.E("ՃշՋՅջը՛Տ՟ֈՓՙ", (byte)85, 69);
               b[2] = βθκςνθΩθυμςτκχ.A("ŘŷƗƏƣƣƨƣƟŵƌű", (byte)85, 65);
               b[3] = μεςΩΔΣγν.E("՛պՌՠ\u0557Ջ՝ղէևվՙ", (byte)85, 69);
               b[4] = ςΦζσμτΓσ.D("ԫԋӷӬԦԲԬԟԞԟԭӼ", (byte)85, 68);
               b[5] = πχσδΦΦνθΔπ.D("ԛԤԬԊӰԌӽԯԍԦӿӼ", (byte)85, 68);
               b[6] = πψυκΠΨμΛΩβΣφμφσ.A("ƣƚŞƄŢźŵżżšūű", (byte)85, 65);
               b[7] = δΛψπξκσβγςα.F("ճռպՅտ֎գ֊բՠհՙ", (byte)85, 70);
               b[8] = χφπρψπφΦθμπ.D("ԙӫԚԋԩԓԟԌԍԦԱӼ", (byte)85, 68);
               b[9] = ΨΦνΨΦωυΩνβςμ.F("դՋռէրհ֏՟ի֒հՙ", (byte)85, 70);
               break;
            case 1:
               b[0] = ξψθρΣΠΣς.D("ԎԌԮӬԁԡԋӾԮԳӶӼ", (byte)85, 68);
               b[1] = δΛψπξκσβγςα.E("ՠդՄՠՖ՛ՆձՄՑ՜ՙ", (byte)85, 69);
               b[2] = φΨαξωυθανΣφυκη.C("ԚԖӦԍԜԥԪӽӽԵԓӼ", (byte)85, 67);
               b[3] = ζοηκορΦνΣθγΩ.B("ƠƀƟŵŶƂŦƀƈūƌű", (byte)85, 66);
               b[4] = ΠΛΨοδΩσμνΛγΦφβς.F("օեՂր՟փէծՋՅըՙ", (byte)85, 70);
               b[5] = χφπρψπφΦθμπ.B("ƏŲƁƜŸƙŠƟƉƄƆƈƄŸƣƯƮƟƉƍƔſżŽ", (byte)85, 66);
               b[6] = ΣφδσΔζιΠρα.B("źşƗŴŻƄƛťŻŨƄƋƯżƀƬŲƬƞƌžƵżŽ", (byte)85, 66);
               b[7] = ςΦζσμτΓσ.C("ӟӫӷԢԪԠԥԤԐӭӭԹԇԅԧԧԦԺԯԵӷԊԇԈ", (byte)85, 67);
               b[8] = πψυκΠΨμΛΩβΣφμφσ.D("ӧԇԣԤԙԑ\u0530ԔӱԌԭӼ", (byte)85, 68);
               b[9] = ΠΛΨοδΩσμνΛγΦφβς.A("ƐūŽţƒƤźžŧƔƞű", (byte)85, 65);
               break;
            case 2:
               b[0] = ΣερμΔσατσκ.A("ſūśťŮšƕŤžŽŧƫƁƉƀưƑƍŽƢƗƥżŽ", (byte)85, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = ξψθρΣΠΣς.B("ƓŝƁƓſƕƚƀƤƚƦƂƉƙƍŬŬƇƆƊƷųƠƈųƒƯƽƟƼƔŽ", (byte)85, 66);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣερμΔσατσκ.F("Վ՛՚ԝ՝ՙՔ՝ը\u0557Ԥբզ՟բըԪ\u088fࣀࣀࢽࢵࢺࢴࢸࢻࢾࣇ࣎࣋", (byte)47, 70));
         }
   ...
   public static String a(long var0, long var2, boolean var4) {
      ...
      ΠσνδσκξΠθεΨ[] var8 = ΠσνδσκξΠθεΨ.values();
      int var9 = var8.length;

      for (int var10 = z; var10 < var9; var10++) {
         ΠσνδσκξΠθεΨ var11 = var8[var10];
         if (!var4 || var11 != ΠσνδσκξΠθεΨ.d || var5 < aa) {
            long var12 = (Long)ΠσνδσκξΠθεΨ.a(var11).apply(var5);
            if (var12 > 0L) {
               if (var7.length() > 0) {
                  var7.append(c<"㺀">(ab, ac));
               }

               var7.append(var12).append(ΠσνδσκξΠθεΨ.a(var11));
            }
         }
      }
