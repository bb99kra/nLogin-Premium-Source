...
public interface ΨαχΨχΣλεΠψΦ extends θΦγνΩερριδκ {
   κκψασΩψμωΩυθ a();
   ...
   default InetSocketAddress b() {
      ...
      if (var1 == null) {
         throw new IllegalArgumentException(φδχεθοκψαλΛογλ.A("ĖĺĻŊľōŎüŒŌŀŖłŋŏŅŇŒŌĈŏřŝČ", (byte)43, 65) + this);
      } else {
         return var1;
      }
   }
   ...
   void a(εηχβγρΦβΦΛκγΦοδ<?> var1, γΦΠυρρρπη var2, Object var3, byte[] var4);
