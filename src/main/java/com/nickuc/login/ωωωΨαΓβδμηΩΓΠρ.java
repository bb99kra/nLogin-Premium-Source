...
public class ωωωΨαΓβδμηΩΓΠρ extends ΨιβιψκωΓγ {
   private static long f = Long.reverse(248438088264159289L);
   private static String[] d = new String[ωωωΨαΓβδμηΩΓΠρ.m];
   ...
   public ωωωΨαΓβδμηΩΓΠρ(ξςγΛωπεΠωγπχ var1) {
      this.a = var1;
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ωωωΨαΓβδμηΩΓΠρ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ςπυηννναΣ.D("ԌԮ\u0530ԐԴՓՋաՍԜ՚Ր՞\u0558ԡՆըէ՟ե՟Դ", (byte)101, 68), ωωωΨαΓβδμηΩΓΠρ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζβησεθωυγτ.C("ՇՔՓԖՖՒՍՖաՐԝ՛՟\u0558՛աԣࢾࢿࣀࢠࢪࢍࢭࢰࢹࢵࢨ\u0893ࢡࣃԽ", (byte)101, 67) + var1 + φΨαξωυθανΣφυκη.E("՛", (byte)101, 69) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(οοθδΨιοΦΠβδζ.E("ճրտՂւվչւ֍ռՉև\u058bքև֍Տ࣪࣫࣬࣌ࣖࢹࣙࣜࣥ࣡ࣔࢿ࣯࣍", (byte)84, 69));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = οΩνΩρωλΨηΛδωδ.A("ƟƜơƀƉŶƅƦƊƜƙƁƢƞƳŬƎƥƫƶƂƃƀƁ", (byte)87, 65);
               break;
            case 1:
               d[0] = ιΠοθΩΦξκ.F("օւևզկ՜ի\u058cհւշհօ֑թ֔ֆզչթոր֛ձ֒տ֚՞ձ֦չ֓", (byte)87, 70);
               break;
            case 2:
               d[0] = πηγμΣΔκκ.A("ƆƑŶũƖƜƭƂƬźƙƤƛƛŰƤűƭƍŴƑƃƀƁ", (byte)87, 65);
            case 3:
            default:
               break;
            case 4:
               d[0] = ΠΛΨοδΩσμνΛγΦφβς.D("ԅԋԓԥԧԬԢԆԪԝӽԊԌԘԎԽԮԹӾԽԓԠԍԎ", (byte)87, 68);
         }
      }
   }
}
