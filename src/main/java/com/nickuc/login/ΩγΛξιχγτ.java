...
public enum ΩγΛξιχγτ {
   a(ΔΔβΓσθρΔω.class),
   b(εχχξλχΠΠΠΛΣββχΣ.class),
   c(ΦζαΩςωης.class),
   d(οωζδΠεφκΔχΔδωσρ.class),
   e(φσηΣλξμρβχ.class),
   f(ςβφΩΓσξιηιΦΠ.class),
   g(ΔνΠηυςδΩΛβτΦπ.class),
   h(ζαωφαωΨεεΛΣΓτο.class),
   i(ΨΠτσδφΨν.class),
   j(ΦΩξδχΛΣβΓταθσκκ.class),
   k(ΠγξθνΨΠΦττΣρ.class),
   l(ζκκΓΣΔαζψ.class),
   m(ΨζψσπνυΣ.class),
   n(ωπφΓασεΠχ.class),
   o(ρινχξλΛηαυΓπσΩ.class),
   p(μφΛΓδΨξκσος.class),
   q(ηξωβσΩχλδ.class),
   r(ΓξΩΓρυεεοξΓΩΛπχ.class),
   s(ωπλδωσΩΠ.class),
   t(θαζτλΔΔλ.class),
   u(οθΛσξαΩκΩ.class),
   v(ξηΦΛΣθτε.class),
   w(ρφηξξωυαρζνξΦ.class),
   x(βπψοβσρκΠφκΓΣΛθ.class),
   y(ωψζςιλζπΦςζΠ.class),
   z(ΓςΦαψοκβ.class),
   A(γΓΠσΛξξιθκ.class),
   B(ΩλαΠηΩχΔεωςΔ.class),
   C(ζΛζκεΣΔρβ.class),
   D(ρΓΔκρΠθτλχγΦΓ.class),
   E(ωΦγηηρΔαηα.class),
   F(ςυΣλςΦφφ.class),
   G(δπςφΩοτσςΠκρβης.class),
   H(ρργεΛτΛχΣ.class),
   I(σχυυισρΣο.class),
   J(λΨΛΨγπγΛΨλ.class),
   K(νζοιεμθΛηξτυωΦθ.class);

   private final εβοςοηΦςψμνςωξΛ a;
   private static String[] a = new String[ΩγΛξιχγτ.av];
   private static String[] b = new String[ΩγΛξιχγτ.aw];
   ...
   private static int do = (4718592 >>> 210 | 4718592 << -210) & -1;
   ...
   private static ΩγΛξιχγτ[] a(boolean var0) {
      if (var0) {
         ΩγΛξιχγτ[] var1 = values();
         ΩγΛξιχγτ[] var2 = new ΩγΛξιχγτ[var1.length];
         int var3 = e;
         ΩγΛξιχγτ[] var4 = var1;
         int var5 = var1.length;

         for (int var6 = f; var6 < var5; var6++) {
            ΩγΛξιχγτ var7 = var4[var6];
            if (var7.a instanceof ιΨφαρελΣζΠΔΩ) {
               var2[var3++] = var7;
            }
         }
         ...
         for (int var10 = g; var10 < var5; var10++) {
            ΩγΛξιχγτ var11 = var4[var10];
            if (!(var11.a instanceof ιΨφαρελΣζΠΔΩ)) {
               var2[var3++] = var11;
            }
         }
   ...
   private ΩγΛξιχγτ(Class<? extends εβοςοηΦςψμνςωξΛ> var3) {
      try {
         Class[] var10002 = new Class[a];
         var10002[b] = ΩγΛξιχγτ.class;
         Constructor var10001 = var3.getConstructor(var10002);
         Object[] var6 = new Object[c];
         var6[d] = this;
         this.a = (εβοςοηΦςψμνςωξΛ)var10001.newInstance(var6);
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ντθΔζβΔζ.A("ĹśŝĽšƀŸƎźŉƇŽƋƅŎųƕƔƌƒƌš", (byte)73, 65), ΩγΛξιχγτ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ξψθρΣΠΣς.F("ըյմԷշճծշւձԾռրչռւՄࢿ࣊ࢳ࣓ࣗ\u08e2࣏࣡\u0558", (byte)73, 70) + var1 + φδχεθοκψαλΛογλ.B("ŋ", (byte)73, 66) + var2.toString(), var4
         );
      }
   }

   public εβοςοηΦςψμνςωξΛ a() {
      return this.a;
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΨφιωσρΓδΔθ.C("мщшЋычтыіхВѐєэѐіИޓޞއޫާ\u07b6ޣ\u07b5", (byte)12, 67));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = βεξΠθρρςΔΦμ.F("֗՚֎ս֗ո՞՞֘ք֛֢՞յդճոբչ\u058b֮չխգ֊ի֔մ֧֭փ֍և֑֭օ֨\u058cָրտ֛ջ։", (byte)101, 70);
               b[1] = ντθΔζβΔζ.C("Ծ՞ԲՍՖԚՃՓ՞ՃՑ՟Օաթգ՞\u0557հլՇԫՐՠՈԵկՉէձպջպխշ՜ԾմԼվչՕԾՌ", (byte)101, 67);
               b[2] = ΠΛΨοδΩσμνΛγΦφβς.A("ƣǃƗƲƻſƨƸǃƨƹƾƉơƌƋǆƯǃƍǄǐƘǏǖƥǝǑƵǏǒǘ", (byte)101, 65);
               b[3] = ςπυηννναΣ.A("ƖŻƤƞƵƤƧǉƉƣƞƣǋƋƇƦƤưǁƒƠƯƜƝ", (byte)101, 65);
               b[4] = ςπυηννναΣ.B("ƖŻƤƞƵƤƧǉƉƣƞƘƤƊǈǁƎƪǕƮƥǅƜƝ", (byte)101, 66);
               b[5] = χφπρψπφΦθμπ.C("ԵՓԫՁՊԞ\u0557Ձ՞զէգՙզ՜ԶժԷՄՆԭ՞գԬՠշ\u0530բԱՐԶ՚", (byte)101, 67);
               b[6] = ζβησεθωυγτ.B("ƚƸƐƦƯƃƼƦǃǋǌƕƌƜǂǋƮǓƔǅƫǅƜƝ", (byte)101, 66);
               b[7] = πψυκΠΨμΛΩβΣφμφσ.B("ƪǄƣƓƧǆƵƑƵƕƊǃǉƮǆǐƑƒƎǂƓƟƜƝ", (byte)101, 66);
               b[8] = πψυκΠΨμΛΩβΣφμφσ.B("ƣǃƗƲƻſƨƸǃƨƶǄƺǆǎǈǃƼǕǑƬƕǕƩǃƦƽƔƺƛƪǋƴǝƞƠƲǤǡƳƾǜǖƱ", (byte)101, 66);
               b[9] = ςΦζσμτΓσ.A("ƀǄƷǂƚƾƜơƨƃǇƜƌƘƮơǒǉǊƪƱǊƧƲǆƺƗƬǝƻƩǋƱǋǁǐǠƙƠƿǖƩƫƱ", (byte)101, 65);
               b[10] = ΣφδσΔζιΠρα.B("ƮƎƀǅƞƏƣƅƻƫƘƦǃƥǊƥƩǐƋƪƤǎǋƸƗƓƗƲƽƛƱƱ", (byte)101, 66);
               b[11] = βεξΠθρρςΔΦμ.A("ƀƎƮƾƜƾſƞƁƹžǆǌƮƹƱƫƿƌƒǗǅƜƝ", (byte)101, 65);
               b[12] = οοθδΨιοΦΠβδζ.B("ƴƷżƢƄǂƹƦƒƇƻƢƅƯƧƠǈǈƲƬǔƟƜƝ", (byte)101, 66);
               b[13] = οΩνΩρωλΨηΛδωδ.A("ƠǂǀƁƱƷƙƗƔƈƸƧƶƨƨưǇƍǂƍǀƿƏƦƭǄƶƜǊǞƵǌǓǎƚǂǁƷǅǆƹơǪƱ", (byte)101, 65);
               b[14] = βεξΠθρρςΔΦμ.B("ƠǂǀƁƱƷƙƗƔƈƶǍƿƷǇƛƫƲƓƣƢǍƎǕǙǋǏǏưƳǋƾƹƞǎƾƝǈǕǓƼǩƼƺǙƪǀǭǯƪǪǈǫƿƼƽ", (byte)101, 66);
               b[15] = λΣΩσμφγχ.C("Ի՝՛ԜՌՒԴԲԯԣՔԴՔՔԪ՟Իՠՠթզ՝\u0530ժՆՊԴգծԷձէՆտՎԷյփԺւնրՓՌ", (byte)101, 67);
               b[16] = ΣερμΔσατσκ.B("ƴǀƘƤǁƔƇƝƁƆƛƫƞƙƜƤǈƛƵƨǖƯƜƝ", (byte)101, 66);
               b[17] = φΨαξωυθανΣφυκη.B("ƠǂǀƁƱƷƙƗƔƈƷǆƈǅƍƦƨƽƩƝǖǆǈƘǂƼǇǙǟƙƚƯ", (byte)101, 66);
               b[18] = ΨφιωσρΓδΔθ.D("Ի՝՛ԜՌՒԴԲԯԣՓգՈՖ՞\u0557ԩՈՎգԪէՎՋՁՉԲմՄՔոշ", (byte)101, 68);
               b[19] = φΨαξωυθανΣφυκη.F("Ռք\u0558Ք֘մ՜ղծ֠լ֢զնմ֕֨ֈը֩֎ֆվ֍ս։֢֩փճ֠ձ\u058cնչ֞֍֎ֶַֹ֔֘։", (byte)101, 70);
               b[20] = ζοηκορΦνΣθγΩ.E("ո֚֘ՙ։֏ձկլՠ֏ջ֛ս֚զ֜պ\u058b֢ց֜սժդ։ֈս֗ճֲ֏յֱ֫֊֯յַ\u058b֡֕տ։", (byte)101, 69);
               b[21] = θεωψξβΛσσ.A("ƠǂǀƁƱƷƙƗƔƈƷƣǃƥǂƎǄƢƳǊƩǄƥƒƌƱưƥƿƛǚƷǞƬƛƱƵƷǣǪơǃǫǎǧǰǁǛƿǛǢǰǟǴƷǑǆǬƶǋǛǴǏǐ", (byte)101, 65);
               b[22] = χφπρψπφΦθμπ.B("ƾƒƒƒƳƅƹƵƅƚǆǆǋǄǃƯƼơǒƶƓƪƸǖǊǎǇǛƦǋƸƙƲǡǖƳưƦǧǑƢǘǀǦǀǬǬǥǃǢƯǕǁǵƼƽ", (byte)101, 66);
               b[23] = ΨΦνΨΦωυΩνβςμ.E("֓պ֒֔Ֆֈ֒ւռւ\u0590օդ֒ֆփ\u058bենտխ֑֮֝֊հժ\u058b֖֨֯հյևֆְ\u0590\u058cֽ֖֮֨֗֗սֳ֜օ֫\u05c9ֶ֣ևֽ֔֕", (byte)101, 69);
               b[24] = μζξτΩσσφυδεπλΨ.A("ƮǃƹǀſƚǅƃƆƥƽƇǉǋƺƎƒƭƓƠƫƴƒƶƥǍƓƪƲƜǜǟ", (byte)101, 65);
               b[25] = πχσδΦΦνθΔπ.E("ջֈ։լ֚յ֊\u058c֚֒շհֆ֓փ֡֊չլթ֥֯ժ֢֑րհրֵ\u058bִַ", (byte)101, 69);
               b[26] = ΣφδσΔζιΠρα.A("ƳƳƒƮƲƺƕƇżǄƺƪƢǃưƯƐƭǋƍǗǍƪǁƘƨƛưƯǉƴƽ", (byte)101, 65);
               b[27] = βθκςνθΩθυμςτκχ.B("ƳƏưƿſǃƣǅǇƥƞƸƠƟƸƏƉƾƤƪƐƓƕƏƧǔǒƾǉǟƞǔ", (byte)101, 66);
               b[28] = πχσδΦΦνθΔπ.F("֛Սն֎տ֖֘ւ֙ի֑֜֝բւմ֣֜֘֠շռտւ֧ծ֯\u058bւָ֪֣", (byte)101, 70);
               b[29] = ΣφδσΔζιΠρα.F("նո՚Ք՝՝֞\u058c֙ս՟ա֕ք֛֥զւ֞փցռ֪֧\u058b֣֯կְյֱհ", (byte)101, 70);
               b[30] = ντθΔζβΔζ.A("ƘƎǁǄƤƺƦƞƼƳƊƪƼǋƻǑƒǑǌƲưƯƏǈƚǅǒǌƴǘƛƽ", (byte)101, 65);
               b[31] = πψυκΠΨμΛΩβΣφμφσ.C("ԛ՟Ւ՝ԵՙԷԼՃԞաԧՖՙԥխՀՀ՞ՠԯ՜՜ՂիժիՏհԲՖշ", (byte)101, 67);
               b[32] = ζοηκορΦνΣθγΩ.A("ƠƲƵƔƂƼƾƙƼƈǀƈƚƯƜƐǌƿƜƋǊƶǕǙƖƹǜƦƨƹƯƮ", (byte)101, 65);
               b[33] = λΣΩσμφγχ.E("ջ֛կ֊֓\u0557ր\u0590֛ր\u0590խ֕բ՚պ֖ֈզ֡։֭մյ", (byte)101, 69);
               b[34] = ΣδτΠνεγοΓορητ.D("ԾՍԧԪԪԙԝԚԲԯԳ՛ՠՔՅԩԾ՝աեԹՍԫՀՀԾհգՔԷԶՍ", (byte)101, 68);
               b[35] = πψυκΠΨμΛΩβΣφμφσ.E("զՍո֙֊֑ո՚ռ֣բճգդո֠ստ֝փ֮֗ս֙րժ֊֖ւֲ֖֠", (byte)101, 69);
               b[36] = φΨαξωυθανΣφυκη.E("ջ֛կ֊֓\u0557ր\u0590֛ր֏֎քճբ֖֔\u058bշ֬։եְֱֶ֛֓֜֜֟֘\u058c", (byte)101, 69);
               b[37] = θεωψξβΛσσ.C("ԹՎՙԜՔԙգ՛ՐԣՅԱՁԪԢՌ՛ՌԬԻզհԷԸ", (byte)101, 67);
               break;
            case 1:
               b[0] = πηγμΣΔκκ.D("՚ԝՑՀ՚Իԡԡ՛Շ՞եԡԸԧԶԻԥԼՎձԼ\u0530ԦՍԮ\u0557ԷհժՆՐՓԵծԽնԿՁՖռմ՟Ռ", (byte)101, 68);
               b[1] = ντθΔζβΔζ.F("ջ֛կ֊֓\u0557ր\u0590֛ր֎֦֛֭֜֒֞֠֔֩քը֍֝օղ֬ֆַָ֤֮ևշչ֯֍֬\u0590֛ջׂ֔։", (byte)101, 70);
               b[2] = ξψθρΣΠΣς.A("ƣǃƗƲƻſƨƸǃƨƹƾƉơƌƋǆƯǃƍǄǈǏǉƶƗƨƱƫƧǐǐ", (byte)101, 65);
               b[3] = ξψθρΣΠΣς.C("ԱԖԿԹՐԿՂդԤԾԺԳԹԥզԶՌթՆԫ՟ՎՐՓիԨՇՁՉՖթո", (byte)101, 67);
               b[4] = λΣΩσμφγχ.F("ծՓռն֍ռտ֡աջն՟ւո֥֨֒ըշ֜ոս֜ց\u058bւմ\u0590քտ։֓", (byte)101, 70);
               b[5] = χφπρψπφΦθμπ.C("ԵՓԫՁՊԞ\u0557Ձ՞զէգՙզ՜ԶժԷՄՆԭ՛Ԫ՞ՈգիՐՊՒՙե", (byte)101, 67);
               b[6] = ντθΔζβΔζ.B("ƚƸƐƦƯƃƼƦǃǋǍƵǀǍƠǒƍǆƭƢƣǗǂǆƳǓƨǋƳƛƹƳ", (byte)101, 66);
               b[7] = θεωψξβΛσσ.E("ւ֜ջիտ֞֍թ֍խայ֛ջ֚֚֙֗\u058bըְ֫ևօְֱ֪֕փն֍֑", (byte)101, 69);
               b[8] = φΨαξωυθανΣφυκη.B("ƣǃƗƲƻſƨƸǃƨƶǄƺǆǎǈǃƼǕǑƬƕǕƩǃƦƽƔƺƛƪǋǕǁƝơǗǓǉǖƳǁǈƱ", (byte)101, 66);
               b[9] = ΠΛΨοδΩσμνΛγΦφβς.A("ƀǄƷǂƚƾƜơƨƃǇƜƌƘƮơǒǉǊƪƱǊƧƲǆƺƗƬǝƻƩǋƹƚǗǜơƠǟƶǓǛǈƱ", (byte)101, 65);
               b[10] = ξψθρΣΠΣς.E("ֆզ\u0558֝նէջ՝֓փհվ֛ս֢սց֨գւռ֥վլֆִ֪֮\u058cֱֲշ", (byte)101, 69);
               b[11] = δΛψπξκσβγςα.E("\u0558զֆ֖մ֖\u0557նՙ֑դն֣֚օ֚բւ֊֠շ֧֊֏փ\u0590ցֆ\u058b֦ճկ", (byte)101, 69);
               b[12] = ΨφιωσρΓδΔθ.F("\u058c֏Քպ՜֑֚վժ՟֕՝գ֢ց֊֥֙և֣դ֜։֥֩֊֦֮֗֯֡\u058c", (byte)101, 70);
               b[13] = ιΠοθΩΦξκ.F("ո֚֘ՙ։֏ձկլՠ\u0590տ֎րրֈ֟ե֚ե֘֗էվօ֜֎մֶ֢֍֤֧֧ֆַּ֛պׂ֯յ֤։", (byte)101, 70);
               b[14] = βθκςνθΩθυμςτκχ.E("ո֚֘ՙ։֏ձկլՠ֎֥֗֏֟ճփ֊իջպ֥զֱ֣֧֧֭ֈ\u058b֣֖֑ն֦֖յׁ֭֠֫֔֕վ־ְֻׂ֧֥֚֠\u058bֽ֔֕", (byte)101, 69);
               b[15] = ΣερμΔσατσκ.D("Ի՝՛ԜՌՒԴԲԯԣՔԴՔՔԪ՟Իՠՠթզ՝\u0530ժՆՊԴգծԷձէխտՔց\u0557շ՟ՀՁևՏՌ", (byte)101, 68);
               b[16] = ζβησεθωυγτ.F("\u058c֘հռ֙լ՟յՙ՞ղ֝֏յ֒եֆըգյւ֏լ֢։ձְַ֦ղ֙֊", (byte)101, 70);
               b[17] = μζξτΩσσφυδεπλΨ.D("Ի՝՛ԜՌՒԴԲԯԣՒաԣՠԨՁՃ\u0558ՄԸձիելՔՇԳըգչհղ", (byte)101, 68);
               b[18] = μεςΩΔΣγν.B("ƠǂǀƁƱƷƙƗƔƈƸǈƭƻǃƼƎƭƳǈƏǉƭƺƪƴƧƖǒƝǀƵƽƛƸƛǗǃƵƠǊǢǄƱ", (byte)101, 66);
               b[19] = ΦδφπθΩΩλζξ.F("Ռք\u0558Ք֘մ՜ղծ֠լ֢զնմ֕֨ֈը֩֎ֆվ֍ս։֢֩փճ֠ձ֊֣ֈ֒֞յֲ\u058b׃֑֘։", (byte)101, 70);
               b[20] = ζοηκορΦνΣθγΩ.D("Ի՝՛ԜՌՒԴԲԯԣՒԾ՞Հ՝ԩ՟ԽՎեՄ՟ՀԭԧՌՋՀ՚ԶյՒ՛ձիսՠտ՞՝\u0557դչՌ", (byte)101, 68);
               b[21] = φδχεθοκψαλΛογλ.B("ƠǂǀƁƱƷƙƗƔƈƷƣǃƥǂƎǄƢƳǊƩǄƥƒƌƱưƥƿƛǚƷǞƬƛƱƵƷǣǪơǃǫǎǧǰǁǛƿǛǢǰǟǫǋƸǖǇǭǱǏƱǊǊ", (byte)101, 66);
               b[22] = ΦδφπθΩΩλζξ.F("֖ժժժ\u058b՝֑֍՝ղ֣֛֞֞֜և֔չ֪֎իւ\u0590ֳ֢֦֮֟վ֣\u0590ձ֊ֹ֮\u058bֈվֿ֩պְׂ֘սֵֽ֤֟־֊\u05cd׀ֽ֔֕", (byte)101, 70);
               b[23] = βεξΠθρρςΔΦμ.F("֓պ֒֔Ֆֈ֒ւռւ\u0590օդ֒ֆփ\u058bենտխ֑֮֝֊հժ\u058b֖֨֯հյևֆְ\u0590\u058cֽ֖֮֨֕֒֟ք\u05c8֖֔ս֝և֚֗֔֕", (byte)101, 70);
               b[24] = ΨφιωσρΓδΔθ.A("ƮǃƹǀſƚǅƃƆƥƽƇǉǋƺƎƒƭƓƠƫǄƶǒǄƪǈǝƕƲǟƝǚǍƽƸƴƳǃƣƠǛǞƱ", (byte)101, 65);
               b[25] = μεςΩΔΣγν.E("ջֈ։լ֚յ֊\u058c֚֒շհֆ֓փ֡֊չլթ֯֞իև֍֦֭֕֏ֶ֥ղ", (byte)101, 69);
               b[26] = ΨφιωσρΓδΔθ.B("ƳƳƒƮƲƺƕƇżǄƺƪƢǃưƯƐƭǋƍǗǆƎƪƒǑƤǚƐƖǒǔ", (byte)101, 66);
               b[27] = ΦδφπθΩΩλζξ.B("ƳƏưƿſǃƣǅǇƥƞƸƠƟƸƏƉƾƤƪƐƓƦƮƥƦƗǋƖƧǀǖǃƷǒƠưƺƺǅǁƺƫƱ", (byte)101, 66);
               b[28] = ΨΦνΨΦωυΩνβςμ.F("֛Սն֎տ֖֘ւ֙ի֑֜֝բւմ֣֜֘֠շջ֏֤֭֡֝փխֵևւ", (byte)101, 70);
               b[29] = οοθδΨιοΦΠβδζ.F("նո՚Ք՝՝֞\u058c֙ս՟ա֕ք֛֥զւ֞փցփ֧֭ջְ֛յ֊ָֹ֯", (byte)101, 70);
               b[30] = χφπρψπφΦθμπ.F("հզ֙֜ռ֒վն֔\u058bբւ֣֔֓֩ժ֤֩֊ֈ։ջ։ֳ֣օէղ֪֒ց", (byte)101, 70);
               b[31] = ζβησεθωυγτ.C("ԛ՟Ւ՝ԵՙԷԼՃԞաԧՖՙԥխՀՀ՞ՠԯ՝ՌՎԵ\u0557ՑԮՐԸճԹ", (byte)101, 67);
               b[32] = ΨΦνΨΦωυΩνβςμ.D("ԻՍՐԯԝ\u0557ՙԴ\u0557ԣ՛ԣԵՊԷԫէ՚ԷԦեՌԿՠթՇխԳ՚ջՈ՝", (byte)101, 68);
               b[33] = ζβησεθωυγτ.F("ջ֛կ֊֓\u0557ր\u0590֛ր֑֢֕շ֢֧գ֡֍օջ֭մյ", (byte)101, 70);
               b[34] = φδχεθοκψαλΛογλ.E("ջ֊դէէՖ՚\u0557կլհ֑֘֝ւզջ֢֚֞ն։֍֑֒ժվ֢֞֎֒֏", (byte)101, 69);
               b[35] = ςΦζσμτΓσ.C("ԩԐԻ՜ՍՔԻԝԿզԥԶԦԧԻգՀՂՠՆ՚ԤՀՉՑՄճըՈ\u0530մս", (byte)101, 67);
               b[36] = βεξΠθρρςΔΦμ.D("Ծ՞ԲՍՖԚՃՓ՞ՃՒՑՇԶԥՙ\u0557ՎԺկՌԪիԦԵժՠՍ\u0557ՔծՄ", (byte)101, 68);
               b[37] = βεξΠθρρςΔΦμ.E("ն\u058b֖ՙ֑Ֆ֠֘֍ՠփմդ֔֓֓֨բվֈլռ֣հ֜֊֮֞ք֪֙֒", (byte)101, 69);
               break;
            case 2:
               b[0] = οοθδΨιοΦΠβδζ.C("\u0558ԙՍԜ՝\u0558ԹԯԟԻԢԬ", (byte)101, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = πηγμΣΔκκ.B("ƸǁŶƎǄǀƥƵơƃƺƑ", (byte)101, 66);
         }
      }
   }
   ...
   public static ΩγΛξιχγτ a(int var0, boolean var1) {
      ΩγΛξιχγτ[] var2 = a(var1);
      if (var0 >= 0 && var0 < var2.length) {
         return var2[var0];
      } else {
         throw new IllegalArgumentException(c<"㺀">(h, i) + var0);
      }
   }
}
