...
public class δκυβΦΩαχΩβ {
   ...
   private static String[] b = new String[δκυβΦΩαχΩβ.m];
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            ...
            case 1:
               ...
               break;
            case 2:
               b[0] = ζοηκορΦνΣθγΩ.F("ԺդԲ՞ՠ\u0557ԶԦԤ՞ԩԱՄ՞՞ՄՇՋՒեՑՃՀՁ", (byte)49, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = θεωψξβΛσσ.C("ҁѻҳҌҕґҔґҵӋқҐ", (byte)49, 67);
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΣερμΔσατσκ.D("҂ҤҦ҆ҪӉӁӗӃҒӐӆӔӎҗҼӞӝӕӛӕҪ", (byte)55, 68), δκυβΦΩαχΩβ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(ςΦζσμτΓσ.E("Ֆգբԥեա՜եհ՟ԬժծէժհԲࢸࢿ࣋ࢹࢮࢲࢻ࣒ࢵࢿՈ", (byte)55, 69) + var1 + ξψθρΣΠΣς.C("Ҕ", (byte)55, 67) + var2.toString(), var4);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ςΦζσμτΓσ.F("ճրտՂւվչւ֍ռՉև\u058bքև֍Տ࣏࣯࣒ࣕࣜࣨࣖ࣋ࣘࣜ", (byte)84, 70));
         }
