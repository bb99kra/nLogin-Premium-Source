...
public class ξςγΛωπεΠωγπχ extends σηηκτλρχωβΓιξ {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = μεςΩΔΣγν.D("\u058b՜ՔռկՈձ՜կՍ֒ֈտՑնՙ֊֜՚ղմը֒֔պ՛կխւՠօփ", (byte)116, 68);
               d[1] = οΩνΩρωλΨηΛδωδ.E("֗֡֗ս\u058b֍ւ֤գծ֎֣֨կֲֵ֣֚֮֕֔ն֎֛ց\u0590׃ֵֵַׁ֦֟֩֕ւ֛֝\u05caֿ֑֯\u05c9֘", (byte)116, 69);
               d[2] = μζξτΩσσφυδεπλΨ.D("չոևոՇ֍֎աբմՔ֒օհւևկկէս֖էՒ֑շՠՖհւզ֨ՠչւ֞պ֖\u0590֍֤֞֜ռչ", (byte)116, 68);
               d[3] = θεωψξβΛσσ.E("֦֘֗֗զ֭֬րց֓եվ֟լ֦րֆְֱֳ֥֜֔պַ֑րַֿׁׅ֦֯֝֒փֱּׁׂ֭֮֫֘", (byte)116, 69);
               d[4] = πχσδΦΦνθΔπ.A("ƷǍƚƞǖƜƱǡǜƶǗƸǭǋƥǘǪƿǋǍǑǍƺƻ", (byte)116, 65);
               break;
            case 1:
               d[0] = ξψθρΣΠΣς.C("\u058b՜ՔռկՈձ՜կՍ֒ֈտՑնՙ֊֜՚ղմժռտ֕՞ծ֧֚֝֔թ֣֓֩ֈջ֤֍֣֜վ֪չ", (byte)116, 67);
               d[1] = ΣφδσΔζιΠρα.E("֗֡֗ս\u058b֍ւ֤գծ֎֣֨կֲֵ֣֚֮֕֔ն֎֛ց\u0590׃ֵֵֹ֦֟֩\u05c8ֶ֚֨֕\u05c8֨׀א֛֘", (byte)116, 69);
               d[2] = μζξτΩσσφυδεπλΨ.F("֦֘֗֗զ֭֬րց֓ճֱ֤֏֦֡֎֎ֆֵ֜ֆձְ֖տյ֏֡օׇտ֔։ַָ\u058c֦֮\u05cb׆\u05caׁ֘", (byte)116, 70);
               d[3] = μεςΩΔΣγν.B("ǏǎǝǎƝǣǤƷƸǊƜƵǖƣǝƷƽǪǓǜǨǋǧƱǮǈƷǦǔǮǼǉǜǿǴǴȀǣǎǀǤǽǪǤǙǪǜǆǈǬȍȈȎȃǚǛ", (byte)116, 66);
               d[4] = ντθΔζβΔζ.A("ƷǍƚƞǖƜƱǡǜƶǗǄǊǚƤƹǙǚƭƮǑƽƺƻ", (byte)116, 65);
               break;
            case 2:
               d[0] = δΛψπξκσβγςα.E("պ֘ըվ֭ցր֦֜ւ֝ո", (byte)116, 69);
            case 3:
            default:
               break;
            case 4:
               d[0] = ΦδφπθΩΩλζξ.F("֛ճ֤֖շ֖\u0590֊պ֚և֎էֳֶ֦֕ւ֛֖֚֩փք", (byte)116, 70);
         }
      }
   }
   ...
   public void requestLogin(@Nonnull Identity var1, @Nonnull Object var2) {
      if (var2 == null) {
         ...
         throw new IllegalArgumentException(c<"㺃">(u, v ^ w));
      } else if (!(var1 instanceof δΓβςζΣψΠ)) {
         throw new IllegalArgumentException(c<"㺆">(aa, ac ^ ad) + δΓβςζΣψΠ.class.getCanonicalName() + c<"㺉">(af, ag ^ aj) + var1.getClass().getCanonicalName());
      } else {
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ζοηκορΦνΣθγΩ.D("жутЅхсмхѐпЌъючъѐВޢާޙނޱީޟދ\u07b5ޠޮ\u07b6", (byte)10, 68));
         }
   ...
   public Optional<Location> getSpawnLocation(@Nonnull SpawnType var1) {
      throw new UnsupportedOperationException(c<"㺀">(f, h ^ j));
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(μεςΩΔΣγν.F("ՉիխՍձ\u0590ֈ֞֊ՙ֗֍֛֕՞փ֥֤֢֜֜ձ", (byte)101, 70), ξςγΛωπεΠωγπχ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΨφιωσρΓδΔθ.B("ƬƹƸŻƻƷƲƻǆƵƂǀǄƽǀǆƈԘԝԏӸԧԟԕԁԫԖԤԬƠ", (byte)101, 66) + var1 + ςπυηννναΣ.A("ƃ", (byte)101, 65) + var2.toString(), var4
         );
      }
   }

   public ξςγΛωπεΠωγπχ(ΨγημιδξΓτοθαζ var1) {
      super(var1);
   }
