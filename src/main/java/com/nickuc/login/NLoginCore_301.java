...
public class NLoginCore_301 {
   private static String[] ZKM_STR_A = new String[NLoginCore_301.aq];
   ...
   private static String[] ZKM_STR_B = new String[NLoginCore_301.ar];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_575.F("ԼԾթզՂՅԺկԲՑԿծՏԮՉձԭՒԽսԶ՛ՉղյՍչԼռչ։ՀփֆիՖըջ֊Պմղյծքճկ֒ռՒ\u0557ՙնոեզ", (byte)54, 70);
               ZKM_STR_B[1] = NLoginCore_427.F("ԢաԸՋեՠՊՑըղՀգ՟ՏԸԲթԹ՛խՍվՅՆ", (byte)54, 70);
               ZKM_STR_B[2] = NLoginCore_471.B("ĶŅĞŤĠħťĥŠŊťĻţŰłœūūŊűŴŧİŲŮœŹĿŀũţŷńŲşŶƃƄŗŃśƎŧƌŸŬŉŴŒŠƉťŘƍƎŧƏƆžŞŴųŘƚ", (byte)54, 66);
               ZKM_STR_B[3] = NLoginCore_471.D("ӂӉҚҏҫңӈӈӔӓҺҟ", (byte)54, 68);
               ZKM_STR_B[4] = NLoginCore_127.B("ōşłľğŠĿŧŅŌřĥŭŃţşūŅŀŘŌŧľĿ", (byte)54, 66);
               ZKM_STR_B[5] = NLoginCore_141.D("ӉӃӎӃҨҰӇӂӍӉҵҵҼҝҚҾӠӊҳҙҭҤүҟӧҨӛӞӕҷӈӇҼӤһҽӴӑӏӢӔӸӆҿ", (byte)54, 68);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_091.E("ԼԾթզՂՅԺկԲՑԿծՏԮՉձԭՒԽսԶ՛ՉղյՍչԼռչ։ՀփֆիՖըջ֊ՊմղյՒ\u0557չֈհղճխչ֎ըեզ", (byte)54, 69);
               ZKM_STR_B[1] = NLoginCore_127.E("ԢաԸՋեՠՊՑըղԽԯկմԷժձխկՑխչպղյԿՠԼոտճև", (byte)54, 69);
               ZKM_STR_B[2] = NLoginCore_183.A("ĶŅĞŤĠħťĥŠŊťĻţŰłœūūŊűŴŧİŲŮœŹĿŀũţŷńŲşŶƃƄŗŃśƎŧƌŸŬŉŴŒŠƉťŘƉƑƙƙƇŴūźŭƠţ", (byte)54, 65);
               ZKM_STR_B[3] = NLoginCore_004.B("ŎĿŁĿĺŇĩġņŭņĳ", (byte)54, 66);
               ZKM_STR_B[4] = NLoginCore_521.C("ҹӋҮҪҋӌҫӓұҸӅҒҖҘӌҰҚҶҜӗӒҭҪҫ", (byte)54, 67);
               ZKM_STR_B[5] = NLoginCore_183.A("ŝŗŢŗļńśŖšŝŉŉŐıĮŒŴŞŇĭŁĸŃĳŻļůŲũŋŜśżŞšƄŘſŕłŶƀŮœ", (byte)54, 65);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_091.B("ţņĴŕģĺŒĹŉřŃļņŏńŔńŬŨıūŧľĿ", (byte)54, 66);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_559.A("şťĹţşġĽŦīĹůĦšŢūŎĿŨŧĶŕűŖĸůŬŔŎŻŐĸŸ", (byte)54, 65);
         }
      }
   }
