...
public class ΩψτσψΣριΣ {
   ...
   boolean e;
   float d;
   private static String[] a = new String[ΩψτσψΣριΣ.j];
   private static long e = Long.reverse(144115188075855872L);
   volatile ναδπσζρλδψ a = ναδπσζρλδψ.b;
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(χΠξΦιζΨΣωΦσΨζ.F("ոօքՇևփվև֒ցՎ\u058c\u0590։\u058c֒Քࣲ࣏࣯࣭ࣦ࣑࣬࣬࣎", (byte)89, 70));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = πψυκΠΨμΛΩβΣφμφσ.E("\u0558ԴԕԘ\u0557Բ՞ԟԾԛՑԗԝ\u0558ՕՊՇԦՠՇգՆԿԩդԿ՟ՆղԶյե", (byte)37, 69);
               b[1] = βθκςνθΩθυμςτκχ.F("Չԙ՚ԬԖՎԛԬՒՓՄԩ", (byte)37, 70);
               break;
            case 1:
               b[0] = δΛψπξκσβγςα.A("ŀĜýĀĿĚņćĦăĹÿąŀĽĲįĎňįŋģēİĺřŋĺĚŀŖŞ", (byte)37, 65);
               b[1] = πψυκΠΨμΛΩβΣφμφσ.C("ѭѲҗғҋҍҀѲҀҡґѬ", (byte)37, 67);
               break;
            case 2:
               b[0] = λΣΩσμφγχ.A("ľĺŅıĦĳĴđľĽġÿČĮĦĨĄŇŋņőŅĜĝ", (byte)37, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = χφπρψπφΦθμπ.C("їѬҒѱўҙҖѲқјѤѹҪѹҟѸѪҗ҉ѦѭѤҟ҄ҞҮҮҔѹѬҪҷ", (byte)37, 67);
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ςπυηννναΣ.E("ԓԵԷԗԻ՚ՒըՔԣա\u0557ե՟ԨՍկծզլզԻ", (byte)47, 69), ΩψτσψΣριΣ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            φΨαξωυθανΣφυκη.D("ҥҲұѴҴҰҫҴҿҮѻҹҽҶҹҿҁ\u07fcࠜ࠙࠙ࠟ\u07fbࠚࠓ߾Җ", (byte)47, 68) + var1 + δΛψπξκσβγςα.A("ė", (byte)47, 65) + var2.toString(), var4
         );
      }
   }

   public ΩψτσψΣριΣ(Player var1, File var2) {
      this.a = var1;
      this.b = var2;
   }
   ...
   public String toString() {
      return c<"㺀">(b, d ^ e) + this.a + c<"㺃">(f, g ^ h);
   }
}
