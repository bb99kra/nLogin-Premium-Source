...
public class NLoginCore_189 {
   ...
   private static String[] ZKM_STR_B = new String[NLoginCore_189.aj];
   ...
   private static String[] ZKM_STR_A = new String[ai];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_433.A("žƀŞţžťƓŶƚŽƈű", (byte)85, 65);
               ZKM_STR_B[1] = NLoginCore_127.E("ՃշՋՅջը՛Տ՟ֈՓՙ", (byte)85, 69);
               ZKM_STR_B[2] = NLoginCore_173.A("ŘŷƗƏƣƣƨƣƟŵƌű", (byte)85, 65);
               ZKM_STR_B[3] = NLoginCore_521.E("՛պՌՠ\u0557Ջ՝ղէևվՙ", (byte)85, 69);
               ZKM_STR_B[4] = NLoginCore_324.D("ԫԋӷӬԦԲԬԟԞԟԭӼ", (byte)85, 68);
               ZKM_STR_B[5] = NLoginCore_384.D("ԛԤԬԊӰԌӽԯԍԦӿӼ", (byte)85, 68);
               ZKM_STR_B[6] = NLoginCore_201.A("ƣƚŞƄŢźŵżżšūű", (byte)85, 65);
               ZKM_STR_B[7] = NLoginCore_183.F("ճռպՅտ֎գ֊բՠհՙ", (byte)85, 70);
               ZKM_STR_B[8] = NLoginCore_004.D("ԙӫԚԋԩԓԟԌԍԦԱӼ", (byte)85, 68);
               ZKM_STR_B[9] = NLoginCore_127.F("դՋռէրհ֏՟ի֒հՙ", (byte)85, 70);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_141.D("ԎԌԮӬԁԡԋӾԮԳӶӼ", (byte)85, 68);
               ZKM_STR_B[1] = NLoginCore_183.E("ՠդՄՠՖ՛ՆձՄՑ՜ՙ", (byte)85, 69);
               ZKM_STR_B[2] = NLoginCore_453.C("ԚԖӦԍԜԥԪӽӽԵԓӼ", (byte)85, 67);
               ZKM_STR_B[3] = NLoginCore_092.B("ƠƀƟŵŶƂŦƀƈūƌű", (byte)85, 66);
               ZKM_STR_B[4] = NLoginCore_091.F("օեՂր՟փէծՋՅըՙ", (byte)85, 70);
               ZKM_STR_B[5] = NLoginCore_004.B("ƏŲƁƜŸƙŠƟƉƄƆƈƄŸƣƯƮƟƉƍƔſżŽ", (byte)85, 66);
               ZKM_STR_B[6] = NLoginCore_451.B("źşƗŴŻƄƛťŻŨƄƋƯżƀƬŲƬƞƌžƵżŽ", (byte)85, 66);
               ZKM_STR_B[7] = NLoginCore_324.C("ӟӫӷԢԪԠԥԤԐӭӭԹԇԅԧԧԦԺԯԵӷԊԇԈ", (byte)85, 67);
               ZKM_STR_B[8] = NLoginCore_201.D("ӧԇԣԤԙԑ\u0530ԔӱԌԭӼ", (byte)85, 68);
               ZKM_STR_B[9] = NLoginCore_091.A("ƐūŽţƒƤźžŧƔƞű", (byte)85, 65);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_241.A("ſūśťŮšƕŤžŽŧƫƁƉƀưƑƍŽƢƗƥżŽ", (byte)85, 65);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_141.B("ƓŝƁƓſƕƚƀƤƚƦƂƉƙƍŬŬƇƆƊƷųƠƈųƒƯƽƟƼƔŽ", (byte)85, 66);
         }
      }
   }
