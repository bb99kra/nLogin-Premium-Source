...
public class ρααΨξφζκξπψοΩ {
   ...
   private static String[] a = new String[ρααΨξφζκξπψοΩ.f];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΨφιωσρΓδΔθ.F("ծմՆԸոէՇԴՌլԻկԸԹշւԼ\u0557մՖռՁ\u058bՇևա֎Պՠցր֎Վ֏ի\u0590֖ն՛ը֑ճկ֍՚ղ՜֝ռ֖֠։եզ֭֡֨խցպֲ֜րվ֞։֥֭օ֣֖֒ս֟\u058bք", (byte)64, 70);
               break;
            case 1:
               b[0] = δΛψπξκσβγςα.C("ӧӭҿұӱӠӀҭӅӥҴӨұҲӰӻҵӐӭӏӵҺԄӀԀӚԇӃәӺӹԇӇԈӤԉԏӯӔӡԊӬӨԆӓӫӕԖӵԙԏԂӞӟԚԡԦӦӺӳԕԫӹӷԞӺԌӫԛԲӼӭԯӿԮӽ", (byte)64, 67);
               break;
            case 2:
               b[0] = δΛψπξκσβγςα.C("ӞҿӟӪӭҲӥӀӒӱӊӋӆҺӤөӚҶҺӲӾӛӈӉ", (byte)64, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = λΣΩσμφγχ.A("ĶŕŰŹŧňŬňśŵŎŠŻśŲſŕƈŁƌňŕŒœ", (byte)64, 65);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(δΛψπξκσβγςα.D("եղձԴմհիմտծԻչսնչտՁࣔࣅࣆࢾ࣏ࣕࣞࣔࣙࣜࣥࣝࣈ", (byte)111, 68));
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(πψυκΠΨμΛΩβΣφμφσ.E("ӧԉԋӫԏԮԦԼԨӷԵԫԹԳӼԡՃՂԺՀԺԏ", (byte)3, 69), ρααΨξφζκξπψοΩ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ιΠοθΩΦξκ.F("ԢԯԮӱԱԭԨԱԼԫӸԶԺԳԶԼӾ\u0891ࢂࢃࡻ\u0892࢛ࢌ\u0891\u0896࢙ࢢ࢚ࢅԗ", (byte)3, 70) + var1 + ςπυηννναΣ.F("ӹ", (byte)3, 70) + var2.toString(), var4
         );
      }
   }
}
