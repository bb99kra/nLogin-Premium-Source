...
public class NLoginCore_462 extends NLoginType_032 {
   ...
   private static String[] d = new String[hi];
   ...
   private static String[] c = new String[hh];
               ...
               if (var3.length < a) {
                  ...
                  if (var17 != null) {
                     if (!var17.h()) {
                        ...
                        ForceRegisterConfig var19 = this.a.a().a(var14, null, null, (boolean)bh);
                        if (var19 == null) {
                           NLoginCore_150.a(var1, NLoginCore_487.w);
                        } else {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = NLoginCore_173.A("ÐàÝĈēõÿĈąÑÑß", (byte)12, 65);
               d[1] = NLoginCore_076.C("ШмнЕЈсѓвУмяИёдКюОСѡдѐмхѝчѓсќўцпџ", (byte)12, 67);
               d[2] = NLoginCore_453.E("ՁӹԒՁԎԅԙԜԈԿԖԻԆՉԈԠԊԠՆՆԿԵԬԧԙԳԗՙՎՑԲԯԻԹՀԿԵՃԻԴՆԼԪըԻ\u0557ըՏԫՈժձՆխժղիՅԭշՇԶԸկձվՌԿչԿՑՆՠՇմլ՛ՠփՍ՝Մմ֏ֈ՞՛՜", (byte)12, 69);
               d[3] = NLoginCore_173.E("ԢӻՂԱԯՆԤԿՀԉԉԂՍԥՐՋԇԞԞԫՄՅԸԔՌԔՄԹԹ՜ԻՈԩՍԷԽԼՠԤԤ՛Պ՝ՙԬԦ\u0558ԢԩեՠժՇաՀՉՑՙչթԹյի\u0558ՠժջգԼոՏ՜րւիՐ", (byte)12, 69);
               d[4] = NLoginCore_183.B("ÆîÐċĐôþĖÏòĊÓēĘôóĉęëāĖĆùćûĕþĆčýĤĨđĀĐĩëčĉĠąĢĂĩĎęðĔĚłĭĕČŃĊċ", (byte)12, 66);
               d[5] = NLoginCore_453.D("ЯхсхЧєЗТЌаиЛмюнџжЯКњосмбѪќЧѦѪѡэсѮђђѮэтЮэѴѷѪйѻѿѸюѶѕ҄ѲѥѯѰлѕѵьчѻ҂чѡѿ҃҃ҐҌяѬыҍ҈Ғѡ", (byte)12, 68);
               d[6] = NLoginCore_091.D("ЈаВэђжрјБдывѕаіЯџѕзрсзйгѓНѢпѡррЩммЦѵЯѴѕёњшѳмѭѰѡѡяяѬѭмџєҁўѽїѭѫѢѿю", (byte)12, 68);
               d[7] = NLoginCore_241.B("ÞÚÝÎăßÈÍÓåúß", (byte)12, 66);
               d[8] = NLoginCore_453.C("МєЫЎАуБѓцлћШЗаЗьиСэжѐїоХУѩШѧњСЪѝ", (byte)12, 67);
               d[9] = NLoginCore_433.C("ХлЬЬУЏхЯйумС", (byte)12, 67);
               d[10] = NLoginCore_453.A("ĀČĈçēÓĎÔĈèâóæêĆöĈàñþãģýåñúêģģêĩġ", (byte)12, 65);
               d[11] = NLoginCore_173.E("ԏԋԎӿԴԐӹӾԄԖԫԐ", (byte)12, 69);
               d[12] = NLoginCore_110.A("ÐëÒĀíąåôĐăñĎĝĎÚÝûċďíĂġôĦĚĕĀøĪĉíĭıĤêąĈýíĦĸČċĖļěûċĽĻĵĳĻüģĢĢĀŋĉěħŉİ", (byte)12, 65);
               d[13] = NLoginCore_091.D("РМПАхСЊЏЕЧмС", (byte)12, 68);
               d[14] = NLoginCore_553.A("ùðúÍĕĔþčćìēëĊĞøĊúýĂďĐñĠþĂüċăğąäëīĩĎĠĆĔõēĦēĬĒĸļćĸ÷øļčĚĎŁŇŁÿğĽþņŅĥŉĈĄĦōĶēŗİģĴěōĜĦĲĴŕĴŜŠłŎķŧŪħļŠŀĹŇ", (byte)12, 65);
               d[15] = NLoginCore_092.E("ԩԊԽԹԺԯՈԧԁԺՊԇԟԧԻԘԙԊՃԱԯՈԮՒԴԨԑՖՋԞ\u0530ՏԚԫԹ՚ԲՀԟ՟ԴՕՠԫՄՌՊխթխծԱՊՐեխձըպոՌշյժ", (byte)12, 69);
               d[16] = NLoginCore_384.D("яЛфдѕюйШТміС", (byte)12, 68);
               d[17] = NLoginCore_446.A(
               ...
               d[18] = NLoginCore_446.D("гНЯЎщдрЪифїйнЛНъѝћѕдћљѝщекЩсЩѢѯѬЬЯЯѯгѷѳйзыжыиюѺѹѶћѭмћяьэ", (byte)12, 68);
               d[19] = NLoginCore_110.D("оЍхЫдЎсіЖдєбъѝљъѝфѓСОѕѩѧфЩѢыХојќыѱќфШїяѦчѶвіджинҁѳѮџў҅ьэ", (byte)12, 68);
               d[20] = NLoginCore_530.C("РМПАхСЊЏЕЧмС", (byte)12, 67);
               d[21] = NLoginCore_521.C("лвмЏїірящЮђяыЬЭўдКвУХуКСпўјѝмћѨууѢѠшџЯѥѨхёѺѼђєѭѵѼѷћѯѤ҇҃пђџѾѬфчѬъѦѳ҈҅ѵҒҙѰқёѕҊѼѾѮѳҌѠѱѡҎљҦґѲҡҭҦѷѪѽҍ", (byte)12, 67);
               d[22] = NLoginCore_559.C("эыёеГёсЫИлцѐЗѝЗєзМолђѨТъєНХѤшкъьуХѯѨащсгыњюжѵѧѱҀѳјяўюѕѲѪѹ҇уѧҊцѨҋъѾ҄ѿѫѡҗѫѭѤѸѡ", (byte)12, 67);
               d[23] = NLoginCore_138.D("яЛфдѕюйШТміС", (byte)12, 68);
               d[24] = NLoginCore_427.B(
               ...
               d[25] = NLoginCore_453.A("ÂÏæĂčíÔìÊËđðĐĔĈØĔďĕñĥąýüĆąĒâùąĜĆģįĀëĔąîö÷āöĆěûīĹĖııĢęčĊċ", (byte)12, 65);
               d[26] = NLoginCore_453.D("РМПАхСЊЏЕЧмС", (byte)12, 68);
               d[27] = NLoginCore_553.D("ЬШТьЮуаЦбЬЯЮЙѓЗЙЬклЮѠчќцмхмїяѡѬЯѫѳтѤђзѧѴтѱѽцѨзьѬ҂ѠѭѮїі҂ѳѨ҈ѝѭѫ҇ҐҒѠѪцѕѠҕѐјѕѶѪѷғѶѲҙҍҗѹҘѺѿѬѭ", (byte)12, 68);
               d[28] = NLoginCore_433.E("ԏԋԎӿԴԐӹӾԄԖԫԐ", (byte)12, 69);
               d[29] = NLoginCore_091.D("БЉъгуЎхАЯййЕгѕыэѐѕѥѢћѢЧщТѦъіЧпчѤѡлѠѭпѓѵѐкюјс", (byte)12, 68);
               d[30] = NLoginCore_241.F("ԚԿԱԾԎԱԃԗԀՅԆԐ", (byte)12, 70);
               d[31] = NLoginCore_559.D("ЬШТьЮуаЦбЬЯЮЙѓЗЙЬклЮѠчќцмхмїяѡѬЯѫѳтѤђзѧѴтѱѽцѨзьѬ҂ѠѭѮїі҂ѳѨ҈ѝѭѫ҇ҐҒёѩѤѽҀѥѮ҂ѦҜѭѫҍѽѷҘҊҤћѹңҕѬѭ", (byte)12, 68);
               d[32] = NLoginCore_324.F("ԏԋԎӿԴԐӹӾԄԖԫԐ", (byte)12, 70);
               d[33] = NLoginCore_521.B("ÏÇĈñāÌăÎí÷÷ÓñēĉċĎēģĠęĠåćàĤĈĔåýąĢğùĞīýđĳĎøČĖÿ", (byte)12, 66);
               d[34] = NLoginCore_446.B("éĎĀčÝĀÒæÏĔÕß", (byte)12, 66);
               d[35] = NLoginCore_141.E("ԴӿԂԞԷԝԖԥԤԇԗԐ", (byte)12, 69);
               d[36] = NLoginCore_232.D("ЛАяСчЭАцтЖеёјоЮюъПарњпЬЭ", (byte)12, 68);
               d[37] = NLoginCore_559.D("урѐУЍУрЫшљХЮлЙпрыЭсЮљпЬЭ", (byte)12, 68);
               break;
            case 1:
               d[0] = NLoginCore_183.D("щЯЧдшёєіЙЪцС", (byte)12, 68);
               d[1] = NLoginCore_141.B("æúûÓÆÿđðáúčÖďòØČÜßğòĎøùğàĦøĪćêġĂ", (byte)12, 66);
               d[2] = NLoginCore_127.B("ĐÈáĐÝÔèë×ĎåĊÕĘ×ïÙïĕĕĎĄûöèĂæĨĝĠāþĊĈďĎĄĒĊăĕċùķĊĦķĞúėĹŀĕļĹŁĺĔüņĖąćľŀōěĎňĎĠĕįĖłįņŅŋęŘĪŊĳŤĭĪī", (byte)12, 66);
               d[3] = NLoginCore_433.F("ԢӻՂԱԯՆԤԿՀԉԉԂՍԥՐՋԇԞԞԫՄՅԸԔՌԔՄԹԹ՜ԻՈԩՍԷԽԼՠԤԤ՛Պ՝ՙԬԦ\u0558ԢԩեՠժՇաՀՉՑՙչթԹյի\u0558ԺՂՁպՓչավՙՄ\u0557Ր", (byte)12, 70);
               d[4] = NLoginCore_232.E("ӷԟԁԼՁԥԯՇԀԣԻԄՄՉԥԤԺՊԜԲՇԷԪԸԬՆԯԷԾԮՕՙՂԱՁ՚ԜԾԺՑԶՓԵ՜բիէԭՌ՛՟էԾԿՕդնԶԭԴԸՌիՓ", (byte)12, 69);
               d[5] = NLoginCore_384.C("ЯхсхЧєЗТЌаиЛмюнџжЯКњосмбѪќЧѦѪѡэсѮђђѮэтЮэѴѷѪйѻѿѸюѶѕ҄ѲѥѯѰлѕѵьчѻ҂чѡѦяюѝєҎѭѤѕҖҝҔѸњҎѵҠѲѣѴґѯѬѭ", (byte)12, 67);
               d[6] = NLoginCore_091.B("ÆîÐċĐôþĖÏòĉðēîĔíĝēõþÿõ÷ñđÛĠýğþþçúúäĳíĲēďĘĆıúīĮğğččĪīúĮĝĥĔĠĘģŇčĤĝ", (byte)12, 66);
               d[7] = NLoginCore_553.F("ԷԪԎԜԯՇԼԘԂՈԵԐ", (byte)12, 70);
               d[8] = NLoginCore_127.D("МєЫЎАуБѓцлћШЗаЗьиСэжѐібгщХѫѢчѩШч", (byte)12, 68);
               d[9] = NLoginCore_446.D("ЊЅЦѕоЏЦИуЧЛС", (byte)12, 68);
               d[10] = NLoginCore_453.C("тюъЩѕЕѐЖъЪФеШЬшиъТгрХЦшѓиѠиъѮЭёѢ", (byte)12, 67);
               d[11] = NLoginCore_141.F("ԴԚՂԴԤԟԺԆԟԀԵԐ", (byte)12, 70);
               d[12] = NLoginCore_530.F("ԁԜԃԱԞԶԖԥՁԴԢԿՎԿԋԎԬԼՀԞԳՒԥ\u0557ՋՆԱԩ՛ԺԞ՞բՕԛԶԹԮԞ\u0557թԽԼՇխՌԬԼծլզդլմկըխըՍՔՑ\u0557ՌՠՑ՚ղփԿևգքՒե՛Ր", (byte)12, 70);
               d[13] = NLoginCore_427.C("ыядЎёЩйюЪфмС", (byte)12, 67);
               d[14] = NLoginCore_076.D("лвмЏїірящЮѕЭьѠкьмпфёђгѢрфоэхѡчЦЭѭѫѐѢшізѕѨѕѮєѺѾщѺйкѾяќѐ҃҉҃сѡѿр҈҇ѧҋъцѨҏѸѕҙѲѥѶѝҏўѨѴѶҗѶҞҢҒѹҗѹңҍ҉ѭҫҩҙ", (byte)12, 68);
               d[15] = NLoginCore_092.C("кЛюъырљиВыћИаиьЩЪЛєтрљпѣхйТѧќЯсѠЫмъѫуёаѰхѦѱмѕѝћѾѺѾѿтћѰћ҆ѽѦќу҅ѯ҅ґѰьѪяѶѐҀҏҎѸѸѡ", (byte)12, 67);
               d[16] = NLoginCore_453.E("ԊӺՀԬԒӽԺԇԖӼԫԣԮԤԨԪԾԒԬՋԭՔԛԜ", (byte)12, 69);
               d[17] = NLoginCore_223.C(
               ...
               d[18] = NLoginCore_110.B("ñÛíÌćòþèöĂĕ÷ûÙÛĈěęēòęėěćóøçÿçĠĭĪêííĭñĵı÷õĉñĕćıĸĘúĹĪĢĤčĤŁěĨŁŁĶĻīŎ", (byte)12, 66);
               d[19] = NLoginCore_530.B("üËăéòÌÿĔÔòĒïĈěėĈěĂđßÜēħĥĂçĠĉãüĖĚĉįĚĂæĕčĤąĴúČĊĆĲĮĻėûĝăāĳģŉĿľĞĕĄĻŃ", (byte)12, 66);
               d[20] = NLoginCore_201.E("ԾԓԁՄԃԸԹՈӻԀԆԐ", (byte)12, 69);
               d[21] = NLoginCore_451.D(
                  "лвмЏїірящЮђяыЬЭўдКвУХуКСпўјѝмћѨууѢѠшџЯѥѨхёѺѼђєѭѵѼѷћѯѤ҇҃пђџѾѬфчѬъѦѳ҈҅ѵҒҙѰқёѕҊѼѾѮѳҌѠѱѡҎҧқҒѺѪҊѥѪѪҥҌғҒѬҖҟѭѰҺѵ҆ѷҁ", (byte)12, 68
               );
               d[22] = NLoginCore_324.E("ԼԺՀԤԂՀ\u0530ԚԇԪԵԿԆՌԆՃԦԋԭԪՁ\u0557ԑԹՃԌԔՓԷԩԹԻԲԔ՞\u0557ԟԸ\u0530ԢԺՉԽԥդՖՠկբՇԾՍԽՄաՙընԲՖչԵ\u0557պԽՒատյՂեֈՒժ։Ր", (byte)12, 69);
               d[23] = NLoginCore_446.C("мЫтЫвШыЩћбаЪяэьџжѝгюжѥЬЭ", (byte)12, 67);
               d[24] = NLoginCore_138.D(
               ...
               d[25] = NLoginCore_553.A("ÂÏæĂčíÔìÊËđðĐĔĈØĔďĕñĥąýüĆąĒâùąĜĆģįĀëĔąîö÷āöēđĔúľĹıĳĺŃÿĆĔēŇāğĕĕĥĽ", (byte)12, 65);
               d[26] = NLoginCore_004.D("ЪэєаѕУчњбФъС", (byte)12, 68);
               d[27] = NLoginCore_471.A("êæàĊìāîäïêíì×đÕ×êøùìĞąĚĄúăúĕčğĪíĩıĀĢĐõĥĲĀįĻĄĦõĊĪŀĞīĬĕĔŀıĦņěīĩŅŎŐĞĨĄēĞœĎĖēĴħŒěņĖđĨŎŚńĴŐŁŔĹœŊĺņŞŁş", (byte)12, 65);
               d[28] = NLoginCore_076.D("МЎпЯрѓЯДѓгиС", (byte)12, 68);
               d[29] = NLoginCore_201.B("ÏÇĈñāÌăÎí÷÷ÓñēĉċĎēģĠęĠåćàĤĈĔåýąĢđĬİĠþĉĞđĪĩĤĻēĸĖĵĩŁľĔđĳĊċ", (byte)12, 66);
               d[30] = NLoginCore_027.F("ՀԖԌԖԗՄԢԂԡՉԾԡԭԖԇ\u0530ԤԭՋԔՆԮԛԜ", (byte)12, 70);
               d[31] = NLoginCore_127.A("êæàĊìāîäïêíì×đÕ×êøùìĞąĚĄúăúĕčğĪíĩıĀĢĐõĥĲĀįĻĄĦõĊĪŀĞīĬĕĔŀıĦņěīĩŅŎŐďħĢĻľģĬŀĤŚĬĻńŚĮŝĒőŁŞĢĭŜğĵŔĹœŝķīł", (byte)12, 65);
               d[32] = NLoginCore_446.A("åòëÌõýÕčÎÙÑß", (byte)12, 65);
               d[33] = NLoginCore_127.F("ԀӸԹԢԲӽԴӿԞԨԨԄԢՄԺԼԿՄՔՑՊՑԖԸԑՕԹՅԖԮԶՓ\u0530Խ՚ՌՂԾԦզ՚գԵԦՉՏ՜ՀՂԩԩՍզմԻԼ", (byte)12, 70);
               d[34] = NLoginCore_433.E("ӸԁԴԠԏԹԿԚՅՇԹԐ", (byte)12, 69);
               d[35] = NLoginCore_427.C("КЌВЋЈдхфцФшиѕПЮсѓѠѓлђпЬЭ", (byte)12, 67);
               d[36] = NLoginCore_397.B("ÙÎčßąëÎĄĀÔôąåĚïğòýăëĤĎÿĥü÷øÿôĕĥġ", (byte)12, 66);
               d[37] = NLoginCore_451.B("āþĎáËáþéĆėâîóØÿĠØÿċęÿģêë", (byte)12, 66);
               break;
            case 2:
               d[0] = NLoginCore_173.A("ÈĈÞĔĕßò×ďÖĄąÒþýóÛāĕČēģêë", (byte)12, 65);
            case 3:
            default:
               break;
            case 4:
               d[0] = NLoginCore_232.E("ԐԻԼԿԡӽ\u0530ӾՀԉԪՊՎՎԸԽԞՉԡՎԝՔԛԜ", (byte)12, 69);
         }
      }
   }
