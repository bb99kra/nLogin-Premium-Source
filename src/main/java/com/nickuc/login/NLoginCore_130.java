...
public abstract class NLoginCore_130 implements NLoginInterface_009 {
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_130.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_201.D("ѹқҝѽҡӀҸӎҺ҉ӇҽӋӅҎҳӕӔӌӒӌҡ", (byte)52, 68), NLoginCore_130.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_076.A("ŊŗŖęřŕŐřŤœĠŞŢśŞŤĦҸҶҺӁҰҸҙҿҽӉļ", (byte)52, 65) + var1 + NLoginCore_397.B("ġ", (byte)52, 66) + var2.toString(), var4
         );
      }
   }
   ...
   @Generated
   protected NLoginCore_130(String var1) {
      this.cm = var1;
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_559.C("ԲԓՈԬԼԬԶ՜ԪԺԛԩ", (byte)100, 67);
               ZKM_STR_B[1] = NLoginCore_173.A("ƸƫƢƎƑǄƯƂƲƩƢƏ", (byte)100, 65);
               ZKM_STR_B[2] = NLoginCore_183.C("ԒԙԹԼԗՔՓԓԪԹ՞ԩ", (byte)100, 67);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_521.F("է։և֝֕\u0557֜ն֛֙տը", (byte)100, 70);
               ZKM_STR_B[1] = NLoginCore_446.B("ƞƓƜƳƙƤƃƞǁƗƞƏ", (byte)100, 66);
               ZKM_STR_B[2] = NLoginCore_427.D("ԲԸԳԏԗԯՌ\u0530ԸԼԸԩ", (byte)100, 68);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_575.D("ՖՊՐ՝ԙԳԞԩ՜ՠՏՅՐՀՆԻգՂԦ՟ՈխԴԵ", (byte)100, 68);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_446.B("ŽƫƲƭƴƴƂƷƇƣƦƼƙƨǎǐƎƌǌƦƑǓƚƛ", (byte)100, 66);
         }
      }
   }
   ...
   public String w(String var1) {
      try {
         ...
         String var10000 = a(f, g ^ h) + (var3.length << i) + a(j, k ^ l);
