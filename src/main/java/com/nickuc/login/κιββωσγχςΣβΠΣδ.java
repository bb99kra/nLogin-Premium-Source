...
public enum κιββωσγχςΣβΠΣδ {
   b(c<"㺃">(κιββωσγχςΣβΠΣδ.k, κιββωσγχςΣβΠΣδ.l ^ κιββωσγχςΣβΠΣδ.m), c<"㺆">(κιββωσγχςΣβΠΣδ.n, κιββωσγχςΣβΠΣδ.o ^ κιββωσγχςΣβΠΣδ.p), (boolean)κιββωσγχςΣβΠΣδ.q),
   c(c<"㺌">(κιββωσγχςΣβΠΣδ.v & κιββωσγχςΣβΠΣδ.w, κιββωσγχςΣβΠΣδ.x), c<"㺏">(κιββωσγχςΣβΠΣδ.y & κιββωσγχςΣβΠΣδ.z, κιββωσγχςΣβΠΣδ.aa), (boolean)κιββωσγχςΣβΠΣδ.ab),
   d(c<"㺕">(κιββωσγχςΣβΠΣδ.ag, κιββωσγχςΣβΠΣδ.ah), c<"㺘">(κιββωσγχςΣβΠΣδ.ai, κιββωσγχςΣβΠΣδ.aj), (boolean)κιββωσγχςΣβΠΣδ.ak);

   private final String bs;
   private final String bt;
   private final boolean ak;
   private static String[] a = new String[κιββωσγχςΣβΠΣδ.e];
   private static String[] b = new String[κιββωσγχςΣβΠΣδ.f];
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ιΠοθΩΦξκ.E("թնյԸոմկոփղԿսցպսփՅ࣑࣑࣐࣋࣌ࣤࣟࣥ࣡ࣃ࣓ࣂࣆࣘ", (byte)74, 69));
         }
   ...
   @Generated
   private κιββωσγχςΣβΠΣδ(String var3, String var4, boolean var5) {
      this.bs = var3;
      this.bt = var4;
      this.ak = var5;
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  κιββωσγχςΣβΠΣδ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(χΠξΦιζΨΣωΦσΨζ.A("šƃƅťƉƨƠƶƢűƯƥƳƭŶƛƽƼƴƺƴƉ", (byte)93, 65), κιββωσγχςΣβΠΣδ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ξψθρΣΠΣς.F("ռ։ֈՋ\u058bևւ\u058b֖օՒ\u0590֔֍\u0590֖\u0558ࣲࣣࣦࣤࣤࣞࣟࣷࣸࣴࣖࣕࣙ࣫ղ", (byte)93, 70)
               + var1
               + ΠΛΨοδΩσμνΛγΦφβς.A("ų", (byte)93, 65)
               + var2.toString(),
            var4
         );
      }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = οοθδΨιοΦΠβδζ.E("՞րրտՖձըձ֎ոժգ", (byte)95, 69);
               b[1] = βεξΠθρρςΔΦμ.F("լժ֎֒։Ջ֎֑֘ն֜գ", (byte)95, 70);
               b[2] = ΨφιωσρΓδΔθ.A("ƎƌưƴƫŭưƳƺƘƾƅ", (byte)95, 65);
               b[3] = βεξΠθρρςΔΦμ.D("ԚԾԮԦՊՆՒԺԟԢՋԚ", (byte)95, 68);
               b[4] = ΦδφπθΩΩλζξ.E("ՔցեՠշՔ՚\u0557֏ճՙ՞֚ննյռյևՙ֛֧ծկ", (byte)95, 69);
               b[5] = φΨαξωυθανΣφυκη.C("ԣԧԊԎԦԏԬԜԱԔԔԚ", (byte)95, 67);
               b[6] = δΛψπξκσβγςα.E("լսև֔֒ն\u0558իեզհնն֢ա֢֓ՠ֓օը֗ծկ", (byte)95, 69);
               b[7] = ΣφδσΔζιΠρα.E("օՒ՞տՓֈՓ\u058bհև֙՛֑ի֣֡օ՝՟չէցծկ", (byte)95, 69);
               b[8] = δΛψπξκσβγςα.D("ԼԉԕԶԊԿԊՂԧԾՐԒՈԢ՚\u0558ԼԔԖ\u0530ԞԸԥԦ", (byte)95, 68);
               break;
            case 1:
               b[0] = μζξτΩσσφυδεπλΨ.D("ԂԦԥԻԗԭԃԪԉԩԦՄՈԒԸ\u0557ԻԼԲՆՙԸԥԦ", (byte)95, 68);
               b[1] = χΠξΦιζΨΣωΦσΨζ.F("Պ՝ֈ։֙\u0557պ֗֝մպ՞֞վ֞֒\u0590փ֛տչձծկ", (byte)95, 70);
               b[2] = δΛψπξκσβγςα.C("ԋԪԤԣՉԂԡԥՋԩԯԒՉՔՆԬՃԭԖՐՠԸԥԦ", (byte)95, 67);
               b[3] = ΦδφπθΩΩλζξ.A("ƐƠŪƦŷƧŴƲƔŸǀƿƕƃſƷƀǁǉƓƉƣƐƑ", (byte)95, 65);
               b[4] = ντθΔζβΔζ.D("ԋԸԜԗԮԋԑԎՆԪԒՓԯԧԓԹԸՇՍԮԶ՞ԥԦ", (byte)95, 68);
               b[5] = δΛψπξκσβγςα.A("ƀŷƔŶųƊźƏƾƿƊƳƠƠƣƵƂƣƑǇƢƹƐƑ", (byte)95, 65);
               b[6] = ζβησεθωυγτ.A("ƎƟƩƶƴƘźƍƇƈƓƕƋƺƷƙƴǆƺƇƼƓƐƑ", (byte)95, 65);
               b[7] = βεξΠθρρςΔΦμ.B("ƧŴƀơŵƪŵƭƒƩƽƴŻƒƘƶƜƑƵƗƚǉƐƑ", (byte)95, 66);
               b[8] = οοθδΨιοΦΠβδζ.E("օՒ՞տՓֈՓ\u058bհև֙\u0557\u0558֤֚֒ւխ֡չզ֧ծկ", (byte)95, 69);
               break;
            case 2:
               b[0] = λΣΩσμφγχ.A("ƫƓŷƒƉưƪƯƽŻƶƅ", (byte)95, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = χΠξΦιζΨΣωΦσΨζ.F("֏\u058bէր\u0558֑֍քֆ֓\u0590գ", (byte)95, 70);
         }
      }
   }
