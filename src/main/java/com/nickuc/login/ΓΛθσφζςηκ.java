...
public class ΓΛθσφζςηκ {
   ...
   private static String[] b = new String[ΓΛθσφζςηκ.p];
   private static int n = Integer.reverse(Integer.MIN_VALUE);
   private static int g = (0 >>> 37 | 0 << ~37 + 1) & -1;
   private static String[] a = new String[ΓΛθσφζςηκ.o];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = πηγμΣΔκκ.F("Ոէ\u0558՟ցՉՒօտնժ\u0590\u0557ցմփ։՝իյ՝պ֏աբ֣֛֤֗֜֔֔", (byte)87, 70);
               b[1] = πχσδΦΦνθΔπ.C("ԡԠԴӳӶӪԹԗӴԼӸԦԑӲԔӽԝӼԗ\u0530ԂԙՂԩՀԋԦԬԭԩ\u0530ԟ", (byte)87, 67);
               break;
            case 1:
               b[0] = μζξτΩσσφυδεπλΨ.A("ŢƁŲŹƛţŬƟƙƐƄƪűƛƎƝƣŷƅƏŷƔƺƒƔŸƴƍƠƿżƄ", (byte)87, 65);
               b[1] = πχσδΦΦνθΔπ.C("ԡԠԴӳӶӪԹԗӴԼӸԦԑӲԔӽԝӼԗ\u0530ԂԓՃՄԔԅԣՏՏԮԩԼՎՒԪԕ\u0530ՕՇԌՖԚ\u0557Ԣ", (byte)87, 67);
               break;
            case 2:
               b[0] = ΨΦνΨΦωυΩνβςμ.D("ӪԁԎԨӲԐԲԍԜԪԨԵӸՀӽԬԭԥԭԻՁԐԍԎ", (byte)87, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = ντθΔζβΔζ.E("՞֍բՋջի՜՞\u0590կՐե\u058c֘Ր֔֘պ֑֍֞֏զէ", (byte)87, 69);
         }
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(φΨαξωυθανΣφυκη.F("ԿագՃէֆվ֔րՏ֍փ֑\u058bՔչ֛֚֒֘֒է", (byte)91, 70), ΓΛθσφζςηκ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            φΨαξωυθανΣφυκη.F("պևֆՉ։օր։֔փՐ֎֒\u058b֎֔Ֆࢻࣄ\u08e2ࣰࣲ࣮ࣣࣦ࣪ի", (byte)91, 70) + var1 + ξψθρΣΠΣς.A("ů", (byte)91, 65) + var2.toString(), var4
         );
      }
   }
   ...
   public static Field a(Class<?> var0, @Nullable Class<?> var1, int var2) {
      if (var2 < 0) {
         throw new IllegalArgumentException(c<"㺀">(d, e) + var2);
      } else {
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(θεωψξβΛσσ.E("ԱԾԽԀՀԼԷՀՋԺԇՅՉՂՅՋԍࡲࡻ࢙ࢥࢩ࢚ࢧ࢝ࢡ", (byte)18, 69));
         }
