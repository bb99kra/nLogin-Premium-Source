...
public class ρΓΔκρΠθτλχγΦΓ implements ιΨφαρελΣζΠΔΩ, κΓΦνκχβδ {
   private static int g = (0 >>> 212 | 0 << ~212 + 1) & -1;
   private static long i = Long.reverse(5162468837789311745L);
   private final ΩγΛξιχγτ V;
   private static String[] b = new String[ρΓΔκρΠθτλχγΦΓ.l];
   private static long c;
   private static String[] a = new String[ρΓΔκρΠθτλχγΦΓ.k];
   ...
   public αΠαβσΠτΦ[] a(ΨγημιδξΓτοθαζ var1, ΨαχΨχΣλεΠψΦ var2, ιηοψσγξςΩγδ var3, πααΔΣνΨγνθυ var4) {
      εδδΠηδξΛΣχ.a(var2, ευτβπαψω.w);
      γοηλιμεπη[] var10001 = new γοηλιμεπη[b];
      var10001[c] = γοηλιμεπη.b;
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = μζξτΩσσφυδεπλΨ.A("ŴƟƍŜƤƅŶƇŚśƈƛƖŽƉƄƐƀƣƈƤƊŶƶƑŲŰŶƏƍƚƇƈƵưƿƣƄǅƏƑǆƞƏ", (byte)84, 65);
               b[1] = ντθΔζβΔζ.A("ƚƉƒƗŭƦƜſƈƑſŷŦƨŭƦŮƥƄƦƮŴƦŵƹƕųƪƕŽƻƬƳƜƒƑƻƮƮƄƒƅƕƚƨƻƦƻƾƦƑǀǏǒǇǏƩǏƵƘǘƙƹǐƟǛƚƸǎǚǟǣƱǜǟƵǇǍƠƪǝǆǪǜǌǡƬǆǒǑǄƺǗǍǛǓǷǍǌǸǀȄǠǥǖȆǖǏ", (byte)84, 65);
               break;
            case 1:
               b[0] = πψυκΠΨμΛΩβΣφμφσ.E("՝ֈնՅ֍ծ՟հՃՄձքտզղխչթ\u058cձ֍ճ՟֟պ՛ՙ՟ոնփհ֊ն։յ֖֙֝ւ֢֦֢֩լ\u058bյֺ֣֭ճּּ֝փք", (byte)84, 69);
               b[1] = πηγμΣΔκκ.D(
               ...
               break;
            case 2:
               b[0] = χφπρψπφΦθμπ.D("ӹӷԈӿԅԏӧӣԫԑԥԴӲԷԣԳԫӳԧӺԾԗԄԅ", (byte)84, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = ντθΔζβΔζ.F("՛Օ՝յ՜ֈ֎ՙ\u0590֒ՓՑֈ\u058bծօդչփ֖մմո՟՜֟աՠ֑֙շվ", (byte)84, 70);
         }
      }
   }

   @Generated
   public ρΓΔκρΠθτλχγΦΓ(ΩγΛξιχγτ var1) {
      this.V = var1;
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(φΨαξωυθανΣφυκη.F("ԉԫԭԍԱՐՈ՞Պԙ\u0557Ս՛ՕԞՃեդ՜բ՜Ա", (byte)37, 70), ρΓΔκρΠθτλχγΦΓ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            πηγμΣΔκκ.B("ĬĹĸûĻķĲĻņĵĂŀńĽŀņĈқѮѰҗҟѿҘҥҝҪҗҋѹġ", (byte)37, 66) + var1 + οοθδΨιοΦΠβδζ.B("ă", (byte)37, 66) + var2.toString(), var4
         );
      }
   }
   ...
   public void a(ΨγημιδξΓτοθαζ var1, ΨαχΨχΣλεΠψΦ var2, ιηοψσγξςΩγδ var3, πααΔΣνΨγνθυ var4, γοηλιμεπη var5) {
      if (var5 == γοηλιμεπη.b) {
         try {
            ...
            ψΓωτιμωκχψΛΨ.c(c<"㺀">(d & e, f), var7);
            εδδΠηδξΛΣχ.a(var2, c<"㺃">(h, i));
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(πχσδΦΦνθΔπ.F("ռ։ֈՋ\u058bևւ\u058b֖օՒ\u0590֔֍\u0590֖\u0558࣫ࢾࣀ࣯࣏࣭ࣺࣧࣨࣵࣧࣛࣉ", (byte)93, 70));
         }
