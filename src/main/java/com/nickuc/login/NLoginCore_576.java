...
public class NLoginCore_576 {
   ...
   private static int j = (32 >>> 5 | 32 << -5) & -1;
   private static int f = Integer.reverse(0);
   private static long n = Long.reverse(-5575472716769139069L);
   ...
   private static int k = -1 >>> 60 | -1 << -60;
   ...
   private static void b() {
      c = -4510380911093614257L;
      long var0 = c ^ 5836840985886288112L;
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_576.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_397.D("ґҳҵҕҹӘӐӦӒҡӟӕӣӝҦӋӭӬӤӪӤҹ", (byte)60, 68), NLoginCore_576.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(NLoginCore_110.B("ŚŧŦĩũťŠũŴţİŮŲūŮŴĶҮҽӀӑӃӅұӖŊ", (byte)60, 66) + var1 + NLoginCore_004.F("Բ", (byte)60, 70) + var2.toString(), var4);
      }
   }
   ...
   public String toString() {
      return a(g, h ^ i) + this.o() + a(j & k, l) + this.a() + a(m, n);
   }

   @Generated
   NLoginCore_576(String var1, Collection<NLoginCore_216> var2) {
      this.z = var1;
      this.a = var2;
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_530.D("ԂԏԎӑԑԍԈԑԜԋӘԖԚԓԖԜӞࡖࡥࡨࡹ\u086b\u086d࡙ࡾ", (byte)78, 68));
         }
