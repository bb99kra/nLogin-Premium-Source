...
public enum NLoginCore_254 {
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_254.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_433.E("ԢՄՆԦՊթաշգԲհզմծԷ՜վսյջյՊ", (byte)62, 69), NLoginCore_254.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_397.B("ŞūŪĭŭũŤŭŸŧĴŲŶůŲŸĺӉӇӆӌӅӆӉӇӈŏ", (byte)62, 66) + var1 + NLoginCore_451.E("Դ", (byte)62, 69) + var2.toString(), var4
         );
      }
   }
   ...
   public UUID a(String var1, UUID var2) {
      switch (this) {
         ...
         case c:
            return var2 != null ? var2 : NLoginCore_432.d(var1);
         case d:
            return NLoginCore_432.d(var1);
         default:
            throw new IllegalArgumentException(a(a, b ^ d) + this);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (ZKM_STR_A[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_521.D("ѝѪѩЬѬѨѣѬѷѦгѱѵѮѱѷй߈߆߅ߋ߄߅߈߆߇", (byte)23, 68));
         }
