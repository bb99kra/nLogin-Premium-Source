...
public class Πυκβτδζθ implements πααΔΣνΨγνθυ {
   private static final TextComponent a = Component.text(c<"㺀">(Πυκβτδζθ.x, Πυκβτδζθ.y ^ Πυκβτδζθ.z));
   ...
   private static String[] a = new String[Πυκβτδζθ.v];
   ...
   private TextComponent a(String var1, boolean var2) {
      return ΩτωνοφχεΠ.b(var1, var2);
   }

   @Generated
   Πυκβτδζθ(ΨαχΨχΣλεΠψΦ var1, ιηοψσγξςΩγδ var2, γξτΩΛχΣΓπμΠσΓγφ var3) {
      this.b = var1;
      this.a = var2;
      this.a = var3;
   }
   ...
   public void a(String var1, @Nullable String var2, @Nullable String var3, @Nullable String var4, @Nullable String var5) {
      ...
      if (var3 != null) {
         var6 = var6.clickEvent(ClickEvent.suggestCommand(ςβικδπφδΣκ.m(var3)));
      } else if (var4 != null) {
         var4 = ςβικδπφδΣκ.m(var4);
         if (!var4.isEmpty()) {
         ...
         var6 = var6.clickEvent(ClickEvent.openUrl(ςβικδπφδΣκ.m(var5)));
      }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΠΛΨοδΩσμνΛγΦφβς.D("ԬԹԸӻԻԷԲԻՆԵԂՀՄԽՀՆԈࡺࢠ\u0896\u088fࢢ\u0893\u0896࢙", (byte)92, 68));
         }
   ...
   public void a(int var1, αΠαβσΠτΦ[] var2) {
      if (var2.length != 0) {
         if (var2.length > f) {
            throw new IllegalArgumentException(c<"㺀">(g, h ^ i) + var2.length);
         } else {
            TextComponent var3 = Component.text(c<"㺃">(j & k, l));
            String var4 = c<"㺆">(m, n ^ o) + var1 + c<"㺉">(p & q, r);
            ...
            for (int var5 = s; var5 < var2.length; var5++) {
               ...
               αΠαβσΠτΦ var6 = var2[var5];
               λθΩζιΣΔεΔθτβ var7 = var6.a();
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ντθΔζβΔζ.D("ҔҶҸҘҼӛӓөӕҤӢӘӦӠҩӎӰӯӧӭӧҼ", (byte)61, 68), Πυκβτδζθ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(φΨαξωυθανΣφυκη.D("ӏӜӛҞӞӚӕӞөӘҥӣӧӠӣөҫࠝࡃ࠹࠲ࡅ࠶࠹࠼ҿ", (byte)61, 68) + var1 + ςΦζσμτΓσ.A("ĳ", (byte)61, 65) + var2.toString(), var4);
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = βεξΠθρρςΔΦμ.C("ՏԯՐԘ\u0530ՔԨդԣ՟ՙ\u0558ՐԮՐկՂմըՃզԸՏԶմԶյԸՇ\u0557՜Ս", (byte)103, 67);
               b[1] = ΦδφπθΩΩλζξ.D("ՌՎԜԱզՐԛԦԾ՞ՁԲ", (byte)103, 68);
               b[2] = ΨΦνΨΦωυΩνβςμ.B("żƳƜƒƾǈǇƹƯǊƩǋƫƍǍƑƷƗǘƮǖƒƯƮƔǒǟǋƱǠƬǢƢƵǁƺƽǌǚǪƬǆǦƵ", (byte)103, 66);
               b[3] = ςπυηννναΣ.B("ƹƥƟƹƽƾƻƃƜƩƋƕ", (byte)103, 66);
               b[4] = ΦδφπθΩΩλζξ.A("ƯƱſƔǉƳžƉơǁƤƕ", (byte)103, 65);
               break;
            case 1:
               b[0] = ΠΛΨοδΩσμνΛγΦφβς.F("ֈը։Ցթ֍ա֝՜֑֘֒։է։֨ջ֭֡ռ֟լփ֬֏տ֦֗֠ո֩\u058b", (byte)103, 70);
               b[1] = θεωψξβΛσσ.C("ՎԳԸ\u0558ԱէՅՊԳԢՍԲ", (byte)103, 67);
               b[2] = οοθδΨιοΦΠβδζ.D("ԙՐԹԯ՛եդՖՌէՆըՈԪժԮՔԴյՋճԯՌՋԱկռըՎսՉտիցճձսվֆճդցՈՒ", (byte)103, 68);
               b[3] = μεςΩΔΣγν.D("ՐԟԢ\u0557ԵՠԲԡ\u0557ԹգԲ", (byte)103, 68);
               b[4] = θεωψξβΛσσ.D("ԸՅԿԱԴդՊՙԨէՉԲ", (byte)103, 68);
               break;
            case 2:
               b[0] = φδχεθοκψαλΛογλ.E("է֍֕ո֚֞ս֚֗՟֣ափ֥թ֛֫ս֥֢֟կդևհլյ֫֩ց֘֘", (byte)103, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = ςΦζσμτΓσ.C("ՐՎ\u0558Թ՞Ք\u0558ԧԩՈգԲ", (byte)103, 67);
         }
      }
   }
}
