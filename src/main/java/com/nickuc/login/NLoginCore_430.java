...
public class NLoginCore_430 {
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_430.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_530.A("ßāăãćĦĞĴĠïĭģıīôęĻĺĲĸĲć", (byte)28, 65), NLoginCore_430.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_446.E("ԻՈՇԊՊՆՁՊՕՄԑՏՓՌՏՕԗࢣࡽࢴࢧࢨࢲࢣࢷࢭࢩԭ", (byte)28, 69) + var1 + NLoginCore_004.A("ñ", (byte)28, 65) + var2.toString(), var4
         );
      }
   }
   ...
   public static void b(nLoginBukkit var0, Player var1) {
      try {
         NLoginCore_187 var2 = var0.a().a();
         BukkitLoader var3 = var0.a();

         for (NLoginCore_277 var5 : var0.b().c()) {
         ...
         NLoginCore_370.c(a(i, j ^ k) + var1.getName() + a(l, m), var7);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_232.B("òÿþÁāýøāČûÈĆĊăĆČÎњдѫўџѩњѮѤѠ", (byte)8, 66));
         }
   ...
   public static void a(nLoginBukkit var0, Player var1) {
      try {
         ...
         for (NLoginCore_277 var4 : var0.b().c()) {
            if (!var4.S()) {
               Player var5 = var4.c();
               a(var2, var5, var1);
               a(var2, var1, var5);
         ...
         NLoginCore_370.c(a(a & b, d) + var1.getName() + a(e & f, g), var6);
      }
   }
}
