...
public enum ΠβππΓωΛΦυβΩμΔ {
   b,
   c,
   d;

   private static String[] a = new String[ΠβππΓωΛΦυβΩμΔ.e];
   private static String[] b = new String[ΠβππΓωΛΦυβΩμΔ.f];
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΨΦνΨΦωυΩνβςμ.A("ĹśŝĽšƀŸƎźŉƇŽƋƅŎųƕƔƌƒƌš", (byte)73, 65), ΠβππΓωΛΦυβΩμΔ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            δΛψπξκσβγςα.E("ըյմԷշճծշւձԾռրչռւՄࢶࣉࣘࣙࢭࣤࢷࣃࣣ࣑ࣉࣝࢶ՝", (byte)73, 69) + var1 + λΣΩσμφγχ.B("ŋ", (byte)73, 66) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = μεςΩΔΣγν.F("լմՐԽՠրղՂւֆչՌ", (byte)72, 70);
               b[1] = ζβησεθωυγτ.C("ҿӡӔӲӺӳԇԂӸӠӠӝԂӮӼԕөӸӵӫӢԙӠӡ", (byte)72, 67);
               b[2] = πηγμΣΔκκ.C("ӷӾӚԃӟӳԀӞӠԁӯӝӿӪԃӏӲԍӴԇӹԉӠӡ", (byte)72, 67);
               break;
            case 1:
               b[0] = ΨφιωσρΓδΔθ.A("ŅƊƆŽƃŪƇƂŇŤŪŗ", (byte)72, 65);
               b[1] = οΩνΩρωλΨηΛδωδ.A("ŁţŖŴżŵƉƄźŢŤƓƑŦŵƈŦŬƅŲƝƛŢţ", (byte)72, 65);
               b[2] = ΣφδσΔζιΠρα.E("ծյՑպՖժշՕ\u0557ոե՚ԿԼՠ՚ջ\u0557զՊպժ\u0557\u0558", (byte)72, 69);
               break;
            case 2:
               b[0] = ζβησεθωυγτ.E("ԹԸ՛խՖս\u0558շկՕՏՌ", (byte)72, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = βθκςνθΩθυμςτκχ.B("ŹŘƄũƄƂſŗŜŪƀŗ", (byte)72, 66);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(φδχεθοκψαλΛογλ.C("ԋԘԗӚԚԖԑԚԥԔӡԟԣԜԟԥӧ࡙\u086cࡻࡼࡐࢇ࡚ࡦࢆࡴ\u086cࢀ࡙", (byte)81, 67));
         }
