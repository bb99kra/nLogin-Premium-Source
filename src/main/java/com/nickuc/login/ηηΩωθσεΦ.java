...
public class ηηΩωθσεΦ extends θνθΦζωΩτζδψΠ {
   private static int e = (0 >>> 21 | 0 << -21) & -1;
   private static int ai = 4 >>> 226 | 4 << ~226 + 1;
   private static String[] e = new String[ηηΩωθσεΦ.ah];
   ...
   private static String[] f = new String[ai];

   public ηηΩωθσεΦ(ΨγημιδξΓτοθαζ var1) {
      super(var1, ΓεοκπνΨωπτ.n, c<"㺀">(e, p ^ q), (boolean)(var1.b().a() == κιββωσγχςΣβΠΣδ.b ? z : af));
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               f[0] = ΦδφπθΩΩλζξ.E("ԫԡԙӭӷԧԱԷԩԾԭԺԿԝԎԼԄԴՆԅՁՋԒԓ", (byte)3, 69);
               break;
            case 1:
               f[0] = χΠξΦιζΨΣωΦσΨζ.E("ԫԡԙӭӷԧԱԷԩԾԭՃԖԡԚԯԒԼԄԞՆԕԒԓ", (byte)3, 69);
               break;
            case 2:
               f[0] = οΩνΩρωλΨηΛδωδ.B("úØÓÊÊ¾»ĀûãĀöüĀâĉîÈçýÛßóĄéēãÕďöĘö", (byte)3, 66);
            case 3:
            default:
               break;
            case 4:
               f[0] = μζξτΩσσφυδεπλΨ.B("°ØÓïÎÚßăåôåéàÔ×ĂúîãàßđØÙ", (byte)3, 66);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (e[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(πχσδΦΦνθΔπ.F("ԶՃՂԅՅՁԼՅՐԿԌՊՎՇՊՐԒ࢛࢜\u088fࢰࢠࢬ࢟\u0891", (byte)23, 70));
         }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(πψυκΠΨμΛΩβΣφμφσ.B("ŁţťŅũƈƀƖƂőƏƅƓƍŖŻƝƜƔƚƔũ", (byte)77, 66), ηηΩωθσεΦ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            μζξτΩσσφυδεπλΨ.A("żƉƈŋƋƇƂƋƖƅŒƐƔƍƐƖŘӡӢӕӶӦӲӥӗŬ", (byte)77, 65) + var1 + βθκςνθΩθυμςτκχ.F("Ճ", (byte)77, 70) + var2.toString(), var4
         );
      }
   }
}
