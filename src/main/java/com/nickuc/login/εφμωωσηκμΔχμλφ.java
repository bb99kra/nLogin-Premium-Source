...
public class εφμωωσηκμΔχμλφ {
   ...
   private static String[] b = new String[εφμωωσηκμΔχμλφ.d];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΦδφπθΩΩλζξ.B("ƭǕǁǌǑƮǚǛǄǅǗǔƩǨƿƭǅǞƺƿǤǳƺƻ", (byte)116, 66);
               break;
            case 1:
               b[0] = οΩνΩρωλΨηΛδωδ.F("ն֞֊֚֕շ֣֤֍֎ֳ֪֠լ֢֔֎ֵֺ֭կֆփք", (byte)116, 70);
               break;
            case 2:
               b[0] = μεςΩΔΣγν.C("ֆՕՠՋք\u058bբՙք՜ժՇՓ֓չ֊խ\u0558ճ\u0557Օ֍դե", (byte)116, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = πχσδΦΦνθΔπ.F("֧֔գօպ։ը֎֢դ֩ո", (byte)116, 70);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(χφπρψπφΦθμπ.F("\u0590֝֜՟֛֖֪֟֟֙զ֤֤֪֨֡լࣳअࣼऊऋआࣻࣿंࣛएअअऑ", (byte)113, 70));
         }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  εφμωωσηκμΔχμλφ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(πψυκΠΨμΛΩβΣφμφσ.E("Լ՞ՠՀդփջ֑սՌ֊ր֎ֈՑն֘֗֏֕֏դ", (byte)88, 69), εφμωωσηκμΔχμλφ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζοηκορΦνΣθγΩ.F("շքփՆֆւսֆ֑րՍ\u058b֏ֈ\u058b֑Փࣱࣲࣣ࣭ࣚ࣬\u08e2ࣦࣩࣂࣶ࣬࣬ࣸխ", (byte)88, 70) + var1 + λΣΩσμφγχ.F("Վ", (byte)88, 70) + var2.toString(), var4
         );
      }
   }
   ...
   static {
      b();
      j = (boolean)(ΓΛθσφζςηκ.a(Player.class, c<"㺀">(e & f, g)) != null ? i : j);
   }
}
