...
abstract class ΩλχΦΛξδμιμΨβυΠφ implements ξετφΔοΩψνε {
   ...
   public boolean v(String var1) {
      return this.a.needsRehash(var1, ΣλνΨουΩΔοθεβ.af.r(), ΣλνΨουΩΔοθεβ.ag.r() * b, ΣλνΨουΩΔοθεβ.ah.r());
   }

   @Generated
   protected ΩλχΦΛξδμιμΨβυΠφ(Argon2 var1) {
      this.a = var1;
   }
   ...
   public String w(String var1) {
      return this.a.hash(ΣλνΨουΩΔοθεβ.af.r(), ΣλνΨουΩΔοθεβ.ag.r() * a, ΣλνΨουΩΔοθεβ.ah.r(), var1.toCharArray());
   }
}
