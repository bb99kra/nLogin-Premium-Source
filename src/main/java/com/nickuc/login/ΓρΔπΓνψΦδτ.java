...
public class ΓρΔπΓνψΦδτ implements μθοδηοΠνΦΛνξΛ {
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(χφπρψπφΦθμπ.D("ҨҵҴѷҷҳҮҷӂұѾҼӀҹҼӂ҄ߩ࠘߬࠙߭࠘ࠤࠃࠒࠣ", (byte)48, 68));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = δΛψπξκσβγςα.D("ФѝўвОгыуљюрѣуѣўчпыЧѬююкѭѝЭѬъѦѓжѯѲкћџѻџїѹўкпћєѣѧъфѥѭюѼјѕі", (byte)15, 68);
               b[1] = ΣδτΠνεγοΓορητ.B("ćĀĊçďíęÜćĈ×õĀĝĚûĞĤñòĕĜĈĜĢďđñÿąĢĦñĉĊĪđĦćĳĖ÷öįĀģþĕĽĴĥđĀĹĐđ", (byte)15, 66);
               b[2] = ιΠοθΩΦξκ.A("ßĘęíÙîĆþĔĉûĞþĞęĂúĆâħĉĉõĨĘèħąġĎñĪĭõĖĚĶĚĒĴęõúĖďĞĢąÿĠĨĉķēĐđ", (byte)15, 65);
               b[3] = βεξΠθρρςΔΦμ.B("ÒĎđÏéøóęÜÚĊå", (byte)15, 66);
               b[4] = λΣΩσμφγχ.E("ՅԄԑԚԅԿԆԹԟԸԧԮԈԲՅԭՎՇԍՃ\u0557ԡՌՇԦԹԭՋԱԪԠԹՑգԠԴՇԢԧՔՆՅ՜ԺգՏճԩՇՇԯՄղՁԾԿ", (byte)15, 69);
               break;
            case 1:
               b[0] = φδχεθοκψαλΛογλ.E("ԍՆՇԛԇԜԴԬՂԷԩՌԬՌՇ\u0530ԨԴԐՕԷԷԣՖՆԖՕԳՏԼԟ\u0558՛ԣՄՈդՈՀբՇԣԨՁծկՌՒէՕժՀթՑԾԿ", (byte)15, 69);
               b[1] = ζοηκορΦνΣθγΩ.B("ćĀĊçďíęÜćĈ×õĀĝĚûĞĤñòĕĜĈĜĢďđñÿąĢĦñĉĊĪđĦćĳĖ÷öěĚúýĂďęĞķăĄĔĮĬłŀĥōąňĭ", (byte)15, 66);
               b[2] = φδχεθοκψαλΛογλ.C("ФѝўвОгыуљюрѣуѣўчпыЧѬююкѭѝЭѬъѦѓжѯѲкћџѻџїѹўкоїѳѦҁѺѣѥѧѠшҎѕі", (byte)15, 67);
               b[3] = ΦδφπθΩΩλζξ.B("ÍòĖČčïäĊĆëĎå", (byte)15, 66);
               b[4] = ιΠοθΩΦξκ.E("ՅԄԑԚԅԿԆԹԟԸԧԮԈԲՅԭՎՇԍՃ\u0557ԡՌՇԦԹԭՋԱԪԠԹՑգԠԴՇԢԧՔՆՅ՟՜ՍՆՋՏբԲկհՍՁԾԿ", (byte)15, 69);
               break;
            case 2:
               b[0] = πηγμΣΔκκ.A("ãÕĖÕĒČùĆĎêÛéâëþĎûâĖñĉóðñ", (byte)15, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = φδχεθοκψαλΛογλ.C("јЫЪіЖакДџѥПфтѣхѝщТнѡпѮеж", (byte)15, 67);
         }
      }
   }

   @Generated
   private ΓρΔπΓνψΦδτ(ΓΩηκψγΓεςσγΓ var1) {
      this.d = var1;
   }
   ...
   public void a(PacketSendEvent var1) {
      if (ΣλνΨουΩΔοθεβ.an.ar()) {
         ...
         if (var2 != null) {
            ΨαχΨχΣλεΠψΦ var3 = ΓΩηκψγΓεςσγΓ.a(this.d).b().a(var2);
            ιηοψσγξςΩγδ var4 = ΓΩηκψγΓεςσγΓ.a(this.d).a().a(var3);
            if (var4 != null) {
               if (!var4.a().b(οωλθςδυΛβσΨδγπ.f)) {
                  ...
                  try {
                     ...
                     if (!ψΓωτιμωκχψΛΨ.aj() && var8 instanceof IllegalArgumentException) {
                        ψΓωτιμωκχψΛΨ.c(c<"㺆">(i, j) + var3.getName() + c<"㺉">(k, l) + var8.getMessage());
                     } else {
                        ψΓωτιμωκχψΛΨ.c(c<"㺀">(a, b ^ d) + var3.getName() + c<"㺃">(e & f, g), var8);
                     }
                  ...
                  if (!var5.isOverlay()) {
                     ...
                     if (var6 instanceof TranslatableComponent) {
                        ...
                        if (c<"㺌">(n, o).equals(var7.key())) {
                           var1.setCancelled((boolean)p);
                           return;
                        }
                     }

                     List var9 = var4.a(πβκνλοΛκΠδΦτφλ.l, var0 -> new ArrayList());
                     if (var9.size() < q) {
                        var9.add(var6);
                     }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ΠΛΨοδΩσμνΛγΦφβς.D("һӝӟҿӣԂӺԐӼӋԉӿԍԇӐӵԗԖԎԔԎӣ", (byte)74, 68), ΓρΔπΓνψΦδτ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΨΦνΨΦωυΩνβςμ.E("թնյԸոմկոփղԿսցպսփՅࢪࣙࢭࣚࢮࣙࣥࣄ࣓ࣤ՛", (byte)74, 69) + var1 + φΨαξωυθανΣφυκη.C("Ӎ", (byte)74, 67) + var2.toString(), var4
         );
      }
   }
}
