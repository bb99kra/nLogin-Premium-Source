...
public abstract class νεΓτεκΓηζεΔλιΩ implements LoaderBootstrap, ΦΦδΓθΣηεΦποχθ, εηχβγρΦβΦΛκγΦοδ<VelocityLoader> {
   ...
   private static String[] a = new String[νεΓτεκΓηζεΔλιΩ.r];
            ...
            if (var2 != null && !var2.isEmpty()) {
               ...
               for (RegisteredServer var5 : var2) {
                  ...
                  if (!var6.isUnresolved()) {
                     ...
                     var8 = !var9.isLoopbackAddress() && !var9.isAnyLocalAddress() && !γντωΩλβκν.a.b(var9) && !γντωΩλβκν.b.b(var9) && !γντωΩλβκν.c.b(var9)
                        ? e
                        : d;
                  ...
                  if (var3.length() > 0) {
                     var3.append(c<"㺀">(i, j ^ k));
                  }

                  if (var8 != 0) {
                     var3.append(c<"㺃">(l, m ^ n));
                  } else {
                     var3.append(var7);
                  }

                  var3.append(c<"㺆">(o, p ^ q));
   ...
   public βΛβελΛχιω a(boolean var1) {
      return (βΛβελΛχιω)this.c.b(var1);
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = πχσδΦΦνθΔπ.A("šůšĩĬũūņŤŔŮĽ", (byte)59, 65);
               b[1] = πηγμΣΔκκ.F("Ջ՚ՠըՓյՕԶՂաըԿ", (byte)59, 70);
               b[2] = πψυκΠΨμΛΩβΣφμφσ.B("ŌřůŉņĳűŀŵİŲĽ", (byte)59, 66);
               break;
            case 1:
               b[0] = πψυκΠΨμΛΩβΣφμφσ.C("ҕӘһӜҮӖҳӁӑӖӗҮ", (byte)59, 67);
               b[1] = οοθδΨιοΦΠβδζ.A("ŜŅŇůľūŏŧőůĪŲŰĭŅĶŲƀŭŚłƁňŉ", (byte)59, 65);
               b[2] = χφπρψπφΦθμπ.F("գ՞թՑլՃՈդՉՕ՚Կ", (byte)59, 70);
               break;
            case 2:
               b[0] = ΨφιωσρΓδΔθ.C("ҶҾӜӚӟҮӆӕӄӣҳөӡӃӝӠӞҧңұӰӢҹҺ", (byte)59, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = ςΦζσμτΓσ.F("ՋԱճՄիմՕՒՓլՇԵսկՎՙՊԹ՟որ՝ՊՋ", (byte)59, 70);
         }
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  νεΓτεκΓηζεΔλιΩ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(φΨαξωυθανΣφυκη.D("ҋҭүҏҳӒӊӠӌқәӏӝӗҠӅӧӦӞӤӞҳ", (byte)58, 68), νεΓτεκΓηζεΔλιΩ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(μεςΩΔΣγν.C("ӆӓӒҕӕӑӌӕӠӏҜӚӞӗӚӠҢ࠱ࠪࠉ࠻࠭࠳ࠍ࠲࠲࠲ࠒ࠺࠹ࠪҼ", (byte)58, 67) + var1 + ςΦζσμτΓσ.B("ĭ", (byte)58, 66) + var2.toString(), var4);
      }
   }
   ...
   public νεΓτεκΓηζεΔλιΩ(VelocityLoader var1, String var2, καΦζθθυυεφΦγ var3) {
      this.a = var1;
      this.a = new εβθλγΛχημ(this);
      this.c = new πηλΣρηΛρλΨβχλ(var2, var1.getVersion(), var3, this);
      this.c = new ΠφψΨΣΠνΛΠ(var1.getLogger());
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(πψυκΠΨμΛΩβΣφμφσ.B("ĠĭĬïįīĦįĺĩöĴĸıĴĺüҋ҄ѣҕ҇ҍѧҌҌҌѬҔғ҄", (byte)31, 66));
         }
