...
public class σιβεθκιπΓνΣΔουρ {
   private static int d = Integer.reverse(0);
   private static int f = (-1 >>> 252 | -1 << -252) & -1;
   private static String[] b = new String[σιβεθκιπΓνΣΔουρ.l];
   ...
   private static String[] a = new String[σιβεθκιπΓνΣΔουρ.k];
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(οοθδΨιοΦΠβδζ.E("ԥԲԱӴԴ\u0530ԫԴԿԮӻԹԽԶԹԿԁ\u0896ࢍࢇࢋ\u088f\u0892\u0892࢚\u086e࢙ࢀࡲ࢞ࢥࢢ", (byte)6, 69));
         }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  σιβεθκιπΓνΣΔουρ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(
                     ΣδτΠνεγοΓορητ.F("ԯՑՓԳ\u0557նծքհԿսճցջՄթ\u058b֊ւֈւ\u0557", (byte)75, 70), σιβεθκιπΓνΣΔουρ.class.getClassLoader()
                  )
               )
               .asType(var2)
         );
         ...
         throw new RuntimeException(
            πχσδΦΦνθΔπ.E("ժշնԹչյհչքճՀվւջվքՆ࣒࣐ࣛ࣌ࣔࣗࣗࣟࢳࣞࣅࢷࣣ࣪ࣧա", (byte)75, 69) + var1 + μεςΩΔΣγν.F("Ձ", (byte)75, 70) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = οοθδΨιοΦΠβδζ.E("Ճ՞ԹռբևրՅժ֊սփըըկհձժտՑբնմզ֝֞տս\u058cւվջ\u0557դգհպ֨թ֞֙֨ռհ֭\u058b֊ս֖ձֲ֧֎֨տր", (byte)80, 69);
               b[1] = οοθδΨιοΦΠβδζ.A("ŎƏţƔŦƆŪŪƊŷƜŧ", (byte)80, 65);
               break;
            case 1:
               b[0] = ξψθρΣΠΣς.E("Ճ՞ԹռբևրՅժ֊սփըըկհձժտՑբնմզ֝֞տս\u058cւվջ\u0557դգհպ֨թ֞֙֨ռ\u058cչ֡ձ֑֠֫֒֊ֈշֵ֘ճմִָ֛֙֕֔", (byte)80, 69);
               b[1] = χφπρψπφΦθμπ.B("ŎƆŨŧƗžŞőŜŹƔŧ", (byte)80, 66);
               break;
            case 2:
               b[0] = μζξτΩσσφυδεπλΨ.F("՜ՓՅտգ֊Նիպկ֎ՠըպՠ\u0590Ցհի\u058cցպպ֔֏ֆ\u0557֑֍\u058cխօ", (byte)80, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = χΠξΦιζΨΣωΦσΨζ.D("ԑӝԍӓӭӾӡԘӠӿԅӻӿԃԉӻӸԭԭԤԚԋӸӹ", (byte)80, 68);
         }
      }
   }
   ...
   public static <T> AttributeKey<T> a(String var0) {
      try {
         ...
         try {
            ...
            throw new RuntimeException(c<"㺀">(e & f, g) + var0 + c<"㺃">(h, i ^ j), var3);
         }
      }
   }
}
