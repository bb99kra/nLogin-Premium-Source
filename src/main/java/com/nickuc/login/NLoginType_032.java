...
public abstract class NLoginType_032 extends NLoginCore_168<NLoginType_008> {
   ...
   protected final NLoginCore_466 a;
   ...
   public NLoginType_032(NLoginCore_466 var1) {
      super(var1.e());
      this.a = var1;
   }

   protected abstract void a(NLoginInterface_042 var1, String var2, String[] var3);

   @Override
   protected final void b(NLoginInterface_042 var1, String var2, String[] var3) {
      if (var1 instanceof NLoginCore_277) {
         ...
         Long var7 = var6.a(NLoginCore_567.k);
         if (var7 == null || System.currentTimeMillis() - var7 > a) {
            return;
         }

         String[] var8 = var6.a(NLoginCore_567.j);
         if (var8 != null) {
            var3 = var8;
         }

         NLoginCore_077 var9 = var6.a();
         if (var9.c(NLoginCore_077.c) || (var9 == NLoginCore_077.c || var9 == NLoginCore_077.f) && !this.a.m()) {
            return;
         }
         ...
         int var12 = var9 != NLoginCore_077.f && !this.a.l() && !var5.b(var4) ? ab : ac;
         if (var10 != null) {
   ...
   @Override
   protected final List<String> a(NLoginInterface_042 var1, String var2, String[] var3) {
