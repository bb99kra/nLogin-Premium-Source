...
public class χψκξγιδθΣψη implements απνηβηψθσΣγοξ {
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(βεξΠθρρςΔΦμ.B("ŃťŧŇūƊƂƘƄœƑƇƕƏŘŽƟƞƖƜƖū", (byte)78, 66), χψκξγιδθΣψη.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(χφπρψπφΦθμπ.A("žƋƊōƍƉƄƍƘƇŔƒƖƏƒƘŚӳӵӨӭӣӪӦӫӗӽӭű", (byte)78, 65) + var1 + μεςΩΔΣγν.D("ә", (byte)78, 68) + var2.toString(), var4);
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(λΣΩσμφγχ.C("ѻ҈҇ъҊ҆ҁҊҕ҄ёҏғҌҏҕї߲߰ߥߪߠߧߣߨߔߺߪ", (byte)33, 67));
         }
   ...
   public χψκξγιδθΣψη a(JavaPlugin var1, long var2, long var4, TimeUnit var6) {
      if (var1.isEnabled()) {
         if (this.a != null) {
            throw new IllegalStateException(c<"㺀">(k, l ^ m));
         }
   ...
   public χψκξγιδθΣψη a(JavaPlugin var1) {
      if (var1.isEnabled()) {
         if (this.a != null) {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ςΦζσμτΓσ.E("ՂՅաճԫՅՌՕՓՏԯՇ\u0557ԹհՌ\u0558ՐՉՎՀԶզՆՃ\u0558Ֆդսյդ՝", (byte)58, 69);
               b[1] = πηγμΣΔκκ.B("ĿłŞŰĨłŉŒŐŌĬńŔĶŭŉŕōņŋĽĳţŃŀŕœšźŲšŚ", (byte)58, 66);
               b[2] = χΠξΦιζΨΣωΦσΨζ.E("ՂՅաճԫՅՌՕՓՏԯՇ\u0557ԹհՌ\u0558ՐՉՎՀԶզՆՃ\u0558Ֆդսյդ՝", (byte)58, 69);
               break;
            case 1:
               b[0] = πηγμΣΔκκ.C("үҲӎӠҘҲҹӂӀҼҜҴӄҦӝҹӅҽҶһҭұӆӝӴҳӆӠӴӤӢӶӖӴӴҸӏӯӱӯӭӼӰӋ", (byte)58, 67);
               b[1] = δΛψπξκσβγςα.E("ՂՅաճԫՅՌՕՓՏԯՇ\u0557ԹհՌ\u0558ՐՉՎՀԺգւԽքժց\u0558քսՈծի\u058bտ՞ծ֍֏\u0590ՕՔ՞", (byte)58, 69);
               b[2] = ΣφδσΔζιΠρα.C("үҲӎӠҘҲҹӂӀҼҜҴӄҦӝҹӅҽҶһҭүҼӳҦӪӈҩӣӭӕӭӗӹӧҽӷӠӶһӯҷӰӋ", (byte)58, 67);
               break;
            case 2:
               b[0] = ξψθρΣΠΣς.B("īŅŧřĻŏŞųŵŕıŇņŘŏĶźĶśĵŉŉņŇ", (byte)58, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = ξψθρΣΠΣς.D("ғҲҨӑӠӢӐҕҰқӗӠҧӉҾӋӊҦҧӇҾӯҶҷ", (byte)58, 68);
         }
      }
   }

   χψκξγιδθΣψη(@Nullable Player var1, boolean var2, θυυΔΓΨνεπς var3, Consumer<απνηβηψθσΣγοξ> var4) {
   ...
   χψκξγιδθΣψη(@Nullable Player var1, boolean var2, θυυΔΓΨνεπς var3, Runnable var4) {
   ...
   public χψκξγιδθΣψη a(JavaPlugin var1, long var2, TimeUnit var4) {
      if (var1.isEnabled()) {
         if (this.a != null) {
            throw new IllegalStateException(c<"㺀">(f, g ^ h));
         }
