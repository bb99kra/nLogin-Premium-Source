...
public class χοαγΓΣΓθψΠυχΓεΨ {
   private static String[] b = new String[χοαγΓΣΓθψΠυχΓεΨ.k];
   ...
   private static String[] a = new String[χοαγΓΣΓθψΠυχΓεΨ.j];
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  χοαγΓΣΓθψΠυχΓεΨ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(ςΦζσμτΓσ.C("ЖикКоѝѕѫїЦѤњѨѢЫѐѲѱѩѯѩо", (byte)19, 67), χοαγΓΣΓθψΠυχΓεΨ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            οΩνΩρωλΨηΛδωδ.A("ĈĕĔ×ėēĎėĢđÞĜĠęĜĢäѽѶѩѬэўяѵ҆џ҅҈ѕѸѬÿ", (byte)19, 65) + var1 + οοθδΨιοΦΠβδζ.B("ß", (byte)19, 66) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = λΣΩσμφγχ.D("ӞӑԈӡԐәԖԘӖӚԖԡԓԐӾӯԢӜԛӡӦԔԦӻԣӦӫԜӬӱԃԫԖԎԘԆԖӲԴԘԔԱԗԠԫԫՂԐՅԻԘՉԺԢԏԐ", (byte)77, 68);
               b[1] = λΣΩσμφγχ.E("Կ՝վկյչ\u0558Իռսժ\u058bՍծակժՒվ֍Ոն֓դջ՚֍ըճչ֒՝փ֔՛ՠՠ՝՟ֈզֈգձ", (byte)77, 69);
               b[2] = ΣερμΔσατσκ.F("Կ՝վկյչ\u0558Իռսժն֎փ՝Վ֊լաի\u058cշզ֑֗դկյ֖֖֡պռ֒ղ֥֘֠օտժջ֦ձ", (byte)77, 70);
               break;
            case 1:
               b[0] = ζοηκορΦνΣθγΩ.E("ՋԾյՎսՆփօՃՇփ֎րսի՜֏ՉֈՎՓց֓ը\u0590Փ\u0558։ՙ՞հ֘փջօճփ՟֡օց֞քռ֤օցպ֝հղֱֵ֥ռս", (byte)77, 69);
               b[1] = δΛψπξκσβγςα.F("Կ՝վկյչ\u0558Իռսժ\u058bՍծակժՒվ֍Ոն֓դջ՚֍ըճչ֒՝՟֠՟նդա֦֢֟֝֠ըֈևպկ֏֤զ֍ֱֵռս", (byte)77, 70);
               b[2] = δΛψπξκσβγςα.D("ӒӰԑԂԈԌӫӎԏԐӽԉԡԖӰӡԝӿӴӾԟԊӹԪԤӷԂԈԩԩԴԍӭԏԶԬԆԌԺԸԧԔԷӻԳӸԹՃԗԟԣԹՉՈԏԐ", (byte)77, 68);
               break;
            case 2:
               b[0] = θεωψξβΛσσ.F("Ձ՜ճօ՚\u0557աեՙսՋՑ", (byte)77, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = ντθΔζβΔζ.D("ӰԎӗӣԔӷԕӜԔӳԀӼӻӠӠӰԔӴԐԈԤӲӯӰ", (byte)77, 68);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ντθΔζβΔζ.A("ŲſžŁƁŽŸƁƌŻňƆƊƃƆƌŎӧӠӓӖҷӈҹӟӰӉӯӲҿӢӖ", (byte)72, 65));
         }
   ...
   public static byte[] b(byte[] var0) {
      try {
         ...
         throw new RuntimeException(c<"㺀">(e, f), var7);
      }
   }
   ...
   public static byte[] c(byte[] var0) {
      try {
         ...
         throw new RuntimeException(c<"㺀">(g & h, i), var7);
      }
   }
