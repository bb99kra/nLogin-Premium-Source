...
public class βιχγΓλχΠσπ {
   ...
   private static String[] a = new String[βιχγΓλχΠσπ.bu];
   ...
   private static final DecimalFormat[] a = a(βιχγΓλχΠσπ.bw);
   ...
   private static final DecimalFormat b = new DecimalFormat(c<"㺀">(bx & by, bz));
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(πψυκΠΨμΛΩβΣφμφσ.D("ϬЎАϰДгЫсЭϼкаоиЁЦшчпхпД", (byte)5, 68), βιχγΓλχΠσπ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(δΛψπξκσβγςα.D("Чдг϶жвЭжсаϽлпилсЃއޏޞދݬޕޢݼޠޞЙ", (byte)5, 68) + var1 + ςπυηννναΣ.B("Ã", (byte)5, 66) + var2.toString(), var4);
      }
   }

   public static String a(double var0, double var2, int var4, String var5) {
      int var6 = (int)(var0 * var4 / var2);
      return c<"㺀">(az, ba ^ bb) + b(var5, var6) + c<"㺃">(bc, bd ^ be) + b(var5, var4 - var6);
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(οΩνΩρωλΨηΛδωδ.F("ճրտՂւվչւ֍ռՉև\u058bքև֍Տ࣓ࣛ࣪ࣗࢸ࣮࣡ࣈ࣬࣪", (byte)84, 70));
         }
   ...
   public static String y(String var0) {
      if (var0.isEmpty()) {
         ...
         String[] var1 = var0.split(c<"㺀">(l, m ^ n));
         if (var1.length == 0) {
            return var0;
         } else {
            ...
            return String.join(c<"㺃">(p & q, r), var1);
         }
      }
   }
               ...
               while (true) {
                  ...
                  if (var7 == v) {
                     if (var6 - var4 >= w) {
                        ...
                        Integer var9 = ελληλφαΔλα.a(var8);
                        if (var9 == null) {
                           throw new IllegalArgumentException(c<"㺀">(y, z ^ aa) + var8 + c<"㺃">(ab & ac, ad) + var0 + c<"㺆">(ae, af ^ ag) + var4);
                        }
   ...
   public static String a(double var0, double var2) {
      return a(var0, var2, av, c<"㺀">(aw, ax ^ ay));
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = φΨαξωυθανΣφυκη.C("ГбдхОшϻЧшИлВ", (byte)7, 67);
               b[1] = ΣδτΠνεγοΓορητ.B("ÜåÃĉÂĄąß×ÚðÕ", (byte)7, 66);
               b[2] = φδχεθοκψαλΛογλ.A("ûĆØØèÊăĊúÈÏÕ", (byte)7, 65);
               b[3] = ντθΔζβΔζ.B("ûĆØØèÊăĊúÈÏÕ", (byte)7, 66);
               b[4] = βεξΠθρρςΔΦμ.A("ÙÂé¿ÅÅùçíâďÚñĈåæāç××ÚòěÛĔìċáĀÞÞþÞġĔöĈĖø÷ĎĎêħąêĔĖĄĠĂïĘĔĩĬēğĝĳċāĶģ", (byte)7, 65);
               b[5] = μεςΩΔΣγν.E("ӷԖӻӺԭՁԳԿԶԄԤԙԂԞԞԘԶԚԤՉԐԙԖԗ", (byte)7, 69);
               b[6] = ΣδτΠνεγοΓορητ.C("ЙЄрйфЧпЈьрНВ", (byte)7, 67);
               b[7] = φδχεθοκψαλΛογλ.E("ԧԥԈԪԙӻԕԍԚԹԅԋ", (byte)7, 69);
               b[8] = ΨΦνΨΦωυΩνβςμ.D("ЕЂЮЂдГфгоТзВ", (byte)7, 68);
               b[9] = βθκςνθΩθυμςτκχ.E("ԸԊӽԠӲԛԭԘԬՃԒԋ", (byte)7, 69);
               b[10] = ΨφιωσρΓδΔθ.E("ԑԔԝԱԞԺԣӺԹՅՄԋ", (byte)7, 69);
               b[11] = πηγμΣΔκκ.F("ԬԌԏԷԛԡԫԸԿԡԎԋ", (byte)7, 70);
               b[12] = ΣερμΔσατσκ.B("ÏáÈÚÄùãąöäÇÕ", (byte)7, 66);
               b[13] = χφπρψπφΦθμπ.D("ЏЂфЛЀЄСЇУХлВ", (byte)7, 68);
               b[14] = μζξτΩσσφυδεπλΨ.E("ԅԗӾԐӺԯԙԻԬԚӽԋ", (byte)7, 69);
               b[15] = πψυκΠΨμΛΩβΣφμφσ.E("ԫԽӵԜԉӻԻԋԛԚԎԋ", (byte)7, 69);
               break;
            case 1:
               b[0] = ΨφιωσρΓδΔθ.E("ԯԼԖԶԵԾԢԯԼՀԚԋ", (byte)7, 69);
               b[1] = δΛψπξκσβγςα.B("øöăÂĂàÝøčØäÕ", (byte)7, 66);
               b[2] = ιΠοθΩΦξκ.C("лЙРвЂнЃыЪЖпВ", (byte)7, 67);
               b[3] = χΠξΦιζΨΣωΦσΨζ.B("ÛÃóĈãåąÜíìèÕ", (byte)7, 66);
               b[4] = ΣερμΔσατσκ.C("ЖϿЦϼЂЂжФЪПьЗЮхТУоФДДЗЯјИёЩшОнЛЛлЛўёгхѓедыыЧѤтЧёѓсѝпЬѕѤѳхѥклѬјіѬљёњѶјйѵ҉ћѩѕѭђ", (byte)7, 67);
               b[5] = μζξτΩσσφυδεπλΨ.A("ÁàÅÄ÷ċýĉĀÎîÏäċÊĉêč×âåĉàá", (byte)7, 65);
               b[6] = βθκςνθΩθυμςτκχ.C("ДнцфЖКПГКтЧьзЉОЦэѕцЩЎцНО", (byte)7, 67);
               b[7] = φδχεθοκψαλΛογλ.A("æåãäĆåÚÃÊäàÕ", (byte)7, 65);
               b[8] = ΣδτΠνεγοΓορητ.D("ЁЍиДоϺмъемХВ", (byte)7, 68);
               b[9] = πηγμΣΔκκ.D("еуϿЁϾГпКЈЧцРяЉчЋХђЎѓааНО", (byte)7, 68);
               b[10] = οοθδΨιοΦΠβδζ.B("øăÑÞÁËČúąæĂÕ", (byte)7, 66);
               b[11] = ζοηκορΦνΣθγΩ.A("üÕúöø×ùøøÍäÕ", (byte)7, 65);
               b[12] = μεςΩΔΣγν.D("УмхСРЄчЂонпВ", (byte)7, 68);
               b[13] = οοθδΨιοΦΠβδζ.E("ԦӴԩԌԬԕՂԬԏԴԼԋ", (byte)7, 69);
               b[14] = βεξΠθρρςΔΦμ.F("ԷԳԱՀՁӾԘԟԿԦԴԋ", (byte)7, 70);
               b[15] = λΣΩσμφγχ.E("ԐԧԴԚԋԭԮԏԭԶԚԋ", (byte)7, 69);
               break;
            case 2:
               b[0] = λΣΩσμφγχ.D("ЭгоПГЖЃЀЊСЃяСОмкЛыжШѓРНО", (byte)7, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = δΛψπξκσβγςα.E("Խԕ\u0530ӻӶԓԍԝӽԼԛԑՇՄԡԧԵՀԌԯԧԛԾՍԿԶՍԡԯՈԖՃ", (byte)7, 69);
         }
      }
   }
   ...
   public static String b(double var0, double var2, int var4, String var5) {
      ...
      return c<"㺀">(bp & bq, br) + var7 + b(var5, var8) + c<"㺃">(bs, bt) + b(var5, var4 - var8);
   }

   public static String a(int var0) {
      return c<"㺀">(ah, ai ^ aj) + Integer.toHexString(var0).toUpperCase(Locale.ENGLISH);
   }

   private static DecimalFormat a(int var0) {
      return new DecimalFormat(c<"㺀">(a, b ^ d) + b(c<"㺃">(e, f ^ g), var0), DecimalFormatSymbols.getInstance(Locale.ENGLISH));
   }
}
