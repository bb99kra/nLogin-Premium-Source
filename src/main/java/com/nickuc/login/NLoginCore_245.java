...
public class NLoginCore_245 extends NLoginType_011 {
   private static long h = Long.reverse(864691128455135232L);
   private static int c = Integer.reverse(0);
   private static long f = Long.reverse(5071525607157180063L);
   private static String[] ZKM_STR_A = new String[NLoginCore_245.j];
   private static String[] ZKM_STR_B = new String[NLoginCore_245.m];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_241.C("ҊѸҼґҁҴҧѺңҩҿҜҖҷӈҮӆҋӀҾҫҞқҜ", (byte)49, 67);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_110.B("ģđŕĪĚōŀēļłŖœŘğŜĤĲŕĿŕŬĭĬŀűņņĿţşĸť", (byte)49, 66);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_453.F("ԵԺՉԧԣԼդԹԪՋ՞Ե", (byte)49, 70);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_141.A("ŚĲŉĬĶŐŝŐĪĵŃłœŦļĢţĹĵņĽīĪũŤįŇĬŊŒŘŶ", (byte)49, 65);
         }
      }
   }
   ...
   public void lockableEvent(LockableEvent var1, byte var2, byte var3) {
      if (var2 == 0) {
         ...
         switch (var3) {
            case 1:
               NLoginType_012.a(this.a).callEvent(var4);
            case 2:
               break;
            default:
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_245.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_427.E("ԤՆՈԨՌիգչեԴղընհԹ՞րտշսշՌ", (byte)64, 69), NLoginCore_245.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_446.C("ӘӥӤҧӧӣӞӧӲӡҮӬӰөӬӲҴࠡࠧࡇࡅࡑࠞࡊࡐ࠷ࠣӊ", (byte)64, 67) + var1 + NLoginCore_076.B("Ĺ", (byte)64, 66) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (ZKM_STR_A[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_530.F("ՇՔՓԖՖՒՍՖաՐԝ՛՟\u0558՛աԣ\u0890\u0896ࢶࢴࣀࢍࢹࢿࢦ\u0892", (byte)40, 70));
         }
   ...
   public NLoginCore_245(NLoginType_012 var1) {
      this.a = var1;
   }
