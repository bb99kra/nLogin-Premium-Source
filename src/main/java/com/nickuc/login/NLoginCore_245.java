...
public class NLoginCore_245 extends NLoginType_011 {
   ...
   private static String[] c = new String[NLoginCore_245.j];
   private static String[] d = new String[NLoginCore_245.m];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = NLoginCore_241.C("ҊѸҼґҁҴҧѺңҩҿҜҖҷӈҮӆҋӀҾҫҞқҜ", (byte)49, 67);
               break;
            case 1:
               d[0] = NLoginCore_110.B("ģđŕĪĚōŀēļłŖœŘğŜĤĲŕĿŕŬĭĬŀűņņĿţşĸť", (byte)49, 66);
               break;
            case 2:
               d[0] = NLoginCore_453.F("ԵԺՉԧԣԼդԹԪՋ՞Ե", (byte)49, 70);
            case 3:
            default:
               break;
            case 4:
               d[0] = NLoginCore_141.A("ŚĲŉĬĶŐŝŐĪĵŃłœŦļĢţĹĵņĽīĪũŤįŇĬŊŒŘŶ", (byte)49, 65);
         }
      }
   }
