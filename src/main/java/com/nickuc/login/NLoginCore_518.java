...
public class NLoginCore_518 extends NLoginCore_098 {
   ...
   private static String[] ZKM_STR_A = new String[NLoginCore_518.gg];
   ...
   private static String[] ZKM_STR_B = new String[NLoginCore_518.gh];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_138.E("յ֝թ֚֝՛֝հփ՞֚չ֊֙քսժզէ\u058cֲ֦չպ", (byte)106, 69);
               ZKM_STR_B[1] = NLoginCore_324.D("ԽԹՈՌՈԣՇԿԼՁՁՇթնԳ՛՚ձԺՙյՙՆՇ", (byte)106, 68);
               ZKM_STR_B[2] = NLoginCore_201.F("Ֆ՞֘՜֢֥մֆև֧֚ծ", (byte)106, 70);
               ZKM_STR_B[3] = NLoginCore_110.D("ՈԭՆԬգաՐՍՈՎԲԯԷԫԲձթՕՎՇցտՆՇ", (byte)106, 68);
               ZKM_STR_B[4] = NLoginCore_446.B("ƻǉƊƤǃƐƩƠƼƟǈƛ", (byte)106, 66);
               ZKM_STR_B[5] = NLoginCore_471.F("։ս֎ի֏֓՝ց֔ց֛ծ", (byte)106, 70);
               ZKM_STR_B[6] = NLoginCore_575.F("պ՟\u058c֣֖֗֡ադ\u0590֣ծ", (byte)106, 70);
               ZKM_STR_B[7] = NLoginCore_530.B("ƟǌƙƎƠǀƞƨƔƓǇƎƦǙǍǐƫƦƻǇƾǓǟǕǙǀƴǟưǙơǌ", (byte)106, 66);
               ZKM_STR_B[8] = NLoginCore_324.B("ƨƍƦƌǃǁưƭƨƮƒƖǐǁƴƦǋƔƲƱǎƩƦƧ", (byte)106, 66);
               ZKM_STR_B[9] = NLoginCore_076.A("ƨƍƦƌǃǁưƭƨƮƑǍǅƣǊƤƗǉǚƽƼƮǡƴǖǑǎƻƿƷǔƤ", (byte)106, 65);
               ZKM_STR_B[10] = NLoginCore_127.B("ƨƍƦƌǃǁưƭƨƮƓƑǂƫƫƶƺǘƬƙǝƹǠƢǅƟǟƤƟƥƽǚ", (byte)106, 66);
               ZKM_STR_B[11] = NLoginCore_575.A("ƨƍƦƌǃǁưƭƨƮƒǃƔǗƯǚƶǖǜǚƙƹƦƧ", (byte)106, 65);
               ZKM_STR_B[12] = NLoginCore_453.F("ջՠչ՟֖֔փրջցզ֘շթզժք֊֑֫֯֠֍ձձ֒յִָֻ֜֞", (byte)106, 70);
               ZKM_STR_B[13] = NLoginCore_471.A("ƨƍƦƌǃǁưƭƨƮƔơǑưǓƗǝƾƪƹƲǙǐǣƽǁǗǟǛǘƵǄ", (byte)106, 65);
               ZKM_STR_B[14] = NLoginCore_241.D("գԼԺԬՆ՟ՠգՂյըԻ", (byte)106, 68);
               ZKM_STR_B[15] = NLoginCore_173.A("ƌƮƫƚǐǌƈǎǉƬƕƮƊƩƌƤǉƚǔƙƭƳǗǋƼǢǏǆƞƢǧƴǈǈǆǚǏƣǬǅǜǋƾǦƱǑǎǖǪǖǖƺǀǉǆǇ", (byte)106, 65);
               ZKM_STR_B[16] = NLoginCore_232.C("\u0558՜դխգկԼԬԭՈԱԻ", (byte)106, 67);
               ZKM_STR_B[17] = NLoginCore_183.C("զ\u0558զՏՈժՓԮլՒՆԻ", (byte)106, 67);
               ZKM_STR_B[18] = NLoginCore_004.B("ƼƖƝƋƏǍǅǌƿǔǄƛ", (byte)106, 66);
               ZKM_STR_B[19] = NLoginCore_241.D("Ս\u0557ԪԡՆԱՆհՋյԵՓՓՕՉՆ՝չնչպՙՆՇ", (byte)106, 68);
               ZKM_STR_B[20] = NLoginCore_575.F("֚ՠ֡փք֞՜փկ֖֔֔ց֡֬֎֧֟իֆ֪\u058cչպ", (byte)106, 70);
               ZKM_STR_B[21] = NLoginCore_397.A("ǄƕƛƯƘƣƎǉƧƽǗƿƲǅƮǖƯƸǘƜƗƩƦƧ", (byte)106, 65);
               ZKM_STR_B[22] = NLoginCore_530.E("տՖ՜Քկւ֦֒ևղցծ", (byte)106, 69);
               ZKM_STR_B[23] = NLoginCore_173.D("ԻՖԩէդՌեՅ՞ԿԱԻ", (byte)106, 68);
               ZKM_STR_B[24] = NLoginCore_530.A("ƛƉƣƅƎƮƱƞƎǀƞƛ", (byte)106, 65);
               ZKM_STR_B[25] = NLoginCore_127.C("ԸբԿՉԾ՟ԯՓԳաԲթգէՊխշնՎԿԽՉՆՇ", (byte)106, 67);
               ZKM_STR_B[26] = NLoginCore_427.D("ժԵկ՛ԢժՋժՔնՖԻ", (byte)106, 68);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_427.B("ƢǊƖǊǇƈǊƝưƋǄǕƶǍƣǔƻǑǚǓǀƩƦƧ", (byte)106, 66);
               ZKM_STR_B[1] = NLoginCore_091.A("ƝƙƨƬƨƃƧƟƜơƞơƫƵǈƩƺǗƙǟƻǑƘƿǣǎƱǨǤǩƼǡ", (byte)106, 65);
               ZKM_STR_B[2] = NLoginCore_201.C("Ձԭլ\u0557ԩԾժՌՍԳըԻ", (byte)106, 67);
               ZKM_STR_B[3] = NLoginCore_183.F("ջՠչ՟֖֔փրջցդ֟\u058bփ֠պ֙չջ֧ղְ\u058bղ֥֚֡ֈշ֊ջ֓", (byte)106, 70);
               ZKM_STR_B[4] = NLoginCore_471.F("՜ռ֗՚֣տչ՝֕գգջ֝դ֪\u058bէ֥իլփ֢չպ", (byte)106, 70);
               ZKM_STR_B[5] = NLoginCore_397.C("ԾԪՠԹՈկՇ՞՝ՁեՈՏՑՅռՕճԴնՍտՆՇ", (byte)106, 67);
               ZKM_STR_B[6] = NLoginCore_092.E("թպ\u0558՜Օ֛վօ֏֛՟բյտ՟ե֑֣֡֫֊ֲչպ", (byte)106, 69);
               ZKM_STR_B[7] = NLoginCore_110.B("ƟǌƙƎƠǀƞƨƔƓǇƎƦǙǍǐƫƦƻǇƾǝưǜƣƹǡƦǇǁƴǥ", (byte)106, 66);
               ZKM_STR_B[8] = NLoginCore_138.B("ƨƍƦƌǃǁưƭƨƮƔƗƸƓƖǐǜƱǑƽǒƴǎǎǥǄƯƶǢƻƷƵ", (byte)106, 66);
               ZKM_STR_B[9] = NLoginCore_223.D("ՈԭՆԬգաՐՍՈՎԱխեՃժՄԷթպ՝՜\u0558Թի՚Լդ\u0557։ռՆճ", (byte)106, 68);
               ZKM_STR_B[10] = NLoginCore_446.E("ջՠչ՟֖֔փրջցզդ֕վվ։֍֫տլְֶ֟ևն֨֘֎֕նֵ֜", (byte)106, 69);
               ZKM_STR_B[11] = NLoginCore_241.B("ƨƍƦƌǃǁưƭƨƮƒƑƳǙǅƸưǎƮƮǐǒǎƺǜƵǁǓǂƟƜƣ", (byte)106, 66);
               ZKM_STR_B[12] = NLoginCore_575.C("ՈԭՆԬգաՐՍՈՎԳեՄԶԳԷՑ\u0557ոռ՞ՠՂԼւխՄփ\u0557ՙՆլ", (byte)106, 67);
               ZKM_STR_B[13] = NLoginCore_387.E("ջՠչ՟֖֔փրջցէմ֤փ֦ժְ֑ս\u058cօ֪֢֓֍ֺ֣յֶ\u0590֫ֈ", (byte)106, 69);
               ZKM_STR_B[14] = NLoginCore_076.B("ǀǄǇƞƉǐƉƋǏƵƲơǃưƸƖǆƳǛƷƬƹƦƧ", (byte)106, 66);
               ZKM_STR_B[15] = NLoginCore_559.B("ƌƮƫƚǐǌƈǎǉƬƕƮƊƩƌƤǉƚǔƙƭƳǗǋƼǢǏǆƞƢǧƴǈǈǆǚǏƣǬǅǜǋǁǔǤǚǪǸǬǻǚǚǯǯǆǇ", (byte)106, 66);
               ZKM_STR_B[16] = NLoginCore_232.C("ԢծՌԼԾԣԪՇԫՊմԻ", (byte)106, 67);
               ZKM_STR_B[17] = NLoginCore_559.B("ƝƊƋƧƜǅǒƉƎǁƌƳǓƒǍǇƛƏƘǓƽǏƦƧ", (byte)106, 66);
               ZKM_STR_B[18] = NLoginCore_092.D("ԵԻծԨԢ՝Փմՠդ\u0530լՇՊԴՌ\u0557ԷվԱժՉՆՇ", (byte)106, 68);
               ZKM_STR_B[19] = NLoginCore_092.C("Ս\u0557ԪԡՆԱՆհՋյԶկԮնԺդղխ՟շՕՙՆՇ", (byte)106, 67);
               ZKM_STR_B[20] = NLoginCore_127.B("ǇƍǎưƱǋƉưƜǃǂƷƴƭǘƔǅƝƵƫƞƹƦƧ", (byte)106, 66);
               ZKM_STR_B[21] = NLoginCore_127.D("դԵԻՏԸՃԮթՇ՝նԴչլիՕՙ՚ԾչյՙՆՇ", (byte)106, 68);
               ZKM_STR_B[22] = NLoginCore_201.B("ƺơƘƸƼǑƺƤǏƍƕƛ", (byte)106, 66);
               ZKM_STR_B[23] = NLoginCore_559.E("՚֗\u0590֔բձկ\u0558֜֕ՠդնեְ֪֤֚ֈտճ֢չպ", (byte)106, 69);
               ZKM_STR_B[24] = NLoginCore_201.D("Ո՜գիԫԣՁդբԾԵԻ", (byte)106, 68);
               ZKM_STR_B[25] = NLoginCore_127.F("ի֕ղռձ֒բֆզ֔ե֛զռշժֱ֣ը֜ճռչպ", (byte)106, 70);
               ZKM_STR_B[26] = NLoginCore_027.E("ղ\u0590֢֝֍վֆևմՠ֛ծ", (byte)106, 69);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_387.F("՛խ֙րհ֔\u0557ո֖ճ֩րճ֠գ֊։֛վ֒֜ռչպ", (byte)106, 70);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_471.B("ƥƿƧƺǂƈƪƽƵƪƈƵƑƥƴǋƎƾƕǚƱƹƦƧ", (byte)106, 66);
         }
      }
   }
