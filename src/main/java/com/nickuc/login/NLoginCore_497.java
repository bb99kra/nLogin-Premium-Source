...
public class NLoginCore_497 extends PBKDF2HashProvider implements NLoginInterface_037 {
   ...
   private static final char[] e = a(NLoginCore_497.ar, as ^ NLoginCore_497.at).toCharArray();
   ...
   private static final String ct = a(ao, NLoginCore_497.ap ^ aq);
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_076.F("օ֑֒Ք֔\u0590\u058b֔֟֎՛֖֙֝֙֟աࣹࣩࣹ࣬ࣽ࣡ࣸࣚऄࣰ࣏ࣳࣽ", (byte)102, 70));
         }
   ...
   public boolean i(String var1, String var2) {
      ...
      if (var3.length != i) {
         ...
         for (int var9 = w; var9 < var8; var9++) {
            ...
            byte[] var11 = a(a(ad, ae ^ af), (var1 + var10).toCharArray(), var6, var4, ag);
            int var12 = ah;
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_497.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_183.C("ѶҘҚѺҞҽҵӋҷ҆ӄҺӈӂҋҰӒӑӉӏӉҞ", (byte)51, 67), NLoginCore_497.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_433.A("ňŕŔėŗœŎŗŢőĞŜŠřŜŢĤҼҬүӀҼҤһҝӇҒҳҶӀĽ", (byte)51, 65) + var1 + NLoginCore_451.F("ԩ", (byte)51, 70) + var2.toString(), var4
         );
      }
   }
