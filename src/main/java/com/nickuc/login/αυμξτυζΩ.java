...
public class αυμξτυζΩ {
   private static String[] b = new String[αυμξτυζΩ.g];
   private static int c = 33554432 >>> 89 | 33554432 << ~89 + 1;
   private static int a = Integer.reverse(0);
   private static String[] a = new String[αυμξτυζΩ.f];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = μζξτΩσσφυδεπλΨ.D("ԲՋՇՍՏԙԻԿՃՙ՟ՑՄէԽժՇդդթեԭՎՉԲզաիԯ\u0557ոիժ՚կ\u0558\u0558ՋցԷչ՛պջՒըՅ\u0557Չւ\u0557վ֍\u0557ՔՕ", (byte)100, 68);
               b[1] = πψυκΠΨμΛΩβΣφμφσ.F("֒ՐՕզթիըֈ՞֟ձխվ֒ա֒֗յ֣ք։ֆճմ", (byte)100, 70);
               break;
            case 1:
               b[0] = οοθδΨιοΦΠβδζ.E("ձ֊ֆ\u058c֎\u0558պվւ֘֞\u0590փ֦ռ֩ֆ֣֣֤֨լ֍ֈձ֥֪֠ծַ֖֪֮֩֙֗֗֊׀նָֹ֚֚֔փ֚֕֜։ׇָ֟\u05cc֓֔", (byte)100, 69);
               b[1] = ΦδφπθΩΩλζξ.B("ƹŷżƍƐƒƏƯƅǆƙŽƆƕǃƉƋǀƧƍƯǓƚƛ", (byte)100, 66);
               break;
            case 2:
               b[0] = μζξτΩσσφυδεπλΨ.C("ԒԥԩԶԻՋԷԗԱՖՄԩ", (byte)100, 67);
            case 3:
            default:
               break;
            case 4:
               b[0] = βθκςνθΩθυμςτκχ.F("ճծ՚Փխմս֔֝ճփը", (byte)100, 70);
         }
      }
   }
   ...
   public static void a(User var0, Component var1) {
      switch (ξχςκΨργπΛΓμγζ.R[var0.getEncoderState().ordinal()]) {
         case 1:
         ...
         default:
            ...
            throw new IllegalStateException(c<"㺀">(a, b) + var0.getEncoderState() + c<"㺃">(c, d ^ e) + var0.getDecoderState());
      }
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ζβησεθωυγτ.A("ēĵķėĻŚŒŨŔģšŗťşĨōůŮŦŬŦĻ", (byte)54, 65), αυμξτυζΩ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            βεξΠθρρςΔΦμ.D("ҺӇӆ҉ӉӅӀӉӔӃҐӎӒӋӎӔҖ࠙\u082eࠦࠩ࠰࠲ࠤ࠘Ҫ", (byte)54, 68) + var1 + θεωψξβΛσσ.C("ґ", (byte)54, 67) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ντθΔζβΔζ.F("ԷՄՃԆՆՂԽՆՑՀԍՋՏՈՋՑԓ\u0896ࢫࢣࢦࢭࢯࢡ\u0895", (byte)24, 70));
         }
