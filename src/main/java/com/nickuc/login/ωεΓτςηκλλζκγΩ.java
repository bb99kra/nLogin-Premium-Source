...
public class ωεΓτςηκλλζκγΩ implements θβορΛτηατθΨτΠτΦ {
   ...
   public void a(PacketReceiveEvent var1) {
      ...
      com.nickuc.login.bukkit.ΠιζζοΨκψΠΔπ var6 = new com.nickuc.login.bukkit.ΠιζζοΨκψΠΔπ(var1.getUser(), null, var3, null, (boolean)a, null, var4, null);
      var4.attr(com.nickuc.login.bukkit.ΠιζζοΨκψΠΔπ.a).set(var6);
      com.nickuc.login.bukkit.ΠιζζοΨκψΠΔπ.a(var3, var3, var5, var6);
   }
}
