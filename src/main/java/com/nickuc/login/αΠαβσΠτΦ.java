...
public class αΠαβσΠτΦ {
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(βεξΠθρρςΔΦμ.C("ԈԕԔӗԗԓԎԗԢԑӞԜԠԙԜԢӤࡧࡗࡩ\u086bࡽ࡛ࢀࡣ", (byte)80, 67));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = οΩνΩρωλΨηΛδωδ.A("ƟƦƗǋǐƷǎƺǓǞƠǔǣǞƯǅǠǛƦǇǒƴǆǌƭǛǮǅǲǅǃƱƮǦǒǯǉǍǲǚǴǻǶǅ", (byte)111, 65);
               break;
            case 1:
               b[0] = οοθδΨιοΦΠβδζ.A("ƟƦƗǋǐƷǎƺǓǞƠǔǣǞƯǅǠǛƦǇǒƴǆǌƭǛǮǅǲǅǃƱƯƵǧǋƸǧǴǝǪǭǘǅ", (byte)111, 65);
               break;
            case 2:
               b[0] = μεςΩΔΣγν.A("ǒǍƢƴƐǐǏƧƱƸǡƚƼǚǟƱǐǂǀǘǦǅƤǮǋǩǪǰǪǛǉǋ", (byte)111, 65);
            case 3:
            default:
               break;
            case 4:
               b[0] = ζβησεθωυγτ.E("շ֕ձցօն֣֪֦֝նիօթ֍֤֞֔֊։ַցվտ", (byte)111, 69);
         }
      }
   }
   ...
   public static αΠαβσΠτΦ[] a(ΨαχΨχΣλεΠψΦ var0, γοηλιμεπη... var1) {
      if (var1.length == 0) {
         throw new IllegalArgumentException(c<"㺀">(a & b, d));
      } else {
         αΠαβσΠτΦ[] var2 = new αΠαβσΠτΦ[var1.length];

         for (int var3 = e; var3 < var2.length; var3++) {
            γοηλιμεπη var4 = var1[var3];
   ...
   @Generated
   public αΠαβσΠτΦ(γοηλιμεπη var1, λθΩζιΣΔεΔθτβ var2) {
      this.q = var1;
      this.a = var2;
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(χΠξΦιζΨΣωΦσΨζ.B("ÍïñÑõĔČĢĎÝěđğęâćĩĨĠĦĠõ", (byte)19, 66), αΠαβσΠτΦ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΨφιωσρΓδΔθ.E("ԲԿԾԁՁԽԸՁՌԻԈՆՊՃՆՌԎ\u0891ࢁ\u0893\u0895ࢧࢅࢪࢍԢ", (byte)19, 69) + var1 + ΦδφπθΩΩλζξ.F("ԉ", (byte)19, 70) + var2.toString(), var4
         );
      }
   }
}
