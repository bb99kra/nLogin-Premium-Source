...
public enum χκιΛφΓκκρλθλψο {
   b(αψσπμογΩ.x),
   c(αψσπμογΩ.y),
   d(αψσπμογΩ.z);

   private final ρΣνμχγΨοΔΦ a;
   private static String[] a = new String[χκιΛφΓκκρλθλψο.e];
   private static String[] b = new String[χκιΛφΓκκρλθλψο.f];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ζβησεθωυγτ.A("æüíåăïĐáÕä×á", (byte)13, 65);
               b[1] = μζξτΩσσφυδεπλΨ.A("êûÎĈéÓæõâě×á", (byte)13, 65);
               b[2] = οοθδΨιοΦΠβδζ.E("ԞӽԻԡӽԸԣՆԤԓԤԑ", (byte)13, 69);
               break;
            case 1:
               b[0] = πηγμΣΔκκ.A("ÐĒăĊĈĐÑÑÔòðá", (byte)13, 65);
               b[1] = πηγμΣΔκκ.B("ÌÏëčèçèāċÒĎá", (byte)13, 66);
               b[2] = οοθδΨιοΦΠβδζ.A("ïÐđçČêéĐØúĆá", (byte)13, 65);
               break;
            case 2:
               b[0] = βεξΠθρρςΔΦμ.F("ӴԳԥՆԽԞԓԘԤԊԙԥԝՀՌՃՈԞԢԍԢՕԜԝ", (byte)13, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = ντθΔζβΔζ.C("АщьБЙЭзѕШњѝФ", (byte)13, 67);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(φΨαξωυθανΣφυκη.E("ԺՇՆԉՉՅՀՉՔՃԐՎՒՋՎՔԖࢯࢣࢣࢆࢲࢀࢨࢩࢱࢬࢪࢮࢼࢴ", (byte)27, 69));
         }
   ...
   @Generated
   private χκιΛφΓκκρλθλψο(ρΣνμχγΨοΔΦ var3) {
      this.a = var3;
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  χκιΛφΓκκρλθλψο.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(βεξΠθρρςΔΦμ.A("ƉƫƭƍƱǐǈǞǊƙǗǍǛǕƞǃǥǤǜǢǜƱ", (byte)113, 65), χκιΛφΓκκρλθλψο.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΦδφπθΩΩλζξ.D("իոշԺպնձպօմՁտփռտօՇ࣠ࣔࣔࢷࣣࢱࣙࣚ\u08e2࣭ࣝࣛࣟࣥա", (byte)113, 68) + var1 + δΛψπξκσβγςα.E("է", (byte)113, 69) + var2.toString(), var4
         );
      }
   }
}
