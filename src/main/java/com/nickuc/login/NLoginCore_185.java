...
public class NLoginCore_185 implements NLoginInterface_031 {
   ...
   private static String[] ZKM_STR_A = new String[NLoginCore_185.n];
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_185.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_183.B("©ËÍ\u00adÑðèþê¹÷íûõ¾ãąĄüĂüÑ", (byte)1, 66), NLoginCore_185.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_091.D("ЛШЧϪЪЦСЪеФϱЯгЬЯеϷޑݝދݽދހݸމޔއޜގޛݪޓВ", (byte)1, 68) + var1 + NLoginCore_471.A("»", (byte)1, 65) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (ZKM_STR_A[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(NLoginCore_427.C("ҷӄӃ҆ӆӂҽӆӑӀҍӋӏӈӋӑғ࠭߹ࠧ࠙ࠧࠜࠔࠥ࠰ࠣ࠸ࠪ࠷ࠆ\u082f", (byte)53, 67));
         }
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            ...
            case 1:
               ...
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_427.D("ӧӃӤӇҡҺҭӣӜӢӏҭҰӍӦӏӧӲӧҴҵӾӅӆ", (byte)63, 68);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_110.B("ŒŷİŅĳĭŇįŰňŮŅ", (byte)63, 66);
         }
      }
   }
}
