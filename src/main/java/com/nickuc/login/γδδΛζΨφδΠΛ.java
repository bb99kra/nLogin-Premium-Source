...
public class γδδΛζΨφδΠΛ implements Location {
   ...
   private static String[] a = new String[γδδΛζΨφδΠΛ.u];
   private final double c;
   private static String[] b = new String[γδδΛζΨφδΠΛ.v];
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣδτΠνεγοΓορητ.C("Պ\u0557ՖԙՙՕՐՙդՓԠ՞բ՛՞դԦࢫࢭࢮ\u0896ࢲࢥࣄࢳࢠ࢜", (byte)102, 67));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = φΨαξωυθανΣφυκη.D("ӝұңӞҴӡӏӚӑңұӟұӴҶҵӆөӍұӱәӚҵӀӒӲӰԂӱԂӶ", (byte)62, 68);
               b[1] = ΨφιωσρΓδΔθ.C("ӗұҶҨҷӅҩҮҿӄӎҷ", (byte)62, 67);
               b[2] = φΨαξωυθανΣφυκη.F("ԬԦժագՐղէՆժ՝Ղ", (byte)62, 70);
               b[3] = ΣφδσΔζιΠρα.E("ծՅըբԱՂՋմՆճԸՂ", (byte)62, 69);
               b[4] = ντθΔζβΔζ.B("ŦľłŕŶŋŪŇœŭŨŃ", (byte)62, 66);
               b[5] = πηγμΣΔκκ.A("ŴŋšŤŒłŖűźũŕůŀŪļőťłŝůźšŎŏ", (byte)62, 65);
               b[6] = ζβησεθωυγτ.B("ĮŶŨĩŅœťŰŪĳŖŃ", (byte)62, 66);
               break;
            case 1:
               b[0] = βεξΠθρρςΔΦμ.B("ũĽįŪŀŭśŦŝįĽūĽƀłŁŒŵřĽŽűŝŉŵŪŗŬŬŭőůƇƌŎŒƔœƛŚƎŮƈţ", (byte)62, 66);
               b[1] = βεξΠθρρςΔΦμ.E("ՅԬԱՁհՆէՉՍղՙՂ", (byte)62, 69);
               b[2] = λΣΩσμφγχ.E("ՂԲՔմԿԯպխՌՊչտ՛Զ՛հծՠցՑֈՠՍՎ", (byte)62, 69);
               b[3] = ςΦζσμτΓσ.D("ӆӨәҵңҶӇҦӘӧӆҷ", (byte)62, 68);
               b[4] = ΣδτΠνεγοΓορητ.F("ՈԾՍըՍՔաթՓԮԸՕՇսՑչՐտՄնքֆՍՎ", (byte)62, 70);
               b[5] = μεςΩΔΣγν.C("ӨҿӕӘӆҶӊӥӮӝӆӊөөӏұӹӌӓӫӗӻӂӃ", (byte)62, 67);
               b[6] = ΠΛΨοδΩσμνΛγΦφβς.F("ԯիզլ\u0557ղՏոհՒշՂ", (byte)62, 70);
               break;
            case 2:
               b[0] = ξψθρΣΠΣς.B("ŅĬŦŃŠŖŬśŎŬżŃ", (byte)62, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = δΛψπξκσβγςα.D("ӅӅҵҽӠӕӨҫҩӉұӨӂӈҮӤӰҸӳҭӷӫӂӃ", (byte)62, 68);
         }
      }
   }
   ...
   @Generated
   public γδδΛζΨφδΠΛ(String var1, double var2, double var4, double var6, float var8, float var9) {
      this.j = var1;
      this.a = var2;
      this.b = var4;
      this.c = var6;
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(θεωψξβΛσσ.D("ՑճյՕչ֘\u0590֦֒ա֣֟֕֝զ\u058b֤֪֤֭֬չ", (byte)124, 68), γδδΛζΨφδΠΛ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ντθΔζβΔζ.A("ǚǧǦƩǩǥǠǩǴǣưǮǲǫǮǴƶԻԽԾԦՂԵՔՃ\u0530Ԭǌ", (byte)124, 65) + var1 + ςΦζσμτΓσ.F("ղ", (byte)124, 70) + var2.toString(), var4
         );
      }
   }
