...
public enum NLoginCore_515 {
   a((NLoginCore_515 != 0).i),
   b((NLoginCore_515 != 0).n);

   private final boolean aR;
   private static String[] ZKM_STR_A = new String[NLoginCore_515.d];
   private static String[] ZKM_STR_B = new String[NLoginCore_515.e];
   ...
   @Generated
   private NLoginCore_515(boolean var3) {
      this.aR = var3;
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_515.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_433.E("ՎհղՒն֕֍֣֏՞֚֜֒֠գֈ֪֧֩֡֡ն", (byte)106, 69), NLoginCore_515.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_553.C("Ֆգբԥեա՜եհ՟ԬժծէժհԲࢾ࣎ࢩࢭࢫࢾ࣐ࣅࣆࣇࣆ࣏࣏ࣚՌ", (byte)106, 67) + var1 + NLoginCore_183.F("ՠ", (byte)106, 70) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_223.E("ՅՏՆՕ\u058bՇ\u0558\u058cկօլՕ", (byte)81, 69);
               ZKM_STR_B[1] = NLoginCore_530.F("ֆ\u0557ըւվՉքՄիտհՕ", (byte)81, 70);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_027.E("ՐՇՅւտ\u0558ՂՈւբՇՕ", (byte)81, 69);
               ZKM_STR_B[1] = NLoginCore_138.B("ŤűƎŻŜƓƁƏŶŬşũ", (byte)81, 66);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_387.E("բըֈ՞ՂևփՄկփրբհժ\u058c֕ՐքփղՕգՠա", (byte)81, 69);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_530.D("ӭӮԓԤԁӜӟԐӿӧԌԧӫԖԉԆԱӯԃԩԆԅӱԩԸԆԯԵԔԵԟԚ", (byte)81, 68);
         }
      }
   }
}
