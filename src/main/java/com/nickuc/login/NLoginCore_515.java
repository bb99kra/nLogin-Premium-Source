...
public enum NLoginCore_515 {
   a((boolean)NLoginCore_515.i),
   b((boolean)NLoginCore_515.n);

   private final boolean aR;
   private static String[] a = new String[NLoginCore_515.d];
   private static String[] b = new String[NLoginCore_515.e];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = NLoginCore_223.E("ՅՏՆՕ\u058bՇ\u0558\u058cկօլՕ", (byte)81, 69);
               b[1] = NLoginCore_530.F("ֆ\u0557ըւվՉքՄիտհՕ", (byte)81, 70);
               break;
            case 1:
               b[0] = NLoginCore_027.E("ՐՇՅւտ\u0558ՂՈւբՇՕ", (byte)81, 69);
               b[1] = NLoginCore_138.B("ŤűƎŻŜƓƁƏŶŬşũ", (byte)81, 66);
               break;
            case 2:
               b[0] = NLoginCore_387.E("բըֈ՞ՂևփՄկփրբհժ\u058c֕ՐքփղՕգՠա", (byte)81, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = NLoginCore_530.D("ӭӮԓԤԁӜӟԐӿӧԌԧӫԖԉԆԱӯԃԩԆԅӱԩԸԆԯԵԔԵԟԚ", (byte)81, 68);
         }
      }
   }
}
