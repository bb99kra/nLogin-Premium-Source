...
public class ισγηιςμΩδΠλοΔφΔ extends ζαξρυωβζπ implements λιμριγδβψ {
   ...
   private static String[] d = new String[ισγηιςμΩδΠλοΔφΔ.bb];
   ...
   private static final String cn = c<"㺀">(ισγηιςμΩδΠλοΔφΔ.bc, bd ^ be);
   ...
   public boolean i(String var1, String var2) {
      String[] var3 = var2.split(c<"㺀">(f, h ^ j));
      if (var3.length != k) {
         return (boolean)n;
      } else if (!var3[p].equalsIgnoreCase(c<"㺃">(q, r ^ t))) {
         return (boolean)v;
      } else {
         Integer var4 = ελληλφαΔλα.a(var3[w]);
         if (var4 == null) {
            ψΓωτιμωκχψΛΨ.c(c<"㺆">(ad, ae ^ af) + var3[ag] + c<"㺉">(ah, ai ^ aj));
            return (boolean)al;
         } else {
            String var5 = var3[am];
            byte[] var6 = d(var3[an]);
            byte[] var7 = a(c<"㺌">(ao, ap ^ aq), var1.toCharArray(), var5.getBytes(), var4, b(c<"㺏">(ar, as)));
            return ζαξρυωβζπ.a(var6, var7);
         }
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ισγηιςμΩδΠλοΔφΔ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(δΛψπξκσβγςα.F("՞րւբֆֳ֥֝֟ծְ֢֪֬ճֱֱַֺֹ֘ֆ", (byte)122, 70), ισγηιςμΩδΠλοΔφΔ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζβησεθωυγτ.E("֦֥֙ըֳ֤֢֨֟֨կֱֳ֪֭֭յऀऋࣼँऄऎउࣷःࣰऌऑࣧचࣩ\u0590", (byte)122, 69) + var1 + μεςΩΔΣγν.C("՝", (byte)122, 67) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (c[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΣφδσΔζιΠρα.D("ҐҝҜџҟқҖҟҪҙѦҤҨҡҤҪѬ߷ࠂ߳߸\u07fbࠅࠀ߮ߺߧࠃࠈߞࠑߠ", (byte)40, 68));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               d[0] = ιΠοθΩΦξκ.E("֚\u0590ս֡֙ֈւ֣իծշմ", (byte)112, 69);
               d[1] = ζβησεθωυγτ.A("ƮǓƔƬƲƼǙƪƖǘƔǡƮǛƠƴơǙǩǃǄǅƲƳ", (byte)112, 65);
               d[2] = ΦδφπθΩΩλζξ.D(
                  "ըՈԺՀմ՜քռՆկֆեեըզէւոըկլփլկ֏ՉՑՔ֚փ֍֞֞ֈ֕ձ֣մ֢՟՝֥ր֪֢֥֣շզ֢\u058b\u058b֎ִ։֤\u058c֖֩֬շִַָֻּ֪֮֞ռջֽׁ֥֘֝֠֟\u05c9ׅ\u05ccא\u058c\u05cb\u05cfׄגֿ֎֪֗\u058b֮ז\u05caׇ",
                  (byte)112,
                  68
               );
               d[3] = πχσδΦΦνθΔπ.F("դ֕֞դև֣վ֢֭֠֟մ", (byte)112, 70);
               d[4] = ζβησεθωυγτ.A("ƮƫǅƫǉǖǌǛƮǞǜƢƠƟƯǥǃǩǜƣǖƵƲƳ", (byte)112, 65);
               d[5] = μζξτΩσσφυδεπλΨ.E("ջո֒ո֖֣֙֨ջ֫֩կխլռֲ\u0590ֶ֩հ֣ւտր", (byte)112, 69);
               d[6] = ΣδτΠνεγοΓορητ.F("ջո֒ո֖֣֙֨ջ֫֩կխլռֲ\u0590ֶ֩հ֣ւտր", (byte)112, 70);
               break;
            case 1:
               d[0] = ντθΔζβΔζ.F("֠զճ֦։թբռսլ֙մ", (byte)112, 70);
               d[1] = πχσδΦΦνθΔπ.C("ՔչԺՒ\u0558բտՐԼվՇ՞ՊնբևՙչւՋօ՛\u0558ՙ", (byte)112, 67);
               d[2] = θεωψξβΛσσ.F(
                  "֏կաէ֛փ֣֫խ֖֭\u058c\u058c֏֍֎֩֟֏ֶ֖֪֖֓֓հոջִּׁ֪ׅׅ֯֘\u05ca֛\u05c9ֆք\u05cc֧ב\u05c9\u05cc\u05ca֞֍\u05c9ֲֲֵכְ\u05cbֳאֽד֞מכׅוןףעבֿ֣֢ׄ\u05ccׇרפ׆װ\u05ec׳\u05f7ֳײ\u05f6\u05ee\u05cb\u05ed\u05fd\u05f7ױ־ׯּ\u05ed\u05f8",
                  (byte)112,
                  70
               );
               d[3] = πψυκΠΨμΛΩβΣφμφσ.F("բ֜ղ֡դ֞գ֣֭իտմ", (byte)112, 70);
               d[4] = ντθΔζβΔζ.D("ՔՑիՑկռղցՔքւՄ՝սՂրվև\u0558փլ՛\u0558ՙ", (byte)112, 68);
               d[5] = θεωψξβΛσσ.A("ƮƫǅƫǉǖǌǛƮǞǞƢǓǥǇƣǕǅǓǜǘƵƲƳ", (byte)112, 65);
               d[6] = ΣφδσΔζιΠρα.F("ջո֒ո֖֣֙֨ջ֫֫֙֡ֈխִ֦֩֊նָ֚տր", (byte)112, 70);
               break;
            case 2:
               d[0] = ΠΛΨοδΩσμνΛγΦφβς.E("֦֦յ֑֖բ֘֫֊֤պ֜վձև֊ְֱխָո֑֧֭֕֬ն֚\u058bְ֘֕", (byte)112, 69);
            case 3:
            default:
               break;
            case 4:
               d[0] = δΛψπξκσβγςα.A("ƗƯƖƤǘǔƬǔƠǛƚǡƝƟǧǤǂƻǂƝǌǥǘƫǪǝƬƿƱǣƵǦ", (byte)112, 65);
         }
      }
   }
