...
public class ελληλφαΔλα {
   ...
   private static final DecimalFormat a = new DecimalFormat(c<"㺆">(v & w, x));
   ...
   private static final String bQ = c<"㺀">(p & q, r);
   private static long m = Long.reverse(-3830180570975612702L);
   private static int ai = (-1 >>> 244 | -1 << -244) & -1;
   private static final String bR = c<"㺃">(ελληλφαΔλα.s, t ^ u);
   ...
   public static String c(long var0) {
      if (var0 <= 0L) {
         ...
         return a.format(var3) + c<"㺃">(l, m) + e[var2];
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = δΛψπξκσβγςα.D("պՌռֈՐ՞Փ֏֕ճաազՐ֙զ֖պ՛լ՚\u0590էը", (byte)117, 68);
               b[1] = χφπρψπφΦθμπ.B("ƬǘƴǜǅǨƢƛǅǔƣƱ", (byte)117, 66);
               b[2] = ΣδτΠνεγοΓορητ.C("ՃիՏՠխ՝՜խՠ֑Ւ՜", (byte)117, 67);
               b[3] = ντθΔζβΔζ.C("պՌռֈՐ՞Փ֏֕ճաազՐ֙զ֖պ՛լ՚\u0590էը", (byte)117, 67);
               b[4] = χΠξΦιζΨΣωΦσΨζ.C("\u0557փ՟ևհ֓ՍՆհտՎ՜", (byte)117, 67);
               b[5] = ΨΦνΨΦωυΩνβςμ.D("\u058bՄՎջբ֒էեմձ։՜", (byte)117, 68);
               b[6] = ΠΛΨοδΩσμνΛγΦφβς.E("գր֦և֥\u058b֑֯ձ։֞չ", (byte)117, 69);
               b[7] = ζοηκορΦνΣθγΩ.B("ƹƺǍǦǔƞǃǝǪǫƧƱ", (byte)117, 66);
               b[8] = ςπυηννναΣ.D("տՎՎՉլճփՋժևց՜", (byte)117, 68);
               b[9] = χφπρψπφΦθμπ.B("ǢƼǢǎǞǦƠǘǈǦǚƱ", (byte)117, 66);
               b[10] = θεωψξβΛσσ.B("ǣǐǞƜǣǞƶƵǛǌƼƱ", (byte)117, 66);
               break;
            case 1:
               b[0] = οΩνΩρωλΨηΛδωδ.B("ǏơǑǝƥƳƨǤǪǈƷƼƸƷǐǌƯǲǦǟǪƿƼƽ", (byte)117, 66);
               b[1] = λΣΩσμφγχ.F("֨վեգ֨֏֭֯֓ջ\u058cչ", (byte)117, 70);
               b[2] = ΣφδσΔζιΠρα.E("ոք֨թ֥֨֡\u058bփճռչ", (byte)117, 69);
               b[3] = δΛψπξκσβγςα.C("պՌռֈՐ՞Փ֏֕ճ՟ճ֖֑ոջՏժ֠\u058b֙֠էը", (byte)117, 67);
               b[4] = βεξΠθρρςΔΦμ.D("վ՜խՊ՜։\u058bժւմ֍՜", (byte)117, 68);
               b[5] = ξψθρΣΠΣς.B("ǏǤƺƿƴƷƢƠǛƥǭƩƼǡƫǟƪǇǲǰƲǵƼƽ", (byte)117, 66);
               b[6] = δΛψπξκσβγςα.D("ԿֆհխկՠըֈՔՠՎ՜", (byte)117, 68);
               b[7] = χφπρψπφΦθμπ.B("ƼǞƛǜǀơǡǤƼǂǌƱ", (byte)117, 66);
               b[8] = μζξτΩσσφυδεπλΨ.B("ƫǡǎǝƥǖƨǗǧǤǦƱ", (byte)117, 66);
               b[9] = φΨαξωυθανΣφυκη.A("ǏǛƿƟƤǂǆǑƪǩǦƱ", (byte)117, 65);
               b[10] = ΣφδσΔζιΠρα.E("֒֊֕չծ֣֠֫տ֟\u0590չ", (byte)117, 69);
               break;
            case 2:
               b[0] = μεςΩΔΣγν.D("պՌՉխՈ֍ՠՊ։ւ\u0590հխ\u058b֚֍նլխջ\u0557մ\u0590ջ֔֓ո֡ւֆգլ", (byte)117, 68);
            case 3:
            default:
               break;
            case 4:
               b[0] = μεςΩΔΣγν.D("բթ\u0558ՆՉ֑մՎժՒ։՜", (byte)117, 68);
         }
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(φΨαξωυθανΣφυκη.E("ց֎֍Ր\u0590\u058cև\u0590֛֊\u0557֛֕֙֒֕՝ࣲࣩ࣮ࣺࣦࣩࣤ࣫࣬࣊", (byte)98, 69));
         }
   ...
   public static boolean a(char var0) {
      return (boolean)(c<"㺀">(a, b ^ d).indexOf(var0) > e ? f : g);
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(πηγμΣΔκκ.E("Օշչՙս֪֖֜֔ե֣֧֙֡ժ֏ְֱ֮֨֨ս", (byte)113, 69), ελληλφαΔλα.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            οΩνΩρωλΨηΛδωδ.E("\u0590֝֜՟֛֖֪֟֟֙զ֤֤֪֨֡լࣺࣳࣻࣸࣽउࣵࣙँࣸւ", (byte)113, 69) + var1 + οοθδΨιοΦΠβδζ.B("ƛ", (byte)113, 66) + var2.toString(), var4
         );
      }
   }
   ...
   static {
      ...
      var10000[z] = c<"㺉">(aa, ab ^ ac);
      var10000[ad] = c<"㺌">(ae, af);
      var10000[ag] = c<"㺏">(ah & ai, aj);
      var10000[ak] = c<"㺒">(al & am, an);
      var10000[ao] = c<"㺕">(ap, aq ^ ar);
      e = var10000;
