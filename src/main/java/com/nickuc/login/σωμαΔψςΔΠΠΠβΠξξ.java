...
public class σωμαΔψςΔΠΠΠβΠξξ {
   private static String[] a = new String[σωμαΔψςΔΠΠΠβΠξξ.aq];
   ...
   private static String[] b = new String[σωμαΔψςΔΠΠΠβΠξξ.ar];
   ...
   private static final int f = σωμαΔψςΔΠΠΠβΠξξ.av;
   ...
   private final κζκδΦοωοζξΔψμΓ b;
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ςπυηννναΣ.F("ԼԾթզՂՅԺկԲՑԿծՏԮՉձԭՒԽսԶ՛ՉղյՍչԼռչ։ՀփֆիՖըջ֊Պմղյծքճկ֒ռՒ\u0557ՙնոեզ", (byte)54, 70);
               b[1] = ιΠοθΩΦξκ.F("ԢաԸՋեՠՊՑըղՀգ՟ՏԸԲթԹ՛խՍվՅՆ", (byte)54, 70);
               b[2] = οοθδΨιοΦΠβδζ.B("ĶŅĞŤĠħťĥŠŊťĻţŰłœūūŊűŴŧİŲŮœŹĿŀũţŷńŲşŶƃƄŗŃśƎŧƌŸŬŉŴŒŠƉťŘƍƎŧƏƆžŞŴųŘƚ", (byte)54, 66);
               b[3] = οοθδΨιοΦΠβδζ.D("ӂӉҚҏҫңӈӈӔӓҺҟ", (byte)54, 68);
               b[4] = ΨΦνΨΦωυΩνβςμ.B("ōşłľğŠĿŧŅŌřĥŭŃţşūŅŀŘŌŧľĿ", (byte)54, 66);
               b[5] = ξψθρΣΠΣς.D("ӉӃӎӃҨҰӇӂӍӉҵҵҼҝҚҾӠӊҳҙҭҤүҟӧҨӛӞӕҷӈӇҼӤһҽӴӑӏӢӔӸӆҿ", (byte)54, 68);
               break;
            case 1:
               b[0] = ΠΛΨοδΩσμνΛγΦφβς.E("ԼԾթզՂՅԺկԲՑԿծՏԮՉձԭՒԽսԶ՛ՉղյՍչԼռչ։ՀփֆիՖըջ֊ՊմղյՒ\u0557չֈհղճխչ֎ըեզ", (byte)54, 69);
               b[1] = ΨΦνΨΦωυΩνβςμ.E("ԢաԸՋեՠՊՑըղԽԯկմԷժձխկՑխչպղյԿՠԼոտճև", (byte)54, 69);
               b[2] = δΛψπξκσβγςα.A("ĶŅĞŤĠħťĥŠŊťĻţŰłœūūŊűŴŧİŲŮœŹĿŀũţŷńŲşŶƃƄŗŃśƎŧƌŸŬŉŴŒŠƉťŘƉƑƙƙƇŴūźŭƠţ", (byte)54, 65);
               b[3] = χφπρψπφΦθμπ.B("ŎĿŁĿĺŇĩġņŭņĳ", (byte)54, 66);
               b[4] = μεςΩΔΣγν.C("ҹӋҮҪҋӌҫӓұҸӅҒҖҘӌҰҚҶҜӗӒҭҪҫ", (byte)54, 67);
               b[5] = δΛψπξκσβγςα.A("ŝŗŢŗļńśŖšŝŉŉŐıĮŒŴŞŇĭŁĸŃĳŻļůŲũŋŜśżŞšƄŘſŕłŶƀŮœ", (byte)54, 65);
               break;
            case 2:
               b[0] = ΠΛΨοδΩσμνΛγΦφβς.B("ţņĴŕģĺŒĹŉřŃļņŏńŔńŬŨıūŧľĿ", (byte)54, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = ΨφιωσρΓδΔθ.A("şťĹţşġĽŦīĹůĦšŢūŎĿŨŧĶŕűŖĸůŬŔŎŻŐĸŸ", (byte)54, 65);
         }
      }
   }
   ...
   @Generated
   public σωμαΔψςΔΠΠΠβΠξξ(κζκδΦοωοζξΔψμΓ var1) {
      this.b = var1;
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  σωμαΔψςΔΠΠΠβΠξξ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(δΛψπξκσβγςα.D("ϠЂЄϤЈЧПеСϰЮФвЬϵКмлгйгЈ", (byte)1, 68), σωμαΔψςΔΠΠΠβΠξξ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            πχσδΦΦνθΔπ.F("ԠԭԬӯԯԫԦԯԺԩӶԴԸԱԴԺӼ\u0891࢘ࢌࢂࡦ࢛\u0896ࡩࡶࡷࡸࢋࡺ࢙࢚ԗ", (byte)1, 70) + var1 + βεξΠθρρςΔΦμ.F("ӷ", (byte)1, 70) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(λΣΩσμφγχ.B("ƘƥƤŧƧƣƞƧƲơŮƬưƩƬƲŴԉԐԄӺӞԓԎӡӮӯӰԃӲԑԒ", (byte)91, 66));
         }
   ...
   public void a(ΩψτσψΣριΣ var1, boolean var2) {
      File var3 = var1.b;
      if (!var3.exists()) {
         throw new IllegalStateException(c<"㺀">(a, b ^ d));
      } else {
         BufferedInputStream var4 = πησοιΣζΩθΛδλζσ.a(var3);
         ...
         try {
            ...
            try {
               ...
               if (var6 > i) {
                  throw new UnsupportedOperationException(c<"㺃">(j, k ^ l) + var3 + c<"㺆">(m, n ^ o) + var6 + c<"㺉">(p, q) + r);
               }
               ...
               if ((var7 & x) != 0) {
                  ...
                  try {
                     ...
                     ψΓωτιμωκχψΛΨ.d(c<"㺌">(y, z) + var23 + c<"㺏">(aa, ab ^ ac) + var1.a);
                  }
               }
   ...
   // $VF: Could not verify finally blocks. A semaphore variable has been added to preserve control flow.
   // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
   public void c(ΩψτσψΣριΣ var1) {
      File var2 = var1.b;
      if (!var2.exists()) {
         πησοιΣζΩθΛδλζσ.b(var2);
         DataOutputStream var3 = new DataOutputStream(πησοιΣζΩθΛδλζσ.a(var2));
