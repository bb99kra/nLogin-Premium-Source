...
public class μμφζρτγοθξςμΩ {
   ...
   private static String[] a = new String[μμφζρτγοθξςμΩ.z];
   private static int z = 4194304 >>> 19 | 4194304 << -19;
   @Generated
   private String U;

   @Generated
   public μμφζρτγοθξςμΩ d(String var1) {
      this.s = var1;
      return this;
   }

   @Generated
   public μμφζρτγοθξςμΩ c(String var1) {
      this.V = var1;
      return this;
   }

   @Generated
   public μμφζρτγοθξςμΩ a(βθσπψλΓωυΨλω var1) {
      this.a = var1;
      return this;
   }
   ...
   @Generated
   public μμφζρτγοθξςμΩ a(int var1) {
      this.t = var1;
      return this;
   }
      ...
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ...
                  MethodType.fromMethodDescriptorString(ςΦζσμτΓσ.C("Ѥ҆҈ѨҌҫңҹҥѴҲҨҶҰѹҞӀҿҷҽҷҌ", (byte)45, 67), μμφζρτγοθξςμΩ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ΣδτΠνεγοΓορητ.F("Ռՙ\u0558ԛ՛\u0557Ւ՛զՕԢՠդ՝ՠզԨࢶࢷࣂࢳࢿࣃࢳࣀࢺࣁࣆࣁࢯՁ", (byte)45, 70) + var1 + ξψθρΣΠΣς.B("ē", (byte)45, 66) + var2.toString(), var4
         );
      }
   }

   @Generated
   public μμφζρτγοθξςμΩ e(String var1) {
      this.X = var1;
      return this;
   }

   @Generated
   public μμφζρτγοθξςμΩ b(String var1) {
      this.U = var1;
      return this;
   }

   @Generated
   public μμφζρτγοθξςμΩ a(String var1) {
      this.T = var1;
      return this;
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(πψυκΠΨμΛΩβΣφμφσ.C("ѝѪѩЬѬѨѣѬѷѦгѱѵѮѱѷй߇߈ߓ߄ߐߔ߄ߑߋߒߗߒ߀", (byte)23, 67));
         }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = ΨΦνΨΦωυΩνβςμ.A("ÈĀýÝąďæąÍÎôďÕåčĕĘÒēÔùØû÷ėÛìĥąüāąýĪĭČç÷îįêăēĊîéĕùėİĈĉĳñďĵĒļĹığĘĄĹķĸėĠĹćĘŎņŅĮĠįņĲĴĐĚĭĻĩķĤĥ", (byte)9, 65);
               b[1] = ΣφδσΔζιΠρα.B("ĄÆçăçÏÐĂĊÓĈĔĐĂĊêěĆēĔéčäå", (byte)9, 66);
               b[2] = μζξτΩσσφυδεπλΨ.D("хвЇЈНЙЪЧтцэИ", (byte)9, 68);
               b[3] = ΣδτΠνεγοΓορητ.D("ЉФгЊжМомвщёИ", (byte)9, 68);
               b[4] = ΣερμΔσατσκ.C("ϻгЁЉЋмймМяНФбЍиСтХѕдяжУФ", (byte)9, 67);
               b[5] = πχσδΦΦνθΔπ.F("ԵԒӽԓԖԋԮԘՁԾՂԍ", (byte)9, 70);
               b[6] = ΨφιωσρΓδΔθ.F("ӹԖԓԠԁӾԬԖՇԸԺԍ", (byte)9, 70);
               b[7] = ντθΔζβΔζ.B("ÞĄÿÄèèĀäÄÉĆÙ", (byte)9, 66);
               break;
            case 1:
               b[0] = ντθΔζβΔζ.C("ЇпмМфюХфЌЍгюДФьєїБђГиЗкжіКЫѤфлрфмѩѬыЦжЭѮЩтђщЭШєиіѯчшѲаюѴёѻѸѰўїуѸѶѷіџѸцїҍ҅҄ѭѤѯ҄ѸҌѺѶѰѦѧҜѣѤ", (byte)9, 67);
               b[1] = ςΦζσμτΓσ.A("ĄÆçăçÏÐĂĊÓĈéîāÎĐôïÒéěçäå", (byte)9, 65);
               b[2] = ΠΛΨοδΩσμνΛγΦφβς.B("åØúċýËäÑÈÜëýéàÕČíûæĉýčäå", (byte)9, 66);
               b[3] = φδχεθοκψαλΛογλ.D("лчодЋыЪкцЩєпдѓїЩїЭћЩИќУФ", (byte)9, 68);
               b[4] = φΨαξωυθανΣφυκη.A("¼ôÂÊÌýúýÝĐÞĐÖăęĎĄĎĄþìçäå", (byte)9, 65);
               b[5] = ΣδτΠνεγοΓορητ.A("âÂċÈÞìÛĉÍßâĖĊêèñéćêĈç÷äå", (byte)9, 65);
               b[6] = ΦδφπθΩΩλζξ.B("àĀËÌÞäíòâþðÏĊöĈāÌĈùĝþçäå", (byte)9, 66);
               b[7] = δΛψπξκσβγςα.A("āćýÝčþĈæĒĆĆÙ", (byte)9, 65);
               break;
            case 2:
               b[0] = βεξΠθρρςΔΦμ.E("ԐԪԳԴӺԺӼԍԢԶԇԍ", (byte)9, 69);
            case 3:
            default:
               break;
            case 4:
               b[0] = θεωψξβΛσσ.D("ІвФЈнНЉрЌьПИ", (byte)9, 68);
         }
      }
   }
}
