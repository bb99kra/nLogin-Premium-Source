...
public class NLoginCore_588 implements NLoginInterface_017 {
   ...
   private static long d = Long.reverse(-8358680908399640576L);
   private static long c;
   private static int i = (16 >>> 36 | 16 << ~36 + 1) & -1;
   private static int e = (1024 >>> 138 | 1024 << ~138 + 1) & -1;
   public final NLoginCore_460 a;
   ...
   public final NLoginCore_271 a;
   private static long n = Long.reverse(899367137347213232L);
   private static long b = Long.reverse(-9188696027962697808L);

   @Generated
   public NLoginCore_588(ForceRegisterConfig var1, String var2, NLoginCore_271 var3, NLoginCore_460 var4) {
      this.f = var1;
      this.ci = var2;
      this.a = var3;
      this.a = var4;
   ...
   private static void b() {
      ...
      long var0 = c ^ -2306620689802220317L;
      ...
      SecretKeyFactory var3 = SecretKeyFactory.getInstance(new String(new byte[]{(byte)(43 + 25), 69, (byte)(3 + 80)}, StandardCharsets.UTF_8));
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            var4 = SecretKeyFactory.getInstance(new String(new byte[]{68, 69, (byte)(34 + 49)}, StandardCharsets.UTF_8));
         } catch (Exception var7) {
            throw new RuntimeException(NLoginCore_141.E("բկծԱձխըձռիԸնպճնռԾࣙࢷࢭࢼ࣐࣓࣏ࣚࣞࣛࣜࣕ࣍࣎", (byte)67, 69));
         }
   ...
   @Generated
   private NLoginCore_588(ForceRegisterConfig var1, String var2, NLoginCore_271 var3, NLoginCore_460 var4, @Nullable NLoginCore_042 var5, boolean var6) {
      this.f = var1;
      this.ci = var2;
      this.a = var3;
      this.a = var4;
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  NLoginCore_588.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(NLoginCore_223.C("ϩЋЍϭБаШоЪϹзЭлеϾУхфмтмБ", (byte)4, 67), NLoginCore_588.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            NLoginCore_387.A("ê÷ö¹ùõðùĄóÀþĂûþĄÆѡпефјѢћїѦѣѤѝѕіà", (byte)4, 65) + var1 + NLoginCore_451.D("ϻ", (byte)4, 68) + var2.toString(), var4
         );
      }
   }
   ...
   public NLoginCore_588 a(ForceRegisterConfig var1, String var2) {
      if (var1 == null) {
         throw new IllegalArgumentException(a(a, b ^ d));
      } else if (var2 == null) {
         throw new IllegalArgumentException(a(e & f, g));
      } else {
         return new NLoginCore_588(var1, var2, this.a, this.a, this.a, this.b);
      }
   }
