...
public class κζκδΦοωοζξΔψμΓ implements ητςΛζξμΣμΨξ {
   ...
   private static long do = Long.reverse(2449958197289549824L);
   ...
   private Location b;
   private static String[] a = new String[dr];
   ...
   private static String[] b = new String[ds];
   ...
   public boolean a(ιηοψσγξςΩγδ var1, ΩψτσψΣριΣ var2) {
      synchronized (var1.n) {
         Player var4 = var2.a;
         if (var2.a != ναδπσζρλδψ.c) {
            return (boolean)ax;
         } else {
            int var6;
            try {
               ...
               εσλρΔμΔψχεθυνΔ var5 = this.c.a().a();
               if (!var5.b(this.c.b().a(var4))) {
                  File var16 = var2.b;
                  if (!var16.exists()) {
                     throw new IllegalStateException(c<"㺀">(ba, bb ^ bc));
                  }

                  if (!this.c.a().isPrimaryThread() && !ΓχυψπωΣςΠκγζΦ.V()) {
                     throw new IllegalStateException(c<"㺃">(bd, be ^ bf));
                  }
                  ...
                  if (ΣλνΨουΩΔοθεβ.w.ar()) {
                     ...
                     var4.setAllowFlight(ΣλνΨουΩΔοθεβ.z.ar());
                     var4.setFlying((boolean)bh);
                     εφμωωσηκμΔχμλφ.a(var4, (boolean)bi);
   ...
   private void b(ΩψτσψΣριΣ var1) {
      Player var2 = var1.a;
      if (var1.e && this.c != null) {
         try {
            this.a(var2, this.c);
         } catch (Exception var5) {
            ψΓωτιμωκχψΛΨ.c(c<"㺀">(cc, cd) + var2.getName() + c<"㺃">(ce & cf, cg), var5);
         }
      } else if (!this.c && this.b != null) {
         try {
            this.a(var2, this.b);
         } catch (Exception var6) {
            ψΓωτιμωκχψΛΨ.c(c<"㺆">(ci & cj, ck) + var2.getName() + c<"㺉">(cl, cm), var6);
         }
      } else {
         if (this.d != null) {
            ...
            if (var3 != null) {
               try {
                  ...
                  ψΓωτιμωκχψΛΨ.c(c<"㺌">(co, cp ^ cq) + var2.getName() + c<"㺏">(cr, cs ^ ct), var7);
               }
            }
         }
      }
   ...
   public κζκδΦοωοζξΔψμΓ(nLoginBukkit var1) {
      this.c = var1;
      this.a = new σωμαΔψςΔΠΠΠβΠξξ(this);
      this.a = new File(var1.c(), c<"㺀">(a, b ^ d));
      var1.b((boolean)e).a(new SynchronizeWithServerThreadTask(() -> this.a(var1.a(), (boolean)dq)));
      File var2 = new File(var1.c(), c<"㺃">(f, g ^ h));
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  κζκδΦοωοζξΔψμΓ.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(βθκςνθΩθυμςτκχ.F("ԛԽԿԟՃբ՚հ՜ԫթ՟խէ\u0530ՕշնծմծՃ", (byte)55, 70), κζκδΦοωοζξΔψμΓ.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            ζοηκορΦνΣθγΩ.B("ŐŝŜğşśŖşŪřĦŤŨšŤŪĬҸҵҺҵҨӂӍӄҼӅҜӑӆҞņ", (byte)55, 66) + var1 + ςΦζσμτΓσ.E("ԭ", (byte)55, 69) + var2.toString(), var4
         );
      }
   }
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] =
               b[5] = ζοηκορΦνΣθγΩ.F("ԬԕԸԸԮՙԲԘԯ՛Ֆԥ", (byte)33, 70);
               b[6] = ςπυηννναΣ.B("ñĘĝĥļĽľČĮġĿĖĘņŉĩĶĬĤĈŋŁĨıĞģŒčıŏŋŁĭŋĦŒĭĕŜľĽŗěŗĮŨŅŧĤĤšĿĠŇĴĵ", (byte)33, 66);
               b[7] = ΨφιωσρΓδΔθ.C("ўѐҒҊѿғѐѥєѲѹюѯѴѻѾѠє҃ңҍңҖҦѣѳҨҔѽѫ҃ѧҍҏҥѭңҲҷҥҭҌҗҀ", (byte)33, 67);
               b[8] = ιΠοθΩΦξκ.E("ԍԴԹՁ\u0558ՙ՚ԨՊԽ՛ԲԴբեՅՒՈՀԤէ՝ՄՍԺԿծԩՍիէ՝ՉէՂծՉԱո՚ՙճԷՍջիե՚\u0558բՀռզև։ի֍ռՎՑ՜ֈթ\u0590", (byte)33, 69);
               b[9] = ΨφιωσρΓδΔθ.A("ĚċĕüēĴıĲúėĐĉ", (byte)33, 65);
               b[10] = ζβησεθωυγτ.C("҅Ѿъ҃ѲғҗѨѧѰѵҚѴѸҜҞҟґҀѲѿҢҕҜ҂ѠѾҧ҇ҖҌүѩҬѾғ҇ҤҨҕ҉ґҵҀ", (byte)33, 67);
               b[11] = μεςΩΔΣγν.C("ѺьғҀѱ҃҉їѡѷҌҊјҏџѷ҉ҝҘѹ҄ѳҜџҊѵѺѪѪҧҢҚ", (byte)33, 67);
               b[12] = ξψθρΣΠΣς.B("ĢöúýüĞĩĎĹģłğĹįĐĢņŉŉęĝīĠŊěňĲĦįœŐňĕŔŊĮĳŒŔĜīĠěĩ", (byte)33, 66);
               b[13] = ζοηκορΦνΣθγΩ.D("уѠѯѴ҉Ѷҗҋѹ҇ҚҕҔҍѧѰїҟѯҎ҆ҤџџҢѹѣѧѻѭҤ҇үѿҡѽұѰѰҩҁ҇ҨҳүҵҪҫ҉Ҽ҃Ҝұҵҡ҂ҘѼқҴҨӉӏҠ", (byte)33, 68);
               b[14] = οΩνΩρωλΨηΛδωδ.E("ԐՑՅԯԐԻԧԥԧՐԝԩԸՃՍ\u0530ԝԞՈԟԽԶՋԺԸզՋՈՀԫԮճՅՂՌՆՆԵջթնղՑձլՕփփէև՞ք՚֊ՙևՇՊի֎Տ\u0590ֆ՞֕֘յժջյ\u0590֊Ր\u058b֒ե", (byte)33, 69);
               b[15] = ςπυηννναΣ.B("ăıĄïĜùđùĺûĐěĀĶńăĻĈġćčĸŎĞľĲŋįĞŗĩŃōēřĜőŞėĴıĜŚĩ", (byte)33, 66);
               b[16] = φδχεθοκψαλΛογλ.C("эѪҔђҀѩѬѥѷ҉қѶѯћћѸѽҎҏџѱҗҟҦҊҡҁ҈ҟүѸү", (byte)33, 67);
               b[17] = δΛψπξκσβγςα.A("ăıĄïĜùđùĺûĐěĀĶńăĻĈġćčĸŎĞľĲŋįĞŗĩŃęĒĕĳŌħĠŋĝěŚĩ", (byte)33, 65);
               b[18] = πψυκΠΨμΛΩβΣφμφσ.D("ҍ҈хя҃ѪєіѭѐѵѕҋҒ҇ҖѰҢҗҀѱҖѰѻҀғҔҙ҉ѬҤ҆", (byte)33, 68);
               b[19] = ΨΦνΨΦωυΩνβςμ.B("ăıĄïĜùđùĺûĐěĀĶńăĻĈġćčĸŎĞľĲŋįĞŗĩŃĕĨķĺĬĚĩęŊěŚĩ", (byte)33, 66);
               b[20] = ΨΦνΨΦωυΩνβςμ.C("ѺҍђѝҒѢғҗіҘҎҊҖҋҙѿѪѭҠѝҥґҧқҊҗѵ҇Ѩ҈ѷҋ", (byte)33, 67);
               b[21] = ςπυηννναΣ.F("ԑԨԮՙՏՖԯՆՙԛՐԓԿՎԬՎԠԣԚբՃԵԼԻժԪթգՍթՂՓյհՊՓղՈի՝ոԹնՅ", (byte)33, 70);
               b[22] = ιΠοθΩΦξκ.E("ՔԟՕԺԑԹԺՙԝԹԼ՚ԻԭԯԷՑ՛ՠգզՃ\u0530Ա", (byte)33, 69);
               b[23] = ΣδτΠνεγοΓορητ.B("ĎČĕĉĐĸĨýĞāĬİģĚĻĲāęĽăĩŅćŅĄĪłĒĿĲŗįńŏŒŗņıĘŀŃĞŅĭİŢũŖĨģľŦņŇĴĵ", (byte)33, 66);
               b[24] = ςΦζσμτΓσ.C("ҏњҐѵьѴѵҔјѴѸҜѷѮёѯјҙҙҡҝҔѫѬ", (byte)33, 67);
               b[25] = ΨΦνΨΦωυΩνβςμ.B("ĎČĕĉĐĸĨýĞāĥĭĽĐĿņňĤąĤĥćňċĬĐĪŀĕńďŘ", (byte)33, 66);
               break;
            case 2:
               b[0] = ΨΦνΨΦωυΩνβςμ.F("ՖԿՎԹԦՇՄԜ՜\u0557ԪԮ\u0557ԛԽ՞ԴՖԺԧիԳ\u0530Ա", (byte)33, 70);
            case 3:
            default:
               break;
            case 4:
               b[0] = μζξτΩσσφυδεπλΨ.F("ՖԟԖՒԲԩԨ\u0530ԧՍԯբԬՕ\u0557ԝՇ՜ԢԾ՜ՙ\u0530Ա", (byte)33, 70);
         }
      }
   }

   public void a(ιηοψσγξςΩγδ var1, ΩψτσψΣριΣ var2, boolean var3) {
      synchronized (var1.n) {
         try {
            Player var5 = var2.a;
            if (!var5.isOnline()) {
            ...
            if (!this.c.a().isPrimaryThread() && !ΓχυψπωΣςΠκγζΦ.V()) {
               throw new IllegalStateException(c<"㺀">(bo & bp, bq));
            }

            var5.updateInventory();
            if (var2.a == ναδπσζρλδψ.d) {
               this.a(var2);
               this.b(var2);
               if (ΣλνΨουΩΔοθεβ.y.ar() || var3) {
                  κΓωλλτδχμη.b(this.c, var5);
               }
               ...
               this.c.b((boolean)br).a(var2.b::delete);
               return;
            }

            if (var2.a != ναδπσζρλδψ.e) {
               this.b(var2);
            }
         } finally {
            var2.a = ναδπσζρλδψ.e;
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(μζξτΩσσφυδεπλΨ.F("ածխ\u0530հլէհջժԷյչղյջԽࣉࣆ࣋ࣆࢹ࣓ࣞࣕ࣍ࣖࢭ\u08e2ࣗࢯ", (byte)66, 70));
         }
   ...
   private void a(ΩψτσψΣριΣ var1) {
      Player var2 = var1.a;
      if (var1.d) {
         GameMode var3 = var1.a;
         var2.setGameMode(var3 != null ? var3 : GameMode.SURVIVAL);
         var2.setAllowFlight(var1.g);
         var2.setFlying((boolean)(var1.h && var2.getAllowFlight() ? bs : bt));
         εφμωωσηκμΔχμλφ.a(var2, var1.i);
   ...
   @Nullable
   private Location a(nLoginBukkit var1, ραδκμΠΔαωεηεΛ var2) {
      if (var2 == ραδκμΠΔαωεηεΛ.f) {
         throw new UnsupportedOperationException(c<"㺀">(da, db) + var2);
      } else {
         μθκβΠυξωδΠΠγ var3 = this.c.a().a();
         String var4 = var2.aE();

         try {
            Location var5 = ξπχιβρμογιω.a(var3.k(var4));
            if (var5 != null) {
               World var6 = var5.getWorld();
               if (var6 == null || var1.a().getWorld(var6.getName()) == null) {
                  ψΓωτιμωκχψΛΨ.d(c<"㺃">(dc, dd ^ de) + var2 + c<"㺆">(df & dg, dh));
                  var3.a(var4).ag();
                  var5 = null;
               }
            }
            ...
            ψΓωτιμωκχψΛΨ.c(c<"㺉">(dj, dk ^ dl) + var2 + c<"㺌">(dm, dn ^ do), var7);
            var3.a(var4).ag();
            return null;
         }
      }
   ...
   public boolean a(ιηοψσγξςΩγδ var1, ΩψτσψΣριΣ var2, boolean var3) {
      synchronized (var1.n) {
         Player var5 = var2.a;
         if (var2.a != ναδπσζρλδψ.b) {
            return (boolean)i;
         } else {
            try {
               if (var2.b.exists()) {
                  try {
                     ...
                     ψΓωτιμωκχψΛΨ.c(c<"㺀">(j, k ^ l) + var5.getName() + c<"㺃">(m, n ^ o), var20);
                     return (boolean)q;
                  } catch (Exception var21) {
                     ψΓωτιμωκχψΛΨ.c(c<"㺆">(r & s, t) + var5.getName() + c<"㺉">(u, v ^ w) + var2.b, var21);
                     return (boolean)y;
                  }
               } else {
                  var2.g = var5.getAllowFlight();
                  var2.h = var5.isFlying();
                  var2.i = εφμωωσηκμΔχμλφ.a(var5);
               ...
               try {
                  ...
                  ψΓωτιμωκχψΛΨ.c(c<"㺌">(z, aa ^ ab) + var2.a.getName() + c<"㺏">(ac, ad ^ ae), var18);
                  return (boolean)ag;
               } catch (Exception var19) {
                  ψΓωτιμωκχψΛΨ.c(c<"㺒">(ah, ai ^ aj) + var2.a.getName() + c<"㺕">(ak, al ^ am) + var2.b, var19);
                  return (boolean)ao;
               }
               ...
               if (var3 || var2.h != null) {
                  try {
                     ...
                     ψΓωτιμωκχψΛΨ.c(c<"㺘">(ap, aq ^ ar) + var5.getName() + c<"㺛">(as, at ^ au), var17);
                  }
               }
   ...
   public void a(ΨγημιδξΓτοθαζ var1, boolean var2) {
      ...
      this.b = this.a(var3, ραδκμΠΔαωεηεΛ.c);
      this.c = this.a(var3, ραδκμΠΔαωεηεΛ.d);
      this.d = this.a(var3, ραδκμΠΔαωεηεΛ.a);
      this.e = this.a(var3, ραδκμΠΔαωεηεΛ.b);
      this.f = this.a(var3, ραδκμΠΔαωεηεΛ.e);
      μθκβΠυξωδΠΠγ var4 = var1.a().a();
      String var5 = ραδκμΠΔαωεηεΛ.f.aE();
      if (!var4.c(var5)) {
         var4.a(var5, (boolean)(this.b == null ? cx : cy));
      }

      this.c = var4.a(var5, (boolean)cz);
   }
