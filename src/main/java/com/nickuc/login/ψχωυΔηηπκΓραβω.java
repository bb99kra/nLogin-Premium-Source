...
public class ψχωυΔηηπκΓραβω {
   ...
   public static final String aQ = c<"㺆">(am, ψχωυΔηηπκΓραβω.an ^ ψχωυΔηηπκΓραβω.ao);
   ...
   private static final String aS = c<"㺃">(ψχωυΔηηπκΓραβω.aj, ak ^ ψχωυΔηηπκΓραβω.al);
   private final ΔυΠωθαψδΣΣαδψω a;
   ...
   public static final ρΣνμχγΨοΔΦ[] a;
   private static long d = Long.reverse(5942478315216813742L);
   private static final String aR = c<"㺀">(ag, ah ^ ai);
   ...
   private static String[] a = new String[ψχωυΔηηπκΓραβω.ae];
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               b[0] = μζξτΩσσφυδεπλΨ.D("ЦЯЃПзЅзЇϺКлкЙАЊЛГДхйМПІыэжлхмЌьъЊшжЯцТУиьДЖИрѝјїоСѣћѠїЮЯ", (byte)2, 68);
               b[1] = ιΠοθΩΦξκ.C("УААϲШУЎжгГмЃ", (byte)2, 67);
               b[2] = φδχεθοκψαλΛογλ.A("Ä»îÊāÿÙô÷Ö½Ë", (byte)2, 65);
               b[3] = ζοηκορΦνΣθγΩ.F("өԘԒԈԃӵԋԲԒԔԊԊԑԎԓԮԧԕӻԵԖӾԦՋԩԡԺՏԯԎՓԯ", (byte)2, 70);
               b[4] = πηγμΣΔκκ.B("Ä»îÊāÿÙô÷Ö½Ë", (byte)2, 66);
               b[5] = ΣερμΔσατσκ.D("ЦЯЃПзЅзЇϺКлкЙАЊЛГДхйМПІыэжлхмЌьъЊшжЯцТУиьДЖИрѝјїоСѣћѠїЮЯ", (byte)2, 68);
               b[6] = πηγμΣΔκκ.D("УААϲШУЎжгГмЃ", (byte)2, 68);
               b[7] = μεςΩΔΣγν.E("өԘԒԈԃӵԋԲԒԔԊԊԑԎԓԮԧԕӻԵԖӾԦՋԩԡԺՏԯԎՓԯ", (byte)2, 69);
               break;
            case 1:
               b[0] = οΩνΩρωλΨηΛδωδ.B("î÷ËçÿÍÿÏÂâăĂáØÒãÛÜčāäçÎēĕþăčĄÔĔĒÒĐþ÷ĎêëĀĔÜÝßĂ÷âĘüČĖīĂğö÷", (byte)2, 66);
               b[1] = ςΦζσμτΓσ.F("ԧԍԋԯӶԵԔӹԝԴԕԆ", (byte)2, 70);
               b[2] = ζοηκορΦνΣθγΩ.D("ЌОЮϿФЄаϹЮбІЃ", (byte)2, 68);
               b[3] = πηγμΣΔκκ.A("®Ý×ÍÈºÐ÷×ÙÏÏÖÓØóìÚÀúÛÈãďĎÓďÐăõÚÙ", (byte)2, 65);
               b[4] = φδχεθοκψαλΛογλ.D("ДϴгРЀДІϻкЙдЃ", (byte)2, 68);
               b[5] = πηγμΣΔκκ.C("ЦЯЃПзЅзЇϺКлкЙАЊЛГДхйМПІыэжлхмЌьъЊшжЯцТУиьДЖжўйэПьЮвђђїЮЯ", (byte)2, 67);
               b[6] = ςΦζσμτΓσ.A("ÖúÎ¶à¸ÞÃñíÖË", (byte)2, 65);
               b[7] = πψυκΠΨμΛΩβΣφμφσ.F("өԘԒԈԃӵԋԲԒԔԊԊԑԎԓԮԧԕӻԵԖԊՅԹՎԙԑԨԉԓԑԲՖԎԋԗԴԔ՛ԐԬԼ\u0557Ԧ", (byte)2, 70);
               break;
            case 2:
               b[0] = ζοηκορΦνΣθγΩ.B("³Ò¸íÿÙúÜĄÜðË", (byte)2, 66);
            case 3:
            default:
               break;
            case 4:
               b[0] = ντθΔζβΔζ.C("ДϴЉЕЌЁЯЮϴЭАϻЋϽИМЏпбМϿХЅлеЉшЁшОФЯ", (byte)2, 67);
         }
      }
   }
   ...
   private static Object c(Lookup var0, String var1, MethodType var2) {
      try {
         return new MutableCallSite(
            var0.findStatic(
                  ψχωυΔηηπκΓραβω.class,
                  new String(new byte[]{97}, StandardCharsets.UTF_8),
                  MethodType.fromMethodDescriptorString(πχσδΦΦνθΔπ.A("ĥŇŉĩōŬŤźŦĵųũŷűĺşƁƀŸžŸō", (byte)63, 65), ψχωυΔηηπκΓραβω.class.getClassLoader())
               )
               .asType(var2)
         );
      } catch (Exception var4) {
         throw new RuntimeException(
            μζξτΩσσφυδεπλΨ.D("ӕӢӡҤӤӠӛӤӯӞҫөӭӦөӯұࡋࡋࡎࡋࠛ\u083fࡀࡊࡅࠟࡎ\u083fࡁ࡙Ӌ", (byte)63, 68) + var1 + πψυκΠΨμΛΩβΣφμφσ.C("Ҭ", (byte)63, 67) + var2.toString(), var4
         );
      }
   }
   ...
   private static String a(int var0, long var1) {
      ...
      if (a[var0] == null) {
         ...
         try {
            ...
            throw new RuntimeException(ΦδφπθΩΩλζξ.D("шѕєЗїѓюїѢёОќѠљќѢФ\u07be\u07be߁\u07beގ\u07b2\u07b3\u07bd\u07b8ޒ߁\u07b2\u07b4ߌ", (byte)16, 68));
         }
   ...
   public void a(File var1, File var2, ρΣνμχγΨοΔΦ var3) {
      HashMap var4 = new HashMap();

      for (ΔΣλυΓΨΓβθςξη var6 : var3.a()) {
         String var7 = var6.F();
         String var8 = var6.E() + c<"㺀">(n, o ^ p);
         String var10000 = c<"㺃">(q, r ^ s);
   ...
   public ψχωυΔηηπκΓραβω(ΔυΠωθαψδΣΣαδψω var1) {
      try {
         this.a = var1;
         var1.a(a);
         ΔΦξΩΣαγλθεΓβχ var2 = var1.a(a);
         Class var3 = var2.loadClass(c<"㺀">(a & b, d));
         ...
         this.m = var3.getDeclaredMethod(c<"㺃">(j, k));
   ...
   static {
      b();
      ρΣνμχγΨοΔΦ[] var10000 = new ρΣνμχγΨοΔΦ[ap];
      var10000[aq] = αψσπμογΩ.b;
      var10000[ar] = αψσπμογΩ.c;
      var10000[as] = αψσπμογΩ.d;
      a = var10000;
   }
}
