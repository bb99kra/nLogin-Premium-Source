...
public class NLoginCore_222 {
   ...
   private static void b() {
      ...
      for (int var6 = 0; var6 < var7; var6++) {
         switch (var6) {
            case 0:
               ZKM_STR_B[0] = NLoginCore_232.B("ƅŘłţŢƐƁſŽƍųőƍŪƅŴŕƅƖŔƉƍƙƟƊŽųƦƄƥŽƀŜſŶŸƩƏũŨƞƦƢŹ", (byte)73, 66);
               ZKM_STR_B[1] = NLoginCore_446.A("ŴĽŵŪšŌſƊůŦŠř", (byte)73, 65);
               ZKM_STR_B[2] = NLoginCore_553.B("ŉŷŽŶņŠŋňƁżƎř", (byte)73, 66);
               ZKM_STR_B[3] = NLoginCore_451.B("ũŚśƂƄƊżřűŢœř", (byte)73, 66);
               ZKM_STR_B[4] = NLoginCore_201.A("ƅŘłţŢƐƁſŽƍűƖƈŗƔŹƋƊƚœżƎŗũšŴƜţşųƝƊƅŻŴţƁšƞžƜƃƮŹ", (byte)73, 65);
               break;
            case 1:
               ZKM_STR_B[0] = NLoginCore_201.B("ƅŘłţŢƐƁſŽƍųőƍŪƅŴŕƅƖŔƉƍƙƟƊŽųƦƄƥŽƀƖŵƥơťƫżƊơƓƈŹ", (byte)73, 66);
               ZKM_STR_B[1] = NLoginCore_384.A("ŗŊŌƅţŉŘŏźŉƆř", (byte)73, 65);
               ZKM_STR_B[2] = NLoginCore_201.E("տչտ՟հՑԻՒՔկղՍ", (byte)73, 69);
               ZKM_STR_B[3] = NLoginCore_091.D("ӔӢԂөԌԄӻԌӱӜӯӘ", (byte)73, 68);
               ZKM_STR_B[4] = NLoginCore_027.D("ԄӗӁӢӡԏԀӾӼԌӰԕԇӖԓӸԊԉԙӒӻԍӖӨӠӳԛӢӞӲԜԉԈөԤԘԌӤӺӧԞԜԝӸ", (byte)73, 68);
               break;
            case 2:
               ZKM_STR_B[0] = NLoginCore_559.A("ńťŖŹŦŦŏřŮƒŲšŌƎŒŤŨƒƖƜƌƐŵŶƂſƗŹšŝƈƅ", (byte)73, 65);
            case 3:
            default:
               break;
            case 4:
               ZKM_STR_B[0] = NLoginCore_387.C("ӖӧӺԌӗӚԌԀӼӲӧԊӏӪӸԕԖԑӼөԞӦӣӤ", (byte)73, 67);
         }
      }
   }
}
